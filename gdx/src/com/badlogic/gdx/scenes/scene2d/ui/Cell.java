...
public class Cell<T extends Actor> implements Poolable {
  ...
  void clear() {
    ...
    maxWidth = null;
    maxHeight = null;
    if (spaceTop != null) spaceTop = null;
    if (spaceLeft != null) spaceLeft = null;
    if (spaceBottom != null) spaceBottom = null;
    if (spaceRight != null) spaceRight = null;
    if (padTop != null) padTop = null;
    if (padLeft != null) padLeft = null;
    if (padBottom != null) padBottom = null;
    if (padRight != null) padRight = null;
    fillX = null;
    fillY = null;
    align = null;
    expandX = null;
