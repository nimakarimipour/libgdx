...
public class SplitPane extends WidgetGroup {
    ...
    protected void clampSplitAmount() {
        ...
        if (// Locked handle. Average the position.
     ...
     */
    @Initializer()
    public void setFirstWidget(@Null @Nullable() Actor widget) {
        if (firstWidget != null)
     ...
     */
    @Initializer()
    public void setSecondWidget(@Null @Nullable() Actor widget) {
        if (secondWidget != null)
