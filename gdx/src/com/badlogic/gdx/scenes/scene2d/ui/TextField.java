...
public class TextField extends Widget implements Disableable {
	...
	@Null
	@SuppressWarnings("NullAway.Init") TextFieldListener listener;

	@Null
	@SuppressWarnings("NullAway.Init") TextFieldFilter filter;
			...
			if (checkFocusTraversal(character))
				...
				if (add || remove) {
					...
					if (changeText(oldText, text)) {
						...
						lastChangeTime = time;
						updateDisplayText();
					} else if (// Keep cursor movement if the text is the same.
					!text.equals(oldText)) cursor = oldCursor;
				}
			}
	...
	static public class TextFieldStyle {
		...
		@Null
		@SuppressWarnings("NullAway.Init") public Color focusedFontColor, disabledFontColor;

		@Null
		@SuppressWarnings("NullAway.Init") public Drawable background, focusedBackground, disabledBackground, cursor, selection;

		@Null
		@SuppressWarnings("NullAway.Init") public BitmapFont messageFont;

		@Null
		@SuppressWarnings("NullAway.Init") public Color messageFontColor;
