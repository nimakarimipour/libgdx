...
public class TextField extends Widget implements Disableable {
    ...
    protected void calculateOffsets() {
        ...
        for (int n = Math.min(displayText.length(), glyphCount); end <= n; end++) if (glyphPositions[end] > endX)
            break;
    ...
    @Null
    @Nullable
    private TextField findNextTextField(Array<Actor> actors, @Null @Nullable TextField best, Vector2 bestCoords, Vector2 currentCoords, boolean up) {
