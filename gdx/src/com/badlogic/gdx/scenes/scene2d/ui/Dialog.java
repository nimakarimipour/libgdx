...
public class Dialog extends Window {
     ...
     */
    public Dialog button(@Null String text, @Null @Nullable() Object object) {
        if (skin == null)
            throw new IllegalStateException("This method may only be used if the dialog was constructed with a Skin.");
     ...
     * @param object The object that will be passed to {@link #result(Object)} if this button is clicked. May be null.
     */
    public Dialog button(@Null String text, @Null @Nullable() Object object, TextButtonStyle buttonStyle) {
     ...
     * @param object The object that will be passed to {@link #result(Object)} if this button is clicked. May be null.
     */
    public Dialog button(Button button, @Null @Nullable() Object object) {
    ...
    public void setObject(Actor actor, @Null @Nullable() Object object) {
