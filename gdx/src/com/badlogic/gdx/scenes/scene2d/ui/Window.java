        ...
        new InputListener() {
          ...
          public void touchDragged(InputEvent event, float x, float y, int pointer) {
                      ...
                      if ((edge & Align.right) != 0) {
                        ...
                        if (width + amountX < minWidth) amountX = minWidth - width;
                        if (clampPosition && windowX + width + amountX > Nullability.castToNonnull(stage, "stage not null").getWidth())
                          amountX = Nullability.castToNonnull(stage, "stage not null").getWidth() - windowX - width;
                        width += amountX;
                      }
                      if ((edge & Align.top) != 0) {
