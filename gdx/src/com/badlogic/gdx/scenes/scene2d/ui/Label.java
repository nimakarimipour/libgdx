...
public class Label extends Widget {
  ...
  public void layout() {
                  ...
                  if ((labelAlign & Align.top) != 0) {
                      ...
                      y += Nullability.castToNonnull(style.font, "style font not null").getDescent();
  ...
  public float getPrefHeight() {
      ...
      if (fontScaleChanged) {
          descentScaleCorrection = fontScaleY / Nullability.castToNonnull(style.font, "Null checked earlier").getScaleY();
      }
      
      float height = prefHeight - Nullability.castToNonnull(style.font, "Null checked earlier").getDescent() * descentScaleCorrection * 2;
      Drawable background = style.background;
      if (background != null)
        height =
            Math.max(
