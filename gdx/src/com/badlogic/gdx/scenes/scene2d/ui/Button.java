...
public class Button extends Table implements Disableable {
	...
	@SuppressWarnings("NullAway.Init") ButtonGroup buttonGroup;
	...
	static public class ButtonStyle {
		...
		@Null
		@SuppressWarnings("NullAway.Init") public Drawable up, down, over, focused, disabled;

		@Null
		@SuppressWarnings("NullAway.Init") public Drawable checked, checkedOver, checkedDown, checkedFocused;
