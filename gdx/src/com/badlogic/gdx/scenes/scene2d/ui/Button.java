...
public class Button extends Table implements Disableable {
	...
	static public class ButtonStyle {
		...
		@Null
		@Nullable public Drawable up, down, over, focused, disabled;

		@Null
		@Nullable public Drawable checked, checkedOver, checkedDown, checkedFocused;
		...
		public ButtonStyle (@Null @Nullable Drawable up, @Null @Nullable Drawable down, @Null @Nullable Drawable checked) {
			this.up = up;
			this.down = down;
