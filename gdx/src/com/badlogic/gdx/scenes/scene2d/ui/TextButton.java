...
public class TextButton extends Button {
	...
	static public class TextButtonStyle extends ButtonStyle {
		...
		@Null
		@SuppressWarnings("NullAway.Init") public Color fontColor, downFontColor, overFontColor, focusedFontColor,
			disabledFontColor;

		@Null
		@SuppressWarnings("NullAway.Init") public Color checkedFontColor, checkedDownFontColor, checkedOverFontColor,
