...
public class TextButton extends Button {
	...
	static public class TextButtonStyle extends ButtonStyle {
		...
		@Null
		@Nullable public Color fontColor, downFontColor, overFontColor, focusedFontColor, disabledFontColor;

		@Null
		@Nullable public Color checkedFontColor, checkedDownFontColor, checkedOverFontColor, checkedFocusedFontColor;
