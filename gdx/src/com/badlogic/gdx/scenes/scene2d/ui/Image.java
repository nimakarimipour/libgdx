...
public class Image extends Widget {
     ...
     */
    public Image(@Null @Nullable() Drawable drawable) {
     ...
     * @param drawable May be null.
     */
    public Image(@Null @Nullable() Drawable drawable, Scaling scaling) {
     ...
     * @param drawable May be null.
     */
    public Image(@Null @Nullable() Drawable drawable, Scaling scaling, int align) {
     ...
     */
    @Initializer()
    public void setDrawable(@Null @Nullable() Drawable drawable) {
