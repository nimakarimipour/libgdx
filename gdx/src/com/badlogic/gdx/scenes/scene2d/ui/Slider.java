...
public class Slider extends ProgressBar {
	...
	public Slider (float min, float max, float stepSize, boolean vertical, SliderStyle style) {
		...
		addListener(new InputListener() {
			...
			public void enter (InputEvent event, float x, float y, int pointer, @Null @Nullable Actor fromActor) {
	...
	static public class SliderStyle extends ProgressBarStyle {
		...
		@Null
		@Nullable public Drawable backgroundOver, backgroundDown;

		@Null
		@Nullable public Drawable knobOver, knobDown;

		@Null
		@Nullable public Drawable knobBeforeOver, knobBeforeDown;

		@Null
		@Nullable public Drawable knobAfterOver, knobAfterDown;
