...
public class Slider extends ProgressBar {
	...
	static public class SliderStyle extends ProgressBarStyle {
		...
		@Null
		@SuppressWarnings("NullAway.Init") public Drawable backgroundOver, backgroundDown;

		@Null
		@SuppressWarnings("NullAway.Init") public Drawable knobOver, knobDown;

		@Null
		@SuppressWarnings("NullAway.Init") public Drawable knobBeforeOver, knobBeforeDown;

		@Null
		@SuppressWarnings("NullAway.Init") public Drawable knobAfterOver, knobAfterDown;
