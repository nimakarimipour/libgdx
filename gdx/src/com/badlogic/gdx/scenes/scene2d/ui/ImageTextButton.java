...
public class ImageTextButton extends Button {
	...
	static public class ImageTextButtonStyle extends TextButtonStyle {
		...
		@Null
		@SuppressWarnings("NullAway.Init") public Drawable imageUp, imageDown, imageOver, imageDisabled;

		@Null
		@SuppressWarnings("NullAway.Init") public Drawable imageChecked, imageCheckedDown, imageCheckedOver;
