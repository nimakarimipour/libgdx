...
public class ProgressBar extends Widget implements Disableable {
	...
	@SuppressWarnings("NullAway.Init") private ProgressBarStyle style;
	...
	public void draw (Batch batch, float parentAlpha) {
		...
		if (vertical) {
			...
			if (knobBefore != null) {
				...
				//
				//
				drawRound(batch, knobBefore, x + (width - knobBefore.getMinWidth()) * 0.5f, y + bgBottomHeight,
			...
			if (knobAfter != null) {
				...
				//
				//
				drawRound(batch, knobAfter, x + (width - knobAfter.getMinWidth()) * 0.5f, y + position + knobHeightHalf,
			...
			if (knobBefore != null) {
				...
				//
				//
				drawRound(batch, knobBefore, x + bgLeftWidth, y + (height - knobBefore.getMinHeight()) * 0.5f,
			...
			if (knobAfter != null) {
				...
				//
				//
				drawRound(batch, knobAfter, x + position + knobWidthHalf, y + (height - knobAfter.getMinHeight()) * 0.5f,
	...
	static public class ProgressBarStyle {
		...
		@Null
		@Nullable public Drawable background, disabledBackground;

		@Null
		@Nullable public Drawable knob, disabledKnob;

		@Null
		@Nullable public Drawable knobBefore, disabledKnobBefore;

		@Null
		@Nullable public Drawable knobAfter, disabledKnobAfter;
