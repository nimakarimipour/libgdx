    ...
    public void draw(Batch batch, float parentAlpha) {
        ...
        if (vertical) {
            ...
            if (knobBefore != null) {
                ...
                // 
                // 
                drawRound(batch, knobBefore, x + (width - knobBefore.getMinWidth()) * 0.5f, y + bgBottomHeight, knobBefore.getMinWidth(), beforeHeight + knobHeightHalf);
            }
            if (knobAfter != null) {
                // 
                // 
                ...
                // 
                // 
                drawRound(batch, knobAfter, x + (width - knobAfter.getMinWidth()) * 0.5f, y + position + knobHeightHalf, knobAfter.getMinWidth(), total - (round ? Math.round(beforeHeight - knobHeightHalf) : beforeHeight - knobHeightHalf));
            }
            if (currentKnob != null) {
                ...
                // 
                // 
                drawRound(batch, currentKnob, x + (width - w) * 0.5f, y + position + (knobHeight - h) * 0.5f, w, h);
            }
        } else {
            ...
            if (knobBefore != null) {
                ...
                // 
                // 
                drawRound(batch, knobBefore, x + bgLeftWidth, y + (height - knobBefore.getMinHeight()) * 0.5f, beforeWidth + knobWidthHalf, knobBefore.getMinHeight());
            }
            if (knobAfter != null) {
                // 
                // 
                ...
                // 
                // 
                drawRound(batch, knobAfter, x + position + knobWidthHalf, y + (height - knobAfter.getMinHeight()) * 0.5f, total - (round ? Math.round(beforeWidth - knobWidthHalf) : beforeWidth - knobWidthHalf), knobAfter.getMinHeight());
            }
            if (currentKnob != null) {
                float w = currentKnob.getMinWidth(), h = currentKnob.getMinHeight();
                // 
                ...
                // 
                // 
                drawRound(batch, currentKnob, x + position + (knobWidth - w) * 0.5f, y + (height - h) * 0.5f, w, h);
            }
        }
    }
