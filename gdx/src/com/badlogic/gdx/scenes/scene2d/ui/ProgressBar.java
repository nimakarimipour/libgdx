    ...
    public void draw(Batch batch, float parentAlpha) {
        ...
        if (vertical) {
            ...
            if (knobAfter != null) {
                ...
                y + position + knobHeightHalf, knobAfter.getMinWidth(), total - (round ? Math.round(beforeHeight - knobHeightHalf) : beforeHeight - knobHeightHalf));
            }
            if (currentKnob != null) {
            ...
            if (knobAfter != null) {
                ...
                y + (height - knobAfter.getMinHeight()) * 0.5f, total - (round ? Math.round(beforeWidth - knobWidthHalf) : beforeWidth - knobWidthHalf), knobAfter.getMinHeight());
            }
            if (currentKnob != null) {
                float w = currentKnob.getMinWidth(), h = currentKnob.getMinHeight();
                // 
