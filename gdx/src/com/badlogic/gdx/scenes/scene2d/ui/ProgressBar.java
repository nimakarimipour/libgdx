...
public class ProgressBar extends Widget implements Disableable {
		...
		if (vertical) {
			...
			if (knobBefore != null) {
				...
				drawRound(//
					...
					y + bgBottomHeight, knobBefore.getMinWidth(), beforeHeight + knobHeightHalf);
			}
			if (knobAfter != null) {
				//
				drawRound(//
					...
					y + position + knobHeightHalf, knobAfter.getMinWidth(),
			...
			if (currentKnob != null) {
				...
				drawRound(//
					...
					currentKnob, //
					x + (width - w) * 0.5f, //
					y + position + (knobHeight - h) * 0.5f, w, h);
			}
		} else {
			...
			if (knobBefore != null) {
				...
				drawRound(//
					...
					knobBefore, //
					x + bgLeftWidth, //
					y + (height - knobBefore.getMinHeight()) * 0.5f, beforeWidth + knobWidthHalf, knobBefore.getMinHeight());
			}
			if (knobAfter != null) {
				//
				drawRound(//
	...
	static public class ProgressBarStyle {
		...
		@Null
		@SuppressWarnings("NullAway.Init") public Drawable background, disabledBackground;

		@Null
		@SuppressWarnings("NullAway.Init") public Drawable knob, disabledKnob;

		@Null
		@SuppressWarnings("NullAway.Init") public Drawable knobBefore, disabledKnobBefore;

		@Null
		@SuppressWarnings("NullAway.Init") public Drawable knobAfter, disabledKnobAfter;
