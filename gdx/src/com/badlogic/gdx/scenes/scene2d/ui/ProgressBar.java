...
public class ProgressBar extends Widget implements Disableable {
    ...
    public void draw(Batch batch, float parentAlpha) {
        ...
        if (vertical) {
            ...
            if (knobBefore != null) {
                if (round) {
                    knobBefore.draw(batch, Math.round(x + (width - knobBefore.getMinWidth()) * 0.5f), Math.round(y + bgTopHeight), Math.round(knobBefore.getMinWidth()), Math.round(position + knobHeightHalf));
                } else {
            ...
            if (knobAfter != null) {
                if (round) {
                    knobAfter.draw(batch, Math.round(x + (width - knobAfter.getMinWidth()) * 0.5f), Math.round(y + position + knobHeightHalf), Math.round(knobAfter.getMinWidth()), Math.round(height - position - knobHeightHalf - bgBottomHeight));
                } else {
            ...
            if (knobBefore != null) {
                if (round) {
                    knobBefore.draw(batch, Math.round(x + bgLeftWidth), Math.round(y + (height - knobBefore.getMinHeight()) * 0.5f), Math.round(position + knobWidthHalf), Math.round(knobBefore.getMinHeight()));
                } else {
            ...
            if (knobAfter != null) {
                if (round) {
                    knobAfter.draw(batch, Math.round(x + position + knobWidthHalf), Math.round(y + (height - knobAfter.getMinHeight()) * 0.5f), Math.round(width - position - knobWidthHalf - bgRightWidth), Math.round(knobAfter.getMinHeight()));
                } else {
