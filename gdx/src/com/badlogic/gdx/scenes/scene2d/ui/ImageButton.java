...
public class ImageButton extends Button {
    ...
    static public class ImageButtonStyle extends ButtonStyle {
        ...
        public ImageButtonStyle(@Null @Nullable Drawable up, @Null @Nullable Drawable down, @Null @Nullable Drawable checked, @Null Drawable imageUp, @Null @Nullable Drawable imageDown, @Null @Nullable Drawable imageChecked) {
