...
public class Table extends WidgetGroup {
	...
	@Nullable private float[] columnMinWidth, rowMinHeight;
	@Nullable private float[] columnPrefWidth, rowPrefHeight;
	private float tableMinWidth, tableMinHeight;
	private float tablePrefWidth, tablePrefHeight;
	@Nullable private float[] columnWidth, rowHeight;
	@Nullable private float[] expandWidth, expandHeight;
	...
	@Nullable public @Null <T extends Actor> Cell<T> getCell (T actor) {
	...
	public void layout () {
		...
		for (int i = 0; i < cellCount; i++) {
			...
			float fillX = c.fillX == null ? 0 : c.fillX, fillY = c.fillY;
			if (fillX > 0) {
