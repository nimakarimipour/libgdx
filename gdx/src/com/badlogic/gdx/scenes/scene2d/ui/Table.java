...
public class Table extends WidgetGroup {
	...
	public Table (@Null @Nullable Skin skin) {
		this.skin = skin;
	...
	public void setBackground (@Null @Nullable Drawable background) {
	...
	public <T extends Actor> Cell<T> add (@Null @Nullable T actor) {
