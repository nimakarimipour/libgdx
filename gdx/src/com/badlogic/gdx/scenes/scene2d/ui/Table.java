...
public class Table extends WidgetGroup {
  ...
  private void computeSize() {
        ...
        for (int i = 0; i < cellCount; i++) {
            ...
            float prefWidth = Nullability.castToNonnull(c.prefWidth, "default value assigned").get(a), prefHeight = c.prefHeight.get(a);
  ...
  public void layout() {
          ...
          for (int i = 0; i < cellCount; i++) {
              ...
              float prefWidth = Nullability.castToNonnull(c.prefWidth, "set to default value").get(a), prefHeight = c.prefHeight.get(a);
              float minWidth = c.minWidth.get(a), minHeight = c.minHeight.get(a);
