...
public class Table extends WidgetGroup {
  ...
  public void layout() {
    ...
    for (int i = 0; i < cellCount; i++) {
      ...
      float prefWidth = c.prefWidth.get(a), prefHeight = c.prefHeight.get(a);
      float minWidth = c.minWidth.get(a), minHeight = c.minHeight.get(a);
      float maxWidth = a != null ? c.maxWidth.get(a) : Float.MAX_VALUE,
          maxHeight = a != null ? c.maxHeight.get(a) : Float.MAX_VALUE;
      if (prefWidth < minWidth) prefWidth = minWidth;
      if (prefHeight < minHeight) prefHeight = minHeight;
      if (maxWidth > 0 && prefWidth > maxWidth) prefWidth = maxWidth;
      if (maxHeight > 0 && prefHeight > maxHeight) prefHeight = maxHeight;
    ...
    for (int i = 0; i < cellCount; i++) {
      ...
      if (fillY > 0) {
        ...
        float maxHeight = a != null ? c.maxHeight.get(a) : Float.MAX_VALUE;
