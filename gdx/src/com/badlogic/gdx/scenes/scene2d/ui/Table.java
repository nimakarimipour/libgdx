...
public class Table extends WidgetGroup {
  ...
  private void computeSize() {
    ...
    for (int i = 0; i < cellCount; i++) {
      ...
      if (a != null) c.computedPadTop = c.padTop.get(a);
      if (c.cellAboveIndex != -1) {
        Cell above = (Cell) cells[c.cellAboveIndex];
        if (a != null && above != null)
          c.computedPadTop += Math.max(0, c.spaceTop.get(a) - above.spaceBottom.get(a));
      }
      float spaceRight = (a != null) ? c.spaceRight.get(a) : 0;
      c.computedPadRight =
          (a != null ? c.padRight.get(a) : 0) + ((column + colspan) == columns ? 0 : spaceRight);
      c.computedPadBottom =
          (a != null ? c.padBottom.get(a) : 0)
              + (row == rows - 1 ? 0 : (a != null ? c.spaceBottom.get(a) : 0));
      spaceRightLast = spaceRight;

      float prefWidth = (a != null ? c.prefWidth.get(a) : 0),
          prefHeight = (a != null ? c.prefHeight.get(a) : 0);
      float minWidth = (a != null ? c.minWidth.get(a) : 0),
          minHeight = (a != null ? c.minHeight.get(a) : 0);
      float maxWidth = (a != null ? c.maxWidth.get(a) : 0),
          maxHeight = (a != null ? c.maxHeight.get(a) : 0);
    ...
    for (int i = 0; i < cellCount; i++) {
      ...
      Actor a = c.actor;
      float minWidth = (a != null ? c.minWidth.get(a) : 0),
          prefWidth = (a != null ? c.prefWidth.get(a) : 0),
          maxWidth = (a != null ? c.maxWidth.get(a) : 0);
      if (prefWidth < minWidth) prefWidth = minWidth;
      if (maxWidth > 0 && prefWidth > maxWidth) prefWidth = maxWidth;
      if (round) {
        minWidth = (float) Math.ceil(minWidth);
