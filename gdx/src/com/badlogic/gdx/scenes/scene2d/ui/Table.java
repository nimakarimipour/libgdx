  ...
  private void computeSize() {
                ...
                for (int i = 0; i < cellCount; i++) {
                    ...
                    if (c.padLeft != null && c.spaceLeft != null) {
                        c.computedPadLeft =
                                Nullability.castToNonnull(c.padLeft, "cannot be null here").get(a) + (column == 0 ? 0 : Math.max(0, Nullability.castToNonnull(c.spaceLeft, "not nullable").get(a) - spaceRightLast));
                    }
                    if (c.padTop != null) {
                    ...
                    if (c.cellAboveIndex != -1) {
                        ...
                        if (c.spaceTop != null && above.spaceBottom != null) {
                            c.computedPadTop += Math.max(0, c.spaceTop.get(a) - Nullability.castToNonnull(above.spaceBottom, "not null").get(a));
                        }
                    }
                    if (c.spaceRight == null) {
                        throw new IllegalArgumentException("spaceRight cannot be null.");
                    }
                    float spaceRight = Nullability.castToNonnull(c.spaceRight, "checked and throws").get(a);
                    if (c.padRight != null) {
