...
public class ScrollPane extends WidgetGroup {
     ...
     * @param actor May be null.
     */
    public ScrollPane(@Null @Nullable Actor actor, ScrollPaneStyle style) {
        if (style == null)
    ...
    public void act(float delta) {
        ...
        // 
        (!touchScrollH || (scrollX && maxX / (hScrollBounds.width - hKnobBounds.width) > actorArea.width * 0.1f)) && (!touchScrollV || (scrollY && maxY / (vScrollBounds.height - vKnobBounds.height) > actorArea.height * 0.1f)))) {
    ...
    public void layout() {
        ...
        if (scrollY) {
            if (vScrollKnob != null) {
                ...
                if (variableSizeKnobs)
                    vKnobBounds.height = Math.max(vScrollKnob.getMinHeight(), (int) (vScrollBounds.height * actorArea.height / actorHeight));
                else
