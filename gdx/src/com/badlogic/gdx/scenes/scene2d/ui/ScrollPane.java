...
public class ScrollPane extends WidgetGroup {
	...
	protected ActorGestureListener getFlickScrollListener () {
		return new ActorGestureListener() {
			...
			public boolean handle (Event event) {
				...
				event instanceof InputEvent && ((InputEvent)event).isTouchFocusCancel()) cancel();
				return false;
			}
		};
	}
	...
	public float getPrefWidth () {
		...
		actor != null) width = actor.getWidth();
	...
	public float getPrefHeight () {
		...
		actor != null) height = actor.getHeight();
		Drawable background = style.background;
		if (background != null)
	...
	static public class ScrollPaneStyle {
		...
		@Null
		@SuppressWarnings("NullAway.Init") public Drawable background, corner;

		@Null
		@SuppressWarnings("NullAway.Init") public Drawable hScroll, hScrollKnob;

		@Null
		@SuppressWarnings("NullAway.Init") public Drawable vScroll, vScrollKnob;
