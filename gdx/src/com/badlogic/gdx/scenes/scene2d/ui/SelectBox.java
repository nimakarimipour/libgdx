...
public class SelectBox<T> extends Widget implements Disableable {
	...
	static public class SelectBoxStyle {
		...
		@Null
		@SuppressWarnings("NullAway.Init") public Color overFontColor, disabledFontColor;

		@Null
		@SuppressWarnings("NullAway.Init") public Drawable background;
		...
		@Null
		@SuppressWarnings("NullAway.Init") public Drawable backgroundOver, backgroundOpen, backgroundDisabled;
