...
public class Tree<N extends Node, V> extends WidgetGroup {
	...
	protected float drawIcons (Batch batch, float r, float g, float b, float a, @Null @Nullable N parent, Array<N> nodes,
	...
	protected Drawable getExpandIcon (N node, float iconX) {
		...
		//
		//
		node == overNode && Gdx.app.getType() == ApplicationType.Desktop
