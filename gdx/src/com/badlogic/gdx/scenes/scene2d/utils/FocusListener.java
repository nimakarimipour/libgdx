...
abstract public class FocusListener implements EventListener {
     ...
     */
    public void keyboardFocusChanged(FocusEvent event, @Nullable Actor actor, boolean focused) {
    }

    /**
     * @param actor The event target, which is the actor that emitted the focus event.
     */
    public void scrollFocusChanged(FocusEvent event, @Nullable Actor actor, boolean focused) {
    }
    ...
    static public class FocusEvent extends Event {
         ...
         */
        public void setRelatedActor(@Null @Nullable Actor relatedActor) {
