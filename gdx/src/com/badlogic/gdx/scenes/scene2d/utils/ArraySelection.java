...
public class ArraySelection<T> extends Selection<T> {
  ...
  /**
   * Removes objects from the selection that are no longer in the items array. If {@link
   * #getRequired()} is true and there is no selected item, the first item is selected.
   */
