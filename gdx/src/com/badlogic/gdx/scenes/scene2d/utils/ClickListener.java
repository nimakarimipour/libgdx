...
/**
 * Detects mouse over, mouse or finger touch presses, and clicks on an actor. A touch must go down
 * over the actor and is considered pressed as long as it is over the actor or within the {@link
 * #setTapSquareSize(float) tap square}. This behavior makes it easier to press buttons on a touch
 * interface when the initial touch happens near the edge of the actor. Double clicks can be
 * detected using {@link #getTapCount()}. Any touch (not just the first) will trigger this listener.
...
public class ClickListener extends InputListener {
  ...
  /**
   * If a touch down is being monitored, the drag and touch up events are ignored until the next
   * touch up.
   */
  public void cancel() {
   ...
   * This allows the UI to show a press and release that was so fast it occurred within a single
   * frame.
   */
