 ...
 * scroll pane's touch focus using <code>
 * stage.cancelTouchFocus(scrollPane);</code>. In this case the drag scroll listener must not be attached to the scroll pane, else
