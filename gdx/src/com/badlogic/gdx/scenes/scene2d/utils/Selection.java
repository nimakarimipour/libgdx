 ...
 * can be vetoed via {@link ChangeEvent#cancel()}.
 *
 * @author Nathan Sweet
 */
public class Selection<T> implements Disableable, Iterable<T> {
  ...
  /**
   * Selects or deselects the specified item based on how the selection is configured, whether ctrl
   * is currently pressed, etc. This is typically invoked by user interaction.
   */
  ...
  public void remove(T item) {
    ...
    if (programmaticChangeEvents && fireChangeEvent()) selected.add(item);
    else {
      lastSelected = null;
      changed();
    }
   ...
   * changes, depending on {@link #setProgrammaticChangeEvents(boolean)}.
   *
