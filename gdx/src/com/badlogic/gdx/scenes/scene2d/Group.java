...
public class Group extends Actor implements Cullable {
    ...
    protected void setStage(Stage stage) {
        ...
        Actor[] childrenArray = children.items;
        for (// StackOverflowError here means the group is its own ascendant.
        int i = 0, n = children.size; // StackOverflowError here means the group is its own ascendant.
        i < n; // StackOverflowError here means the group is its own ascendant.
        i++) childrenArray[i].setStage(stage);
    }
