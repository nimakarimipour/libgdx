...
public class Stage extends InputAdapter implements Disposable {
    ...
    @Null
    @Nullable
    private Actor fireEnterAndExit(@Null @Nullable Actor overLast, int screenX, int screenY, int pointer) {
     ...
     */
    public void addTouchFocus(EventListener listener, Actor listenerActor, @Nullable Actor target, int pointer, int button) {
     ...
     * @see #cancelTouchFocus()
     */
    public void cancelTouchFocusExcept(@Null @Nullable EventListener exceptListener, @Null @Nullable Actor exceptActor) {
        InputEvent event = Pools.obtain(InputEvent.class);
        event.setStage(this);
        event.setType(InputEvent.Type.touchUp);
        event.setStageX(Integer.MIN_VALUE);
     ...
     */
    public boolean setKeyboardFocus(@Null @Nullable Actor actor) {
     ...
     * @return true if the unfocus and focus events were not cancelled by a {@link FocusListener}.
     */
    public boolean setScrollFocus(@Null @Nullable Actor actor) {
