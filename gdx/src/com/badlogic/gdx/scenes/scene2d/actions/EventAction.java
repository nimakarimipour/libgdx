...
/**
 * Adds a listener to the actor for a specific event type and does not complete until {@link
 * #handle(Event)} returns true.
 *
 * @author JavadocMD
 * @author Nathan Sweet
 */
public abstract class EventAction<T extends Event> extends Action {
   ...
   *
   * @return true if the event should be considered {@link Event#handle() handled} and this
   *     EventAction considered complete.
   */
