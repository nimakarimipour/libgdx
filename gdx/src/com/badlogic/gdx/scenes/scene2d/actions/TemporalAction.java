...
public abstract class TemporalAction extends Action {
  ...
  @Nullable private @Null Interpolation interpolation;
  ...
  /**
   * Called the first time {@link #act(float)} is called. This is a good place to query the {@link
   * #actor actor's} starting state.
   */
   ...
   *     duration. If {@link #setReverse(boolean) reversed}, this will shrink from 1 to 0.
   */
  ...
  public void setInterpolation(@Nullable @Null Interpolation interpolation) {
    this.interpolation = interpolation;
  }
