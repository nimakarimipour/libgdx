...
public class Actions {
	...
	public static MoveToAction moveTo (float x, float y, float duration, @Nullable @Null Interpolation interpolation) {
	...
	public static MoveByAction moveBy (float amountX, float amountY, float duration, @Nullable @Null Interpolation interpolation) {
	...
	public static SizeToAction sizeTo (float x, float y, float duration, @Nullable @Null Interpolation interpolation) {
	...
	public static SizeByAction sizeBy (float amountX, float amountY, float duration, @Nullable @Null Interpolation interpolation) {
	...
	public static ScaleToAction scaleTo (float x, float y, float duration, @Nullable @Null Interpolation interpolation) {
	...
	public static RotateToAction rotateTo (float rotation, float duration, @Nullable @Null Interpolation interpolation) {
	...
	public static RotateByAction rotateBy (float rotationAmount, float duration, @Nullable @Null Interpolation interpolation) {
	...
	/** Transitions from the color at the time this action starts to the specified color. */
	public static ColorAction color (Color color, float duration, @Nullable @Null Interpolation interpolation) {
	...
	/** Transitions from the alpha at the time this action starts to the specified alpha. */
	public static AlphaAction alpha (float a, float duration, @Nullable @Null Interpolation interpolation) {
