...
public class Actions {
    ...
    static public MoveToAction moveTo(float x, float y, float duration, @Null @Nullable() Interpolation interpolation) {
    ...
    static public MoveToAction moveToAligned(float x, float y, int alignment, float duration, @Null @Nullable() Interpolation interpolation) {
        MoveToAction action = action(MoveToAction.class);
    ...
    static public MoveByAction moveBy(float amountX, float amountY, float duration, @Null @Nullable() Interpolation interpolation) {
    ...
    static public SizeToAction sizeTo(float x, float y, float duration, @Null @Nullable() Interpolation interpolation) {
    ...
    static public SizeByAction sizeBy(float amountX, float amountY, float duration, @Null @Nullable() Interpolation interpolation) {
    ...
    static public ScaleToAction scaleTo(float x, float y, float duration, @Null @Nullable() Interpolation interpolation) {
    ...
    static public ScaleByAction scaleBy(float amountX, float amountY, float duration, @Null @Nullable() Interpolation interpolation) {
    ...
    static public RotateToAction rotateTo(float rotation, float duration, @Null @Nullable() Interpolation interpolation) {
    ...
    static public RotateByAction rotateBy(float rotationAmount, float duration, @Null @Nullable() Interpolation interpolation) {
     ...
     * Transitions from the color at the time this action starts to the specified color.
     */
    static public ColorAction color(Color color, float duration, @Null @Nullable() Interpolation interpolation) {
     ...
     * Transitions from the alpha at the time this action starts to the specified alpha.
     */
    static public AlphaAction alpha(float a, float duration, @Null @Nullable() Interpolation interpolation) {
