...
public class Actions {
	...
	static public MoveToAction moveTo (float x, float y, float duration, @Nullable @Null Interpolation interpolation) {
	...
	static public MoveByAction moveBy (float amountX, float amountY, float duration, @Nullable @Null Interpolation interpolation) {
	...
	static public SizeToAction sizeTo (float x, float y, float duration, @Nullable @Null Interpolation interpolation) {
	...
	static public SizeByAction sizeBy (float amountX, float amountY, float duration, @Nullable @Null Interpolation interpolation) {
	...
	static public ScaleToAction scaleTo (float x, float y, float duration, @Nullable @Null Interpolation interpolation) {
	...
	static public RotateToAction rotateTo (float rotation, float duration, @Nullable @Null Interpolation interpolation) {
	...
	static public RotateByAction rotateBy (float rotationAmount, float duration, @Nullable @Null Interpolation interpolation) {
	...
	/** Transitions from the color at the time this action starts to the specified color. */
	static public ColorAction color (Color color, float duration, @Nullable @Null Interpolation interpolation) {
	...
	/** Transitions from the alpha at the time this action starts to the specified alpha. */
	static public AlphaAction alpha (float a, float duration, @Nullable @Null Interpolation interpolation) {
