 ...
 * assets directory. FileHandles are created via a {@link Files} instance.
 *
 * <p>Because some of the file types are backed by composite files and may be compressed (for
 * example, if they are in an Android .apk or are found via the classpath), the methods for
 * extracting a {@link #path()} or {@link #file()} may not be appropriate for all types. Use the
 * Reader or Stream methods here to hide these dependencies from your platform independent code.
 *
 * @author mzechner
 * @author Nathan Sweet
 */
public class FileHandle {
   ...
   * don't need any of the backends. Do not use this constructor in case you write something
   * cross-platform. Use the {@link Files} interface instead.
   *
  ...
  /**
   * Creates a new absolute FileHandle for the {@link File}. Use this for tools on the desktop that
   * don't need any of the backends. Do not use this constructor in case you write something
   * cross-platform. Use the {@link Files} interface instead.
   *
   * @param file the file.
   ...
   *     Gdx.files.internal("dir/file.png") -> dir/file.png. backward slashes will be replaced by
   *     forward slashes.
   */
  public String path() {
    ...
    try {
      ...
      if (file().isDirectory())
        throw new GdxRuntimeException(
            "Cannot open a stream to a directory: " + file + " (" + type + ")", ex);
  ...
  /**
   * Returns a buffered reader for reading this file as characters using the platform's default
   * charset.
   *
   * @throws GdxRuntimeException if the file handle represents a directory, doesn't exist, or could
   *     not be read.
   ...
   *
   * @throws GdxRuntimeException if this file handle represents a directory, doesn't exist, or could
   *     not be read, or memory mapping fails, or is a {@link FileType#Classpath} file.
   */
  ...
  public void write(InputStream input, boolean append) {
    ...
    try {
      ...
      throw new GdxRuntimeException(
          "Error stream writing to file: " + file + " (" + type + ")", ex);
    } finally {
      StreamUtils.closeQuietly(input);
  ...
  /**
   * Returns a writer for writing to this file using the default charset. Parent directories will be
  ...
  /**
   * Writes the specified string to the file using the default charset. Parent directories will be
   * created if necessary.
   *
   * @param append If false, this file will be overwritten if it exists, otherwise it will be
   *     appended.
  ...
  /**
   * Writes the specified string to the file using the specified charset. Parent directories will be
   * created if necessary.
   *
   * @param append If false, this file will be overwritten if it exists, otherwise it will be
   *     appended.
  ...
  /**
   * Returns the paths to the children of this directory. Returns an empty list if this file handle
   * represents a file and not a directory. On the desktop, an {@link FileType#Internal} handle to a
  ...
  /**
   * Returns the paths to the children of this directory that satisfy the specified filter. Returns
   * an empty list if this file handle represents a file and not a directory. On the desktop, an
   * {@link FileType#Internal} handle to a directory on the classpath will return a zero length
   * array.
   *
  ...
  /**
   * Returns the paths to the children of this directory with the specified suffix. Returns an empty
   * list if this file handle represents a file and not a directory. On the desktop, an {@link
   * FileType#Internal} handle to a directory on the classpath will return a zero length array.
   *
   * @throws GdxRuntimeException if this file is an {@link FileType#Classpath} file.
   */
  ...
  /**
   * Returns true if this file is a directory. Always returns false for classpath files. On Android,
   * an {@link FileType#Internal} handle to an empty directory will return false. On the desktop, an
  ...
  /**
   * @throws GdxRuntimeException if this file handle is a {@link FileType#Classpath} or {@link
  ...
  /**
   * Returns true if the file exists. On Android, a {@link FileType#Classpath} or {@link
   * FileType#Internal} handle to a directory will always return false. Note that this can be very
  ...
  /**
   * Deletes this file or empty directory and returns success. Will not delete a directory that has
   * children.
   *
   * @throws GdxRuntimeException if this file handle is a {@link FileType#Classpath} or {@link
   *     FileType#Internal} file.
  ...
  /**
   * Deletes all children of this directory, recursively. Optionally preserving the folder
   * structure.
   *
   * @throws GdxRuntimeException if this file handle is a {@link FileType#Classpath} or {@link
   *     FileType#Internal} file.
  ...
  /**
   * Copies this file or directory to the specified file or directory. If this handle is a file,
   * then 1) if the destination is a file, it is overwritten, or 2) if the destination is a
   * directory, this file is copied into it, or 3) if the destination doesn't exist, {@link
   * #mkdirs()} is called on the destination's parent and this file is copied into it with a new
   * name. If this handle is a directory, then 1) if the destination is a file, GdxRuntimeException
   * is thrown, or 2) if the destination is a directory, this directory is copied into it
   * recursively, overwriting existing files, or 3) if the destination doesn't exist, {@link
   * #mkdirs()} is called on the destination and this directory is copied into it recursively.
   *
   * @throws GdxRuntimeException if the destination file handle is a {@link FileType#Classpath} or
   ...
   *
   * @throws GdxRuntimeException if the source or destination file handle is a {@link
  ...
  /**
   * Returns the last modified time in milliseconds for this file. Zero is returned if the file
   * doesn't exist. Zero is returned for {@link FileType#Classpath} files. On Android, zero is
   * returned for {@link FileType#Internal} files. On the desktop, zero is returned for {@link
   * FileType#Internal} files on the classpath.
   */
