...
public interface Predicate<T> {
	...
	public class PredicateIterator<T> implements Iterator<T> {
		@Nullable public Iterator<T> iterator;
		@Nullable public Predicate<T> predicate;
		...
		public PredicateIterator (final Iterator<T> iterator, @Nullable final Predicate<T> predicate) {
		...
		public void set (final Iterator<T> iterator, @Nullable final Predicate<T> predicate) {
	...
	public static class PredicateIterable<T> implements Iterable<T> {
		@Nullable public Iterable<T> iterable;
		@Nullable public Predicate<T> predicate;
