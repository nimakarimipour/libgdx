...
public interface Predicate<T> {
  ...
  public static class PredicateIterable<T> implements Iterable<T> {
     ...
     * each time this method is called. Use the {@link Predicate.PredicateIterator} constructor for
    ...
    public Iterator<T> iterator() {
      ...
      if (iterator == null) iterator = new PredicateIterator<T>(iterable.iterator(), predicate);
      else iterator.set(iterable.iterator(), predicate);
      return iterator;
    }
  }
}
