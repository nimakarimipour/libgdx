 ...
 * conjunction with a comparator that simply returns {@code
 * ((Comparable)first).compareTo(Second)}. If this is the case, you are better off deleting ComparableTimSort to eliminate the
 * code duplication. (See Arrays.java for details.) */
