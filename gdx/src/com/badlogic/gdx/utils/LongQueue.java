 ...
 * functionality is provided via {@link #removeLast()} and {@link #addFirst(long)}.
 */
public class LongQueue {
  ...
  /**
   * Creates a new LongQueue which can hold the specified number of values without needing to resize
   * backing array.
   */
  ...
  /**
   * Append given value to the tail. (enqueue to tail) Unless backing array needs resizing, operates
   * in O(1) time.
   */
  ...
  /**
   * Prepend given value to the head. (enqueue to head) Unless backing array needs resizing,
