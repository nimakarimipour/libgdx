...
/**
 * A resizable, ordered or unordered boolean array. Avoids the boxing that occurs with
 * ArrayList<Boolean>. It is less memory efficient than {@link BitSet}, except for very small sizes.
 * It more CPU efficient than {@link BitSet}, except for very large sizes or if BitSet functionality
 * such as and, or, xor, etc are needed. If unordered, this class avoids a memory copy when removing
...
public class BooleanArray {
  ...
  /**
   * Creates a new array containing the elements in the specific array. The new array will be
   * ordered if the specific array is ordered. The capacity is set to the number of elements, so any
  ...
  /**
   * Creates a new ordered array containing the elements in the specified array. The capacity is set
   * to the number of elements, so any subsequent elements added will cause the backing array to be
   * grown.
   */
  ...
  /**
   * Creates a new array containing the elements in the specified array. The capacity is set to the
