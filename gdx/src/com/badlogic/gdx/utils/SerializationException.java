...
public class SerializationException extends RuntimeException {
  @Nullable private StringBuilder trace;
  ...
  /**
   * Adds information to the exception message about where in the the object graph serialization
   * failure occurred. Serializers can catch {@link SerializationException}, add trace information,
