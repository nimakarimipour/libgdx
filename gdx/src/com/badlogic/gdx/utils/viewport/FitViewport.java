...
/**
 * A ScalingViewport that uses {@link Scaling#fit} so it keeps the aspect ratio by scaling the world
 * up to fit the screen, adding black bars (letterboxing) for the remaining space.
 *
