...
/**
 * A viewport that keeps the world aspect ratio by both scaling and extending the world. By default,
 * the world is first scaled to fit within the viewport using {@link Scaling#fit}, then the shorter
 * dimension is lengthened to fill the viewport. Other scaling, such as {@link Scaling#contain}, may
 * lengthen the world in both directions. A maximum size can be specified to limit how much the
...
public class ExtendViewport extends Viewport {
  ...
  public ExtendViewport(
      float minWorldWidth, float minWorldHeight, float maxWorldWidth, float maxWorldHeight) {
