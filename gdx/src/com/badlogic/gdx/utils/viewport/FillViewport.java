...
/**
 * A ScalingViewport that uses {@link Scaling#fill} so it keeps the aspect ratio by scaling the
 * world up to take the whole screen (some of the world may be off screen).
 *
