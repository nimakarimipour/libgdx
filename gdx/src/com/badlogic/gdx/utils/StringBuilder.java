...
public class StringBuilder implements Appendable, CharSequence {
	 ...
	 * CharSequence}. The capacity of the new builder will be the length of the {@code CharSequence} plus 16.
	 *
	 ...
	 *            {@code destStart + end - begin} is greater than {@code
	 *     dest.length}. */
	 ...
	 * char[]} value is converted to a String according to the rule defined by {@link String#valueOf(char[],int,int)}.
	 *
	 ...
	 * offset}. The {@code char} value is converted to a string according to the rule defined by {@link String#valueOf(char)}.
	 *
	 * @param offset the index to insert at.
	 ...
	 * offset}. The {@code int} value is converted to a String according to the rule defined by {@link String#valueOf(int)}.
	 *
	 * @param offset the index to insert at.
	 ...
	 * offset}. The {@code long} value is converted to a String according to the rule defined by {@link String#valueOf(long)}.
	 *
	 * @param offset the index to insert at.
	 ...
	 * offset}. The {@code float} value is converted to a string according to the rule defined by {@link String#valueOf(float)}.
	 *
	 * @param offset the index to insert at.
	 ...
	 * offset}. The {@code double} value is converted to a String according to the rule defined by {@link String#valueOf(double)}.
	 *
	 * @param offset the index to insert at.
	 ...
	 * offset}. The {@code Object} value is converted to a String according to the rule defined by {@link String#valueOf(Object)}.
	 *
	 * @param offset the index to insert at.
	 ...
	 * offset}. The {@code CharSequence} is converted to a String as defined by {@link CharSequence#toString()}. If {@code s} is
