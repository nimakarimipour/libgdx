...
/**
 * Simple logger that uses the {@link Application} logging facilities to output messages. The log
 * level set with {@link Application#setLogLevel(int)} overrides the log level set here.
 *
 * @author mzechner
 * @author Nathan Sweet
 */
public class Logger {
  ...
  /**
   * Sets the log level. {@link #NONE} will mute all log output. {@link #ERROR} will only let error
   * messages through. {@link #INFO} will let all non-debug messages through, and {@link #DEBUG}
