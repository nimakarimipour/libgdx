 ...
 *
 * <p>This was modified to be used directly on streams, rather than via the command line as in the
 * LZMA SDK.
 *
 * <p>We only currently allow the default LZMA options to be used, as we know it works on for our
 * target usage.
 */
public class Lzma {
  ...
  public static void compress(InputStream in, OutputStream out) throws IOException {
    ...
    com.badlogic.gdx.utils.compression.lzma.Encoder encoder =
        new com.badlogic.gdx.utils.compression.lzma.Encoder();
  ...
  public static void decompress(InputStream in, OutputStream out) throws IOException {
    ...
    com.badlogic.gdx.utils.compression.lzma.Decoder decoder =
        new com.badlogic.gdx.utils.compression.lzma.Decoder();
