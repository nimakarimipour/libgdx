...
public class Encoder {
    ...
    int GetRepLen1Price(int state, int posState) {
        return com.badlogic.gdx.utils.compression.rangecoder.Encoder.GetPrice0(_isRepG0[state]) + com.badlogic.gdx.utils.compression.rangecoder.Encoder.GetPrice0(_isRep0Long[(state << Base.kNumPosStatesBitsMax) + posState]);
    }
    ...
    public void Code(java.io.InputStream inStream, java.io.OutputStream outStream, long inSize, long outSize, @Nullable() ICodeProgress progress) throws IOException {
        _needReleaseMFStream = false;
        try {
    ...
    void FillAlignPrices() {
        for (int i = 0; i < Base.kAlignTableSize; i++) _alignPrices[i] = _posAlignEncoder.ReverseGetPrice(i);
        _alignPriceCount = 0;
    }
