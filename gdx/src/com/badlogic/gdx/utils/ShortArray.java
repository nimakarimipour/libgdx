...
/**
 * A resizable, ordered or unordered short array. Avoids the boxing that occurs with
 * ArrayList<Short>. If unordered, this class avoids a memory copy when removing elements (the last
