 ...
 * fallback in case none of its children was able to respond to a request.
 ...
 * the base bundle need to be handled by a language-specific {@code I18NBundle}.
 ...
 * country and the country of the language bundle need to be handled by a country-specific {@code I18NBundle}.
...
public class I18NBundle {
	 ...
	 * locale</code>. This method is called by the <code>createBundle</code> factory method each time the factory method tries
	 ...
	 *
	 * <p>
	 * If the given locale is equal to <code>Locale.ROOT</code> (the root locale), a <code>List
	 ...
	 * <code>baseFileHandler</code> and <code>
	 * locale</code>, where locale is either the parameter for <code>createBundle</code> or the previous fallback locale returned
	 * by this method.
	 *
	 * <p>
	 ...
	 * </code> to determine whether the resource bundle returned really corresponds to the requested locale or is a fallback.
	 *
