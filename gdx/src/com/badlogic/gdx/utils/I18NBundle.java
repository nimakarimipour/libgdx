...
public class I18NBundle {
    ...
    @Nullable()
    private static I18NBundle loadBundleChain(FileHandle baseFileHandle, String encoding, List<Locale> candidateLocales, int candidateIndex, @Nullable() I18NBundle baseBundle) {
