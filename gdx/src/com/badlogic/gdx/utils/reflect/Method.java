...
public final class Method {
  ...
  /**
   * Return true if the method does not include any of the {@code private}, {@code protected}, or
   * {@code public} modifiers.
   */
   ...
   * method, or an empty array if there are none. Does not include inherited annotations. Does not
  ...
  /**
   * Returns an {@link Annotation} object reflecting the annotation provided, or null of this method
   ...
   */
  @Nullable public Annotation getDeclaredAnnotation(
      Class<? extends java.lang.annotation.Annotation> annotationType) {
    java.lang.annotation.Annotation[] annotations = method.getDeclaredAnnotations();
    if (annotations == null) {
      return null;
