...
public final class ClassReflection {
	 ...
	 * parameter types. */
	public static Constructor getConstructor (Class c, @Nullable Class... parameterTypes) throws ReflectionException {
		try {
	 ...
	 * types. */
	public static Constructor getDeclaredConstructor (Class c, @Nullable Class... parameterTypes) throws ReflectionException {
		try {
