...
public final class NumberUtils {
  ...
  /**
   * Encodes the ABGR int color as a float. The alpha is compressed to use only even numbers between
   * 0-254 to avoid using bits in the NaN range (see {@link Float#intBitsToFloat(int)} javadocs).
   * Rendering which uses colors encoded as floats should expand the 0-254 back to 0-255, else
   * colors cannot be fully opaque.
   */
