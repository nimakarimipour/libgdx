...
public class UBJsonWriter implements Closeable {
  ...
  /**
   * Begins a new named object container, having the given name. To finish the object call {@link
   * #pop()}.
   *
   * @return This writer, for chaining
   */
  ...
  /**
   * Begins a new named array container, having the given name. To finish the array call {@link
   * #pop()}.
   *
   * @return this writer, for chaining.
   */
  ...
  /**
   * Appends a {@code byte} value to the stream. This corresponds to the {@code int8} value type in
   * the UBJSON specification.
   *
   * @return this writer, for chaining
   */
  ...
  /**
   * Appends a {@code short} value to the stream. This corresponds to the {@code int16} value type
   * in the UBJSON specification.
   *
   * @return this writer, for chaining
   */
  ...
  /**
   * Appends an {@code int} value to the stream. This corresponds to the {@code int32} value type in
   * the UBJSON specification.
   *
   * @return this writer, for chaining
   */
  ...
  /**
   * Appends a {@code long} value to the stream. This corresponds to the {@code int64} value type in
   * the UBJSON specification.
   *
   * @return this writer, for chaining
   */
  ...
  /**
   * Appends a {@code float} value to the stream. This corresponds to the {@code float32} value type
   * in the UBJSON specification.
   *
   * @return this writer, for chaining
   */
  ...
  /**
   * Appends a {@code double} value to the stream. This corresponds to the {@code float64} value
  ...
  /**
   * Appends a {@code boolean} value to the stream. This corresponds to the {@code boolean} value
   * type in the UBJSON specification.
   *
   * @return this writer, for chaining
   */
  ...
  /**
   * Appends a {@code String} value to the stream. This corresponds to the {@code string} value type
   * in the UBJSON specification.
   *
   * @return this writer, for chaining
   */
  ...
  /**
   * Appends an optimized {@code byte array} value to the stream. As an optimized array, the {@code
   * int8} value type marker and element count are encoded once at the array marker instead of
  ...
  /**
   * Appends an optimized {@code short array} value to the stream. As an optimized array, the {@code
  ...
  /**
   * Appends an optimized {@code int array} value to the stream. As an optimized array, the {@code
   * int32} value type marker and element count are encoded once at the array marker instead of
   * repeating the type marker for each element.
   *
   * @return this writer, for chaining
   */
  ...
  /**
   * Appends an optimized {@code long array} value to the stream. As an optimized array, the {@code
   * int64} value type marker and element count are encoded once at the array marker instead of
   * repeating the type marker for each element.
   *
   * @return this writer, for chaining
   */
  ...
  /**
   * Appends an optimized {@code float array} value to the stream. As an optimized array, the {@code
   * float32} value type marker and element count are encoded once at the array marker instead of
   * repeating the type marker for each element.
   *
   * @return this writer, for chaining
   */
  ...
  /**
   * Appends an optimized {@code double array} value to the stream. As an optimized array, the
   * {@code float64} value type marker and element count are encoded once at the array marker
   * instead of repeating the type marker for each element. element count are encoded once at the
   * array marker instead of for each element.
   *
   * @return this writer, for chaining
   */
  ...
  /**
   * Appends an optimized {@code String array} value to the stream. As an optimized array, the
   * {@code String} value type marker and element count are encoded once at the array marker instead
   * of repeating the type marker for each element.
   *
   * @return this writer, for chaining
   */
  ...
  /**
   * Appends the object to the stream, if it is a known value type. This is a convenience method
   * that calls through to the appropriate value method.
   *
   * @return this writer, for chaining
   */
  ...
  protected UBJsonWriter pop(boolean silent) throws IOException {
    ...
    if (silent) stack.pop();
    else stack.pop().close();
    current = stack.size == 0 ? null : stack.peek();
    return this;
  }

  /**
   * Flushes the underlying stream. This forces any buffered output bytes to be written out to the
   * stream.
   */
  ...
  /**
   * Closes the underlying output stream and releases any system resources associated with the
   * stream.
   */
