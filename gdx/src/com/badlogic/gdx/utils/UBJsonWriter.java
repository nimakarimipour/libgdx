...
public class UBJsonWriter implements Closeable {
	 ...
	 * int8} value type marker and element count are encoded once at the array marker instead of repeating the type marker for each
	 * element.
	 *
	 * @return this writer, for chaining */
	 ...
	 * int16} value type marker and element count are encoded once at the array marker instead of repeating the type marker for
	 * each element.
	 *
	 * @return this writer, for chaining */
	 ...
	 * int32} value type marker and element count are encoded once at the array marker instead of repeating the type marker for
	 * each element.
	 *
	 * @return this writer, for chaining */
	 ...
	 * int64} value type marker and element count are encoded once at the array marker instead of repeating the type marker for
	 * each element.
	 *
	 * @return this writer, for chaining */
	 ...
	 * float32} value type marker and element count are encoded once at the array marker instead of repeating the type marker for
	 * each element.
	 *
	 * @return this writer, for chaining */
