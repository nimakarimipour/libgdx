...
/**
 * A resizable, ordered or unordered float array. Avoids the boxing that occurs with
 * ArrayList<Float>. If unordered, this class avoids a memory copy when removing elements (the last
...
public class FloatArray {
  ...
  public int hashCode() {
    ...
    float[] items = this.items;
    int h = 1;
    for (int i = 0, n = size; i < n; i++) h = h * 31 + NumberUtils.floatToRawIntBits(items[i]);
    return h;
  }
