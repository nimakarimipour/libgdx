...
/**
 * Implementation of Tony Hoare's quickselect algorithm. Running time is generally O(n), but worst
 * case is O(n^2) Pivot choice is median of three method, providing better performance than a random
...
public class QuickSelect<T> {
  ...
  /**
   * Median of Three has the potential to outperform a random pivot, especially for partially sorted
   * arrays
   */
