...
/**
 * A resizable, ordered or unordered byte array. Avoids the boxing that occurs with ArrayList<Byte>.
 * If unordered, this class avoids a memory copy when removing elements (the last element is moved
