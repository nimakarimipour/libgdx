...
/**
 * A resizable, ordered or unordered char array. Avoids the boxing that occurs with
 * ArrayList<Character>. If unordered, this class avoids a memory copy when removing elements (the
