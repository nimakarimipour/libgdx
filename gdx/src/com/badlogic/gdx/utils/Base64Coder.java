...
public class Base64Coder {
  ...
  /**
   * Encodes a string into Base64 format, optionally using URL-safe encoding instead of the
   * "regular" Base64 encoding. No blanks or line breaks are inserted.
   *
   * @param s A String to be encoded.
   * @param useUrlsafeEncoding If true, this encodes the result with an alternate URL-safe set of
   *     characters.
   * @return A String containing the Base64 encoded data.
   */
  ...
  /**
   * Encodes a byte array into Base64 format and breaks the output into lines of 76 characters. This
   * method is compatible with <code>sun.misc.BASE64Encoder.encodeBuffer(byte[])</code>.
   *
  ...
  public static String encodeLines(
      byte[] in, int iOff, int iLen, int lineLen, String lineSeparator, CharMap charMap) {
   ...
   */
  public static String encodeLines(
      byte[] in, int iOff, int iLen, int lineLen, String lineSeparator, char[] charMap) {
  ...
  public static String decodeString(String s, boolean useUrlSafeEncoding) {
    return new String(
        decode(
            s.toCharArray(), useUrlSafeEncoding ? urlsafeMap.decodingMap : regularMap.decodingMap));
  }
