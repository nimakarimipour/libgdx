...
public class JsonWriter extends Writer {
  ...
  /**
   * When true, quotes long, double, BigInteger, BigDecimal types to prevent truncation in languages
   * like JavaScript and PHP. This is not necessary when using libgdx, which handles these types
   * without truncation. Default is false.
   */
  ...
  public static enum OutputType {
     ...
     *
     * <ul>
     *   <li>Names only require double quotes if they start with <code>space</code> or any of <code>
     *       ":,}/</code> or they contain <code>//</code> or <code>/*</code> or <code>:</code>.
     *   <li>Values only require double quotes if they start with <code>space</code> or any of
     *       <code>":,{[]/</code> or they contain <code>//</code> or <code>/*</code> or any of
     *       <code>}],</code> or they are equal to <code>true</code>, <code>false</code> , or <code>
     *       null</code>.
    ...
    public String quoteValue(@Nullable Object value) {
      ...
      if (this == OutputType.minimal
        ...
        if (length > 0
            ...
            && minimalValuePattern.matcher(buffer).matches()) return buffer.toString();
      }
    ...
    public String quoteName(String value) {
      ...
      switch (this) {
        case minimal:
          if (!value.contains("//")
              && !value.contains("/*")
              && minimalNamePattern.matcher(buffer).matches()) return buffer.toString();
        case javascript:
