...
public class JsonValue implements Iterable<JsonValue> {
     ...
     */
    public JsonValue(@Null @Nullable String value) {
        set(value);
    }
    ...
    public JsonValue get(String name) {
        JsonValue current = child;
        while (current != null && (current.name == null || !current.name.equalsIgnoreCase(name))) current = current.next;
        return current;
    }
     ...
     */
    @Nullable
    public String getString(String name, @Null @Nullable String defaultValue) {
        JsonValue child = get(name);
