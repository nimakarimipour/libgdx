...
public final class BufferUtils {
     ...
     * @param dst the destination Buffer, its position is used as an offset.
     */
    public static void copy(@Nullable float[] src, int srcOffset, int numElements, Buffer dst) {
        copyJni(src, srcOffset, dst, positionInBytes(dst), numElements << 2);
    }
     ...
     * @param numElements the number of elements to copy.
     */
    public static void copy(@Nullable float[] src, int srcOffset, Buffer dst, int numElements) {
        dst.limit(dst.position() + bytesToElements(dst, numElements << 2));
        copyJni(src, srcOffset, dst, positionInBytes(dst), numElements << 2);
    }
	...
	*/
    private native static void copyJni(@Nullable float[] src, Buffer dst, int numFloats, int offset);
	...
	*/
    ...
    /*
		memcpy(dst + dstOffset, src + srcOffset, numBytes);
	*/
    private native static void copyJni(@Nullable float[] src, int srcOffset, Buffer dst, int dstOffset, int numBytes);
