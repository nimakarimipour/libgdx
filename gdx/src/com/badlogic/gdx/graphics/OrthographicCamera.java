...
public class OrthographicCamera extends Camera {
  ...
  /**
   * Constructs a new OrthographicCamera, using the given viewport width and height. For pixel
   * perfect 2D rendering just supply the screen size, for other unit scales (e.g. meters for box2d)
   * proceed accordingly. The camera will show the region [-viewportWidth/2, -(viewportHeight/2-1)]
