...
public class GLVersion {
  ...
  /**
   * Forgiving parsing of gl major, minor and release versions as some manufacturers don't adhere to
   * spec *
   */
  ...
  /**
   * @return what {@link Type} of GL implementation this application has access to, e.g. {@link
   *     Type#OpenGL} or {@link Type#GLES}
   */
  public Type getType() {
    return type;
  }
  ...
  /**
   * @return the name of the renderer associated with the current GL connection. This name is
  ...
  /**
   * Checks to see if the current GL connection version is higher, or equal to the provided test
   * versions.
   *
