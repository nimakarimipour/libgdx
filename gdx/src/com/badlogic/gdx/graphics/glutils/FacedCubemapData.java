...
public class FacedCubemapData implements CubemapData {
     ...
     */
    public FacedCubemapData(@Nullable() TextureData positiveX, @Nullable() TextureData negativeX, @Nullable() TextureData positiveY, @Nullable() TextureData negativeY, @Nullable() TextureData positiveZ, @Nullable() TextureData negativeZ) {
        data[0] = positiveX;
        data[1] = negativeX;
        data[2] = positiveY;
        data[3] = negativeY;
