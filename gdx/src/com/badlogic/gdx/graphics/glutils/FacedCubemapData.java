...
public class FacedCubemapData implements CubemapData {
     ...
     */
    public FacedCubemapData(@Nullable TextureData positiveX, TextureData negativeX, @Nullable TextureData positiveY, TextureData negativeY, @Nullable TextureData positiveZ, TextureData negativeZ) {
        data[0] = positiveX;
        data[1] = negativeX;
        data[2] = positiveY;
        data[3] = negativeY;
