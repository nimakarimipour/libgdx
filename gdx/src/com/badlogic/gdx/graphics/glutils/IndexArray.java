...
public class IndexArray implements IndexData {
  ...
  /**
   * Sets the indices of this IndexArray, discarding the old indices. The count must equal the
   * number of indices to be copied to this IndexArray.
   *
  ...
  /**
   * Invalidates the IndexArray so a new OpenGL buffer handle is created. Use this in case of a
   * context loss.
   */
