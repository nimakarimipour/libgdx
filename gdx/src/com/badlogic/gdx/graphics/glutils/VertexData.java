 ...
 * {@link VertexArray} or a {@link VertexBufferObject}. Only the later supports OpenGL ES 2.0.
 *
 * @author mzechner
 */
public interface VertexData extends Disposable {
  ...
  /**
   * Sets the vertices of this VertexData, discarding the old vertex data. The count must equal the
   * number of floats per vertex times the number of vertices to be copied to this VertexData. The
   * order of the vertex attributes must be the same as specified at construction time via {@link
   * VertexAttributes}.
   *
   ...
   * #setVertices(float[], int, int)}; Any modifications made to the Buffer *after* the call to bind
   * will not automatically be uploaded.
   *
