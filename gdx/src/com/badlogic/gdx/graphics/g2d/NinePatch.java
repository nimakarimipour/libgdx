...
public class NinePatch {
     ...
     */
    // This field has the javadoc comment because it appears first in the javadocs.
    ...
    public NinePatch(TextureRegion region) {
        ...
        // 
        // 
        null, null, null, null, region, null, null, null, null });
    }
    ...
    private void load(TextureRegion[] patches) {
        ...
        if (patches[MIDDLE_CENTER] != null) {
            middleCenter = add(patches[MIDDLE_CENTER], patches[MIDDLE_LEFT] != null || patches[MIDDLE_RIGHT] != null, patches[TOP_CENTER] != null || patches[BOTTOM_CENTER] != null);
