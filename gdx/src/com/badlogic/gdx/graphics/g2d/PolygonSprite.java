...
public class PolygonSprite {
  ...
  public void setColor(float r, float g, float b, float a) {
    ...
    final float[] vertices = this.vertices;
    for (int i = 2; i < vertices.length; i += Sprite.VERTEX_SIZE) vertices[i] = packedColor;
  }
  ...
  /**
   * Returns the color of this sprite. Modifying the returned color will have unexpected effects
   * unless {@link #setColor(Color)} or {@link #setColor(float, float, float, float)} is
   * subsequently called before drawing this sprite.
   */
  ...
  /**
   * Returns the actual color used in the vertices of this sprite. Modifying the returned color will
   * have unexpected effects unless {@link #setColor(Color)} or {@link #setColor(float, float,
   * float, float)} is subsequently called before drawing this sprite.
   */
