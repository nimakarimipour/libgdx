...
public class TextureAtlas implements Disposable {
    ...
    public void load(TextureAtlasData data) {
        ...
        for (Region region : data.regions) {
            ...
            // 
            // 
            AtlasRegion(region.page.texture, region.left, region.top, region.rotate ? region.height : region.width, region.rotate ? region.width : region.height);
    ...
    static public class TextureAtlasData {
        ...
        static public class Region {
            ...
            public int[] findValue(String name) {
                if (names != null) {
                    for (int i = 0, n = names.length; i < n; i++) if (name.equals(names[i]))
                        return values[i];
                }
                return null;
            }
