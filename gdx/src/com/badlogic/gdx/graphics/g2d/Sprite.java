...
/**
 * Holds the geometry, color, and texture information for drawing 2D sprites using {@link Batch}. A
 * Sprite has a position and a size given as width and height. The position is relative to the
 * origin of the coordinate system specified via {@link Batch#begin()} and the respective matrices.
 * A Sprite is always rectangular and its position (x, y) are located in the bottom left corner of
 * that rectangle. A Sprite also has an origin around which rotations and scaling are performed
 * (that is, the origin is not modified by rotation and scaling). The origin is given relative to
 * the bottom left corner of the Sprite, its position.
 *
 * @author mzechner
 * @author Nathan Sweet
 */
public class Sprite extends TextureRegion {
  ...
  /**
   * Creates an uninitialized sprite. The sprite will need a texture region and bounds set before it
   * can be drawn.
   */
  public Sprite() {
    setColor(1, 1, 1, 1);
  ...
  /**
   * Creates a sprite with width, height, and texture region equal to the specified size. The
   * texture region's upper left corner will be 0,0.
   *
   * @param srcWidth The width of the texture region. May be negative to flip the sprite when drawn.
   * @param srcHeight The height of the texture region. May be negative to flip the sprite when
   *     drawn.
   */
  ...
  /**
   * Creates a sprite based on a specific TextureRegion, the new sprite's region is a copy of the
   * parameter region - altering one does not affect the other
   */
  ...
  /**
   * Creates a sprite with width, height, and texture region equal to the specified size, relative
   * to specified sprite's texture region.
   *
   * @param srcWidth The width of the texture region. May be negative to flip the sprite when drawn.
   * @param srcHeight The height of the texture region. May be negative to flip the sprite when
   *     drawn.
   ...
   * If origin, rotation, or scale are changed, it is slightly more efficient to set the bounds
   ...
   * rotation, or scale are changed, it is slightly more efficient to set the size after those
   * operations. If both position and size are to be changed, it is better to use {@link
  ...
  /**
   * Sets the position where the sprite will be drawn. If origin, rotation, or scale are changed, it
   * is slightly more efficient to set the position after those operations. If both position and
   * size are to be changed, it is better to use {@link #setBounds(float, float, float, float)}.
   */
  ...
  /**
   * Sets the x position relative to the current position where the sprite will be drawn. If origin,
   * rotation, or scale are changed, it is slightly more efficient to translate after those
   * operations.
   */
  ...
  /**
   * Sets the y position relative to the current position where the sprite will be drawn. If origin,
   * rotation, or scale are changed, it is slightly more efficient to translate after those
   * operations.
   */
  ...
  /**
   * Sets the rotation of the sprite in degrees. Rotation is centered on the origin set in {@link
  ...
  /**
   * Sets the sprite's rotation in degrees relative to the current rotation. Rotation is centered on
   * the origin set in {@link #setOrigin(float, float)}
   */
  ...
  /**
   * Sets the sprite's scale for both X and Y uniformly. The sprite scales out from the origin. This
   * will not affect the values returned by {@link #getWidth()} and {@link #getHeight()}
   */
  ...
  /**
   * Sets the sprite's scale for both X and Y. The sprite scales out from the origin. This will not
   * affect the values returned by {@link #getWidth()} and {@link #getHeight()}
   */
  ...
  /**
   * Sets the sprite's scale relative to the current scale. for example: original scale 2 ->
   * sprite.scale(4) -> final scale 6. The sprite scales out from the origin. This will not affect
   * the values returned by {@link #getWidth()} and {@link #getHeight()}
   */
   ...
   * and y coordinates describe its bottom left corner. If you change the position or size of the
   * sprite, you have to fetch the triangle again for it to be recomputed.
   *
  ...
  /**
   * The origin influences {@link #setPosition(float, float)}, {@link #setRotation(float)} and the
  ...
  /**
   * Returns the color of this sprite. If the returned instance is manipulated, {@link
