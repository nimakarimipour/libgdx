...
public interface GL30 extends GL20 {
  ...
  // C function void glDrawRangeElements ( GLenum mode, GLuint start, GLuint end, GLsizei count,
  ...
  // C function void glTexImage3D ( GLenum target, GLint level, GLint internalformat, GLsizei width,
  ...
  public void glTexImage3D(
      ...
      int format,
      int type,
      @Nullable java.nio.Buffer pixels);
  ...
  // C function void glTexSubImage3D ( GLenum target, GLint level, GLint xoffset, GLint yoffset,
  ...
  // C function void glCopyTexSubImage3D ( GLenum target, GLint level, GLint xoffset, GLint yoffset,
  ...
  // // C function void glCompressedTexImage3D ( GLenum target, GLint level, GLenum internalformat,
  ...
  // );
  //
  // // C function void glCompressedTexSubImage3D ( GLenum target, GLint level, GLint xoffset, GLint
  ...
  // // C function void glUniformMatrix2x3fv ( GLint location, GLsizei count, GLboolean transpose,
  // const GLfloat *value )
  //
  ...
  // // C function void glUniformMatrix3x2fv ( GLint location, GLsizei count, GLboolean transpose,
  // const GLfloat *value )
  //
  ...
  // // C function void glUniformMatrix2x4fv ( GLint location, GLsizei count, GLboolean transpose,
  // const GLfloat *value )
  //
  ...
  // // C function void glUniformMatrix4x2fv ( GLint location, GLsizei count, GLboolean transpose,
  // const GLfloat *value )
  //
  ...
  // // C function void glUniformMatrix3x4fv ( GLint location, GLsizei count, GLboolean transpose,
  // const GLfloat *value )
  //
  ...
  // // C function void glUniformMatrix4x3fv ( GLint location, GLsizei count, GLboolean transpose,
  // const GLfloat *value )
  //
  ...
  // C function void glBlitFramebuffer ( GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint
  ...
  // C function void glRenderbufferStorageMultisample ( GLenum target, GLsizei samples, GLenum
  ...
  // C function void glFramebufferTextureLayer ( GLenum target, GLenum attachment, GLuint texture,
  // GLint level, GLint layer )

  public void glFramebufferTextureLayer(
      int target, int attachment, int texture, int level, int layer);

  // C function GLvoid * glMapBufferRange ( GLenum target, GLintptr offset, GLsizeiptr length,
  // GLbitfield access )
  ...
  // C function void glBindBufferRange ( GLenum target, GLuint index, GLuint buffer, GLintptr
  ...
  // C function void glTransformFeedbackVaryings ( GLuint program, GLsizei count, const GLchar
  // *varyings, GLenum bufferMode )

  public void glTransformFeedbackVaryings(int program, String[] varyings, int bufferMode);

  // // C function void glGetTransformFeedbackVarying ( GLuint program, GLuint index, GLsizei
  // bufSize, GLsizei *length, GLint *size,
  ...
  // C function void glVertexAttribIPointer ( GLuint index, GLint size, GLenum type, GLsizei stride,
  // GLsizei offset )
  ...
  // C function void glCopyBufferSubData ( GLenum readTarget, GLenum writeTarget, GLintptr
  ...
  // // C function void glGetUniformIndices ( GLuint program, GLsizei uniformCount, const GLchar
  // *const *uniformNames, GLuint
  // *uniformIndices )
  //
  ...
  // C function void glGetUniformIndices ( GLuint program, GLsizei uniformCount, const GLchar *const
  // *uniformNames, GLuint
  // *uniformIndices )
  ...
  // // C function void glGetActiveUniformsiv ( GLuint program, GLsizei uniformCount, const GLuint
  // *uniformIndices, GLenum pname,
  // GLint *params )
  //
  ...
  // // C function void glGetActiveUniformBlockiv ( GLuint program, GLuint uniformBlockIndex, GLenum
  // pname, GLint *params )
  //
  ...
  // // C function void glGetActiveUniformBlockName ( GLuint program, GLuint uniformBlockIndex,
  ...
  // C function void glGetActiveUniformBlockName ( GLuint program, GLuint uniformBlockIndex, GLsizei
  // bufSize, GLsizei *length,
  // GLchar *uniformBlockName )

  public void glGetActiveUniformBlockName(
      int program, int uniformBlockIndex, java.nio.Buffer length, java.nio.Buffer uniformBlockName);
  ...
  // C function void glUniformBlockBinding ( GLuint program, GLuint uniformBlockIndex, GLuint
  // uniformBlockBinding )

  public void glUniformBlockBinding(int program, int uniformBlockIndex, int uniformBlockBinding);

  // C function void glDrawArraysInstanced ( GLenum mode, GLint first, GLsizei count, GLsizei
  // instanceCount )

  public void glDrawArraysInstanced(int mode, int first, int count, int instanceCount);

  // // C function void glDrawElementsInstanced ( GLenum mode, GLsizei count, GLenum type, const
  // GLvoid *indices, GLsizei
  // instanceCount )
  //
  ...
  // C function void glDrawElementsInstanced ( GLenum mode, GLsizei count, GLenum type, const GLvoid
  // *indices, GLsizei
  // instanceCount )
  ...
  // // C function void glGetSynciv ( GLsync sync, GLenum pname, GLsizei bufSize, GLsizei *length,
  // GLint *values )
  //
  ...
  // // C function void glGetProgramBinary ( GLuint program, GLsizei bufSize, GLsizei *length,
  ...
  // );
  //
  // // C function void glProgramBinary ( GLuint program, GLenum binaryFormat, const GLvoid *binary,
  // GLsizei length )
  //
  ...
  // // C function void glInvalidateFramebuffer ( GLenum target, GLsizei numAttachments, const
  // GLenum *attachments )
  //
  ...
  // C function void glInvalidateFramebuffer ( GLenum target, GLsizei numAttachments, const GLenum
  // *attachments )

  public void glInvalidateFramebuffer(
      int target, int numAttachments, java.nio.IntBuffer attachments);

  // // C function void glInvalidateSubFramebuffer ( GLenum target, GLsizei numAttachments, const
  ...
  // // C function void glTexStorage2D ( GLenum target, GLsizei levels, GLenum internalformat,
  // GLsizei width, GLsizei height )
  //
  ...
  // );
  //
  // // C function void glTexStorage3D ( GLenum target, GLsizei levels, GLenum internalformat,
  // GLsizei width, GLsizei height,
  // GLsizei depth )
  //
  ...
  // );
  //
  // // C function void glGetInternalformativ ( GLenum target, GLenum internalformat, GLenum pname,
  ...
  @Deprecated
  /**
   * In OpenGl core profiles (3.1+), passing a pointer to client memory is not valid. Use the other
   * version of this function instead, pass a zero-based offset which references the buffer
