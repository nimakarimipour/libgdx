...
public interface GL30 extends GL20 {
    ...
    public void glTexImage3D(int target, int level, int internalformat, int width, int height, int depth, int border, int format, int type, @Nullable() java.nio.Buffer pixels);
