 ...
 * markup language defined by the {@code BitmapFontCache} class uses this class to retrieve colors
 * and the user can define his own colors.
 *
 * @author davebaol
 */
public final class Colors {
  ...
  /**
   * Convenience method to lookup a color by {@code name}. The invocation of this method is
   * equivalent to the expression {@code Colors.getColors().get(name)}
   *
   * @param name the name of the color
   * @return the color to which the specified {@code name} is mapped, or {@code null} if there was
  ...
  /**
   * Convenience method to add a {@code color} with its {@code name}. The invocation of this method
   * is equivalent to the expression {@code Colors.getColors().put(name, color)}
   *
   * @param name the name of the color
