...
/**
 * Minimalistic grouping strategy useful for orthogonal scenes where the camera faces the negative z
 * axis. Handles enabling and disabling of blending and uses world-z only front to back sorting for
 * transparent decals.
 *
...
public class SimpleOrthoGroupStrategy implements GroupStrategy {
  ...
  public void beforeGroup(int group, Array<Decal> contents) {
    if (group == GROUP_BLEND) {
      ...
      // no need for writing into the z buffer if transparent decals are the last thing to be
      // rendered
