 ...
 * graphical properties. A NodePart is the smallest visible part of a {@link Model}, each NodePart
 * implies a render call.
 *
...
public class NodePart {
  ...
  /**
   * Construct a new NodePart with null values. At least the {@link #meshPart} and {@link #material}
   * member must be set before the newly created part can be used.
   */
  public NodePart() {}
  ...
  /**
   * Convenience method to set the material, mesh, meshPartOffset, meshPartSize, primitiveType and
   * bones members of the specified Renderable. The other member of the provided {@link Renderable}
   * remain untouched. Note that the material, mesh and bones members are referenced, not copied.
   * Any changes made to those objects will be reflected in both the NodePart and Renderable object.
   *
    ...
    if (other.invBoneBindTransforms == null) {
      ...
      if (invBoneBindTransforms == null)
        invBoneBindTransforms =
            new ArrayMap<Node, Matrix4>(
                true, other.invBoneBindTransforms.size, Node.class, Matrix4.class);
      else invBoneBindTransforms.clear();
