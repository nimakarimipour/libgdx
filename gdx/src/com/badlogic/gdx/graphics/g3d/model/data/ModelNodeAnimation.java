...
public class ModelNodeAnimation {
	...
	@SuppressWarnings("NullAway.Init") public String nodeId;

	/** the keyframes, defining the translation of a node for a specific timestamp * */
	@SuppressWarnings("NullAway.Init") public Array<ModelNodeKeyframe<Vector3>> translation;

	/** the keyframes, defining the rotation of a node for a specific timestamp * */
	@SuppressWarnings("NullAway.Init") public Array<ModelNodeKeyframe<Quaternion>> rotation;

	/** the keyframes, defining the scaling of a node for a specific timestamp * */
	@SuppressWarnings("NullAway.Init") public Array<ModelNodeKeyframe<Vector3>> scaling;
}
