...
public class PatchShapeBuilder extends BaseShapeBuilder {
  ...
  public static void build(
    ...
    for (int u = 0; u <= divisionsU; u++) {
      ...
      for (int v = 0; v <= divisionsV; v++) {
        final short idx =
            builder.vertex(vertTmp7.set(vertTmp5).lerp(vertTmp6, (float) v / (float) divisionsV));
        if (u > 0 && v > 0)
          builder.rect(
              (short) (idx - divisionsV - 2),
              (short) (idx - 1),
              idx,
  ...
  public static void build(
    ...
    build(
        builder,
        vertTmp1.set(null).setPos(x00, y00, z00).setNor(normalX, normalY, normalZ).setUV(0f, 1f),
        ...
        vertTmp4.set(null).setPos(x01, y01, z01).setNor(normalX, normalY, normalZ).setUV(0f, 0f),
        divisionsU,
        divisionsV);
  }
}
