...
public class BaseAnimationController {
     ...
     */
    protected static void applyAnimation(@Nullable final ObjectMap<Node, Transform> out, final Pool<Transform> pool, final float alpha, final Animation animation, final float time) {
        if (out == null) {
