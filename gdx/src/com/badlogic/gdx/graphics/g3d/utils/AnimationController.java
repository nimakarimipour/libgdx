...
public class AnimationController extends BaseAnimationController {
     ...
     *         is completed.
     */
    public AnimationDesc setAnimation(final String id, float offset, float duration, int loopCount, float speed, @Nullable() final AnimationListener listener) {
     ...
     *         is completed.
     */
    public AnimationDesc animate(final String id, int loopCount, float speed, @Nullable() final AnimationListener listener, float transitionTime) {
     ...
     *         is completed.
     */
    public AnimationDesc animate(final String id, float offset, float duration, int loopCount, float speed, @Nullable() final AnimationListener listener, float transitionTime) {
