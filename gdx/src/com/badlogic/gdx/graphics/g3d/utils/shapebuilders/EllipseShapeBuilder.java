...
public class EllipseShapeBuilder extends BaseShapeBuilder {
  ...
  public static void build(
      ...
      float normalZ) {
    build(
        builder, radius, divisions, centerX, centerY, centerZ, normalX, normalY, normalZ, 0f, 360f);
  }
  ...
  public static void build(
      ...
      float binormalZ) {
    build(
        builder, radius, divisions, centerX, centerY, centerZ, normalX, normalY, normalZ, tangentX,
  ...
  public static void build(
      ...
      float angleTo) {
    build(
        builder, radius, divisions, center.x, center.y, center.z, normal.x, normal.y, normal.z,
        angleFrom, angleTo);
  }
  ...
  public static void build(
      ...
      float normalZ) {
    build(
        builder, width, height, divisions, centerX, centerY, centerZ, normalX, normalY, normalZ, 0f,
        360f);
  }
  ...
  public static void build(
      ...
      final Vector3 normal) {
    build(
        builder, width, height, divisions, center.x, center.y, center.z, normal.x, normal.y,
        normal.z);
  }
  ...
  public static void build(
      ...
      float binormalZ) {
    build(
        builder, width, height, divisions, centerX, centerY, centerZ, normalX, normalY, normalZ,
        tangentX, tangentY, tangentZ, binormalX, binormalY, binormalZ, 0f, 360f);
  }
  ...
  public static void build(
      ...
      float angleTo) {
    build(
        builder, width, height, 0f, 0f, divisions, centerX, centerY, centerZ, normalX, normalY,
        normalZ, angleFrom, angleTo);
  }
  ...
  public static void build(
      ...
      float angleTo) {
    build(
        builder, width, height, 0f, 0f, divisions, center.x, center.y, center.z, normal.x, normal.y,
        normal.z, angleFrom, angleTo);
  }
  ...
  public static void build(
    ...
    build(
        builder, width, height, 0f, 0f, divisions, centerX, centerY, centerZ, normalX, normalY,
        normalZ, tangentX, tangentY, tangentZ, binormalX, binormalY, binormalZ, angleFrom, angleTo);
  }
  ...
  public static void build(
    ...
    for (int i = 0; i <= divisions; i++) {
      ...
      currEx
          ...
          .add(sxEx.x * x + syEx.x * y, sxEx.y * x + syEx.y * y, sxEx.z * x + syEx.z * y);
      ...
      if (innerWidth <= 0f || innerHeight <= 0f) {
        ...
        currIn
            .position
            .set(centerX, centerY, centerZ)
            .add(sxIn.x * x + syIn.x * y, sxIn.y * x + syIn.y * y, sxIn.z * x + syIn.z * y);
