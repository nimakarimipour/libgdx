...
public class TextureDescriptor<T extends GLTexture> implements Comparable<TextureDescriptor<T>> {
    ...
    public void set(final T texture, @Nullable final Texture.TextureFilter minFilter, @Nullable final Texture.TextureFilter magFilter, final Texture.TextureWrap uWrap, @Nullable final Texture.TextureWrap vWrap) {
