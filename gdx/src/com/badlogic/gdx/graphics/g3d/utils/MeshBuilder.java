...
public class MeshBuilder implements MeshPartBuilder {
	...
	private static final void transformPosition (final float[] values, final int offset, final int size, Matrix4 transform) {
		if (size > 2) {
	...
	private static final void transformNormal (final float[] values, final int offset, final int size, Matrix3 transform) {
		if (size > 2) {
