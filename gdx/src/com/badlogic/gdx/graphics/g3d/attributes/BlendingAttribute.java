...
public class BlendingAttribute extends Attribute {
  ...
  /**
   * Whether this material should be considered blended (default: true). This is used for sorting
   * (back to front instead of front to back).
   */
  public boolean blended;

  /**
   * Specifies how the (incoming) red, green, blue, and alpha source blending factors are computed
   * (default: GL_SRC_ALPHA)
   */
  public int sourceFunction;

  /**
   * Specifies how the (existing) red, green, blue, and alpha destination blending factors are
   * computed (default: GL_ONE_MINUS_SRC_ALPHA)
   */
  public int destFunction;

  /**
   * The opacity used as source alpha value, ranging from 0 (fully transparent) to 1 (fully opaque),
   * (default: 1).
   */
  ...
  public BlendingAttribute(
      final boolean blended, final int sourceFunc, final int destFunc, final float opacity) {
    super(Type);
