...
/**
 * An {@link Attribute} which can be used to send an {@link Array} of {@link SpotLight} instances to
 * the {@link Shader}. The lights are stored by reference, the {@link #copy()} or {@link
