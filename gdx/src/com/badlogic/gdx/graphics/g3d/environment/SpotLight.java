...
/**
 * Note that the default shader doesn't support spot lights, you'll have to supply your own shader
 * to use this class.
 *
 * @author realitix
 */
    ...
    return (other != null
        && (other == this
            || (color.equals(other.color)
                ...
                && MathUtils.isEqual(intensity, other.intensity)
                && MathUtils.isEqual(cutoffAngle, other.cutoffAngle)
                && MathUtils.isEqual(exponent, other.exponent))));
  }
}
