...
public class DirectionalLight extends BaseLight<DirectionalLight> {
  ...
  public DirectionalLight set(
      final float r, final float g, final float b, final Vector3 direction) {
  ...
  public DirectionalLight set(
      final Color color, final float dirX, final float dirY, final float dirZ) {
    if (color != null) this.color.set(color);
