    ...
    @Override
      public void update() {
        if (rotationalVelocity2dChannel == null) {
          // Handle the case where rotationalVelocity2dChannel is not initialized.
          // This might include returning early, throwing an exception, or any other logic appropriate for your application.
          return;
        }
    ...
    @Override
        public void update() {
          if (directionalVelocityChannel == null) {
            throw new IllegalStateException("DirectionalVelocityChannel is not allocated");
          }
    ...
    @Override
        public void update() {
          if (accelerationChannel == null) {
            return; // handle the case where accelerationChannel is null
          }
