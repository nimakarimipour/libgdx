 ...
 * management and particle effects update.
 *
 * @author inferno
 */
public final class ParticleSystem implements RenderableProvider {
  ...
  /**
   * Draws all the particle effects. Call {@link #begin()} before this method and {@link #end()}
   * after.
   */
  public void draw() {
    for (ParticleEffect effect : effects) {
  ...
  public void getRenderables(Array<Renderable> renderables, Pool<Renderable> pool) {
    for (ParticleBatch<?> batch : batches) batch.getRenderables(renderables, pool);
  }
