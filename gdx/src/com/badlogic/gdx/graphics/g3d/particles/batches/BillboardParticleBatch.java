...
public class BillboardParticleBatch extends BufferedParticleBatch<BillboardControllerRenderData> {
    ...
    GPU_POSITION_OFFSET = (short) (GPU_ATTRIBUTES.findByUsage(Usage.Position).offset / 4), // Ext
    GPU_UV_OFFSET = (short) (GPU_ATTRIBUTES.findByUsage(Usage.TextureCoordinates).offset / 4), // Ext
    GPU_SIZE_ROTATION_OFFSET = (short) (GPU_ATTRIBUTES.findByUsage(sizeAndRotationUsage).offset / 4), // Ext
    GPU_COLOR_OFFSET = (short) (GPU_ATTRIBUTES.findByUsage(Usage.ColorUnpacked).offset / 4), // Ext
