...
public class ParticleChannels {
	...
	public static class TextureRegionInitializer implements ChannelInitializer<FloatChannel> {
		...
		@SuppressWarnings("NullAway.Init") private static TextureRegionInitializer instance;
	...
	public static class ColorInitializer implements ChannelInitializer<FloatChannel> {
		...
		@SuppressWarnings("NullAway.Init") private static ColorInitializer instance;
	...
	public static class ScaleInitializer implements ChannelInitializer<FloatChannel> {
		...
		@SuppressWarnings("NullAway.Init") private static ScaleInitializer instance;
	...
	public static class Rotation2dInitializer implements ChannelInitializer<FloatChannel> {
		...
		@SuppressWarnings("NullAway.Init") private static Rotation2dInitializer instance;
	...
	public static class Rotation3dInitializer implements ChannelInitializer<FloatChannel> {
		...
		@SuppressWarnings("NullAway.Init") private static Rotation3dInitializer instance;
	...
	// gl units
	public static final ChannelDescriptor Position = new ChannelDescriptor(newGlobalId(), float.class, 3);
	...
	// gl units/s2
	public static final ChannelDescriptor Acceleration = new ChannelDescriptor(newGlobalId(), float.class, 3);
