...
public class DynamicsInfluencer extends Influencer {
  ...
  @Nullable private FloatChannel accellerationChannel,
      positionChannel,
  ...
  public void activateParticles(int startIndex, int count) {
                  if (hasAcceleration) {
                    if (previousPositionChannel != null && positionChannel != null) {
                      for (int i = startIndex * Nullability.castToNonnull(positionChannel, "null check performed").strideSize,
                              c = i + count * Nullability.castToNonnull(positionChannel, "null check performed").strideSize;
                          i < c;
                          i += Nullability.castToNonnull(positionChannel, "null check performed").strideSize) {
                  ...
                  if (has2dAngularVelocity) {
                    if (rotationChannel != null) {
                      for (int i = startIndex * Nullability.castToNonnull(rotationChannel, "null check performed").strideSize,
                              c = i + count * Nullability.castToNonnull(rotationChannel, "null check performed").strideSize;
                          i < c;
                          i += Nullability.castToNonnull(rotationChannel, "null check performed").strideSize) {
  ...
  public void update() {
                      if (hasAcceleration && accellerationChannel != null) {
                          Arrays.fill(
                              Nullability.castToNonnull(accellerationChannel, "checked before access").data,
                              0,
                      ...
                      if (has2dAngularVelocity || has3dAngularVelocity) {
                          if (angularVelocityChannel != null) {
                              Arrays.fill(
                                  Nullability.castToNonnull(angularVelocityChannel, "checked before access").data,
                                  0,
                      ...
                      if (hasAcceleration && previousPositionChannel != null && accellerationChannel != null) {
                          ...
                          for (int i = 0, offset = 0;
                              ...
                              float x = Nullability.castToNonnull(positionChannel, "checked before usage").data[offset + ParticleChannels.XOffset],
                                  y = Nullability.castToNonnull(positionChannel, "checked before usage").data[offset + ParticleChannels.YOffset],
                                  z = Nullability.castToNonnull(positionChannel, "checked before usage").data[offset + ParticleChannels.ZOffset];
                              positionChannel.data[offset + ParticleChannels.XOffset] =
                                  2 * x
                                      - Nullability.castToNonnull(previousPositionChannel, "checked before usage").data[offset + ParticleChannels.XOffset]
                                      + Nullability.castToNonnull(accellerationChannel, "checked before usage").data[offset + ParticleChannels.XOffset]
                      ...
                      if (has2dAngularVelocity) {
                          ...
                          if (angularVelocityChannel != null) {
                              for (int i = 0, offset = 0;
                                  i < controller.particles.size;
                                  ++i, offset += Nullability.castToNonnull(rotationChannel, "always initialized before use").strideSize) {
                                  float rotation = Nullability.castToNonnull(angularVelocityChannel, "checked before use").data[i] * controller.deltaTime;
                                  if (rotation != 0) {
                                      float cosBeta = MathUtils.cosDeg(rotation), sinBeta = MathUtils.sinDeg(rotation);
                                      float currentCosine = Nullability.castToNonnull(rotationChannel, "always initialized before use").data[offset + ParticleChannels.CosineOffset];
                          ...
                          if (angularVelocityChannel != null) {
                              for (int i = 0, offset = 0, angularOffset = 0;
                                  ...
                                  if (angularVelocityChannel != null) {
                                      float wx = Nullability.castToNonnull(angularVelocityChannel, "checked before use").data[angularOffset + ParticleChannels.XOffset],
                                      ...
                                      float qx = Nullability.castToNonnull(rotationChannel, "always initialized before use").data[offset + ParticleChannels.XOffset],
