...
public class ParticleEffect implements Disposable, ResourceData.Configurable {
    ...
    public ParticleEffect(ParticleEffect effect) {
        ...
        for (int i = 0, n = effect.controllers.size; i < n; i++) controllers.add(effect.controllers.get(i).copy());
    }
    ...
    public void init() {
        for (int i = 0, n = controllers.size; i < n; i++) controllers.get(i).init();
    }

    public void start() {
        for (int i = 0, n = controllers.size; i < n; i++) controllers.get(i).start();
    }

    public void end() {
        for (int i = 0, n = controllers.size; i < n; i++) controllers.get(i).end();
    }

    public void reset() {
        for (int i = 0, n = controllers.size; i < n; i++) controllers.get(i).reset();
    }

    public void update() {
        for (int i = 0, n = controllers.size; i < n; i++) controllers.get(i).update();
    }

    public void update(float deltaTime) {
        for (int i = 0, n = controllers.size; i < n; i++) controllers.get(i).update(deltaTime);
    }

    public void draw() {
        for (int i = 0, n = controllers.size; i < n; i++) controllers.get(i).draw();
    }
    ...
    public void setTransform(Matrix4 transform) {
        for (int i = 0, n = controllers.size; i < n; i++) controllers.get(i).setTransform(transform);
    }
    ...
    public void rotate(Quaternion rotation) {
        for (int i = 0, n = controllers.size; i < n; i++) controllers.get(i).rotate(rotation);
    }
    ...
    public void rotate(Vector3 axis, float angle) {
        for (int i = 0, n = controllers.size; i < n; i++) controllers.get(i).rotate(axis, angle);
    }
    ...
    public void scale(float scaleX, float scaleY, float scaleZ) {
        for (int i = 0, n = controllers.size; i < n; i++) controllers.get(i).scale(scaleX, scaleY, scaleZ);
    }
    ...
    public void scale(Vector3 scale) {
        for (int i = 0, n = controllers.size; i < n; i++) controllers.get(i).scale(scale.x, scale.y, scale.z);
    }
