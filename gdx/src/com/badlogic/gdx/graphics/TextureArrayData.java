 ...
 * the format, whether the TextureArrayData is able to manage the pixel data if the OpenGL ES context is lost. Before a call to
 * either {@link #consumeTextureArrayData()}, TextureArray will bind the OpenGL ES texture. Look at {@link FileTextureArrayData}
