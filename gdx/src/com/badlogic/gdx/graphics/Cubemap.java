...
public class Cubemap extends GLTexture {
     ...
     */
    public Cubemap(@Nullable() TextureData positiveX, @Nullable() TextureData negativeX, @Nullable() TextureData positiveY, @Nullable() TextureData negativeY, @Nullable() TextureData positiveZ, @Nullable() TextureData negativeZ) {
        super(GL20.GL_TEXTURE_CUBE_MAP);
