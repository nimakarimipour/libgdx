...
public class Mesh implements Disposable {
     ...
     *           normal or texture coordinate
     */
    public Mesh(boolean isStatic, int maxVertices, int maxIndices, @Nullable VertexAttributes attributes) {
     ...
     */
    public float calculateRadiusSquared(final float centerX, final float centerY, final float centerZ, int offset, int count, @Nullable final Matrix4 transform) {
     ...
     */
    public float calculateRadius(final float centerX, final float centerY, final float centerZ, int offset, int count, @Nullable final Matrix4 transform) {
