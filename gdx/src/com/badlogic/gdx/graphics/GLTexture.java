...
/**
 * Class representing an OpenGL texture by its target and handle. Keeps track of its state like the
 * TextureFilter and TextureWrap. Also provides some (protected) static methods to create
 * TextureData and upload image data.
 *
...
public abstract class GLTexture implements Disposable {
   ...
   * via {@link GL20#glActiveTexture(int)}.
   */
  public void bind() {
  ...
  /**
   * Binds the texture to the given texture unit. Sets the currently active texture unit via {@link
  ...
  /**
   * Sets the {@link TextureWrap} for this texture on the u and v axis. Assumes the texture is bound
   * and active!
   *
   * @param u the u wrap
   * @param v the v wrap
  ...
  /**
   * Sets the {@link TextureFilter} for this texture for minification and magnification. Assumes the
   * texture is bound and active!
   *
   * @param minFilter the minification filter
   * @param magFilter the magnification filter
   */
  public void unsafeSetFilter(
      @Nullable TextureFilter minFilter, @Nullable TextureFilter magFilter) {
   ...
   */
  public void unsafeSetFilter(
      @Nullable TextureFilter minFilter, @Nullable TextureFilter magFilter, boolean force) {
  ...
  /**
   * Sets the {@link TextureFilter} for this texture for minification and magnification. This will
   * bind this texture!
   *
   * @param minFilter the minification filter
   * @param magFilter the magnification filter
   ...
   *
   * @param level The desired level of filtering. The maximum level supported by the device up to
   *     this value will be used.
   * @return The actual level set, which may be lower than the provided value due to device
   *     limitations.
   */
  ...
  /**
   * @return The currently set anisotropic filtering level for the texture, or 1.0f if none has been
   *     set.
   */
