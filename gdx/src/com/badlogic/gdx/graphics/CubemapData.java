 ...
 * the CubemapData is able to manage the pixel data if the OpenGL ES context is lost. Before a call to either
 * {@link #consumeCubemapData()}, Cubemap will bind the OpenGL ES texture. Look at {@link KTXTextureData} for example
