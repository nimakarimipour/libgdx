...
public interface Input {
	 ...
	 * that on Android backend you'll need the permission <code>
	 *  <uses-permission android:name="android.permission.VIBRATE" /></code> in your manifest file in order for this to work. On
	 * iOS backend you'll need to set <code>useHaptics = true</code> for devices with haptics capabilities to use them.
	 *
	 ...
	 * center.
	 *
	 * @see <a href="http://developer.android.com/reference/android/hardware/SensorManager.html#getRotationMatrix(float[], float[],
	 *      float[],
