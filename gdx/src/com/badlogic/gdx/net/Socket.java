 ...
 * {@link Net#newServerSocket(Protocol, int, ServerSocketHints)}. A socket has an {@link InputStream} used to send data to the
 * other end of the connection, and an {@link OutputStream} to receive data from the other end of the connection. A socket needs
 * to be disposed if it is no longer used. Disposing also closes the connection.
 *
 * @author mzechner */
