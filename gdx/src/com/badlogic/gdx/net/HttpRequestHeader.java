...
public interface HttpRequestHeader {
   ...
   *
   * <p>Example: Accept-Charset: utf-8
   */
   ...
   *
   * <p>Example: Accept-Encoding: gzip, deflate
   */
   ...
   *
   * <p>Example: Accept-Language: en-US
   */
   ...
   *
   * <p>Example: Accept-Datetime: Thu, 31 May 2007 20:35:00 GMT
   */
   ...
   *
   * <p>Example: Authorization: Basic QWxhZGRpbjpvcGVuIHNlc2FtZQ==
   */
   ...
   *
   * <p>Example: Cache-Control: no-cache
   */
   ...
   *
   * <p>Example: Connection: keep-alive
   */
   ...
   *
   * <p>Example: Cookie: $Version=1=""; Skin=new="";
   */
   ...
   *
   * <p>Example: Content-Type: application/x-www-form-urlencoded
   */
   ...
   *
   * <p>Example: From: user@example.com
   */
   ...
   *
   * <p>Example: If-Match: "737060cd8c284d8af7ad3082f209582d"
   */
   ...
   *
   * <p>Example: If-Modified-Since: Sat, 29 Oct 1994 19:43:31 GMT
   */
   ...
   *
   * <p>Example: If-None-Match: "737060cd8c284d8af7ad3082f209582d"
   */
   ...
   * entire new entity.
   *
   * <p>Example: If-Range: "737060cd8c284d8af7ad3082f209582d"
   */
   ...
   *
   * <p>Example: If-Unmodified-Since: Sat, 29 Oct 1994 19:43:31 GMT
   */
   ...
   *
   * <p>Example: Origin: http://www.example-social-network.com
   */
   ...
   *
   * <p>Example: Proxy-Authorization: Basic QWxhZGRpbjpvcGVuIHNlc2FtZQ==
   */
   ...
   * terminology).
   *
   * <p>Example: Referer: http://en.wikipedia.org/wiki/Main_Page
   */
  public static final String Referer = "Referer";

  /**
   * The transfer encodings the user agent is willing to accept: the same values as for the response
   * header field Transfer-Encoding can be used, plus the "trailers" value (related to the "chunked"
   * transfer method) to notify the server it expects to receive additional fields in the trailer
   * after the last, zero-sized, chunk.
   *
   * <p>Example: TE: trailers, deflate
   */
   ...
   *
   * <p>Example: User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:12.0) Gecko/20100101 Firefox/21.0
   */
