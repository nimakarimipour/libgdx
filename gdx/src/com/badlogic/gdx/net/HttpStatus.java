 ...
 * http://www.apache.org/licenses/LICENSE-2.0 For more information on the Apache Software
 * Foundation, please see <http://www.apache.org/>.
 *
 * <p>Contains information about the HTTP status line returned with the {@link HttpResponse} after a
 * {@link HttpRequest} was performed. Also contains constants enumerating the HTTP Status Codes. All
...
public class HttpStatus {
  ...
  /**
   * Returns the status code of the HTTP response, normally 2xx status codes indicate success while
   * 4xx and 5xx indicate client and server errors, respectively (see <a
   * href="http://www.w3.org/Protocols/rfc2616/rfc2616-sec10.html">HTTP/1.1: Status Code
