...
public class ServerSocketHints {
   ...
   * waiting for accept(...). If a connection indication arrives when the queue is full, the
  ...
  /**
   * The SO_TIMEOUT in milliseconds for how long to wait during server.accept(). Enter 0 for
   * infinite wait.
   */
