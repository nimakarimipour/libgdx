...
public class OrthoCachedTiledMapRenderer implements TiledMapRenderer, Disposable {
	 ...
	 *
	 * <p>
	 * The amount of tiles cached is computed using <code>(view size + max tile size) * overCache
	 * </code>, meaning the max tile size increases the amount cached and possibly {@link #setOverCache(float)} can be reduced.
	 *
	 * <p>
