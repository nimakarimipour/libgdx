...
public class EllipseMapObject extends MapObject {
  ...
  /**
   * Creates an {@link Ellipse} object whose lower left corner is at (0, 0) with width=1 and
   * height=1
   */
  ...
  /**
   * Creates an {@link Ellipse} object with the given X and Y coordinates along with a specified
   * width and height.
   *
