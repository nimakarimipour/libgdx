...
public class PixmapLoader extends AsynchronousAssetLoader<Pixmap, PixmapLoader.PixmapParameter> {
  ...
  public void loadAsync(
      AssetManager manager, String fileName, FileHandle file, @Nullable PixmapParameter parameter) {
    pixmap = null;
  ...
  public Array<AssetDescriptor> getDependencies(
      String fileName, FileHandle file, @Nullable PixmapParameter parameter) {
    return null;
  }
