...
public class SkinLoader extends AsynchronousAssetLoader<Skin, SkinLoader.SkinParameter> {
	...
	@Override
	public Array<AssetDescriptor> getDependencies (@Nullable String fileName, FileHandle file, @Nullable SkinParameter parameter) {
	...
	@Override
	public void loadAsync (AssetManager manager, @Nullable String fileName, FileHandle file, @Nullable SkinParameter parameter) {
	}

	@Override
	public Skin loadSync (AssetManager manager, @Nullable String fileName, FileHandle file, @Nullable SkinParameter parameter) {
	...
	protected Skin newSkin (@Nullable TextureAtlas atlas) {
