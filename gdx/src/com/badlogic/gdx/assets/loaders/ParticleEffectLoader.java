 ...
 * ParticleEffectParameter} to {@link AssetManager#load(String, Class, AssetLoaderParameters)}
 * allows to specify an atlas file or an image directory to be used for the effect's images. Per
 * default images are loaded from the directory in which the effect file is found.
 */
