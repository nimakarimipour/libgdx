...
public abstract class AsynchronousAssetLoader<T, P extends AssetLoaderParameters<T>> extends AssetLoader<T, P> {
     ...
     */
    public abstract void loadAsync(AssetManager manager, String fileName, FileHandle file, @Nullable P parameter);
     ...
     */
    @Nullable
    public abstract T loadSync(AssetManager manager, String fileName, FileHandle file, @Nullable P parameter);
}
