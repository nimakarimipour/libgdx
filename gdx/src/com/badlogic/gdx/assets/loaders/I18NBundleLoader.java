 ...
 *
 * <p>Notice that you can't load two bundles with the same base name and different locale or
 * encoding using the same {@link AssetManager}. For example, if you try to load the 2 bundles below
 *
 * <pre>
 ...
 * </pre>
 *
 * the English bundle won't be loaded because the asset manager thinks they are the same bundle
 * since they have the same name. There are 2 use cases:
 *
 * <ul>
 *   <li>If you want to load the English bundle so to replace the Italian bundle you have to unload
 *       the Italian bundle first.
 *   <li>If you want to load the English bundle without replacing the Italian bundle you should use
...
public class I18NBundleLoader
  ...
  public void loadAsync(
      AssetManager manager, String fileName, FileHandle file, @Nullable I18NBundleParameter parameter) {
    this.bundle = null;
    Locale locale;
    String encoding;
    if (parameter == null) {
