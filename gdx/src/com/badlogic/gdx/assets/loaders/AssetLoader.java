...
public abstract class AssetLoader<T, P extends AssetLoaderParameters<T>> {
	...
	@NullUnmarked public FileHandle resolve (@Nullable String fileName) {
	...
	@Nullable
	public abstract Array<AssetDescriptor> getDependencies (@Nullable String fileName, FileHandle file, @Nullable P parameter);
}
