...
/**
 * Describes an asset to be loaded by its filename, type and {@link AssetLoaderParameters}.
...
public class AssetDescriptor<T> {
  ...
  /** Creates an AssetDescriptor with an already resolved name. */
  public AssetDescriptor(
      FileHandle file, Class<T> assetType, @Nullable AssetLoaderParameters<T> params) {
