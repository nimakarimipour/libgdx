...
public class AssetDescriptor<T> {
	...
	@Nullable public final AssetLoaderParameters params;
	/** The resolved file. May be null if the fileName has not been resolved yet. */
	@Nullable public FileHandle file;

	public AssetDescriptor (@Nullable String fileName, @Nullable Class<T> assetType) {
	...
	public AssetDescriptor (@Nullable String fileName, @Nullable Class<T> assetType, @Nullable AssetLoaderParameters<T> params) {
