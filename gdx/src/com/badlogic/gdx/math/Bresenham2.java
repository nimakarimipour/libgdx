...
/**
 * Returns a list of points at integer coordinates for a line on a 2D grid, using the Bresenham
 * algorithm.
 *
 * <p>Instances of this class own the returned array of points and the points themselves to avoid
 * garbage collection as much as possible. Calling any of the methods will result in the reuse of
 * the previously returned array and vectors, expect
 *
 * @author badlogic
 */
