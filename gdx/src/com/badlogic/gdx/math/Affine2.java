...
public final class Affine2 implements Serializable {
  ...
  /**
   * Copies the 2D transformation components from the provided 4x4 matrix. The values are mapped as
   * follows:
   *
   * <pre>
   *      [  M00  M01  M03  ]
  ...
  /**
   * Sets this matrix to a concatenation of translation, rotation and scale. It is a more efficient
   * form for: <code>idt().translate(x, y).rotate(degrees).scale(scaleX, scaleY)</code>
   *
   * @param x The translation in x.
   * @param y The translation in y.
   * @param degrees The angle in degrees.
  ...
  /**
   * Sets this matrix to a concatenation of translation, rotation and scale. It is a more efficient
   * form for: <code>idt().translate(trn).rotate(degrees).scale(scale)</code>
   *
   * @param trn The translation vector.
   * @param degrees The angle in degrees.
   * @param scale The scale vector.
  ...
  /**
   * Sets this matrix to a concatenation of translation, rotation and scale. It is a more efficient
   * form for: <code>idt().translate(x, y).rotateRad(radians).scale(scaleX, scaleY)</code>
   *
   * @param x The translation in x.
   * @param y The translation in y.
   * @param radians The angle in radians.
  ...
  /**
   * Sets this matrix to a concatenation of translation, rotation and scale. It is a more efficient
   * form for: <code>idt().translate(trn).rotateRad(radians).scale(scale)</code>
   *
   * @param trn The translation vector.
   * @param radians The angle in radians.
   * @param scale The scale vector.
