...
public class Ellipse implements Serializable, Shape2D {
  ...
  /**
   * Constructs a new {@link Ellipse} from the position and radius of a {@link Circle} (since
  ...
  public boolean contains(float x, float y) {
    ...
    return (x * x) / (width * 0.5f * width * 0.5f) + (y * y) / (height * 0.5f * height * 0.5f)
        <= 1.0f;
  }
  ...
  /**
   * @return The area of this {@link Ellipse} as {@link MathUtils#PI} * {@link Ellipse#width} *
   *     {@link Ellipse#height}
   */
  public float area() {
  ...
  /**
   * Approximates the circumference of this {@link Ellipse}. Oddly enough, the circumference of an
   * ellipse is actually difficult to compute exactly.
   *
   * @return The Ramanujan approximation to the circumference of an ellipse if one dimension is at
   *     least three times longer than the other, else the simpler approximation
   */
