...
public final class MathUtils {
	 ...
	 * those results occur on and near odd multiples of {@code
	 ...
	 * sin(x)/cos(x)}, approximating tan() in that way is very susceptible to error building up from any of sin(), cos() or the
	 * division. Where this tan() has a maximum error in the -1.55 to 1.55 range of 0.02355957, that simpler division technique on
	 * the same range has a maximum error of 1.25724030 (about 50 times worse), as well as larger absolute and relative errors.
	 * Casting the double result of {@link Math#tan(double)} to float will get the highest precision, but can be anywhere from 2.5x
	 * to nearly 4x slower than this, depending on JVM. <br>
	 ...
	 * max} (exclusive), where the {@code mode} argument defaults to the midpoint between the bounds, giving a symmetric
	 * distribution.
	 *
	 * <p>
