...
public class BoundingBox implements Serializable {
  ...
  /**
   * Minimum vector. All XYZ components should be inferior to corresponding {@link #max} components.
   * Call {@link #update()} if you manually change this vector.
   */
  public final Vector3 min = new Vector3();
  /**
   * Maximum vector. All XYZ components should be superior to corresponding {@link #min} components.
   * Call {@link #update()} if you manually change this vector.
   */
  ...
  /**
   * Returns whether this bounding box is valid. This means that {@link #max} is greater than or
   * equal to {@link #min}.
   *
   ...
   * @param transform The transformation matrix to apply to bounds, before using it to extend this
   *     bounding box.
   * @return This bounding box for chaining.
   */
  ...
  /**
   * Multiplies the bounding box by the given matrix. This is achieved by multiplying the 8 corner
   * points and then calculating the minimum and maximum vectors from the transformed points.
   *
  ...
  /**
   * Returns whether the given bounding box is intersecting this bounding box (at least one point
   * in).
   *
   * @param b The bounding box
