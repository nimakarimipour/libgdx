...
/**
 * Encapsulates a 2D rectangle defined by its corner point in the bottom left and its extents in x
 * (width) and y (height).
 *
...
public class Rectangle implements Serializable, Shape2D {
  /**
   * Static temporary rectangle. Use with care! Use only when sure other code will not also use
   * this.
   */
  ...
  /**
   * Merges this rectangle with a list of points. The rectangle should not have negative width or
   * negative height.
   *
   ...
   *
   * @return the aspect ratio of this rectangle. Returns Float.NaN if height is 0 to avoid
   *     ArithmeticException
   */
  ...
  /**
   * Fits this rectangle around another rectangle while maintaining aspect ratio. This scales and
   * centers the rectangle to the other rectangle (e.g. Having a camera translate and scale to show
   * a given area)
   *
  ...
  /**
   * Fits this rectangle into another rectangle while maintaining aspect ratio. This scales and
   * centers the rectangle to the other rectangle (e.g. Scaling a texture within a arbitrary cell
   * without squeezing)
   *
  ...
  /**
   * Sets this {@code Rectangle} to the value represented by the specified string according to the
