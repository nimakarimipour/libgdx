...
public final class Intersector {
    ...
    public static boolean intersectSegmentCircle(Vector2 start, Vector2 end, Circle circle, MinimumTranslationVector mtv) {
        ...
        if (u <= 0) {
            ...
            // remember v2a is already normalized
            v2d.set(v2a.scl(u));
     ...
     */
    public static boolean intersectSegments(float x1, float y1, float x2, float y2, float x3, float y3, float x4, float y4, @Nullable Vector2 intersection) {
        float d = (y4 - y3) * (x2 - x1) - (x4 - x3) * (y2 - y1);
        if (d == 0)
            return false;
        float yd = y1 - y3;
     ...
     * @return Whether polygons overlap.
     */
    public static boolean overlapConvexPolygons(float[] verts1, int offset1, int count1, float[] verts2, int offset2, int count2, @Nullable MinimumTranslationVector mtv) {
        boolean overlaps;
        if (mtv != null) {
     ...
     */
    private static boolean overlapsOnAxisOfShape(float[] verts1, int offset1, int count1, float[] verts2, int offset2, int count2, @Nullable MinimumTranslationVector mtv, boolean shapesShifted) {
