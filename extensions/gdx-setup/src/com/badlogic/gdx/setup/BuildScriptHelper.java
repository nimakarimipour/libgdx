...
public class BuildScriptHelper {
  ...
  public static void addBuildScript(
      Language language, List<ProjectType> projects, BufferedWriter wr) throws IOException {
  ...
  public static void addProject(
      Language language, ProjectType project, List<Dependency> dependencies, BufferedWriter wr)
      throws IOException {
    space(wr);
  ...
  private static void addDependencies(
      Language language, ProjectType project, List<Dependency> dependencyList, BufferedWriter wr)
      throws IOException {
    write(wr, "dependencies {");
