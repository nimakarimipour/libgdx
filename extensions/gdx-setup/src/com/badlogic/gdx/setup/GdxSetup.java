...
public class GdxSetup {
  ...
  public static boolean isSdkUpToDate(String sdkLocation) {
    ...
    if (compareVersions(targetToolVersion, localToolVersion)) {
      ...
      if (value != 0) {
        JOptionPane.showMessageDialog(
            null, "Using build tools: " + DependencyBank.buildToolsVersion);
      } else {
      ...
      if (!versionsEqual(localToolVersion, targetToolVersion)) {
        JOptionPane.showMessageDialog(
            null,
            "Please update your Android SDK, you need build tools: "
                + DependencyBank.buildToolsVersion);
        return false;
      }
    }
    ...
    if (newestLocalApi > Integer.parseInt(DependencyBank.androidAPILevel)) {
      ...
      if (newestLocalApi != Integer.parseInt(DependencyBank.androidAPILevel)) {
        JOptionPane.showMessageDialog(
            null,
            "Please update your Android SDK, you need the Android API: "
                + DependencyBank.androidAPILevel);
        return false;
      }
    }
  ...
  public void build(
    ...
    project.files.add(
        new ProjectFile(
            "core/src/MainClass", "core/src/" + packageDir + "/" + mainClass + ".java", true));
    if (builder.modules.contains(ProjectType.HTML) && language.gwtSupported) {
      project.files.add(
          new ProjectFile("core/CoreGdxDefinition", "core/src/" + mainClass + ".gwt.xml", true));
    }

    // lwjgl2 project
    if (builder.modules.contains(ProjectType.LWJGL2)) {
      project.files.add(
          new ProjectFile("lwjgl2/build.gradle", "legacy_desktop/build.gradle", true));
      project.files.add(
          new ProjectFile(
              "lwjgl2/src/DesktopLauncher",
              "legacy_desktop/src/" + packageDir + "/DesktopLauncher.java",
              true));
    }
    ...
    if (builder.modules.contains(ProjectType.LWJGL3)) {
      ...
      project.files.add(
          new ProjectFile(
              "lwjgl3/src/DesktopLauncher",
              "desktop/src/" + packageDir + "/DesktopLauncher.java",
              true));
    }
    ...
    if (builder.modules.contains(ProjectType.ANDROID)) {
      ...
      project.files.add(
          new ProjectFile("android/res/drawable-anydpi-v26/ic_launcher_foreground.xml", false));
      ...
      project.files.add(
          new ProjectFile(
              "android/src/AndroidLauncher",
              "android/src/" + packageDir + "/AndroidLauncher.java",
              true));
    ...
    if (builder.modules.contains(ProjectType.HTML)) {
      ...
      project.files.add(
          new ProjectFile(
              "html/src/HtmlLauncher",
              "html/src/" + packageDir + "/client/HtmlLauncher.java",
              true));
      project.files.add(
          new ProjectFile(
              "html/GdxDefinition", "html/src/" + packageDir + "/GdxDefinition.gwt.xml", true));
      project.files.add(
          new ProjectFile(
              "html/GdxDefinitionSuperdev",
              "html/src/" + packageDir + "/GdxDefinitionSuperdev.gwt.xml",
              true));
      ...
      project.files.add(
          new ProjectFile("html/war/WEB-INF/web.xml", "html/webapp/WEB-INF/web.xml", true));
    }
    ...
    if (builder.modules.contains(ProjectType.IOS)) {
      project.files.add(
          new ProjectFile(
              "ios/src/IOSLauncher", "ios/src/" + packageDir + "/IOSLauncher.java", true));
      project.files.add(new ProjectFile("ios/data/Media.xcassets/Contents.json", false));
      project.files.add(
          new ProjectFile(
              "ios/data/Media.xcassets/AppIcon.appiconset/app-store-icon-1024@1x.png", false));
      project.files.add(
          new ProjectFile("ios/data/Media.xcassets/AppIcon.appiconset/Contents.json", false));
      project.files.add(
          new ProjectFile(
              "ios/data/Media.xcassets/AppIcon.appiconset/ipad-app-icon-76@1x.png", false));
      project.files.add(
          new ProjectFile(
              "ios/data/Media.xcassets/AppIcon.appiconset/ipad-app-icon-76@2x.png", false));
      project.files.add(
          new ProjectFile(
      ...
      project.files.add(
          new ProjectFile(
              "ios/data/Media.xcassets/AppIcon.appiconset/ipad-pro-app-icon-83.5@2x.png", false));
      project.files.add(
          new ProjectFile(
              "ios/data/Media.xcassets/AppIcon.appiconset/ipad-settings-icon-29@1x.png", false));
      project.files.add(
          new ProjectFile(
              "ios/data/Media.xcassets/AppIcon.appiconset/ipad-settings-icon-29@2x.png", false));
      project.files.add(
          new ProjectFile(
              "ios/data/Media.xcassets/AppIcon.appiconset/ipad-spotlight-icon-40@1x.png", false));
      project.files.add(
          new ProjectFile(
              "ios/data/Media.xcassets/AppIcon.appiconset/ipad-spotlight-icon-40@2x.png", false));
      project.files.add(
          new ProjectFile(
              "ios/data/Media.xcassets/AppIcon.appiconset/iphone-app-icon-60@2x.png", false));
      project.files.add(
          new ProjectFile(
              "ios/data/Media.xcassets/AppIcon.appiconset/iphone-app-icon-60@3x.png", false));
      project.files.add(
          new ProjectFile(
      ...
      project.files.add(
          new ProjectFile(
              "ios/data/Media.xcassets/AppIcon.appiconset/iphone-spotlight-icon-40@2x.png", false));
      project.files.add(
          new ProjectFile(
              "ios/data/Media.xcassets/AppIcon.appiconset/iphone-spotlight-icon-40@3x.png", false));
      project.files.add(
          new ProjectFile(
      ...
      project.files.add(
          new ProjectFile(
              ...
              false));
      project.files.add(
          new ProjectFile("ios/data/Media.xcassets/Logo.imageset/Contents.json", false));
      project.files.add(
          new ProjectFile("ios/data/Media.xcassets/Logo.imageset/libgdx@1x.png", false));
      project.files.add(
          new ProjectFile("ios/data/Media.xcassets/Logo.imageset/libgdx@2x.png", false));
      project.files.add(
          new ProjectFile("ios/data/Media.xcassets/Logo.imageset/libgdx@3x.png", false));
    ...
    Executor.execute(
        ...
        "gradlew.bat",
        "gradlew",
        "clean" + parseGradleArgs(builder.modules, gradleArgs),
        callback);
  }
  ...
  private void copyAndReplace(String outputDir, Project project, Map<String, String> values) {
    ...
    if (!out.exists() && !out.mkdirs()) {
      throw new RuntimeException(
          "Couldn't create output directory '" + out.getAbsolutePath() + "'");
    }
  ...
  private static void printHelp() {
    ...
    System.out.println(
        "assetPath ... the location assets are stored, relative to project root. Default \"assets\". Optional");
    System.out.println(
  ...
  private static List<String> parseExcludedModules(String excludedModules) {
    ...
    while (excludedModules.contains(";")) {
      excludedModulesList.add(
          excludedModules.substring(0, excludedModules.indexOf(";")).toLowerCase());
  ...
  private boolean containsDependency(
      List<Dependency> dependencyList, ProjectDependency projectDependency) {
  ...
  public static void main(String[] args) throws IOException {
    ...
    if (!params.containsKey("dir")
        ...
        || (!params.containsKey("sdkLocation")
