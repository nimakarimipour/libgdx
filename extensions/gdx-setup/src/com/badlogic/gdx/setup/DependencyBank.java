...
public class DependencyBank {
  ...
  HashMap<ProjectDependency, Dependency> gdxDependencies =
      new HashMap<ProjectDependency, Dependency>();
  ...
  /**
   * This enum will hold all dependencies available for libgdx, allowing the setup to pick the ones
   * needed by default, and allow the option to choose extensions as the user wishes.
   *
   * <p>These dependency strings can be later used in a simple gradle plugin to manipulate the users
   * project either after/before project generation
   *
   * @see Dependency for the object that handles sub-module dependencies. If no dependency is found
   *     for a sub-module, ie FreeTypeFont for gwt, an exception is thrown so the user can be
   *     notified of incompatability
   */
  public enum ProjectDependency {
    ...
    BULLET(
        ...
        new String[] {"com.badlogicgames.gdx:gdx-bullet-platform:$gdxVersion:natives-desktop"},
        new String[] {
          "com.badlogicgames.gdx:gdx-bullet:$gdxVersion",
    ...
    CONTROLLERS(
        new String[] {
          "com.badlogicgames.gdx-controllers:gdx-controllers-core:$gdxControllersVersion"
        },
        new String[] {
        ...
        new String[] {
          "com.badlogicgames.gdx-controllers:gdx-controllers-android:$gdxControllersVersion"
        },
        new String[] {
          "com.badlogicgames.gdx-controllers:gdx-controllers-ios:$gdxControllersVersion"
        },
        new String[] {
          "com.badlogicgames.gdx-controllers:gdx-controllers-core:$gdxControllersVersion:sources",
        ...
        new String[] {
          "com.badlogic.gdx.controllers", "com.badlogic.gdx.controllers.controllers-gwt"
        },
    ...
    BOX2D(
        ...
        new String[] {
          "com.badlogicgames.gdx:gdx-box2d:$gdxVersion:sources",
