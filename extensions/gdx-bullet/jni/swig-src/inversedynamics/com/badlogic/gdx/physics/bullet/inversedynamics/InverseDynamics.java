...
public class InverseDynamics {
  ...
  public static void getVecMatFromDH(
      float theta, float d, float a, float alpha, SWIGTYPE_p_vec3 r, SWIGTYPE_p_mat33 T) {
    InverseDynamicsJNI.getVecMatFromDH(
        theta, d, a, alpha, SWIGTYPE_p_vec3.getCPtr(r), SWIGTYPE_p_mat33.getCPtr(T));
  }
  ...
  public static boolean isValidInertiaMatrix(
      SWIGTYPE_p_mat33 I, int index, boolean has_fixed_joint) {
    return InverseDynamicsJNI.isValidInertiaMatrix(
        SWIGTYPE_p_mat33.getCPtr(I), index, has_fixed_joint);
  }
  ...
  public static void bodyTParentFromAxisAngle(
      SWIGTYPE_p_vec3 axis, float angle, SWIGTYPE_p_mat33 T) {
    InverseDynamicsJNI.bodyTParentFromAxisAngle(
        SWIGTYPE_p_vec3.getCPtr(axis), angle, SWIGTYPE_p_mat33.getCPtr(T));
  }
  ...
  public static SWIGTYPE_p_vec3 rpyFromMatrix(SWIGTYPE_p_mat33 rot) {
    return new SWIGTYPE_p_vec3(
        InverseDynamicsJNI.rpyFromMatrix(SWIGTYPE_p_mat33.getCPtr(rot)), true);
  }
}
