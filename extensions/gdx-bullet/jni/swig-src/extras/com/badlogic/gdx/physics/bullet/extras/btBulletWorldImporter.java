...
public class btBulletWorldImporter extends btWorldImporter {
  ...
  /**
   * Construct a new btBulletWorldImporter, normally you should not need this constructor it's
  ...
  public boolean loadFile(String fileName, String preSwapFilenameOut) {
    return ExtrasJNI.btBulletWorldImporter_loadFile__SWIG_0(
        swigCPtr, this, fileName, preSwapFilenameOut);
  }
  ...
  public boolean loadFileFromMemory(SWIGTYPE_p_bParse__btBulletFile file) {
    return ExtrasJNI.btBulletWorldImporter_loadFileFromMemory__SWIG_0(
        swigCPtr, this, SWIGTYPE_p_bParse__btBulletFile.getCPtr(file));
  }

  public boolean convertAllObjects(SWIGTYPE_p_bParse__btBulletFile file) {
    return (getClass() == btBulletWorldImporter.class)
        ? ExtrasJNI.btBulletWorldImporter_convertAllObjects(
            swigCPtr, this, SWIGTYPE_p_bParse__btBulletFile.getCPtr(file))
        : ExtrasJNI.btBulletWorldImporter_convertAllObjectsSwigExplicitbtBulletWorldImporter(
            swigCPtr, this, SWIGTYPE_p_bParse__btBulletFile.getCPtr(file));
  }
  ...
  public boolean loadFileFromMemory(java.nio.ByteBuffer memoryBuffer, int len) {
    ...
    {
      return ExtrasJNI.btBulletWorldImporter_loadFileFromMemory__SWIG_1(
          swigCPtr, this, memoryBuffer, len);
    }
  }
}
