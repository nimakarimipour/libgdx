...
public class btStringArray extends BulletBase {
  ...
  /**
   * Construct a new btStringArray, normally you should not need this constructor it's intended for
   * low-level usage.
   */
  ...
  public btStringArray operatorAssignment(btStringArray other) {
    return new btStringArray(
        ExtrasJNI.btStringArray_operatorAssignment(
            swigCPtr, this, btStringArray.getCPtr(other), other),
        false);
  }
  ...
  public void copyFromArray(btStringArray otherArray) {
    ExtrasJNI.btStringArray_copyFromArray(
        swigCPtr, this, btStringArray.getCPtr(otherArray), otherArray);
  }
}
