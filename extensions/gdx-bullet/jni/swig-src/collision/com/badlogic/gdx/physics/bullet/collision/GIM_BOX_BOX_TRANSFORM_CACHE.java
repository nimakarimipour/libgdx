...
public class GIM_BOX_BOX_TRANSFORM_CACHE extends BulletBase {
  ...
  /**
   * Construct a new GIM_BOX_BOX_TRANSFORM_CACHE, normally you should not need this constructor it's
  ...
  public void setT1to0(btVector3 value) {
    CollisionJNI.GIM_BOX_BOX_TRANSFORM_CACHE_T1to0_set(
  ...
  public void setR1to0(btMatrix3x3 value) {
    CollisionJNI.GIM_BOX_BOX_TRANSFORM_CACHE_R1to0_set(
  ...
  public void setAR(btMatrix3x3 value) {
    CollisionJNI.GIM_BOX_BOX_TRANSFORM_CACHE_AR_set(
        swigCPtr, this, btMatrix3x3.getCPtr(value), value);
  }
  ...
  public GIM_BOX_BOX_TRANSFORM_CACHE(SWIGTYPE_p_a_4__GREAL trans1_to_0) {
    this(
        CollisionJNI.new_GIM_BOX_BOX_TRANSFORM_CACHE__SWIG_1(
            SWIGTYPE_p_a_4__GREAL.getCPtr(trans1_to_0)),
        true);
  }
