...
public class ClosestNotMeConvexResultCallback extends ClosestConvexResultCallback {
  ...
  protected ClosestNotMeConvexResultCallback(
  ...
  /**
   * Construct a new ClosestNotMeConvexResultCallback, normally you should not need this constructor
  ...
  protected void reset(long cPtr, boolean cMemoryOwn) {
    ...
    super.reset(
        CollisionJNI.ClosestNotMeConvexResultCallback_SWIGUpcast(swigCPtr = cPtr), cMemoryOwn);
  }
  ...
  public void setMe(btCollisionObject value) {
    CollisionJNI.ClosestNotMeConvexResultCallback_me_set(
        swigCPtr, this, btCollisionObject.getCPtr(value), value);
  }

  public btCollisionObject getMe() {
    return btCollisionObject.getInstance(
        CollisionJNI.ClosestNotMeConvexResultCallback_me_get(swigCPtr, this), false);
  }
  ...
  public ClosestNotMeConvexResultCallback(btCollisionObject me, Vector3 fromA, Vector3 toA) {
    this(
        CollisionJNI.new_ClosestNotMeConvexResultCallback(
            btCollisionObject.getCPtr(me), me, fromA, toA),
        true);
  }

  public boolean needsCollision(btBroadphaseProxy proxy0) {
    return CollisionJNI.ClosestNotMeConvexResultCallback_needsCollision(
