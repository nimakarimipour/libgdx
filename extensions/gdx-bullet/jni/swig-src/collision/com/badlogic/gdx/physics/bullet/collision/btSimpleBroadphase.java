...
public class btSimpleBroadphase extends btBroadphaseInterface {
  ...
  /**
   * Construct a new btSimpleBroadphase, normally you should not need this constructor it's intended
   * for low-level usage.
   */
  ...
  public btSimpleBroadphase(int maxProxies, btOverlappingPairCache overlappingPairCache) {
    this(
        CollisionJNI.new_btSimpleBroadphase__SWIG_0(
            maxProxies, btOverlappingPairCache.getCPtr(overlappingPairCache), overlappingPairCache),
        true);
  }
  ...
  public void rayTest(
      ...
      Vector3 aabbMin,
      Vector3 aabbMax) {
    CollisionJNI.btSimpleBroadphase_rayTest__SWIG_0(
        swigCPtr,
        this,
        rayFrom,
        rayTo,
