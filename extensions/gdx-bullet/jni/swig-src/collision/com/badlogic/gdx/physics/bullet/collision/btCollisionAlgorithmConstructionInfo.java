...
public class btCollisionAlgorithmConstructionInfo extends BulletBase {
  ...
  protected btCollisionAlgorithmConstructionInfo(
  ...
  /**
   * Construct a new btCollisionAlgorithmConstructionInfo, normally you should not need this
  ...
  public btCollisionAlgorithmConstructionInfo(btDispatcher dispatcher, int temp) {
    this(
        CollisionJNI.new_btCollisionAlgorithmConstructionInfo__SWIG_1(
            btDispatcher.getCPtr(dispatcher), dispatcher, temp),
        true);
  }

  public void setDispatcher1(btDispatcher value) {
    CollisionJNI.btCollisionAlgorithmConstructionInfo_dispatcher1_set(
        swigCPtr, this, btDispatcher.getCPtr(value), value);
  }
  ...
  public void setManifold(btPersistentManifold value) {
    CollisionJNI.btCollisionAlgorithmConstructionInfo_manifold_set(
