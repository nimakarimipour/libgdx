...
public class btDbvtNode extends BulletBase {
  ...
  /**
   * Construct a new btDbvtNode, normally you should not need this constructor it's intended for
   * low-level usage.
   */
  ...
  private static btDbvtNode[] argumentInstances =
      new btDbvtNode[] {
        new btDbvtNode(0, false),
        new btDbvtNode(0, false),
        new btDbvtNode(0, false),
        new btDbvtNode(0, false)
      };
  ...
  public btBroadphaseProxy getDataAsProxy() {
    return btBroadphaseProxy.internalTemp(
        CollisionJNI.btDbvtNode_getDataAsProxy(swigCPtr, this), false);
  }

  public btCollisionObject getDataAsProxyClientObject() {
    return btCollisionObject.getInstance(
        CollisionJNI.btDbvtNode_getDataAsProxyClientObject(swigCPtr, this), false);
  }
