...
public class btActivatingCollisionAlgorithm extends btCollisionAlgorithm {
  ...
  /**
   * Construct a new btActivatingCollisionAlgorithm, normally you should not need this constructor
  ...
  protected void reset(long cPtr, boolean cMemoryOwn) {
    ...
    super.reset(
        CollisionJNI.btActivatingCollisionAlgorithm_SWIGUpcast(swigCPtr = cPtr), cMemoryOwn);
  }
