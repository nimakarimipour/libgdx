...
public class btPolyhedralConvexAabbCachingShape extends btPolyhedralConvexShape {
  ...
  protected btPolyhedralConvexAabbCachingShape(
  ...
  /**
   * Construct a new btPolyhedralConvexAabbCachingShape, normally you should not need this
  ...
  protected void reset(long cPtr, boolean cMemoryOwn) {
    ...
    super.reset(
        CollisionJNI.btPolyhedralConvexAabbCachingShape_SWIGUpcast(swigCPtr = cPtr), cMemoryOwn);
  }
  ...
  public void getNonvirtualAabb(Matrix4 trans, Vector3 aabbMin, Vector3 aabbMax, float margin) {
    CollisionJNI.btPolyhedralConvexAabbCachingShape_getNonvirtualAabb(
        swigCPtr, this, trans, aabbMin, aabbMax, margin);
  }
