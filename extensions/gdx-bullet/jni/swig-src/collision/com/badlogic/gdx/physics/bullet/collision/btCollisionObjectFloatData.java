...
public class btCollisionObjectFloatData extends BulletBase {
  ...
  /**
   * Construct a new btCollisionObjectFloatData, normally you should not need this constructor it's
  ...
  public void setRootCollisionShape(btCollisionShapeData value) {
    CollisionJNI.btCollisionObjectFloatData_rootCollisionShape_set(
  ...
  public void setWorldTransform(btTransformFloatData value) {
    CollisionJNI.btCollisionObjectFloatData_worldTransform_set(
  ...
  public void setInterpolationWorldTransform(btTransformFloatData value) {
    CollisionJNI.btCollisionObjectFloatData_interpolationWorldTransform_set(
        swigCPtr, this, btTransformFloatData.getCPtr(value), value);
  }

  public btTransformFloatData getInterpolationWorldTransform() {
    long cPtr =
        CollisionJNI.btCollisionObjectFloatData_interpolationWorldTransform_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btTransformFloatData(cPtr, false);
  }

  public void setInterpolationLinearVelocity(btVector3FloatData value) {
    CollisionJNI.btCollisionObjectFloatData_interpolationLinearVelocity_set(
        swigCPtr, this, btVector3FloatData.getCPtr(value), value);
  }

  public btVector3FloatData getInterpolationLinearVelocity() {
    long cPtr =
        CollisionJNI.btCollisionObjectFloatData_interpolationLinearVelocity_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btVector3FloatData(cPtr, false);
  }

  public void setInterpolationAngularVelocity(btVector3FloatData value) {
    CollisionJNI.btCollisionObjectFloatData_interpolationAngularVelocity_set(
        swigCPtr, this, btVector3FloatData.getCPtr(value), value);
  }

  public btVector3FloatData getInterpolationAngularVelocity() {
    long cPtr =
        CollisionJNI.btCollisionObjectFloatData_interpolationAngularVelocity_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btVector3FloatData(cPtr, false);
  }

  public void setAnisotropicFriction(btVector3FloatData value) {
    CollisionJNI.btCollisionObjectFloatData_anisotropicFriction_set(
        swigCPtr, this, btVector3FloatData.getCPtr(value), value);
  }
