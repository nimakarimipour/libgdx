...
public class btGhostPairCallback extends btOverlappingPairCallback {
  ...
  /**
   * Construct a new btGhostPairCallback, normally you should not need this constructor it's
  ...
  public long removeOverlappingPair(
    ...
    return (getClass() == btGhostPairCallback.class)
        ? CollisionJNI.btGhostPairCallback_removeOverlappingPair(
            ...
            dispatcher)
        : CollisionJNI.btGhostPairCallback_removeOverlappingPairSwigExplicitbtGhostPairCallback(
            swigCPtr,
            this,
            btBroadphaseProxy.getCPtr(proxy0),
            proxy0,
