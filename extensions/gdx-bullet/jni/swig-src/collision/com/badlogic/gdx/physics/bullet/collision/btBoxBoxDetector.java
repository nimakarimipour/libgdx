...
public class btBoxBoxDetector extends btDiscreteCollisionDetectorInterface {
  ...
  /**
   * Construct a new btBoxBoxDetector, normally you should not need this constructor it's intended
   * for low-level usage.
   */
  ...
  public btBoxBoxDetector(btBoxShape box1, btBoxShape box2) {
    this(
        CollisionJNI.new_btBoxBoxDetector(
            btBoxShape.getCPtr(box1), box1, btBoxShape.getCPtr(box2), box2),
        true);
  }
  ...
  public void getClosestPoints(
      ...
      boolean swapResults) {
    CollisionJNI.btBoxBoxDetector_getClosestPoints__SWIG_0(
        swigCPtr,
        this,
  ...
  public void getClosestPoints(
      ...
      btDiscreteCollisionDetectorInterface.Result output,
      btIDebugDraw debugDraw) {
    CollisionJNI.btBoxBoxDetector_getClosestPoints__SWIG_1(
        swigCPtr,
        this,
        btDiscreteCollisionDetectorInterface.ClosestPointInput.getCPtr(input),
        input,
