...
public class btOverlappingPairCallback extends BulletBase {
  ...
  /**
   * Construct a new btOverlappingPairCallback, normally you should not need this constructor it's
  ...
  public btBroadphasePair addOverlappingPair(btBroadphaseProxy proxy0, btBroadphaseProxy proxy1) {
    return btBroadphasePair.internalTemp(
        CollisionJNI.btOverlappingPairCallback_addOverlappingPair(
            swigCPtr,
            this,
  ...
  public long removeOverlappingPair(
    ...
    return CollisionJNI.btOverlappingPairCallback_removeOverlappingPair(
        swigCPtr,
        this,
        btBroadphaseProxy.getCPtr(proxy0),
        proxy0,
