...
public class btSphereSphereCollisionAlgorithm extends btActivatingCollisionAlgorithm {
  ...
  /**
   * Construct a new btSphereSphereCollisionAlgorithm, normally you should not need this constructor
  ...
  protected void reset(long cPtr, boolean cMemoryOwn) {
    ...
    super.reset(
        CollisionJNI.btSphereSphereCollisionAlgorithm_SWIGUpcast(swigCPtr = cPtr), cMemoryOwn);
  }
  ...
  public btSphereSphereCollisionAlgorithm(
    ...
    this(
        CollisionJNI.new_btSphereSphereCollisionAlgorithm__SWIG_0(
            btPersistentManifold.getCPtr(mf),
            mf,
            btCollisionAlgorithmConstructionInfo.getCPtr(ci),
            ci,
            btCollisionObjectWrapper.getCPtr(col0Wrap),
            col0Wrap,
  ...
  public btSphereSphereCollisionAlgorithm(btCollisionAlgorithmConstructionInfo ci) {
    this(
        CollisionJNI.new_btSphereSphereCollisionAlgorithm__SWIG_1(
  ...
  public static class CreateFunc extends btCollisionAlgorithmCreateFunc {
    ...
    protected CreateFunc(final String className, long cPtr, boolean cMemoryOwn) {
      super(
          className,
          CollisionJNI.btSphereSphereCollisionAlgorithm_CreateFunc_SWIGUpcast(cPtr),
          cMemoryOwn);
      swigCPtr = cPtr;
    }
    ...
    protected void reset(long cPtr, boolean cMemoryOwn) {
      if (!destroyed) destroy();
      super.reset(
          CollisionJNI.btSphereSphereCollisionAlgorithm_CreateFunc_SWIGUpcast(swigCPtr = cPtr),
          cMemoryOwn);
    }
