...
public class LocalRayResult extends BulletBase {
  ...
  /**
   * Construct a new LocalRayResult, normally you should not need this constructor it's intended for
   * low-level usage.
   */
  ...
  public LocalRayResult(
      ...
      float hitFraction) {
    this(
        CollisionJNI.new_LocalRayResult(
  ...
  public void setCollisionObject(btCollisionObject value) {
    CollisionJNI.LocalRayResult_collisionObject_set(
        swigCPtr, this, btCollisionObject.getCPtr(value), value);
  }

  public btCollisionObject getCollisionObject() {
    return btCollisionObject.getInstance(
        CollisionJNI.LocalRayResult_collisionObject_get(swigCPtr, this), false);
  }

  public void setLocalShapeInfo(LocalShapeInfo value) {
    CollisionJNI.LocalRayResult_localShapeInfo_set(
