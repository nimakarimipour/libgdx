...
public class btConvexTriangleMeshShape extends btPolyhedralConvexAabbCachingShape {
  ...
  /**
   * Construct a new btConvexTriangleMeshShape, normally you should not need this constructor it's
  ...
  public long operatorNewArray(long sizeInBytes) {
    return CollisionJNI.btConvexTriangleMeshShape_operatorNewArray__SWIG_0(
  ...
  public long operatorNewArray(long arg0, long ptr) {
    return CollisionJNI.btConvexTriangleMeshShape_operatorNewArray__SWIG_1(
  ...
  public btConvexTriangleMeshShape(btStridingMeshInterface meshInterface, boolean calcAabb) {
    this(
        CollisionJNI.new_btConvexTriangleMeshShape__SWIG_0(
            btStridingMeshInterface.getCPtr(meshInterface), meshInterface, calcAabb),
        true);
  }

  public btConvexTriangleMeshShape(btStridingMeshInterface meshInterface) {
    this(
        CollisionJNI.new_btConvexTriangleMeshShape__SWIG_1(
            btStridingMeshInterface.getCPtr(meshInterface), meshInterface),
        true);
  }
  ...
  public void calculatePrincipalAxisTransform(
      Matrix4 principal, Vector3 inertia, SWIGTYPE_p_float volume) {
    CollisionJNI.btConvexTriangleMeshShape_calculatePrincipalAxisTransform(
