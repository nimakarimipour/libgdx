...
public class btDispatcherInfo extends BulletBase {
  ...
  /**
   * Construct a new btDispatcherInfo, normally you should not need this constructor it's intended
   * for low-level usage.
   */
  ...
  public static final class DispatchFunc {
    ...
    public static final int DISPATCH_CONTINUOUS = DISPATCH_DISCRETE + 1;
  }
}
