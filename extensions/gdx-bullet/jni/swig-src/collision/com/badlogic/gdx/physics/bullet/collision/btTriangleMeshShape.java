...
public class btTriangleMeshShape extends btConcaveShape {
  ...
  /**
   * Construct a new btTriangleMeshShape, normally you should not need this constructor it's
  ...
  public Vector3 localGetSupportingVertexWithoutMargin(Vector3 vec) {
    return CollisionJNI.btTriangleMeshShape_localGetSupportingVertexWithoutMargin(
        swigCPtr, this, vec);
  }
