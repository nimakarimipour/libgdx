...
public class btGenericPoolAllocator extends BulletBase {
  ...
  /**
   * Construct a new btGenericPoolAllocator, normally you should not need this constructor it's
  ...
  public void setPools(SWIGTYPE_p_p_btGenericMemoryPool value) {
    CollisionJNI.btGenericPoolAllocator_pools_set(
        swigCPtr, this, SWIGTYPE_p_p_btGenericMemoryPool.getCPtr(value));
  }
