...
public class btConvexPlaneCollisionAlgorithm extends btCollisionAlgorithm {
  ...
  /**
   * Construct a new btConvexPlaneCollisionAlgorithm, normally you should not need this constructor
  ...
  protected void reset(long cPtr, boolean cMemoryOwn) {
    ...
    super.reset(
        CollisionJNI.btConvexPlaneCollisionAlgorithm_SWIGUpcast(swigCPtr = cPtr), cMemoryOwn);
  }
  ...
  public btConvexPlaneCollisionAlgorithm(
    ...
    this(
        CollisionJNI.new_btConvexPlaneCollisionAlgorithm(
  ...
  public void collideSingleContact(
      Quaternion perturbeRot,
      btCollisionObjectWrapper body0Wrap,
      btCollisionObjectWrapper body1Wrap,
      btDispatcherInfo dispatchInfo,
      btManifoldResult resultOut) {
    CollisionJNI.btConvexPlaneCollisionAlgorithm_collideSingleContact(
        swigCPtr,
        this,
        perturbeRot,
        btCollisionObjectWrapper.getCPtr(body0Wrap),
  ...
  public static class CreateFunc extends btCollisionAlgorithmCreateFunc {
    ...
    protected CreateFunc(final String className, long cPtr, boolean cMemoryOwn) {
      super(
          className,
          CollisionJNI.btConvexPlaneCollisionAlgorithm_CreateFunc_SWIGUpcast(cPtr),
          cMemoryOwn);
      swigCPtr = cPtr;
    }
    ...
    protected void reset(long cPtr, boolean cMemoryOwn) {
      if (!destroyed) destroy();
      super.reset(
          CollisionJNI.btConvexPlaneCollisionAlgorithm_CreateFunc_SWIGUpcast(swigCPtr = cPtr),
          cMemoryOwn);
    }
    ...
    public void setNumPerturbationIterations(int value) {
      CollisionJNI.btConvexPlaneCollisionAlgorithm_CreateFunc_numPerturbationIterations_set(
          swigCPtr, this, value);
    }

    public int getNumPerturbationIterations() {
      return CollisionJNI.btConvexPlaneCollisionAlgorithm_CreateFunc_numPerturbationIterations_get(
          swigCPtr, this);
    }
