...
public class btDefaultCollisionConfiguration extends btCollisionConfiguration {
  ...
  /**
   * Construct a new btDefaultCollisionConfiguration, normally you should not need this constructor
  ...
  protected void reset(long cPtr, boolean cMemoryOwn) {
    ...
    super.reset(
        CollisionJNI.btDefaultCollisionConfiguration_SWIGUpcast(swigCPtr = cPtr), cMemoryOwn);
  }
  ...
  public btDefaultCollisionConfiguration(btDefaultCollisionConstructionInfo constructionInfo) {
    this(
        CollisionJNI.new_btDefaultCollisionConfiguration__SWIG_0(
  ...
  public void setConvexConvexMultipointIterations(
    ...
    CollisionJNI.btDefaultCollisionConfiguration_setConvexConvexMultipointIterations__SWIG_0(
        swigCPtr, this, numPerturbationIterations, minimumPointsPerturbationThreshold);
  }

  public void setConvexConvexMultipointIterations(int numPerturbationIterations) {
    CollisionJNI.btDefaultCollisionConfiguration_setConvexConvexMultipointIterations__SWIG_1(
        swigCPtr, this, numPerturbationIterations);
  }

  public void setConvexConvexMultipointIterations() {
    CollisionJNI.btDefaultCollisionConfiguration_setConvexConvexMultipointIterations__SWIG_2(
        swigCPtr, this);
  }

  public void setPlaneConvexMultipointIterations(
      int numPerturbationIterations, int minimumPointsPerturbationThreshold) {
    CollisionJNI.btDefaultCollisionConfiguration_setPlaneConvexMultipointIterations__SWIG_0(
        swigCPtr, this, numPerturbationIterations, minimumPointsPerturbationThreshold);
  }

  public void setPlaneConvexMultipointIterations(int numPerturbationIterations) {
    CollisionJNI.btDefaultCollisionConfiguration_setPlaneConvexMultipointIterations__SWIG_1(
        swigCPtr, this, numPerturbationIterations);
  }

  public void setPlaneConvexMultipointIterations() {
    CollisionJNI.btDefaultCollisionConfiguration_setPlaneConvexMultipointIterations__SWIG_2(
        swigCPtr, this);
  }
}
