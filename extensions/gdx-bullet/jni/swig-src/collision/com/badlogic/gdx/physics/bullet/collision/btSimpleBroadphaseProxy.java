...
public class btSimpleBroadphaseProxy extends btBroadphaseProxy {
  ...
  /**
   * Construct a new btSimpleBroadphaseProxy, normally you should not need this constructor it's
  ...
  public btSimpleBroadphaseProxy(
    ...
    this(
        CollisionJNI.new_btSimpleBroadphaseProxy__SWIG_1(
            minpt, maxpt, shapeType, userPtr, collisionFilterGroup, collisionFilterMask),
        true);
  }
