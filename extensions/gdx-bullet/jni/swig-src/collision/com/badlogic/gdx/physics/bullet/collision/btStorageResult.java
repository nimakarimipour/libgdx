...
public class btStorageResult extends btDiscreteCollisionDetectorInterface.Result {
  ...
  /**
   * Construct a new btStorageResult, normally you should not need this constructor it's intended
   * for low-level usage.
   */
  ...
  public void setNormalOnSurfaceB(btVector3 value) {
    CollisionJNI.btStorageResult_normalOnSurfaceB_set(
  ...
  public void setClosestPointInB(btVector3 value) {
    CollisionJNI.btStorageResult_closestPointInB_set(
        swigCPtr, this, btVector3.getCPtr(value), value);
  }
