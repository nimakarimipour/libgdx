...
public class btBox2dBox2dCollisionAlgorithm extends btActivatingCollisionAlgorithm {
  ...
  /**
   * Construct a new btBox2dBox2dCollisionAlgorithm, normally you should not need this constructor
  ...
  protected void reset(long cPtr, boolean cMemoryOwn) {
    ...
    super.reset(
        CollisionJNI.btBox2dBox2dCollisionAlgorithm_SWIGUpcast(swigCPtr = cPtr), cMemoryOwn);
  }
  ...
  public btBox2dBox2dCollisionAlgorithm(btCollisionAlgorithmConstructionInfo ci) {
    this(
        CollisionJNI.new_btBox2dBox2dCollisionAlgorithm__SWIG_0(
  ...
  public btBox2dBox2dCollisionAlgorithm(
    ...
    this(
        CollisionJNI.new_btBox2dBox2dCollisionAlgorithm__SWIG_1(
  ...
  public static class CreateFunc extends btCollisionAlgorithmCreateFunc {
    ...
    protected CreateFunc(final String className, long cPtr, boolean cMemoryOwn) {
      super(
          className,
          CollisionJNI.btBox2dBox2dCollisionAlgorithm_CreateFunc_SWIGUpcast(cPtr),
          cMemoryOwn);
      swigCPtr = cPtr;
    }
    ...
    protected void reset(long cPtr, boolean cMemoryOwn) {
      if (!destroyed) destroy();
      super.reset(
          CollisionJNI.btBox2dBox2dCollisionAlgorithm_CreateFunc_SWIGUpcast(swigCPtr = cPtr),
          cMemoryOwn);
    }
