...
public class btOverlapFilterCallback extends BulletBase {
  ...
  /**
   * Construct a new btOverlapFilterCallback, normally you should not need this constructor it's
  ...
  public boolean needBroadphaseCollision(btBroadphaseProxy proxy0, btBroadphaseProxy proxy1) {
    return CollisionJNI.btOverlapFilterCallback_needBroadphaseCollision(
        swigCPtr,
        this,
