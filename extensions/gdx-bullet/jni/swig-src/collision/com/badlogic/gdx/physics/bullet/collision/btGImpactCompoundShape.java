...
public class btGImpactCompoundShape extends btGImpactShapeInterface {
  ...
  /**
   * Construct a new btGImpactCompoundShape, normally you should not need this constructor it's
  ...
  public static class CompoundPrimitiveManager extends btPrimitiveManagerBase {
    private long swigCPtr;

    protected CompoundPrimitiveManager(final String className, long cPtr, boolean cMemoryOwn) {
      super(
          className,
          CollisionJNI.btGImpactCompoundShape_CompoundPrimitiveManager_SWIGUpcast(cPtr),
          cMemoryOwn);
      swigCPtr = cPtr;
    }

    /**
     * Construct a new CompoundPrimitiveManager, normally you should not need this constructor it's
     * intended for low-level usage.
     */
    ...
    protected void reset(long cPtr, boolean cMemoryOwn) {
      if (!destroyed) destroy();
      super.reset(
          CollisionJNI.btGImpactCompoundShape_CompoundPrimitiveManager_SWIGUpcast(swigCPtr = cPtr),
          cMemoryOwn);
    }
    ...
    public void setCompoundShape(btGImpactCompoundShape value) {
      CollisionJNI.btGImpactCompoundShape_CompoundPrimitiveManager_compoundShape_set(
          swigCPtr, this, btGImpactCompoundShape.getCPtr(value), value);
    }

    public btGImpactCompoundShape getCompoundShape() {
      long cPtr =
          CollisionJNI.btGImpactCompoundShape_CompoundPrimitiveManager_compoundShape_get(
              swigCPtr, this);
    ...
    public CompoundPrimitiveManager(btGImpactCompoundShape.CompoundPrimitiveManager compound) {
      this(
          CollisionJNI.new_btGImpactCompoundShape_CompoundPrimitiveManager__SWIG_0(
              btGImpactCompoundShape.CompoundPrimitiveManager.getCPtr(compound), compound),
          true);
    }

    public CompoundPrimitiveManager(btGImpactCompoundShape compoundShape) {
      this(
          CollisionJNI.new_btGImpactCompoundShape_CompoundPrimitiveManager__SWIG_1(
              btGImpactCompoundShape.getCPtr(compoundShape), compoundShape),
          true);
    }
  ...
  public void addChildShape(Matrix4 localTransform, btCollisionShape shape) {
    CollisionJNI.btGImpactCompoundShape_addChildShape__SWIG_0(
        swigCPtr, this, localTransform, btCollisionShape.getCPtr(shape), shape);
  }

  public void addChildShape(btCollisionShape shape) {
    CollisionJNI.btGImpactCompoundShape_addChildShape__SWIG_1(
        swigCPtr, this, btCollisionShape.getCPtr(shape), shape);
  }
}
