...
public class btSubSimplexClosestResult extends BulletBase {
  ...
  /**
   * Construct a new btSubSimplexClosestResult, normally you should not need this constructor it's
  ...
  public void setClosestPointOnSimplex(btVector3 value) {
    CollisionJNI.btSubSimplexClosestResult_closestPointOnSimplex_set(
  ...
  public void setUsedVertices(btUsageBitfield value) {
    CollisionJNI.btSubSimplexClosestResult_usedVertices_set(
        swigCPtr, this, btUsageBitfield.getCPtr(value), value);
  }
  ...
  public void setBarycentricCoordinates(float a, float b, float c, float d) {
    CollisionJNI.btSubSimplexClosestResult_setBarycentricCoordinates__SWIG_0(
        swigCPtr, this, a, b, c, d);
  }

  public void setBarycentricCoordinates(float a, float b, float c) {
    CollisionJNI.btSubSimplexClosestResult_setBarycentricCoordinates__SWIG_1(
        swigCPtr, this, a, b, c);
  }
