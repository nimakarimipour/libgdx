...
public class btConvexPolyhedron extends BulletBase {
  ...
  /**
   * Construct a new btConvexPolyhedron, normally you should not need this constructor it's intended
   * for low-level usage.
   */
  ...
  public void setVertices(btVector3Array value) {
    CollisionJNI.btConvexPolyhedron_vertices_set(
  ...
  public void setFaces(SWIGTYPE_p_btAlignedObjectArrayT_btFace_t value) {
    CollisionJNI.btConvexPolyhedron_faces_set(
        swigCPtr, this, SWIGTYPE_p_btAlignedObjectArrayT_btFace_t.getCPtr(value));
  }
  ...
  public void setUniqueEdges(btVector3Array value) {
    CollisionJNI.btConvexPolyhedron_uniqueEdges_set(
        swigCPtr, this, btVector3Array.getCPtr(value), value);
  }
  ...
  public void setLocalCenter(btVector3 value) {
    CollisionJNI.btConvexPolyhedron_localCenter_set(
  ...
  public void project(
      ...
      Vector3 witnesPtMin,
      Vector3 witnesPtMax) {
    CollisionJNI.btConvexPolyhedron_project(
        swigCPtr,
        this,
        trans,
        dir,
