...
public class GIM_AABB extends BulletBase {
  ...
  /**
   * Construct a new GIM_AABB, normally you should not need this constructor it's intended for
   * low-level usage.
   */
  ...
  public void find_intersection(GIM_AABB other, GIM_AABB intersection) {
    CollisionJNI.GIM_AABB_find_intersection(
        swigCPtr,
        this,
        GIM_AABB.getCPtr(other),
        other,
        GIM_AABB.getCPtr(intersection),
        intersection);
  }
  ...
  public void projection_interval(Vector3 direction, SWIGTYPE_p_float vmin, SWIGTYPE_p_float vmax) {
    CollisionJNI.GIM_AABB_projection_interval(
  ...
  public boolean overlapping_trans_conservative(GIM_AABB box, Matrix4 trans1_to_0) {
    return CollisionJNI.GIM_AABB_overlapping_trans_conservative(
        swigCPtr, this, GIM_AABB.getCPtr(box), box, trans1_to_0);
  }

  public boolean overlapping_trans_cache(
      GIM_AABB box, GIM_BOX_BOX_TRANSFORM_CACHE transcache, boolean fulltest) {
    return CollisionJNI.GIM_AABB_overlapping_trans_cache(
        swigCPtr,
        this,
        GIM_AABB.getCPtr(box),
        box,
        GIM_BOX_BOX_TRANSFORM_CACHE.getCPtr(transcache),
        transcache,
        fulltest);
  }
  ...
  public boolean collide_triangle_exact(
    ...
    return CollisionJNI.GIM_AABB_collide_triangle_exact(
