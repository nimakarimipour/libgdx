...
public class btPairCachingGhostObject extends btGhostObject {
  ...
  /**
   * Construct a new btPairCachingGhostObject, normally you should not need this constructor it's
  ...
  public void addOverlappingObjectInternal(
    ...
    CollisionJNI.btPairCachingGhostObject_addOverlappingObjectInternal__SWIG_0(
        swigCPtr,
        this,
  ...
  public void addOverlappingObjectInternal(btBroadphaseProxy otherProxy) {
    CollisionJNI.btPairCachingGhostObject_addOverlappingObjectInternal__SWIG_1(
  ...
  public void removeOverlappingObjectInternal(
    ...
    CollisionJNI.btPairCachingGhostObject_removeOverlappingObjectInternal__SWIG_0(
        swigCPtr,
        this,
        btBroadphaseProxy.getCPtr(otherProxy),
        otherProxy,
  ...
  public void removeOverlappingObjectInternal(
    ...
    CollisionJNI.btPairCachingGhostObject_removeOverlappingObjectInternal__SWIG_1(
        swigCPtr,
        this,
        btBroadphaseProxy.getCPtr(otherProxy),
        otherProxy,
