...
public class btHashMapInternalShortBtHashIntBtTriangleInfo extends BulletBase {
  ...
  protected btHashMapInternalShortBtHashIntBtTriangleInfo(
  ...
  /**
   * Construct a new btHashMapInternalShortBtHashIntBtTriangleInfo, normally you should not need
   * this constructor it's intended for low-level usage.
   */
  ...
  public void insert(btHashInt key, btTriangleInfo value) {
    CollisionJNI.btHashMapInternalShortBtHashIntBtTriangleInfo_insert(
        swigCPtr, this, btHashInt.getCPtr(key), key, btTriangleInfo.getCPtr(value), value);
  }

  public void remove(btHashInt key) {
    CollisionJNI.btHashMapInternalShortBtHashIntBtTriangleInfo_remove(
        swigCPtr, this, btHashInt.getCPtr(key), key);
  }
  ...
  public btTriangleInfo getAtIndexConst(int index) {
    long cPtr =
        CollisionJNI.btHashMapInternalShortBtHashIntBtTriangleInfo_getAtIndexConst(
            swigCPtr, this, index);
  ...
  public btTriangleInfo getAtIndex(int index) {
    long cPtr =
        CollisionJNI.btHashMapInternalShortBtHashIntBtTriangleInfo_getAtIndex(
            swigCPtr, this, index);
    return (cPtr == 0) ? null : new btTriangleInfo(cPtr, false);
  }

  public btHashInt getKeyAtIndex(int index) {
    return new btHashInt(
        CollisionJNI.btHashMapInternalShortBtHashIntBtTriangleInfo_getKeyAtIndex(
            swigCPtr, this, index),
        true);
  }
  ...
  public btHashInt getKeyAtIndexConst(int index) {
    return new btHashInt(
        CollisionJNI.btHashMapInternalShortBtHashIntBtTriangleInfo_getKeyAtIndexConst(
            swigCPtr, this, index),
        true);
  }
  ...
  public btTriangleInfo operatorSubscript(btHashInt key) {
    long cPtr =
        CollisionJNI.btHashMapInternalShortBtHashIntBtTriangleInfo_operatorSubscript(
            swigCPtr, this, btHashInt.getCPtr(key), key);
    return (cPtr == 0) ? null : new btTriangleInfo(cPtr, false);
  }
  ...
  public btTriangleInfo operatorSubscriptConst(btHashInt key) {
    long cPtr =
        CollisionJNI.btHashMapInternalShortBtHashIntBtTriangleInfo_operatorSubscriptConst(
            swigCPtr, this, btHashInt.getCPtr(key), key);
    return (cPtr == 0) ? null : new btTriangleInfo(cPtr, false);
  }
  ...
  public btTriangleInfo findConst(btHashInt key) {
    long cPtr =
        CollisionJNI.btHashMapInternalShortBtHashIntBtTriangleInfo_findConst(
            swigCPtr, this, btHashInt.getCPtr(key), key);
    return (cPtr == 0) ? null : new btTriangleInfo(cPtr, false);
  }
  ...
  public btTriangleInfo find(btHashInt key) {
    long cPtr =
        CollisionJNI.btHashMapInternalShortBtHashIntBtTriangleInfo_find(
            swigCPtr, this, btHashInt.getCPtr(key), key);
    return (cPtr == 0) ? null : new btTriangleInfo(cPtr, false);
  }

  public int findIndex(btHashInt key) {
    return CollisionJNI.btHashMapInternalShortBtHashIntBtTriangleInfo_findIndex(
        swigCPtr, this, btHashInt.getCPtr(key), key);
  }
