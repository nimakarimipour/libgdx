...
public class GIM_CONTACT extends BulletBase {
  ...
  /**
   * Construct a new GIM_CONTACT, normally you should not need this constructor it's intended for
   * low-level usage.
   */
  ...
  public void interpolate_normals(btVector3 normals, int normal_count) {
    CollisionJNI.GIM_CONTACT_interpolate_normals(
        swigCPtr, this, btVector3.getCPtr(normals), normals, normal_count);
  }
}
