...
public class btBoxBoxCollisionAlgorithm extends btActivatingCollisionAlgorithm {
  ...
  /**
   * Construct a new btBoxBoxCollisionAlgorithm, normally you should not need this constructor it's
  ...
  public btBoxBoxCollisionAlgorithm(btCollisionAlgorithmConstructionInfo ci) {
    this(
        CollisionJNI.new_btBoxBoxCollisionAlgorithm__SWIG_0(
  ...
  public btBoxBoxCollisionAlgorithm(
    ...
    this(
        CollisionJNI.new_btBoxBoxCollisionAlgorithm__SWIG_1(
  ...
  public static class CreateFunc extends btCollisionAlgorithmCreateFunc {
    ...
    protected CreateFunc(final String className, long cPtr, boolean cMemoryOwn) {
      super(
          className,
          CollisionJNI.btBoxBoxCollisionAlgorithm_CreateFunc_SWIGUpcast(cPtr),
          cMemoryOwn);
      swigCPtr = cPtr;
    }
    ...
    protected void reset(long cPtr, boolean cMemoryOwn) {
      if (!destroyed) destroy();
      super.reset(
          CollisionJNI.btBoxBoxCollisionAlgorithm_CreateFunc_SWIGUpcast(swigCPtr = cPtr),
          cMemoryOwn);
    }
