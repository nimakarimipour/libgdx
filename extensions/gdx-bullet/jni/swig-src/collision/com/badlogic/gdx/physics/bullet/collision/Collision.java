...
public class Collision implements CollisionConstants {
  ...
  public static final com.badlogic.gdx.utils.Pool<Vector3> poolVector3 =
      new com.badlogic.gdx.utils.Pool<Vector3>() {
        @Override
  ...
  public static final com.badlogic.gdx.utils.Pool<Quaternion> poolQuaternion =
      new com.badlogic.gdx.utils.Pool<Quaternion>() {
        @Override
  ...
  public static final com.badlogic.gdx.utils.Pool<Matrix3> poolMatrix3 =
      new com.badlogic.gdx.utils.Pool<Matrix3>() {
        @Override
  ...
  public static final com.badlogic.gdx.utils.Pool<Matrix4> poolMatrix4 =
      new com.badlogic.gdx.utils.Pool<Matrix4>() {
        @Override
  ...
  public static boolean gdxCheckFilter(btCollisionObject colObj0, btCollisionObject colObj1) {
    return CollisionJNI.gdxCheckFilter__SWIG_1(
  ...
  public static int Select(btDbvtAabbMm o, btDbvtAabbMm a, btDbvtAabbMm b) {
    return CollisionJNI.Select(
        btDbvtAabbMm.getCPtr(o), o, btDbvtAabbMm.getCPtr(a), a, btDbvtAabbMm.getCPtr(b), b);
  }

  public static void Merge(btDbvtAabbMm a, btDbvtAabbMm b, btDbvtAabbMm r) {
    CollisionJNI.Merge(
        btDbvtAabbMm.getCPtr(a), a, btDbvtAabbMm.getCPtr(b), b, btDbvtAabbMm.getCPtr(r), r);
  }
  ...
  public static boolean operatorEqualTo(btCompoundShapeChild c1, btCompoundShapeChild c2) {
    return CollisionJNI.operatorEqualTo__SWIG_4(
        btCompoundShapeChild.getCPtr(c1), c1, btCompoundShapeChild.getCPtr(c2), c2);
  }
  ...
  public static SWIGTYPE_p_f_p_q_const__btCollisionShape_p_q_const__btCollisionShape__bool
      getGCompoundChildShapePairCallback() {
    long cPtr = CollisionJNI.gCompoundChildShapePairCallback_get();
    return (cPtr == 0)
        ? null
        : new SWIGTYPE_p_f_p_q_const__btCollisionShape_p_q_const__btCollisionShape__bool(
            cPtr, false);
  }
  ...
  public static void btGenerateInternalEdgeInfo(
      btBvhTriangleMeshShape trimeshShape, btTriangleInfoMap triangleInfoMap) {
    CollisionJNI.btGenerateInternalEdgeInfo(
        btBvhTriangleMeshShape.getCPtr(trimeshShape),
        trimeshShape,
        btTriangleInfoMap.getCPtr(triangleInfoMap),
        triangleInfoMap);
  }

  public static void btAdjustInternalEdgeContacts(
      btManifoldPoint cp,
    ...
    CollisionJNI.btAdjustInternalEdgeContacts__SWIG_0(
        btManifoldPoint.getCPtr(cp),
        cp,
        btCollisionObjectWrapper.getCPtr(trimeshColObj0Wrap),
        trimeshColObj0Wrap,
        btCollisionObjectWrapper.getCPtr(otherColObj1Wrap),
        otherColObj1Wrap,
        partId0,
        index0,
        normalAdjustFlags);
  ...
  public static void btAdjustInternalEdgeContacts(
      ...
      int partId0,
      int index0) {
    CollisionJNI.btAdjustInternalEdgeContacts__SWIG_1(
        btManifoldPoint.getCPtr(cp),
        cp,
        btCollisionObjectWrapper.getCPtr(trimeshColObj0Wrap),
        trimeshColObj0Wrap,
  ...
  public static void bt_calc_quantization_parameters(
      Vector3 outMinBound,
      Vector3 outMaxBound,
    ...
    CollisionJNI.bt_calc_quantization_parameters(
        outMinBound, outMaxBound, bvhQuantization, srcMinBound, srcMaxBound, quantizationMargin);
  }

  public static void bt_quantize_clamp(
  ...
  public static Vector3 bt_unquantize(
      java.nio.IntBuffer vecIn, Vector3 offset, Vector3 bvhQuantization) {
  ...
  public static void bt_plane_clip_polygon_collect(
      Vector3 point0,
      Vector3 point1,
      float dist0,
      float dist1,
    ...
    CollisionJNI.bt_plane_clip_polygon_collect(
        point0,
        point1,
        dist0,
        dist1,
        btVector3.getCPtr(clipped),
        clipped,
        SWIGTYPE_p_int.getCPtr(clipped_count));
  }

  public static int bt_plane_clip_polygon(
      btVector4 plane, btVector3 polygon_points, int polygon_point_count, btVector3 clipped) {
    return CollisionJNI.bt_plane_clip_polygon(
        btVector4.getCPtr(plane),
        plane,
        btVector3.getCPtr(polygon_points),
        polygon_points,
        polygon_point_count,
        btVector3.getCPtr(clipped),
        clipped);
  ...
  public static int bt_plane_clip_triangle(
      btVector4 plane, Vector3 point0, Vector3 point1, Vector3 point2, btVector3 clipped) {
    return CollisionJNI.bt_plane_clip_triangle(
        btVector4.getCPtr(plane),
        plane,
        point0,
        point1,
  ...
  public static int bt_line_plane_collision(
      btVector4 plane,
      Vector3 vDir,
      Vector3 vPoint,
      Vector3 pout,
      ...
      float tmin,
      float tmax) {
    return CollisionJNI.bt_line_plane_collision(
        btVector4.getCPtr(plane),
        plane,
        vDir,
        vPoint,
  ...
  public static void bt_segment_collision(
      Vector3 vA1, Vector3 vA2, Vector3 vB1, Vector3 vB2, Vector3 vPointA, Vector3 vPointB) {
    CollisionJNI.bt_segment_collision(vA1, vA2, vB1, vB2, vPointA, vPointB);
  }

  public static btCompoundShape btCreateCompoundFromGimpactShape(
      btGImpactMeshShape gimpactMesh, float depth) {
    long cPtr =
        CollisionJNI.btCreateCompoundFromGimpactShape(
            btGImpactMeshShape.getCPtr(gimpactMesh), gimpactMesh, depth);
  ...
  public static Vector3 gim_inertia_add_transformed(
      Vector3 source_inertia, Vector3 added_inertia, Matrix4 transform) {
  ...
  public static SWIGTYPE_p_GUINT gim_next_prime(SWIGTYPE_p_GUINT number) {
    return new SWIGTYPE_p_GUINT(
        CollisionJNI.gim_next_prime(SWIGTYPE_p_GUINT.getCPtr(number)), true);
  }
  ...
  public static void gim_radix_sort_rtokens(
      GIM_RSORT_TOKEN array, GIM_RSORT_TOKEN sorted, long element_count) {
    CollisionJNI.gim_radix_sort_rtokens(
        GIM_RSORT_TOKEN.getCPtr(array),
        array,
        GIM_RSORT_TOKEN.getCPtr(sorted),
        sorted,
        element_count);
  }
  ...
  public static void btMprVec3Cross(btVector3 d, btVector3 a, btVector3 b) {
    CollisionJNI.btMprVec3Cross(
        btVector3.getCPtr(d), d, btVector3.getCPtr(a), a, btVector3.getCPtr(b), b);
  }

  public static void btMprVec3Sub2(btVector3 d, btVector3 v, btVector3 w) {
    CollisionJNI.btMprVec3Sub2(
        btVector3.getCPtr(d), d, btVector3.getCPtr(v), v, btVector3.getCPtr(w), w);
  }
  ...
  public static int portalEncapsulesOrigin(_btMprSimplex_t portal, btVector3 dir) {
    return CollisionJNI.portalEncapsulesOrigin(
        _btMprSimplex_t.getCPtr(portal), portal, btVector3.getCPtr(dir), dir);
  }

  public static int portalReachTolerance(
      _btMprSimplex_t portal, _btMprSupport_t v4, btVector3 dir) {
    return CollisionJNI.portalReachTolerance(
        _btMprSimplex_t.getCPtr(portal),
        portal,
        _btMprSupport_t.getCPtr(v4),
        v4,
        btVector3.getCPtr(dir),
        dir);
  }

  public static int portalCanEncapsuleOrigin(
      _btMprSimplex_t portal, _btMprSupport_t v4, btVector3 dir) {
    return CollisionJNI.portalCanEncapsuleOrigin(
        _btMprSimplex_t.getCPtr(portal),
        portal,
        _btMprSupport_t.getCPtr(v4),
        v4,
  ...
  public static void btExpandPortal(_btMprSimplex_t portal, _btMprSupport_t v4) {
    CollisionJNI.btExpandPortal(
        _btMprSimplex_t.getCPtr(portal), portal, _btMprSupport_t.getCPtr(v4), v4);
  }
  ...
  public static float _btMprVec3PointSegmentDist2(
      btVector3 P, btVector3 x0, btVector3 b, btVector3 witness) {
    return CollisionJNI._btMprVec3PointSegmentDist2(
        btVector3.getCPtr(P),
        P,
        btVector3.getCPtr(x0),
        x0,
        btVector3.getCPtr(b),
        b,
        btVector3.getCPtr(witness),
        witness);
  }

  public static float btMprVec3PointTriDist2(
      btVector3 P, btVector3 x0, btVector3 B, btVector3 C, btVector3 witness) {
    return CollisionJNI.btMprVec3PointTriDist2(
        btVector3.getCPtr(P),
        P,
        btVector3.getCPtr(x0),
        x0,
  ...
  public static void btFindPenetrTouch(
      _btMprSimplex_t portal, java.nio.FloatBuffer depth, btVector3 dir, btVector3 pos) {
    assert depth.isDirect() : "Buffer must be allocated direct.";
    {
      CollisionJNI.btFindPenetrTouch(
          _btMprSimplex_t.getCPtr(portal),
          portal,
          depth,
          btVector3.getCPtr(dir),
          dir,
          btVector3.getCPtr(pos),
          pos);
    }
  }

  public static void btFindPenetrSegment(
      _btMprSimplex_t portal, java.nio.FloatBuffer depth, btVector3 dir, btVector3 pos) {
    assert depth.isDirect() : "Buffer must be allocated direct.";
    {
      CollisionJNI.btFindPenetrSegment(
          _btMprSimplex_t.getCPtr(portal),
          portal,
          depth,
          btVector3.getCPtr(dir),
