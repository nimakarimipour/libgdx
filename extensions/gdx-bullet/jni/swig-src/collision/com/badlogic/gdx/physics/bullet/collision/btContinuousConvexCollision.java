...
public class btContinuousConvexCollision extends btConvexCast {
  ...
  /**
   * Construct a new btContinuousConvexCollision, normally you should not need this constructor it's
  ...
  public btContinuousConvexCollision(
    ...
    this(
        CollisionJNI.new_btContinuousConvexCollision__SWIG_0(
  ...
  public btContinuousConvexCollision(btConvexShape shapeA, btStaticPlaneShape plane) {
    this(
        CollisionJNI.new_btContinuousConvexCollision__SWIG_1(
            btConvexShape.getCPtr(shapeA), shapeA, btStaticPlaneShape.getCPtr(plane), plane),
        true);
  }
}
