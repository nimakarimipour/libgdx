...
public class btIndexedMesh extends BulletBase {
  ...
  /**
   * Construct a new btIndexedMesh, normally you should not need this constructor it's intended for
   * low-level usage.
   */
  ...
  protected static final Array<btIndexedMesh> instances = new Array<btIndexedMesh>();
  ...
  /**
   * Create or reuse a btIndexedMesh instance based on the specified {@link MeshPart}. Use {@link
   * #release()} to release the mesh when it's no longer needed.
   */
  ...
  /**
   * Create or reuse a btIndexedMesh instance based on the specified tag. Use {@link #release()} to
   * release the mesh when it's no longer needed.
   */
  public static btIndexedMesh obtain(
      final Object tag,
  ...
  /**
   * The tag to identify this btIndexedMesh, may be null. Typically this is the {@link Mesh} or
   * {@link MeshPart} used to create or set this btIndexedMesh. Use by the static obtain(...)
   * methods to avoid creating duplicate instances.
   */
  public Object tag;

  /**
   * Construct a new btIndexedMesh based on the supplied {@link Mesh} The specified mesh must be
   * indexed and triangulated and must outlive this btIndexedMesh. The buffers for the vertices and
   * indices are shared amonst both.
   */
  ...
  /**
   * Construct a new btIndexedMesh based on the supplied {@link MeshPart} The specified mesh must be
   * indexed and triangulated and must outlive this btIndexedMesh. The buffers for the vertices and
   * indices are shared amonst both.
   */
  ...
  /**
   * Construct a new btIndexedMesh based on the supplied vertex and index data. The specified data
   * must be indexed and triangulated and must outlive this btIndexedMesh. The buffers for the
   * vertices and indices are shared amonst both.
   */
  ...
  /**
   * Convenience method to set this btIndexedMesh to the specified {@link Mesh} The specified mesh
   * must be indexed and triangulated and must outlive this btIndexedMesh. The buffers for the
   * vertices and indices are shared amonst both.
   */
  ...
  /**
   * Convenience method to set this btIndexedMesh to the specified {@link MeshPart} The specified
   * mesh must be indexed and triangulated and must outlive this btIndexedMesh. The buffers for the
   * vertices and indices are shared amonst both.
   */
  ...
  public void set(final Object tag, final Mesh mesh, int offset, int count) {
    ...
    if (posAttr == null)
      throw new com.badlogic.gdx.utils.GdxRuntimeException(
          "Mesh doesn't have a position attribute");
  ...
  /**
   * Convenience method to set this btIndexedMesh to the specified vertex and index data. The
   * specified data must be indexed and triangulated and must outlive this btIndexedMesh.
   */
  public void set(
      final FloatBuffer vertices,
      int sizeInBytesOfEachVertex,
  ...
  public void setVertices(
    ...
    {
      CollisionJNI.btIndexedMesh_setVertices(
          swigCPtr, this, vertices, sizeInBytesOfEachVertex, vertexCount, positionOffsetInBytes);
    }
  }
