...
public class GIM_TRIANGLE_CONTACT extends BulletBase {
  ...
  /**
   * Construct a new GIM_TRIANGLE_CONTACT, normally you should not need this constructor it's
  ...
  public void setSeparating_normal(btVector4 value) {
    CollisionJNI.GIM_TRIANGLE_CONTACT_separating_normal_set(
  ...
  public void copy_from(GIM_TRIANGLE_CONTACT other) {
    CollisionJNI.GIM_TRIANGLE_CONTACT_copy_from(
        swigCPtr, this, GIM_TRIANGLE_CONTACT.getCPtr(other), other);
  }
  ...
  public GIM_TRIANGLE_CONTACT(GIM_TRIANGLE_CONTACT other) {
    this(
        CollisionJNI.new_GIM_TRIANGLE_CONTACT__SWIG_1(GIM_TRIANGLE_CONTACT.getCPtr(other), other),
        true);
  }

  public void merge_points(btVector4 plane, float margin, btVector3 points, int point_count) {
    CollisionJNI.GIM_TRIANGLE_CONTACT_merge_points(
        swigCPtr,
        this,
