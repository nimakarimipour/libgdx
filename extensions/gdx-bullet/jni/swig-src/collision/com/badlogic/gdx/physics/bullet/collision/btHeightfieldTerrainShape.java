...
public class btHeightfieldTerrainShape extends btConcaveShape {
  ...
  /**
   * Construct a new btHeightfieldTerrainShape, normally you should not need this constructor it's
  ...
  public long operatorNewArray(long sizeInBytes) {
    return CollisionJNI.btHeightfieldTerrainShape_operatorNewArray__SWIG_0(
  ...
  public long operatorNewArray(long arg0, long ptr) {
    return CollisionJNI.btHeightfieldTerrainShape_operatorNewArray__SWIG_1(
  ...
  public void setUseDiamondSubdivision(boolean useDiamondSubdivision) {
    CollisionJNI.btHeightfieldTerrainShape_setUseDiamondSubdivision__SWIG_0(
        swigCPtr, this, useDiamondSubdivision);
  }
  ...
  public void setUseZigzagSubdivision(boolean useZigzagSubdivision) {
    CollisionJNI.btHeightfieldTerrainShape_setUseZigzagSubdivision__SWIG_0(
        swigCPtr, this, useZigzagSubdivision);
  }
  ...
  private static long SwigConstructbtHeightfieldTerrainShape(
      int heightStickWidth,
      int heightStickLength,
      java.nio.FloatBuffer heightfieldData,
      float heightScale,
      float minHeight,
      float maxHeight,
      int upAxis,
    ...
    return CollisionJNI.new_btHeightfieldTerrainShape__SWIG_0(
        heightStickWidth,
        heightStickLength,
        heightfieldData,
        heightScale,
  ...
  public btHeightfieldTerrainShape(
      ...
      boolean flipQuadEdges) {
    this(
        btHeightfieldTerrainShape.SwigConstructbtHeightfieldTerrainShape(
            heightStickWidth,
            heightStickLength,
            heightfieldData,
            heightScale,
  ...
  private static long SwigConstructbtHeightfieldTerrainShape(
      int heightStickWidth,
      int heightStickLength,
      java.nio.ShortBuffer heightfieldData,
      float heightScale,
      float minHeight,
      float maxHeight,
      int upAxis,
      boolean flipQuadEdges) {
    assert heightfieldData.isDirect() : "Buffer must be allocated direct.";
    return CollisionJNI.new_btHeightfieldTerrainShape__SWIG_1(
        heightStickWidth,
        heightStickLength,
        heightfieldData,
        heightScale,
