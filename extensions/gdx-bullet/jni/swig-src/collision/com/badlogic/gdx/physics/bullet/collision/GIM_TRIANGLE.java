...
public class GIM_TRIANGLE extends BulletBase {
  ...
  /**
   * Construct a new GIM_TRIANGLE, normally you should not need this constructor it's intended for
   * low-level usage.
   */
  ...
  public void get_edge_plane(long edge_index, Vector3 triangle_normal, btVector4 plane) {
    CollisionJNI.GIM_TRIANGLE_get_edge_plane(
        swigCPtr, this, edge_index, triangle_normal, btVector4.getCPtr(plane), plane);
  }
  ...
  public boolean collide_triangle_hard_test(
      GIM_TRIANGLE other, GIM_TRIANGLE_CONTACT_DATA contact_data) {
    return CollisionJNI.GIM_TRIANGLE_collide_triangle_hard_test(
        swigCPtr,
        this,
        GIM_TRIANGLE.getCPtr(other),
        other,
        GIM_TRIANGLE_CONTACT_DATA.getCPtr(contact_data),
        contact_data);
  }

  public boolean collide_triangle(GIM_TRIANGLE other, GIM_TRIANGLE_CONTACT_DATA contact_data) {
    return CollisionJNI.GIM_TRIANGLE_collide_triangle(
        swigCPtr,
        this,
        GIM_TRIANGLE.getCPtr(other),
        other,
  ...
  public boolean get_uv_parameters(
      Vector3 point, Vector3 tri_plane, SWIGTYPE_p_float u, SWIGTYPE_p_float v) {
    return CollisionJNI.GIM_TRIANGLE_get_uv_parameters(
        swigCPtr, this, point, tri_plane, SWIGTYPE_p_float.getCPtr(u), SWIGTYPE_p_float.getCPtr(v));
  }
  ...
  public boolean ray_collision(
      ...
      float tmax) {
    return CollisionJNI.GIM_TRIANGLE_ray_collision__SWIG_0(
        swigCPtr,
        this,
        vPoint,
        vDir,
  ...
  public boolean ray_collision(
      ...
      Vector3 triangle_normal,
      SWIGTYPE_p_float tparam) {
    return CollisionJNI.GIM_TRIANGLE_ray_collision__SWIG_1(
        swigCPtr, this, vPoint, vDir, pout, triangle_normal, SWIGTYPE_p_float.getCPtr(tparam));
  }

  public boolean ray_collision_front_side(
      Vector3 vPoint,
      Vector3 vDir,
      Vector3 pout,
      Vector3 triangle_normal,
      SWIGTYPE_p_float tparam,
      float tmax) {
    return CollisionJNI.GIM_TRIANGLE_ray_collision_front_side__SWIG_0(
        swigCPtr,
        this,
        vPoint,
        vDir,
  ...
  public boolean ray_collision_front_side(
      ...
      Vector3 triangle_normal,
      SWIGTYPE_p_float tparam) {
    return CollisionJNI.GIM_TRIANGLE_ray_collision_front_side__SWIG_1(
        swigCPtr, this, vPoint, vDir, pout, triangle_normal, SWIGTYPE_p_float.getCPtr(tparam));
  }
}
