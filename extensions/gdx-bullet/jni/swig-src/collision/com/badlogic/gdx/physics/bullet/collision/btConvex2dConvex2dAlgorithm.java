...
public class btConvex2dConvex2dAlgorithm extends btActivatingCollisionAlgorithm {
  ...
  /**
   * Construct a new btConvex2dConvex2dAlgorithm, normally you should not need this constructor it's
  ...
  public btConvex2dConvex2dAlgorithm(
    ...
    this(
        CollisionJNI.new_btConvex2dConvex2dAlgorithm(
            ...
            simplexSolver,
            btConvexPenetrationDepthSolver.getCPtr(pdSolver),
            pdSolver,
  ...
  public static class CreateFunc extends btCollisionAlgorithmCreateFunc {
    ...
    protected CreateFunc(final String className, long cPtr, boolean cMemoryOwn) {
      super(
          className,
          CollisionJNI.btConvex2dConvex2dAlgorithm_CreateFunc_SWIGUpcast(cPtr),
          cMemoryOwn);
      swigCPtr = cPtr;
    }
    ...
    protected void reset(long cPtr, boolean cMemoryOwn) {
      if (!destroyed) destroy();
      super.reset(
          CollisionJNI.btConvex2dConvex2dAlgorithm_CreateFunc_SWIGUpcast(swigCPtr = cPtr),
          cMemoryOwn);
    }
    ...
    public void setPdSolver(btConvexPenetrationDepthSolver value) {
      CollisionJNI.btConvex2dConvex2dAlgorithm_CreateFunc_pdSolver_set(
          swigCPtr, this, btConvexPenetrationDepthSolver.getCPtr(value), value);
    }
    ...
    public void setSimplexSolver(btVoronoiSimplexSolver value) {
      CollisionJNI.btConvex2dConvex2dAlgorithm_CreateFunc_simplexSolver_set(
          swigCPtr, this, btVoronoiSimplexSolver.getCPtr(value), value);
    }

    public btVoronoiSimplexSolver getSimplexSolver() {
      long cPtr =
          CollisionJNI.btConvex2dConvex2dAlgorithm_CreateFunc_simplexSolver_get(swigCPtr, this);
      return (cPtr == 0) ? null : new btVoronoiSimplexSolver(cPtr, false);
    }

    public void setNumPerturbationIterations(int value) {
      CollisionJNI.btConvex2dConvex2dAlgorithm_CreateFunc_numPerturbationIterations_set(
          swigCPtr, this, value);
    }

    public int getNumPerturbationIterations() {
      return CollisionJNI.btConvex2dConvex2dAlgorithm_CreateFunc_numPerturbationIterations_get(
          swigCPtr, this);
    }

    public void setMinimumPointsPerturbationThreshold(int value) {
      CollisionJNI.btConvex2dConvex2dAlgorithm_CreateFunc_minimumPointsPerturbationThreshold_set(
          swigCPtr, this, value);
    }
    ...
    public CreateFunc(
      ...
      this(
          CollisionJNI.new_btConvex2dConvex2dAlgorithm_CreateFunc(
              btVoronoiSimplexSolver.getCPtr(simplexSolver),
              simplexSolver,
              btConvexPenetrationDepthSolver.getCPtr(pdSolver),
              pdSolver),
