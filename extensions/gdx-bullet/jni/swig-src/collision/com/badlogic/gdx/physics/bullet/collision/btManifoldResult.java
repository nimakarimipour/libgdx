...
public class btManifoldResult extends btDiscreteCollisionDetectorInterface.Result {
  ...
  /**
   * Construct a new btManifoldResult, normally you should not need this constructor it's intended
   * for low-level usage.
   */
  ...
  public btManifoldResult(btCollisionObjectWrapper body0Wrap, btCollisionObjectWrapper body1Wrap) {
    this(
        CollisionJNI.new_btManifoldResult__SWIG_1(
            btCollisionObjectWrapper.getCPtr(body0Wrap),
            body0Wrap,
            btCollisionObjectWrapper.getCPtr(body1Wrap),
            body1Wrap),
        true);
  }

  public void setPersistentManifold(btPersistentManifold manifoldPtr) {
    CollisionJNI.btManifoldResult_setPersistentManifold(
        swigCPtr, this, btPersistentManifold.getCPtr(manifoldPtr), manifoldPtr);
  }
  ...
  public btCollisionObjectWrapper getBody0Wrap() {
    return btCollisionObjectWrapper.internalTemp(
        CollisionJNI.btManifoldResult_getBody0Wrap(swigCPtr, this), false);
  }

  public btCollisionObjectWrapper getBody1Wrap() {
    return btCollisionObjectWrapper.internalTemp(
        CollisionJNI.btManifoldResult_getBody1Wrap(swigCPtr, this), false);
  }

  public void setBody0Wrap(btCollisionObjectWrapper obj0Wrap) {
    CollisionJNI.btManifoldResult_setBody0Wrap(
        swigCPtr, this, btCollisionObjectWrapper.getCPtr(obj0Wrap), obj0Wrap);
  }

  public void setBody1Wrap(btCollisionObjectWrapper obj1Wrap) {
    CollisionJNI.btManifoldResult_setBody1Wrap(
        swigCPtr, this, btCollisionObjectWrapper.getCPtr(obj1Wrap), obj1Wrap);
  }

  public btCollisionObject getBody0Internal() {
    return btCollisionObject.getInstance(
        CollisionJNI.btManifoldResult_getBody0Internal(swigCPtr, this), false);
  }

  public btCollisionObject getBody1Internal() {
    return btCollisionObject.getInstance(
        CollisionJNI.btManifoldResult_getBody1Internal(swigCPtr, this), false);
  }
  ...
  public static float calculateCombinedRestitution(
      btCollisionObject body0, btCollisionObject body1) {
    return CollisionJNI.btManifoldResult_calculateCombinedRestitution(
  ...
  public static float calculateCombinedFriction(btCollisionObject body0, btCollisionObject body1) {
    return CollisionJNI.btManifoldResult_calculateCombinedFriction(
        btCollisionObject.getCPtr(body0), body0, btCollisionObject.getCPtr(body1), body1);
  }

  public static float calculateCombinedRollingFriction(
      btCollisionObject body0, btCollisionObject body1) {
    return CollisionJNI.btManifoldResult_calculateCombinedRollingFriction(
        btCollisionObject.getCPtr(body0), body0, btCollisionObject.getCPtr(body1), body1);
  }

  public static float calculateCombinedSpinningFriction(
      btCollisionObject body0, btCollisionObject body1) {
    return CollisionJNI.btManifoldResult_calculateCombinedSpinningFriction(
        btCollisionObject.getCPtr(body0), body0, btCollisionObject.getCPtr(body1), body1);
  }

  public static float calculateCombinedContactDamping(
      btCollisionObject body0, btCollisionObject body1) {
    return CollisionJNI.btManifoldResult_calculateCombinedContactDamping(
        btCollisionObject.getCPtr(body0), body0, btCollisionObject.getCPtr(body1), body1);
  }

  public static float calculateCombinedContactStiffness(
      btCollisionObject body0, btCollisionObject body1) {
    return CollisionJNI.btManifoldResult_calculateCombinedContactStiffness(
        btCollisionObject.getCPtr(body0), body0, btCollisionObject.getCPtr(body1), body1);
  }
}
