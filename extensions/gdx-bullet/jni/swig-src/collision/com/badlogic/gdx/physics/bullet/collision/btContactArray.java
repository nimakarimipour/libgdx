...
public class btContactArray extends btGimContactArray {
  ...
  /**
   * Construct a new btContactArray, normally you should not need this constructor it's intended for
   * low-level usage.
   */
  ...
  public void push_contact(Vector3 point, Vector3 normal, float depth, int feature1, int feature2) {
    CollisionJNI.btContactArray_push_contact(
        swigCPtr, this, point, normal, depth, feature1, feature2);
  }

  public void push_triangle_contacts(GIM_TRIANGLE_CONTACT tricontact, int feature1, int feature2) {
    CollisionJNI.btContactArray_push_triangle_contacts(
        swigCPtr, this, GIM_TRIANGLE_CONTACT.getCPtr(tricontact), tricontact, feature1, feature2);
  }

  public void merge_contacts(btContactArray contacts, boolean normal_contact_average) {
    CollisionJNI.btContactArray_merge_contacts__SWIG_0(
        swigCPtr, this, btContactArray.getCPtr(contacts), contacts, normal_contact_average);
  }

  public void merge_contacts(btContactArray contacts) {
    CollisionJNI.btContactArray_merge_contacts__SWIG_1(
        swigCPtr, this, btContactArray.getCPtr(contacts), contacts);
  }

  public void merge_contacts_unique(btContactArray contacts) {
    CollisionJNI.btContactArray_merge_contacts_unique(
        swigCPtr, this, btContactArray.getCPtr(contacts), contacts);
  }
}
