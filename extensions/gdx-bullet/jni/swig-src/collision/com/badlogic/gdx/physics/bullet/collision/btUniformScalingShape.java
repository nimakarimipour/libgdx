...
public class btUniformScalingShape extends btConvexShape {
  ...
  /**
   * Construct a new btUniformScalingShape, normally you should not need this constructor it's
  ...
  public btUniformScalingShape(btConvexShape convexChildShape, float uniformScalingFactor) {
    this(
        CollisionJNI.new_btUniformScalingShape(
            btConvexShape.getCPtr(convexChildShape), convexChildShape, uniformScalingFactor),
        true);
  }
