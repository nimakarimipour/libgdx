...
public class btConvexHullShape extends btPolyhedralConvexAabbCachingShape {
  ...
  /**
   * Construct a new btConvexHullShape, normally you should not need this constructor it's intended
   * for low-level usage.
   */
  ...
  private static long SwigConstructbtConvexHullShape(
      java.nio.FloatBuffer points, int numPoints, int stride) {
  ...
  private static long SwigConstructbtConvexHullShape(java.nio.FloatBuffer points, int numPoints) {
    assert points.isDirect() : "Buffer must be allocated direct.";
