...
public class bt32BitAxisSweep3 extends btAxisSweep3InternalInt {
  ...
  /**
   * Construct a new bt32BitAxisSweep3, normally you should not need this constructor it's intended
   * for low-level usage.
   */
  ...
  public bt32BitAxisSweep3(
    ...
    this(
        CollisionJNI.new_bt32BitAxisSweep3__SWIG_0(
            worldAabbMin,
            worldAabbMax,
            maxHandles,
  ...
  public bt32BitAxisSweep3(
      ...
      btOverlappingPairCache pairCache) {
    this(
        CollisionJNI.new_bt32BitAxisSweep3__SWIG_1(
            worldAabbMin,
            worldAabbMax,
            maxHandles,
            btOverlappingPairCache.getCPtr(pairCache),
