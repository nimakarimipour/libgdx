...
public class btCollisionObjectDoubleData extends BulletBase {
  ...
  /**
   * Construct a new btCollisionObjectDoubleData, normally you should not need this constructor it's
  ...
  public void setRootCollisionShape(btCollisionShapeData value) {
    CollisionJNI.btCollisionObjectDoubleData_rootCollisionShape_set(
        swigCPtr, this, btCollisionShapeData.getCPtr(value), value);
  }
  ...
  public void setWorldTransform(btTransformDoubleData value) {
    CollisionJNI.btCollisionObjectDoubleData_worldTransform_set(
  ...
  public void setInterpolationWorldTransform(btTransformDoubleData value) {
    CollisionJNI.btCollisionObjectDoubleData_interpolationWorldTransform_set(
        swigCPtr, this, btTransformDoubleData.getCPtr(value), value);
  }

  public btTransformDoubleData getInterpolationWorldTransform() {
    long cPtr =
        CollisionJNI.btCollisionObjectDoubleData_interpolationWorldTransform_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btTransformDoubleData(cPtr, false);
  }

  public void setInterpolationLinearVelocity(btVector3DoubleData value) {
    CollisionJNI.btCollisionObjectDoubleData_interpolationLinearVelocity_set(
        swigCPtr, this, btVector3DoubleData.getCPtr(value), value);
  }

  public btVector3DoubleData getInterpolationLinearVelocity() {
    long cPtr =
        CollisionJNI.btCollisionObjectDoubleData_interpolationLinearVelocity_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btVector3DoubleData(cPtr, false);
  }

  public void setInterpolationAngularVelocity(btVector3DoubleData value) {
    CollisionJNI.btCollisionObjectDoubleData_interpolationAngularVelocity_set(
        swigCPtr, this, btVector3DoubleData.getCPtr(value), value);
  }

  public btVector3DoubleData getInterpolationAngularVelocity() {
    long cPtr =
        CollisionJNI.btCollisionObjectDoubleData_interpolationAngularVelocity_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btVector3DoubleData(cPtr, false);
  }

  public void setAnisotropicFriction(btVector3DoubleData value) {
    CollisionJNI.btCollisionObjectDoubleData_anisotropicFriction_set(
        swigCPtr, this, btVector3DoubleData.getCPtr(value), value);
  }
