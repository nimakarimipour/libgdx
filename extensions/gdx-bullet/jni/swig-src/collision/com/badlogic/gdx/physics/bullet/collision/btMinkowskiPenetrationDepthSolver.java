...
public class btMinkowskiPenetrationDepthSolver extends btConvexPenetrationDepthSolver {
  ...
  /**
   * Construct a new btMinkowskiPenetrationDepthSolver, normally you should not need this
  ...
  protected void reset(long cPtr, boolean cMemoryOwn) {
    ...
    super.reset(
        CollisionJNI.btMinkowskiPenetrationDepthSolver_SWIGUpcast(swigCPtr = cPtr), cMemoryOwn);
  }
