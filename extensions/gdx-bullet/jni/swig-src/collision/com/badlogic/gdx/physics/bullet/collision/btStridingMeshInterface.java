...
public class btStridingMeshInterface extends BulletBase {
  ...
  /**
   * Construct a new btStridingMeshInterface, normally you should not need this constructor it's
  ...
  public long operatorNewArray(long sizeInBytes) {
    return CollisionJNI.btStridingMeshInterface_operatorNewArray__SWIG_0(
  ...
  public void InternalProcessAllTriangles(
      btInternalTriangleIndexCallback callback, Vector3 aabbMin, Vector3 aabbMax) {
    CollisionJNI.btStridingMeshInterface_InternalProcessAllTriangles(
        swigCPtr,
        this,
        btInternalTriangleIndexCallback.getCPtr(callback),
        callback,
        aabbMin,
        aabbMax);
  }
  ...
  public void getLockedReadOnlyVertexIndexBase(
      ...
      SWIGTYPE_p_PHY_ScalarType indicestype,
      int subpart) {
    CollisionJNI.btStridingMeshInterface_getLockedReadOnlyVertexIndexBase__SWIG_0(
        swigCPtr,
        this,
        SWIGTYPE_p_p_unsigned_char.getCPtr(vertexbase),
        SWIGTYPE_p_int.getCPtr(numverts),
  ...
  public void getLockedReadOnlyVertexIndexBase(
      ...
      SWIGTYPE_p_int numfaces,
      SWIGTYPE_p_PHY_ScalarType indicestype) {
    CollisionJNI.btStridingMeshInterface_getLockedReadOnlyVertexIndexBase__SWIG_1(
        swigCPtr,
        this,
        SWIGTYPE_p_p_unsigned_char.getCPtr(vertexbase),
        SWIGTYPE_p_int.getCPtr(numverts),
  ...
  public void getPremadeAabb(btVector3 aabbMin, btVector3 aabbMax) {
    CollisionJNI.btStridingMeshInterface_getPremadeAabb(
        swigCPtr, this, btVector3.getCPtr(aabbMin), aabbMin, btVector3.getCPtr(aabbMax), aabbMax);
  }
  ...
  public String serialize(long dataBuffer, btSerializer serializer) {
    return CollisionJNI.btStridingMeshInterface_serialize(
