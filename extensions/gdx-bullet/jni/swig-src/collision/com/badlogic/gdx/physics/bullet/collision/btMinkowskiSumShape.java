...
public class btMinkowskiSumShape extends btConvexInternalShape {
  ...
  /**
   * Construct a new btMinkowskiSumShape, normally you should not need this constructor it's
  ...
  public btMinkowskiSumShape(btConvexShape shapeA, btConvexShape shapeB) {
    this(
        CollisionJNI.new_btMinkowskiSumShape(
            btConvexShape.getCPtr(shapeA), shapeA, btConvexShape.getCPtr(shapeB), shapeB),
        true);
  }
