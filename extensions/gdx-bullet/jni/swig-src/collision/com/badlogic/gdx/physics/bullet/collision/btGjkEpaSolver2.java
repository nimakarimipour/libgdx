...
public class btGjkEpaSolver2 extends BulletBase {
  ...
  /**
   * Construct a new btGjkEpaSolver2, normally you should not need this constructor it's intended
   * for low-level usage.
   */
  ...
  public static class sResults extends BulletBase {
    ...
    /**
     * Construct a new sResults, normally you should not need this constructor it's intended for
     * low-level usage.
     */
    ...
    public void setWitnesses(btVector3 value) {
      CollisionJNI.btGjkEpaSolver2_sResults_witnesses_set(
    ...
    public void setNormal(btVector3 value) {
      CollisionJNI.btGjkEpaSolver2_sResults_normal_set(
          swigCPtr, this, btVector3.getCPtr(value), value);
    }
    ...
    public static final class eStatus {
      ...
      public static final int Penetrating = Separated + 1;
      public static final int GJK_Failed = Penetrating + 1;
      public static final int EPA_Failed = GJK_Failed + 1;
    }
  }
  ...
  public static boolean Distance(
    ...
    return CollisionJNI.btGjkEpaSolver2_Distance(
        btConvexShape.getCPtr(shape0),
        shape0,
        wtrs0,
        btConvexShape.getCPtr(shape1),
        shape1,
        wtrs1,
        guess,
        btGjkEpaSolver2.sResults.getCPtr(results),
        results);
  }
  ...
  public static boolean Penetration(
      ...
      btGjkEpaSolver2.sResults results,
      boolean usemargins) {
    return CollisionJNI.btGjkEpaSolver2_Penetration__SWIG_0(
        btConvexShape.getCPtr(shape0),
        shape0,
        wtrs0,
        btConvexShape.getCPtr(shape1),
  ...
  public static boolean Penetration(
      ...
      Vector3 guess,
      btGjkEpaSolver2.sResults results) {
    return CollisionJNI.btGjkEpaSolver2_Penetration__SWIG_1(
        btConvexShape.getCPtr(shape0),
        shape0,
        wtrs0,
        btConvexShape.getCPtr(shape1),
  ...
  public static float SignedDistance(
      ...
      Matrix4 wtrs,
      btGjkEpaSolver2.sResults results) {
    return CollisionJNI.btGjkEpaSolver2_SignedDistance__SWIG_0(
        position,
        margin,
        btConvexShape.getCPtr(shape),
        shape,
        wtrs,
        btGjkEpaSolver2.sResults.getCPtr(results),
        results);
  ...
  public static boolean SignedDistance(
      ...
      Vector3 guess,
      btGjkEpaSolver2.sResults results) {
    return CollisionJNI.btGjkEpaSolver2_SignedDistance__SWIG_1(
        btConvexShape.getCPtr(shape0),
        shape0,
        wtrs0,
        btConvexShape.getCPtr(shape1),
