...
public class btManifoldPoint extends BulletBase {
  ...
  /**
   * Construct a new btManifoldPoint, normally you should not need this constructor it's intended
   * for low-level usage.
   */
  ...
  private static btManifoldPoint[] argumentInstances =
      new btManifoldPoint[] {
        new btManifoldPoint(0, false),
        new btManifoldPoint(0, false),
        new btManifoldPoint(0, false),
        new btManifoldPoint(0, false)
      };
