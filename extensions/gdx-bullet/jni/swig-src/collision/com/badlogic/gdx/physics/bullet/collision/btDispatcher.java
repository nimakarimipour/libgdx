...
public class btDispatcher extends BulletBase {
  ...
  /**
   * Construct a new btDispatcher, normally you should not need this constructor it's intended for
   * low-level usage.
   */
  ...
  public btCollisionAlgorithm findAlgorithm(
      ...
      int queryType) {
    long cPtr =
        CollisionJNI.btDispatcher_findAlgorithm(
            swigCPtr,
            this,
            ...
            body1Wrap,
            btPersistentManifold.getCPtr(sharedManifold),
            sharedManifold,
            queryType);
  ...
  public boolean needsResponse(btCollisionObject body0, btCollisionObject body1) {
    return CollisionJNI.btDispatcher_needsResponse(
        swigCPtr,
        this,
        btCollisionObject.getCPtr(body0),
        body0,
  ...
  public void dispatchAllCollisionPairs(
      btOverlappingPairCache pairCache, btDispatcherInfo dispatchInfo, btDispatcher dispatcher) {
    CollisionJNI.btDispatcher_dispatchAllCollisionPairs(
        swigCPtr,
        this,
