...
public class btConvexInternalShapeData extends BulletBase {
  ...
  /**
   * Construct a new btConvexInternalShapeData, normally you should not need this constructor it's
  ...
  public void setCollisionShapeData(btCollisionShapeData value) {
    CollisionJNI.btConvexInternalShapeData_collisionShapeData_set(
  ...
  public void setLocalScaling(btVector3FloatData value) {
    CollisionJNI.btConvexInternalShapeData_localScaling_set(
  ...
  public void setImplicitShapeDimensions(btVector3FloatData value) {
    CollisionJNI.btConvexInternalShapeData_implicitShapeDimensions_set(
        swigCPtr, this, btVector3FloatData.getCPtr(value), value);
  }
