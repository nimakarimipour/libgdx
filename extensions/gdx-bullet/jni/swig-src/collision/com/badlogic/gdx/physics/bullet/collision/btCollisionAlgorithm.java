...
public class btCollisionAlgorithm extends BulletBase {
  ...
  /**
   * Construct a new btCollisionAlgorithm, normally you should not need this constructor it's
  ...
  public void processCollision(
    ...
    CollisionJNI.btCollisionAlgorithm_processCollision(
        swigCPtr,
        this,
  ...
  public float calculateTimeOfImpact(
      btCollisionObject body0,
      btCollisionObject body1,
      btDispatcherInfo dispatchInfo,
      btManifoldResult resultOut) {
    return CollisionJNI.btCollisionAlgorithm_calculateTimeOfImpact(
        swigCPtr,
        this,
  ...
  public void getAllContactManifolds(btPersistentManifoldArray manifoldArray) {
    CollisionJNI.btCollisionAlgorithm_getAllContactManifolds(
