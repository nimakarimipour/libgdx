...
public class gim_bitset extends BulletBase {
  ...
  /**
   * Construct a new gim_bitset, normally you should not need this constructor it's intended for
   * low-level usage.
   */
  ...
  public void setContainer(SWIGTYPE_p_gim_arrayT_GUINT_t value) {
    CollisionJNI.gim_bitset_container_set(
        swigCPtr, this, SWIGTYPE_p_gim_arrayT_GUINT_t.getCPtr(value));
  }
