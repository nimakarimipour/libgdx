...
public class ContactCache extends BulletBase {
  ...
  /**
   * Construct a new ContactCache, normally you should not need this constructor it's intended for
   * low-level usage.
   */
  ...
  public void onContactStarted(btPersistentManifold manifold, boolean match0, boolean match1) {
    CollisionJNI.ContactCache_onContactStarted(
  ...
  public void onContactEnded(
    ...
    CollisionJNI.ContactCache_onContactEnded(
        swigCPtr,
        this,
