...
public class btGhostObject extends btCollisionObject {
  ...
  /**
   * Construct a new btGhostObject, normally you should not need this constructor it's intended for
   * low-level usage.
   */
  ...
  public void convexSweepTest(
    ...
    CollisionJNI.btGhostObject_convexSweepTest__SWIG_0(
        swigCPtr,
        this,
  ...
  public void convexSweepTest(
      ...
      Matrix4 convexToWorld,
      ConvexResultCallback resultCallback) {
    CollisionJNI.btGhostObject_convexSweepTest__SWIG_1(
        swigCPtr,
        this,
        btConvexShape.getCPtr(castShape),
        castShape,
  ...
  public void rayTest(Vector3 rayFromWorld, Vector3 rayToWorld, RayResultCallback resultCallback) {
    CollisionJNI.btGhostObject_rayTest(
        swigCPtr,
        this,
        rayFromWorld,
        rayToWorld,
  ...
  public void addOverlappingObjectInternal(
      btBroadphaseProxy otherProxy, btBroadphaseProxy thisProxy) {
    CollisionJNI.btGhostObject_addOverlappingObjectInternal__SWIG_0(
        swigCPtr,
        this,
        btBroadphaseProxy.getCPtr(otherProxy),
        otherProxy,
        btBroadphaseProxy.getCPtr(thisProxy),
        thisProxy);
  }

  public void addOverlappingObjectInternal(btBroadphaseProxy otherProxy) {
    CollisionJNI.btGhostObject_addOverlappingObjectInternal__SWIG_1(
        swigCPtr, this, btBroadphaseProxy.getCPtr(otherProxy), otherProxy);
  }

  public void removeOverlappingObjectInternal(
      btBroadphaseProxy otherProxy, btDispatcher dispatcher, btBroadphaseProxy thisProxy) {
    CollisionJNI.btGhostObject_removeOverlappingObjectInternal__SWIG_0(
        swigCPtr,
        this,
        btBroadphaseProxy.getCPtr(otherProxy),
        otherProxy,
  ...
  public void removeOverlappingObjectInternal(
    ...
    CollisionJNI.btGhostObject_removeOverlappingObjectInternal__SWIG_1(
        swigCPtr,
        this,
        btBroadphaseProxy.getCPtr(otherProxy),
        otherProxy,
  ...
  public btCollisionObject getOverlappingObject(int index) {
    return btCollisionObject.getInstance(
        CollisionJNI.btGhostObject_getOverlappingObject(swigCPtr, this, index), false);
  }

  public btCollisionObject getOverlappingObjectConst(int index) {
    return btCollisionObject.getInstance(
        CollisionJNI.btGhostObject_getOverlappingObjectConst(swigCPtr, this, index), false);
  }

  public btCollisionObjectArray getOverlappingPairs() {
    return new btCollisionObjectArray(
        CollisionJNI.btGhostObject_getOverlappingPairs(swigCPtr, this), false);
  }

  public btCollisionObjectArray getOverlappingPairsConst() {
    return new btCollisionObjectArray(
        CollisionJNI.btGhostObject_getOverlappingPairsConst(swigCPtr, this), true);
  }

  public static btGhostObject upcastConstBtCollisionObject(btCollisionObject colObj) {
    long cPtr =
        CollisionJNI.btGhostObject_upcastConstBtCollisionObject(
