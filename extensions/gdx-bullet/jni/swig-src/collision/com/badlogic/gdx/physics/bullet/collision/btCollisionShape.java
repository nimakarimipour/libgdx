...
public class btCollisionShape extends BulletBase {
  ...
  /**
   * Construct a new btCollisionShape, normally you should not need this constructor it's intended
   * for low-level usage.
   */
  ...
  public void getBoundingSphere(Vector3 center, SWIGTYPE_p_float radius) {
    CollisionJNI.btCollisionShape_getBoundingSphere(
        swigCPtr, this, center, SWIGTYPE_p_float.getCPtr(radius));
  }
  ...
  public float getContactBreakingThreshold(float defaultContactThresholdFactor) {
    return CollisionJNI.btCollisionShape_getContactBreakingThreshold(
  ...
  public void calculateTemporalAabb(
    ...
    CollisionJNI.btCollisionShape_calculateTemporalAabb(
        swigCPtr, this, curTrans, linvel, angvel, timeStep, temporalAabbMin, temporalAabbMax);
  }
  ...
  public String serialize(long dataBuffer, btSerializer serializer) {
    return CollisionJNI.btCollisionShape_serialize(
  ...
  public void serializeSingleShape(btSerializer serializer) {
    CollisionJNI.btCollisionShape_serializeSingleShape(
