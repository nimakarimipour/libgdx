...
public class btGimQuantizedBvhNodeArray extends BulletBase {
  ...
  /**
   * Construct a new btGimQuantizedBvhNodeArray, normally you should not need this constructor it's
  ...
  public btGimQuantizedBvhNodeArray operatorAssignment(btGimQuantizedBvhNodeArray other) {
    return new btGimQuantizedBvhNodeArray(
        CollisionJNI.btGimQuantizedBvhNodeArray_operatorAssignment(
            swigCPtr, this, btGimQuantizedBvhNodeArray.getCPtr(other), other),
        false);
  }
  ...
  public btGimQuantizedBvhNodeArray(btGimQuantizedBvhNodeArray otherArray) {
    this(
        CollisionJNI.new_btGimQuantizedBvhNodeArray__SWIG_1(
            btGimQuantizedBvhNodeArray.getCPtr(otherArray), otherArray),
        true);
  }
  ...
  public BT_QUANTIZED_BVH_NODE atConst(int n) {
    return new BT_QUANTIZED_BVH_NODE(
        CollisionJNI.btGimQuantizedBvhNodeArray_atConst(swigCPtr, this, n), false);
  }

  public BT_QUANTIZED_BVH_NODE at(int n) {
    return new BT_QUANTIZED_BVH_NODE(
        CollisionJNI.btGimQuantizedBvhNodeArray_at(swigCPtr, this, n), false);
  }

  public BT_QUANTIZED_BVH_NODE operatorSubscriptConst(int n) {
    return new BT_QUANTIZED_BVH_NODE(
        CollisionJNI.btGimQuantizedBvhNodeArray_operatorSubscriptConst(swigCPtr, this, n), false);
  }

  public BT_QUANTIZED_BVH_NODE operatorSubscript(int n) {
    return new BT_QUANTIZED_BVH_NODE(
        CollisionJNI.btGimQuantizedBvhNodeArray_operatorSubscript(swigCPtr, this, n), false);
  }
  ...
  public void resize(int newsize, BT_QUANTIZED_BVH_NODE fillData) {
    CollisionJNI.btGimQuantizedBvhNodeArray_resize__SWIG_0(
        swigCPtr, this, newsize, BT_QUANTIZED_BVH_NODE.getCPtr(fillData), fillData);
  }
  ...
  public BT_QUANTIZED_BVH_NODE expandNonInitializing() {
    return new BT_QUANTIZED_BVH_NODE(
        CollisionJNI.btGimQuantizedBvhNodeArray_expandNonInitializing(swigCPtr, this), false);
  }

  public BT_QUANTIZED_BVH_NODE expand(BT_QUANTIZED_BVH_NODE fillValue) {
    return new BT_QUANTIZED_BVH_NODE(
        CollisionJNI.btGimQuantizedBvhNodeArray_expand__SWIG_0(
            swigCPtr, this, BT_QUANTIZED_BVH_NODE.getCPtr(fillValue), fillValue),
        false);
  }

  public BT_QUANTIZED_BVH_NODE expand() {
    return new BT_QUANTIZED_BVH_NODE(
        CollisionJNI.btGimQuantizedBvhNodeArray_expand__SWIG_1(swigCPtr, this), false);
  }

  public void push_back(BT_QUANTIZED_BVH_NODE _Val) {
    CollisionJNI.btGimQuantizedBvhNodeArray_push_back(
        swigCPtr, this, BT_QUANTIZED_BVH_NODE.getCPtr(_Val), _Val);
  }
  ...
  public void initializeFromBuffer(long buffer, int size, int capacity) {
    CollisionJNI.btGimQuantizedBvhNodeArray_initializeFromBuffer(
        swigCPtr, this, buffer, size, capacity);
  }

  public void copyFromArray(btGimQuantizedBvhNodeArray otherArray) {
    CollisionJNI.btGimQuantizedBvhNodeArray_copyFromArray(
        swigCPtr, this, btGimQuantizedBvhNodeArray.getCPtr(otherArray), otherArray);
  }
}
