...
public class SphereTriangleDetector extends btDiscreteCollisionDetectorInterface {
  ...
  /**
   * Construct a new SphereTriangleDetector, normally you should not need this constructor it's
  ...
  public void getClosestPoints(
      ...
      boolean swapResults) {
    CollisionJNI.SphereTriangleDetector_getClosestPoints__SWIG_0(
        swigCPtr,
        this,
  ...
  public void getClosestPoints(
      ...
      btDiscreteCollisionDetectorInterface.Result output,
      btIDebugDraw debugDraw) {
    CollisionJNI.SphereTriangleDetector_getClosestPoints__SWIG_1(
        swigCPtr,
        this,
        btDiscreteCollisionDetectorInterface.ClosestPointInput.getCPtr(input),
        input,
  ...
  public SphereTriangleDetector(
      btSphereShape sphere, btTriangleShape triangle, float contactBreakingThreshold) {
    this(
        CollisionJNI.new_SphereTriangleDetector(
            btSphereShape.getCPtr(sphere),
            sphere,
            btTriangleShape.getCPtr(triangle),
            triangle,
  ...
  public boolean collide(
    ...
    return CollisionJNI.SphereTriangleDetector_collide(
        ...
        point,
        resultNormal,
        SWIGTYPE_p_float.getCPtr(depth),
        SWIGTYPE_p_float.getCPtr(timeOfImpact),
        contactBreakingThreshold);
  }
}
