...
public class CustomCollisionDispatcher extends btCollisionDispatcher {
  ...
  /**
   * Construct a new CustomCollisionDispatcher, normally you should not need this constructor it's
  ...
  public CustomCollisionDispatcher(btCollisionConfiguration collisionConfiguration) {
    this(
        CollisionJNI.new_CustomCollisionDispatcher(
  ...
  public boolean needsCollision(btCollisionObject body0, btCollisionObject body1) {
    return (getClass() == CustomCollisionDispatcher.class)
        ? CollisionJNI.CustomCollisionDispatcher_needsCollision(
            swigCPtr,
            this,
  ...
  public boolean needsResponse(btCollisionObject body0, btCollisionObject body1) {
    return (getClass() == CustomCollisionDispatcher.class)
        ? CollisionJNI.CustomCollisionDispatcher_needsResponse(
            swigCPtr,
            this,
            btCollisionObject.getCPtr(body0),
            body0,
            btCollisionObject.getCPtr(body1),
            body1)
        : CollisionJNI.CustomCollisionDispatcher_needsResponseSwigExplicitCustomCollisionDispatcher(
            swigCPtr,
            this,
            btCollisionObject.getCPtr(body0),
            body0,
