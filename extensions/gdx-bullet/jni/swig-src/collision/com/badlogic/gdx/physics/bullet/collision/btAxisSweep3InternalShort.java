...
public class btAxisSweep3InternalShort extends btBroadphaseInterface {
  ...
  /**
   * Construct a new btAxisSweep3InternalShort, normally you should not need this constructor it's
  ...
  public long operatorNewArray(long sizeInBytes) {
    return CollisionJNI.btAxisSweep3InternalShort_operatorNewArray__SWIG_0(
        swigCPtr, this, sizeInBytes);
  }
  ...
  public long operatorNewArray(long arg0, long ptr) {
    return CollisionJNI.btAxisSweep3InternalShort_operatorNewArray__SWIG_1(
        swigCPtr, this, arg0, ptr);
  }
  ...
  public static class Edge extends BulletBase {
    ...
    /**
     * Construct a new Edge, normally you should not need this constructor it's intended for
     * low-level usage.
     */
  ...
  public static class Handle extends btBroadphaseProxy {
    ...
    /**
     * Construct a new Handle, normally you should not need this constructor it's intended for
     * low-level usage.
     */
    ...
    protected void reset(long cPtr, boolean cMemoryOwn) {
      if (!destroyed) destroy();
      super.reset(
          CollisionJNI.btAxisSweep3InternalShort_Handle_SWIGUpcast(swigCPtr = cPtr), cMemoryOwn);
    }
    ...
    public long operatorNew(long sizeInBytes) {
      return CollisionJNI.btAxisSweep3InternalShort_Handle_operatorNew__SWIG_0(
          swigCPtr, this, sizeInBytes);
    }
    ...
    public long operatorNew(long arg0, long ptr) {
      return CollisionJNI.btAxisSweep3InternalShort_Handle_operatorNew__SWIG_1(
          swigCPtr, this, arg0, ptr);
    }

    public void operatorDelete(long arg0, long arg1) {
      CollisionJNI.btAxisSweep3InternalShort_Handle_operatorDelete__SWIG_1(
          swigCPtr, this, arg0, arg1);
    }

    public long operatorNewArray(long sizeInBytes) {
      return CollisionJNI.btAxisSweep3InternalShort_Handle_operatorNewArray__SWIG_0(
          swigCPtr, this, sizeInBytes);
    }

    public void operatorDeleteArray(long ptr) {
      CollisionJNI.btAxisSweep3InternalShort_Handle_operatorDeleteArray__SWIG_0(
          swigCPtr, this, ptr);
    }

    public long operatorNewArray(long arg0, long ptr) {
      return CollisionJNI.btAxisSweep3InternalShort_Handle_operatorNewArray__SWIG_1(
          swigCPtr, this, arg0, ptr);
    }

    public void operatorDeleteArray(long arg0, long arg1) {
      CollisionJNI.btAxisSweep3InternalShort_Handle_operatorDeleteArray__SWIG_1(
          swigCPtr, this, arg0, arg1);
    }
    ...
    public void setDbvtProxy(btBroadphaseProxy value) {
      CollisionJNI.btAxisSweep3InternalShort_Handle_dbvtProxy_set(
          swigCPtr, this, btBroadphaseProxy.getCPtr(value), value);
    }

    public btBroadphaseProxy getDbvtProxy() {
      return btBroadphaseProxy.internalTemp(
          CollisionJNI.btAxisSweep3InternalShort_Handle_dbvtProxy_get(swigCPtr, this), false);
    }
  ...
  public btAxisSweep3InternalShort(
    ...
    this(
        CollisionJNI.new_btAxisSweep3InternalShort__SWIG_0(
            worldAabbMin,
            worldAabbMax,
            handleMask,
            handleSentinel,
            maxHandles,
            btOverlappingPairCache.getCPtr(pairCache),
            pairCache,
  ...
  public btAxisSweep3InternalShort(
      ...
      btOverlappingPairCache pairCache) {
    this(
        CollisionJNI.new_btAxisSweep3InternalShort__SWIG_1(
            worldAabbMin,
            worldAabbMax,
            handleMask,
            handleSentinel,
  ...
  public btAxisSweep3InternalShort(
      ...
      int maxHandles) {
    this(
        CollisionJNI.new_btAxisSweep3InternalShort__SWIG_2(
            worldAabbMin, worldAabbMax, handleMask, handleSentinel, maxHandles),
        true);
  }

  public btAxisSweep3InternalShort(
      Vector3 worldAabbMin, Vector3 worldAabbMax, int handleMask, int handleSentinel) {
    this(
        CollisionJNI.new_btAxisSweep3InternalShort__SWIG_3(
            worldAabbMin, worldAabbMax, handleMask, handleSentinel),
        true);
  }
  ...
  public int addHandle(
    ...
    return CollisionJNI.btAxisSweep3InternalShort_addHandle(
        swigCPtr,
        this,
        aabbMin,
        aabbMax,
  ...
  public void removeHandle(int handle, btDispatcher dispatcher) {
    CollisionJNI.btAxisSweep3InternalShort_removeHandle(
        swigCPtr, this, handle, btDispatcher.getCPtr(dispatcher), dispatcher);
  }

  public void updateHandle(int handle, Vector3 aabbMin, Vector3 aabbMax, btDispatcher dispatcher) {
    CollisionJNI.btAxisSweep3InternalShort_updateHandle(
        swigCPtr, this, handle, aabbMin, aabbMax, btDispatcher.getCPtr(dispatcher), dispatcher);
  }
  ...
  public void rayTest(
      ...
      Vector3 aabbMin,
      Vector3 aabbMax) {
    CollisionJNI.btAxisSweep3InternalShort_rayTest__SWIG_0(
        swigCPtr,
        this,
        rayFrom,
        rayTo,
  ...
  public void rayTest(
    ...
    CollisionJNI.btAxisSweep3InternalShort_rayTest__SWIG_1(
        swigCPtr,
        this,
        rayFrom,
        rayTo,
  ...
  public void rayTest(Vector3 rayFrom, Vector3 rayTo, btBroadphaseRayCallback rayCallback) {
    CollisionJNI.btAxisSweep3InternalShort_rayTest__SWIG_2(
        swigCPtr, this, rayFrom, rayTo, btBroadphaseRayCallback.getCPtr(rayCallback), rayCallback);
  }
  ...
  public void unQuantize(btBroadphaseProxy proxy, Vector3 aabbMin, Vector3 aabbMax) {
    CollisionJNI.btAxisSweep3InternalShort_unQuantize(
        swigCPtr, this, btBroadphaseProxy.getCPtr(proxy), proxy, aabbMin, aabbMax);
  }

  public boolean testAabbOverlap(btBroadphaseProxy proxy0, btBroadphaseProxy proxy1) {
    return CollisionJNI.btAxisSweep3InternalShort_testAabbOverlap(
        swigCPtr,
        this,
  ...
  public void setOverlappingPairUserCallback(btOverlappingPairCallback pairCallback) {
    CollisionJNI.btAxisSweep3InternalShort_setOverlappingPairUserCallback(
        swigCPtr, this, btOverlappingPairCallback.getCPtr(pairCallback), pairCallback);
  }

  public btOverlappingPairCallback getOverlappingPairUserCallback() {
    long cPtr =
        CollisionJNI.btAxisSweep3InternalShort_getOverlappingPairUserCallback(swigCPtr, this);
