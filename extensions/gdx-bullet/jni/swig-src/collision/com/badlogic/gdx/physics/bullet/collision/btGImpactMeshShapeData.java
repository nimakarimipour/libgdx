...
public class btGImpactMeshShapeData extends BulletBase {
  ...
  /**
   * Construct a new btGImpactMeshShapeData, normally you should not need this constructor it's
  ...
  public void setCollisionShapeData(btCollisionShapeData value) {
    CollisionJNI.btGImpactMeshShapeData_collisionShapeData_set(
  ...
  public void setMeshInterface(btStridingMeshInterfaceData value) {
    CollisionJNI.btGImpactMeshShapeData_meshInterface_set(
  ...
  public void setLocalScaling(btVector3FloatData value) {
    CollisionJNI.btGImpactMeshShapeData_localScaling_set(
