...
public class btDefaultCollisionConstructionInfo extends BulletBase {
  ...
  protected btDefaultCollisionConstructionInfo(
  ...
  /**
   * Construct a new btDefaultCollisionConstructionInfo, normally you should not need this
  ...
  public void setPersistentManifoldPool(btPoolAllocator value) {
    CollisionJNI.btDefaultCollisionConstructionInfo_persistentManifoldPool_set(
        swigCPtr, this, btPoolAllocator.getCPtr(value), value);
  }

  public btPoolAllocator getPersistentManifoldPool() {
    long cPtr =
        CollisionJNI.btDefaultCollisionConstructionInfo_persistentManifoldPool_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btPoolAllocator(cPtr, false);
  }

  public void setCollisionAlgorithmPool(btPoolAllocator value) {
    CollisionJNI.btDefaultCollisionConstructionInfo_collisionAlgorithmPool_set(
        swigCPtr, this, btPoolAllocator.getCPtr(value), value);
  }

  public btPoolAllocator getCollisionAlgorithmPool() {
    long cPtr =
        CollisionJNI.btDefaultCollisionConstructionInfo_collisionAlgorithmPool_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btPoolAllocator(cPtr, false);
  }

  public void setDefaultMaxPersistentManifoldPoolSize(int value) {
    CollisionJNI.btDefaultCollisionConstructionInfo_defaultMaxPersistentManifoldPoolSize_set(
        swigCPtr, this, value);
  }

  public int getDefaultMaxPersistentManifoldPoolSize() {
    return CollisionJNI.btDefaultCollisionConstructionInfo_defaultMaxPersistentManifoldPoolSize_get(
        swigCPtr, this);
  }

  public void setDefaultMaxCollisionAlgorithmPoolSize(int value) {
    CollisionJNI.btDefaultCollisionConstructionInfo_defaultMaxCollisionAlgorithmPoolSize_set(
        swigCPtr, this, value);
  }

  public int getDefaultMaxCollisionAlgorithmPoolSize() {
    return CollisionJNI.btDefaultCollisionConstructionInfo_defaultMaxCollisionAlgorithmPoolSize_get(
        swigCPtr, this);
  }

  public void setCustomCollisionAlgorithmMaxElementSize(int value) {
    CollisionJNI.btDefaultCollisionConstructionInfo_customCollisionAlgorithmMaxElementSize_set(
        swigCPtr, this, value);
  }
  ...
  public void setUseEpaPenetrationAlgorithm(int value) {
    CollisionJNI.btDefaultCollisionConstructionInfo_useEpaPenetrationAlgorithm_set(
        swigCPtr, this, value);
  }

  public int getUseEpaPenetrationAlgorithm() {
    return CollisionJNI.btDefaultCollisionConstructionInfo_useEpaPenetrationAlgorithm_get(
        swigCPtr, this);
  }
