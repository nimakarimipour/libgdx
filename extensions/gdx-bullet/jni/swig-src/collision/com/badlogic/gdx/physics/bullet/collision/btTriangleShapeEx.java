...
public class btTriangleShapeEx extends btTriangleShape {
  ...
  /**
   * Construct a new btTriangleShapeEx, normally you should not need this constructor it's intended
   * for low-level usage.
   */
  ...
  public boolean overlap_test_conservative(btTriangleShapeEx other) {
    return CollisionJNI.btTriangleShapeEx_overlap_test_conservative(
