...
public class btCapsuleShapeData extends BulletBase {
  ...
  /**
   * Construct a new btCapsuleShapeData, normally you should not need this constructor it's intended
   * for low-level usage.
   */
  ...
  public void setConvexInternalShapeData(btConvexInternalShapeData value) {
    CollisionJNI.btCapsuleShapeData_convexInternalShapeData_set(
