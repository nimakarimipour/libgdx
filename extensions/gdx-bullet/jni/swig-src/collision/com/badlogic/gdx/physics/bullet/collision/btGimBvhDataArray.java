...
public class btGimBvhDataArray extends BulletBase {
  ...
  /**
   * Construct a new btGimBvhDataArray, normally you should not need this constructor it's intended
   * for low-level usage.
   */
  ...
  public btGimBvhDataArray operatorAssignment(btGimBvhDataArray other) {
    return new btGimBvhDataArray(
        CollisionJNI.btGimBvhDataArray_operatorAssignment(
            swigCPtr, this, btGimBvhDataArray.getCPtr(other), other),
        false);
  }
  ...
  public btGimBvhDataArray(btGimBvhDataArray otherArray) {
    this(
        CollisionJNI.new_btGimBvhDataArray__SWIG_1(
            btGimBvhDataArray.getCPtr(otherArray), otherArray),
        true);
  }
  ...
  public GIM_BVH_DATA operatorSubscriptConst(int n) {
    return new GIM_BVH_DATA(
        CollisionJNI.btGimBvhDataArray_operatorSubscriptConst(swigCPtr, this, n), false);
  }

  public GIM_BVH_DATA operatorSubscript(int n) {
    return new GIM_BVH_DATA(
        CollisionJNI.btGimBvhDataArray_operatorSubscript(swigCPtr, this, n), false);
  }
  ...
  public void resize(int newsize, GIM_BVH_DATA fillData) {
    CollisionJNI.btGimBvhDataArray_resize__SWIG_0(
        swigCPtr, this, newsize, GIM_BVH_DATA.getCPtr(fillData), fillData);
  }
  ...
  public GIM_BVH_DATA expandNonInitializing() {
    return new GIM_BVH_DATA(
        CollisionJNI.btGimBvhDataArray_expandNonInitializing(swigCPtr, this), false);
  }

  public GIM_BVH_DATA expand(GIM_BVH_DATA fillValue) {
    return new GIM_BVH_DATA(
        CollisionJNI.btGimBvhDataArray_expand__SWIG_0(
            swigCPtr, this, GIM_BVH_DATA.getCPtr(fillValue), fillValue),
        false);
  }
  ...
  public void copyFromArray(btGimBvhDataArray otherArray) {
    CollisionJNI.btGimBvhDataArray_copyFromArray(
        swigCPtr, this, btGimBvhDataArray.getCPtr(otherArray), otherArray);
  }
}
