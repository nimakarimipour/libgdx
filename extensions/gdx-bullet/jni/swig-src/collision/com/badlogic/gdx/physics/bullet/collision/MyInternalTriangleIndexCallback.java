...
public class MyInternalTriangleIndexCallback extends btInternalTriangleIndexCallback {
  ...
  /**
   * Construct a new MyInternalTriangleIndexCallback, normally you should not need this constructor
  ...
  protected void reset(long cPtr, boolean cMemoryOwn) {
    ...
    super.reset(
        CollisionJNI.MyInternalTriangleIndexCallback_SWIGUpcast(swigCPtr = cPtr), cMemoryOwn);
  }
  ...
  public void setGimpactShape(btGImpactMeshShape value) {
    CollisionJNI.MyInternalTriangleIndexCallback_gimpactShape_set(
        swigCPtr, this, btGImpactMeshShape.getCPtr(value), value);
  }
  ...
  public void setColShape(btCompoundShape value) {
    CollisionJNI.MyInternalTriangleIndexCallback_colShape_set(
        swigCPtr, this, btCompoundShape.getCPtr(value), value);
  }
  ...
  public MyInternalTriangleIndexCallback(
      btCompoundShape colShape, btGImpactMeshShape meshShape, float depth) {
    this(
        CollisionJNI.new_MyInternalTriangleIndexCallback(
            btCompoundShape.getCPtr(colShape),
            colShape,
            btGImpactMeshShape.getCPtr(meshShape),
            meshShape,
            depth),
        true);
  }
