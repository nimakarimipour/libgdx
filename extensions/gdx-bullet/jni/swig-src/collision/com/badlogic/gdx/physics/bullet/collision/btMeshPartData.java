...
public class btMeshPartData extends BulletBase {
  ...
  /**
   * Construct a new btMeshPartData, normally you should not need this constructor it's intended for
   * low-level usage.
   */
  ...
  public void setVertices3f(btVector3FloatData value) {
    CollisionJNI.btMeshPartData_vertices3f_set(
  ...
  public void setVertices3d(btVector3DoubleData value) {
    CollisionJNI.btMeshPartData_vertices3d_set(
  ...
  public void set3indices16(btShortIntIndexTripletData value) {
    CollisionJNI.btMeshPartData_3indices16_set(
        swigCPtr, this, btShortIntIndexTripletData.getCPtr(value), value);
  }
  ...
  public void set3indices8(btCharIndexTripletData value) {
    CollisionJNI.btMeshPartData_3indices8_set(
        swigCPtr, this, btCharIndexTripletData.getCPtr(value), value);
  }
  ...
  public void setIndices16(btShortIntIndexData value) {
    CollisionJNI.btMeshPartData_indices16_set(
        swigCPtr, this, btShortIntIndexData.getCPtr(value), value);
  }
