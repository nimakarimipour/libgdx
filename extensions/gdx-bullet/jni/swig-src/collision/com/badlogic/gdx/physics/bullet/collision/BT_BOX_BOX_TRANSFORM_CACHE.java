...
public class BT_BOX_BOX_TRANSFORM_CACHE extends BulletBase {
  ...
  /**
   * Construct a new BT_BOX_BOX_TRANSFORM_CACHE, normally you should not need this constructor it's
  ...
  public void setT1to0(btVector3 value) {
    CollisionJNI.BT_BOX_BOX_TRANSFORM_CACHE_T1to0_set(
  ...
  public void setR1to0(btMatrix3x3 value) {
    CollisionJNI.BT_BOX_BOX_TRANSFORM_CACHE_R1to0_set(
  ...
  public void setAR(btMatrix3x3 value) {
    CollisionJNI.BT_BOX_BOX_TRANSFORM_CACHE_AR_set(
        swigCPtr, this, btMatrix3x3.getCPtr(value), value);
  }
