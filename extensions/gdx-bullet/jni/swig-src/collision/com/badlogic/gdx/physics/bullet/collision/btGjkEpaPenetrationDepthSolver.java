...
public class btGjkEpaPenetrationDepthSolver extends btConvexPenetrationDepthSolver {
  ...
  /**
   * Construct a new btGjkEpaPenetrationDepthSolver, normally you should not need this constructor
  ...
  protected void reset(long cPtr, boolean cMemoryOwn) {
    ...
    super.reset(
        CollisionJNI.btGjkEpaPenetrationDepthSolver_SWIGUpcast(swigCPtr = cPtr), cMemoryOwn);
  }
