...
public class btScaledTriangleMeshShapeData extends BulletBase {
  ...
  /**
   * Construct a new btScaledTriangleMeshShapeData, normally you should not need this constructor
  ...
  public void setTrimeshShapeData(btTriangleMeshShapeData value) {
    CollisionJNI.btScaledTriangleMeshShapeData_trimeshShapeData_set(
        swigCPtr, this, btTriangleMeshShapeData.getCPtr(value), value);
  }
  ...
  public void setLocalScaling(btVector3FloatData value) {
    CollisionJNI.btScaledTriangleMeshShapeData_localScaling_set(
