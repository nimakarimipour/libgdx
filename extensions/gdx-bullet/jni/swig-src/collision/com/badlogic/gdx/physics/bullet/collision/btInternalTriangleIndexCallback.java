...
public class btInternalTriangleIndexCallback extends BulletBase {
  ...
  /**
   * Construct a new btInternalTriangleIndexCallback, normally you should not need this constructor
  ...
  public void internalProcessTriangleIndex(btVector3 triangle, int partId, int triangleIndex) {
    CollisionJNI.btInternalTriangleIndexCallback_internalProcessTriangleIndex(
  ...
  public btInternalTriangleIndexCallback() {
    ...
    CollisionJNI.btInternalTriangleIndexCallback_director_connect(
