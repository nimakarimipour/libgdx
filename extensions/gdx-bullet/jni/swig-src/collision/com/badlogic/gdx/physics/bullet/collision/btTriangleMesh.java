...
public class btTriangleMesh extends btTriangleIndexVertexArray {
  ...
  /**
   * Construct a new btTriangleMesh, normally you should not need this constructor it's intended for
   * low-level usage.
   */
  ...
  public void addTriangle(
      Vector3 vertex0, Vector3 vertex1, Vector3 vertex2, boolean removeDuplicateVertices) {
    CollisionJNI.btTriangleMesh_addTriangle__SWIG_0(
        swigCPtr, this, vertex0, vertex1, vertex2, removeDuplicateVertices);
  }
  ...
  public int findOrAddVertex(Vector3 vertex, boolean removeDuplicateVertices) {
    return CollisionJNI.btTriangleMesh_findOrAddVertex(
        swigCPtr, this, vertex, removeDuplicateVertices);
  }
