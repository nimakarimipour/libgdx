...
public class btTriangleIndexVertexArray extends btStridingMeshInterface {
  ...
  /**
   * Construct a new btTriangleIndexVertexArray, normally you should not need this constructor it's
  ...
  protected static final Array<btTriangleIndexVertexArray> instances =
      new Array<btTriangleIndexVertexArray>();

  /** @return Whether the supplied array contains all specified tags. */
  public static <T extends Object> boolean compare(
      final btTriangleIndexVertexArray array, final Array<T> tags) {
  ...
  /**
   * Create or reuse a btTriangleIndexVertexArray instance based on the specified {@link MeshPart}
   * array. Use {@link #release()} to release the mesh when it's no longer needed.
   */
  ...
  /**
   * Add a {@link MeshPart} instance to this btTriangleIndexVertexArray. The specified mesh must be
   * indexed and triangulated and must outlive this btTriangleIndexVertexArray. The buffers for the
   * vertices and indices are shared amongst both.
   */
  ...
  /**
   * Add one or more {@link MeshPart} instances to this btTriangleIndexVertexArray. The specified
   * meshes must be indexed and triangulated and must outlive this btTriangleIndexVertexArray. The
   * buffers for the vertices and indices are shared amongst both.
   */
  public btTriangleIndexVertexArray addMeshParts(final MeshPart... meshParts) {
    for (int i = 0; i < meshParts.length; i++) addMeshPart(meshParts[i]);
    return this;
  }
  ...
  /**
   * Add one or more {@link NodePart} instances to this btTriangleIndexVertexArray. The specified
   * meshes must be indexed and triangulated and must outlive this btTriangleIndexVertexArray. The
   * buffers for the vertices and indices are shared amongst both.
   */
  ...
  public long operatorNewArray(long sizeInBytes) {
    return CollisionJNI.btTriangleIndexVertexArray_operatorNewArray__SWIG_0(
  ...
  public long operatorNewArray(long arg0, long ptr) {
    return CollisionJNI.btTriangleIndexVertexArray_operatorNewArray__SWIG_1(
  ...
  private void internalAddIndexedMesh(btIndexedMesh mesh, int indexType) {
    CollisionJNI.btTriangleIndexVertexArray_internalAddIndexedMesh__SWIG_0(
        swigCPtr, this, btIndexedMesh.getCPtr(mesh), mesh, indexType);
  }

  private void internalAddIndexedMesh(btIndexedMesh mesh) {
    CollisionJNI.btTriangleIndexVertexArray_internalAddIndexedMesh__SWIG_1(
        swigCPtr, this, btIndexedMesh.getCPtr(mesh), mesh);
  }

  public void getLockedVertexIndexBase(
      SWIGTYPE_p_p_unsigned_char vertexbase,
      SWIGTYPE_p_int numverts,
      SWIGTYPE_p_PHY_ScalarType type,
      SWIGTYPE_p_int vertexStride,
      SWIGTYPE_p_p_unsigned_char indexbase,
      SWIGTYPE_p_int indexstride,
      SWIGTYPE_p_int numfaces,
      SWIGTYPE_p_PHY_ScalarType indicestype,
      int subpart) {
    CollisionJNI.btTriangleIndexVertexArray_getLockedVertexIndexBase__SWIG_0(
        swigCPtr,
        this,
        SWIGTYPE_p_p_unsigned_char.getCPtr(vertexbase),
        SWIGTYPE_p_int.getCPtr(numverts),
        SWIGTYPE_p_PHY_ScalarType.getCPtr(type),
        SWIGTYPE_p_int.getCPtr(vertexStride),
        SWIGTYPE_p_p_unsigned_char.getCPtr(indexbase),
        SWIGTYPE_p_int.getCPtr(indexstride),
        SWIGTYPE_p_int.getCPtr(numfaces),
  ...
  public void getLockedVertexIndexBase(
      ...
      SWIGTYPE_p_int numfaces,
      SWIGTYPE_p_PHY_ScalarType indicestype) {
    CollisionJNI.btTriangleIndexVertexArray_getLockedVertexIndexBase__SWIG_1(
        swigCPtr,
        this,
        SWIGTYPE_p_p_unsigned_char.getCPtr(vertexbase),
        SWIGTYPE_p_int.getCPtr(numverts),
  ...
  public void getLockedReadOnlyVertexIndexBase(
      ...
      SWIGTYPE_p_PHY_ScalarType indicestype,
      int subpart) {
    CollisionJNI.btTriangleIndexVertexArray_getLockedReadOnlyVertexIndexBase__SWIG_0(
        swigCPtr,
        this,
        SWIGTYPE_p_p_unsigned_char.getCPtr(vertexbase),
        SWIGTYPE_p_int.getCPtr(numverts),
