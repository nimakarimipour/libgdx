...
public class btBroadphasePair extends BulletBase {
  ...
  /**
   * Construct a new btBroadphasePair, normally you should not need this constructor it's intended
   * for low-level usage.
   */
  ...
  protected static final btBroadphasePair temp = new btBroadphasePair(0, false);
  ...
  protected static final com.badlogic.gdx.utils.Pool<btBroadphasePair> pool =
      new com.badlogic.gdx.utils.Pool<btBroadphasePair>() {
        @Override
  ...
  public void setPProxy0(btBroadphaseProxy value) {
    CollisionJNI.btBroadphasePair_pProxy0_set(
  ...
  public btBroadphaseProxy getPProxy0() {
    return btBroadphaseProxy.internalTemp(
        CollisionJNI.btBroadphasePair_pProxy0_get(swigCPtr, this), false);
  }

  public void setPProxy1(btBroadphaseProxy value) {
    CollisionJNI.btBroadphasePair_pProxy1_set(
        swigCPtr, this, btBroadphaseProxy.getCPtr(value), value);
  }

  public btBroadphaseProxy getPProxy1() {
    return btBroadphaseProxy.internalTemp(
        CollisionJNI.btBroadphasePair_pProxy1_get(swigCPtr, this), false);
  }

  public void setAlgorithm(btCollisionAlgorithm value) {
    CollisionJNI.btBroadphasePair_algorithm_set(
        swigCPtr, this, btCollisionAlgorithm.getCPtr(value), value);
  }
