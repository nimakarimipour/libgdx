...
public class btCollisionWorldImporter extends BulletBase {
  ...
  /**
   * Construct a new btCollisionWorldImporter, normally you should not need this constructor it's
  ...
  public boolean convertAllObjects(btBulletSerializedArrays arrays) {
    return CollisionJNI.btCollisionWorldImporter_convertAllObjects(
        swigCPtr, this, btBulletSerializedArrays.getCPtr(arrays), arrays);
  }
  ...
  public btCollisionShape getCollisionShapeByIndex(int index) {
    long cPtr =
        CollisionJNI.btCollisionWorldImporter_getCollisionShapeByIndex(swigCPtr, this, index);
  ...
  public btCollisionObject getRigidBodyByIndex(int index) {
    return btCollisionObject.getInstance(
        CollisionJNI.btCollisionWorldImporter_getRigidBodyByIndex(swigCPtr, this, index), false);
  }
  ...
  public btTriangleInfoMap getTriangleInfoMapByIndex(int index) {
    long cPtr =
        CollisionJNI.btCollisionWorldImporter_getTriangleInfoMapByIndex(swigCPtr, this, index);
  ...
  public btCollisionObject getCollisionObjectByName(String name) {
    return btCollisionObject.getInstance(
        CollisionJNI.btCollisionWorldImporter_getCollisionObjectByName(swigCPtr, this, name),
        false);
  }
  ...
  public btCollisionObject createCollisionObject(
    ...
    return btCollisionObject.getInstance(
        CollisionJNI.btCollisionWorldImporter_createCollisionObject(
  ...
  public btCollisionShape createPlaneShape(Vector3 planeNormal, float planeConstant) {
    long cPtr =
        CollisionJNI.btCollisionWorldImporter_createPlaneShape(
            swigCPtr, this, planeNormal, planeConstant);
    return (cPtr == 0) ? null : btCollisionShape.newDerivedObject(cPtr, false);
  }
  ...
  public btCollisionShape createCapsuleShapeX(float radius, float height) {
    long cPtr =
        CollisionJNI.btCollisionWorldImporter_createCapsuleShapeX(swigCPtr, this, radius, height);
    return (cPtr == 0) ? null : btCollisionShape.newDerivedObject(cPtr, false);
  }

  public btCollisionShape createCapsuleShapeY(float radius, float height) {
    long cPtr =
        CollisionJNI.btCollisionWorldImporter_createCapsuleShapeY(swigCPtr, this, radius, height);
    return (cPtr == 0) ? null : btCollisionShape.newDerivedObject(cPtr, false);
  }

  public btCollisionShape createCapsuleShapeZ(float radius, float height) {
    long cPtr =
        CollisionJNI.btCollisionWorldImporter_createCapsuleShapeZ(swigCPtr, this, radius, height);
    return (cPtr == 0) ? null : btCollisionShape.newDerivedObject(cPtr, false);
  }

  public btCollisionShape createCylinderShapeX(float radius, float height) {
    long cPtr =
        CollisionJNI.btCollisionWorldImporter_createCylinderShapeX(swigCPtr, this, radius, height);
    return (cPtr == 0) ? null : btCollisionShape.newDerivedObject(cPtr, false);
  }

  public btCollisionShape createCylinderShapeY(float radius, float height) {
    long cPtr =
        CollisionJNI.btCollisionWorldImporter_createCylinderShapeY(swigCPtr, this, radius, height);
    return (cPtr == 0) ? null : btCollisionShape.newDerivedObject(cPtr, false);
  }

  public btCollisionShape createCylinderShapeZ(float radius, float height) {
    long cPtr =
        CollisionJNI.btCollisionWorldImporter_createCylinderShapeZ(swigCPtr, this, radius, height);
    return (cPtr == 0) ? null : btCollisionShape.newDerivedObject(cPtr, false);
  }

  public btCollisionShape createConeShapeX(float radius, float height) {
    long cPtr =
        CollisionJNI.btCollisionWorldImporter_createConeShapeX(swigCPtr, this, radius, height);
    return (cPtr == 0) ? null : btCollisionShape.newDerivedObject(cPtr, false);
  }

  public btCollisionShape createConeShapeY(float radius, float height) {
    long cPtr =
        CollisionJNI.btCollisionWorldImporter_createConeShapeY(swigCPtr, this, radius, height);
    return (cPtr == 0) ? null : btCollisionShape.newDerivedObject(cPtr, false);
  }

  public btCollisionShape createConeShapeZ(float radius, float height) {
    long cPtr =
        CollisionJNI.btCollisionWorldImporter_createConeShapeZ(swigCPtr, this, radius, height);
    return (cPtr == 0) ? null : btCollisionShape.newDerivedObject(cPtr, false);
  }
  ...
  public btBvhTriangleMeshShape createBvhTriangleMeshShape(
    ...
    long cPtr =
        CollisionJNI.btCollisionWorldImporter_createBvhTriangleMeshShape(
            swigCPtr,
            this,
  ...
  public btCollisionShape createConvexTriangleMeshShape(btStridingMeshInterface trimesh) {
    long cPtr =
        CollisionJNI.btCollisionWorldImporter_createConvexTriangleMeshShape(
  ...
  public btStridingMeshInterfaceData createStridingMeshInterfaceData(
    ...
    long cPtr =
        CollisionJNI.btCollisionWorldImporter_createStridingMeshInterfaceData(
  ...
  public btScaledBvhTriangleMeshShape createScaledTrangleMeshShape(
    ...
    long cPtr =
        CollisionJNI.btCollisionWorldImporter_createScaledTrangleMeshShape(
            swigCPtr,
            this,
  ...
  public btMultiSphereShape createMultiSphereShape(
    ...
    {
      long cPtr =
          CollisionJNI.btCollisionWorldImporter_createMultiSphereShape(
  ...
  public btTriangleIndexVertexArray createMeshInterface(btStridingMeshInterfaceData meshData) {
    long cPtr =
        CollisionJNI.btCollisionWorldImporter_createMeshInterface(
