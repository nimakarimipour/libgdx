...
public class btCollisionObjectWrapper extends BulletBase {
  ...
  /**
   * Construct a new btCollisionObjectWrapper, normally you should not need this constructor it's
  ...
  private static btCollisionObjectWrapper[] argumentInstances =
  ...
  /**
   * Obtains a temporary instance, used for callback methods with one or more btManifoldPoint
   * arguments
   */
  ...
  public void setParent(btCollisionObjectWrapper value) {
    CollisionJNI.btCollisionObjectWrapper_parent_set(
  ...
  public btCollisionObjectWrapper getParent() {
    return btCollisionObjectWrapper.internalTemp(
        CollisionJNI.btCollisionObjectWrapper_parent_get(swigCPtr, this), false);
  }

  public void setShape(btCollisionShape value) {
    CollisionJNI.btCollisionObjectWrapper_shape_set(
  ...
  public void setCollisionObject(btCollisionObject value) {
    CollisionJNI.btCollisionObjectWrapper_collisionObject_set(
        swigCPtr, this, btCollisionObject.getCPtr(value), value);
  }

  public btCollisionObject getCollisionObject() {
    return btCollisionObject.getInstance(
        CollisionJNI.btCollisionObjectWrapper_collisionObject_get(swigCPtr, this), false);
  }
