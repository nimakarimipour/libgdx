...
public class btGjkConvexCast extends btConvexCast {
  ...
  /**
   * Construct a new btGjkConvexCast, normally you should not need this constructor it's intended
   * for low-level usage.
   */
  ...
  public btGjkConvexCast(
      btConvexShape convexA, btConvexShape convexB, btVoronoiSimplexSolver simplexSolver) {
    this(
        CollisionJNI.new_btGjkConvexCast(
            btConvexShape.getCPtr(convexA),
            convexA,
            btConvexShape.getCPtr(convexB),
            convexB,
