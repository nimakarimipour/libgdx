...
public class btConvexConvexAlgorithm extends btActivatingCollisionAlgorithm {
  ...
  /**
   * Construct a new btConvexConvexAlgorithm, normally you should not need this constructor it's
  ...
  public btConvexConvexAlgorithm(
    ...
    this(
        CollisionJNI.new_btConvexConvexAlgorithm(
  ...
  public static class CreateFunc extends btCollisionAlgorithmCreateFunc {
    ...
    protected CreateFunc(final String className, long cPtr, boolean cMemoryOwn) {
      super(
          className, CollisionJNI.btConvexConvexAlgorithm_CreateFunc_SWIGUpcast(cPtr), cMemoryOwn);
      swigCPtr = cPtr;
    }
    ...
    protected void reset(long cPtr, boolean cMemoryOwn) {
      if (!destroyed) destroy();
      super.reset(
          CollisionJNI.btConvexConvexAlgorithm_CreateFunc_SWIGUpcast(swigCPtr = cPtr), cMemoryOwn);
    }
    ...
    public void setPdSolver(btConvexPenetrationDepthSolver value) {
      CollisionJNI.btConvexConvexAlgorithm_CreateFunc_pdSolver_set(
    ...
    public void setNumPerturbationIterations(int value) {
      CollisionJNI.btConvexConvexAlgorithm_CreateFunc_numPerturbationIterations_set(
          swigCPtr, this, value);
    }
    ...
    public void setMinimumPointsPerturbationThreshold(int value) {
      CollisionJNI.btConvexConvexAlgorithm_CreateFunc_minimumPointsPerturbationThreshold_set(
          swigCPtr, this, value);
    }
    ...
    public CreateFunc(btConvexPenetrationDepthSolver pdSolver) {
      this(
          CollisionJNI.new_btConvexConvexAlgorithm_CreateFunc(
              btConvexPenetrationDepthSolver.getCPtr(pdSolver), pdSolver),
          true);
    }
  }
}
