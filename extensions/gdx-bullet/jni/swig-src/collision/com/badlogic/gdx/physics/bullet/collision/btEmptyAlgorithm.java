...
public class btEmptyAlgorithm extends btCollisionAlgorithm {
  ...
  /**
   * Construct a new btEmptyAlgorithm, normally you should not need this constructor it's intended
   * for low-level usage.
   */
  ...
  public btEmptyAlgorithm(btCollisionAlgorithmConstructionInfo ci) {
    this(
        CollisionJNI.new_btEmptyAlgorithm(btCollisionAlgorithmConstructionInfo.getCPtr(ci), ci),
        true);
  }
