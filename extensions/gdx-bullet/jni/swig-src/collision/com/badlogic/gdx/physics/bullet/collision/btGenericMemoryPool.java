...
public class btGenericMemoryPool extends BulletBase {
  ...
  /**
   * Construct a new btGenericMemoryPool, normally you should not need this constructor it's
  ...
  public void setFree_nodes(SWIGTYPE_p_size_t value) {
    CollisionJNI.btGenericMemoryPool_free_nodes_set(
        swigCPtr, this, SWIGTYPE_p_size_t.getCPtr(value));
  }
  ...
  public void setAllocated_sizes(SWIGTYPE_p_size_t value) {
    CollisionJNI.btGenericMemoryPool_allocated_sizes_set(
        swigCPtr, this, SWIGTYPE_p_size_t.getCPtr(value));
  }
