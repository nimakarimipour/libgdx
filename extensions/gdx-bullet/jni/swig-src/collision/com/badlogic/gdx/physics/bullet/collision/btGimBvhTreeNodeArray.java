...
public class btGimBvhTreeNodeArray extends BulletBase {
  ...
  /**
   * Construct a new btGimBvhTreeNodeArray, normally you should not need this constructor it's
  ...
  public btGimBvhTreeNodeArray operatorAssignment(btGimBvhTreeNodeArray other) {
    return new btGimBvhTreeNodeArray(
        CollisionJNI.btGimBvhTreeNodeArray_operatorAssignment(
            swigCPtr, this, btGimBvhTreeNodeArray.getCPtr(other), other),
        false);
  }
  ...
  public btGimBvhTreeNodeArray(btGimBvhTreeNodeArray otherArray) {
    this(
        CollisionJNI.new_btGimBvhTreeNodeArray__SWIG_1(
            btGimBvhTreeNodeArray.getCPtr(otherArray), otherArray),
        true);
  }
  ...
  public GIM_BVH_TREE_NODE atConst(int n) {
    return new GIM_BVH_TREE_NODE(
        CollisionJNI.btGimBvhTreeNodeArray_atConst(swigCPtr, this, n), false);
  }
  ...
  public GIM_BVH_TREE_NODE operatorSubscriptConst(int n) {
    return new GIM_BVH_TREE_NODE(
        CollisionJNI.btGimBvhTreeNodeArray_operatorSubscriptConst(swigCPtr, this, n), false);
  }

  public GIM_BVH_TREE_NODE operatorSubscript(int n) {
    return new GIM_BVH_TREE_NODE(
        CollisionJNI.btGimBvhTreeNodeArray_operatorSubscript(swigCPtr, this, n), false);
  }
  ...
  public void resize(int newsize, GIM_BVH_TREE_NODE fillData) {
    CollisionJNI.btGimBvhTreeNodeArray_resize__SWIG_0(
        swigCPtr, this, newsize, GIM_BVH_TREE_NODE.getCPtr(fillData), fillData);
  }
  ...
  public GIM_BVH_TREE_NODE expandNonInitializing() {
    return new GIM_BVH_TREE_NODE(
        CollisionJNI.btGimBvhTreeNodeArray_expandNonInitializing(swigCPtr, this), false);
  }

  public GIM_BVH_TREE_NODE expand(GIM_BVH_TREE_NODE fillValue) {
    return new GIM_BVH_TREE_NODE(
        CollisionJNI.btGimBvhTreeNodeArray_expand__SWIG_0(
            swigCPtr, this, GIM_BVH_TREE_NODE.getCPtr(fillValue), fillValue),
        false);
  }

  public GIM_BVH_TREE_NODE expand() {
    return new GIM_BVH_TREE_NODE(
        CollisionJNI.btGimBvhTreeNodeArray_expand__SWIG_1(swigCPtr, this), false);
  }

  public void push_back(GIM_BVH_TREE_NODE _Val) {
    CollisionJNI.btGimBvhTreeNodeArray_push_back(
        swigCPtr, this, GIM_BVH_TREE_NODE.getCPtr(_Val), _Val);
  }
  ...
  public void copyFromArray(btGimBvhTreeNodeArray otherArray) {
    CollisionJNI.btGimBvhTreeNodeArray_copyFromArray(
        swigCPtr, this, btGimBvhTreeNodeArray.getCPtr(otherArray), otherArray);
  }
}
