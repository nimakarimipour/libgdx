...
public class btCompoundCompoundCollisionAlgorithm extends btCompoundCollisionAlgorithm {
  ...
  protected btCompoundCompoundCollisionAlgorithm(
    ...
    super(
        className, CollisionJNI.btCompoundCompoundCollisionAlgorithm_SWIGUpcast(cPtr), cMemoryOwn);
    swigCPtr = cPtr;
  }

  /**
   * Construct a new btCompoundCompoundCollisionAlgorithm, normally you should not need this
  ...
  protected void reset(long cPtr, boolean cMemoryOwn) {
    ...
    super.reset(
        CollisionJNI.btCompoundCompoundCollisionAlgorithm_SWIGUpcast(swigCPtr = cPtr), cMemoryOwn);
  }
  ...
  public btCompoundCompoundCollisionAlgorithm(
      ...
      boolean isSwapped) {
    this(
        CollisionJNI.new_btCompoundCompoundCollisionAlgorithm(
  ...
  public static class CreateFunc extends btCollisionAlgorithmCreateFunc {
    ...
    protected CreateFunc(final String className, long cPtr, boolean cMemoryOwn) {
      super(
          className,
          CollisionJNI.btCompoundCompoundCollisionAlgorithm_CreateFunc_SWIGUpcast(cPtr),
          cMemoryOwn);
      swigCPtr = cPtr;
    }
    ...
    protected void reset(long cPtr, boolean cMemoryOwn) {
      if (!destroyed) destroy();
      super.reset(
          CollisionJNI.btCompoundCompoundCollisionAlgorithm_CreateFunc_SWIGUpcast(swigCPtr = cPtr),
          cMemoryOwn);
    }
  ...
  public static class SwappedCreateFunc extends btCollisionAlgorithmCreateFunc {
    ...
    protected SwappedCreateFunc(final String className, long cPtr, boolean cMemoryOwn) {
      super(
          className,
          CollisionJNI.btCompoundCompoundCollisionAlgorithm_SwappedCreateFunc_SWIGUpcast(cPtr),
          cMemoryOwn);
      swigCPtr = cPtr;
    }
    ...
    protected void reset(long cPtr, boolean cMemoryOwn) {
      if (!destroyed) destroy();
      super.reset(
          CollisionJNI.btCompoundCompoundCollisionAlgorithm_SwappedCreateFunc_SWIGUpcast(
              swigCPtr = cPtr),
          cMemoryOwn);
    }
