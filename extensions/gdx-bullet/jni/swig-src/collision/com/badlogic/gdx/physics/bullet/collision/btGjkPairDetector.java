...
public class btGjkPairDetector extends btDiscreteCollisionDetectorInterface {
  ...
  /**
   * Construct a new btGjkPairDetector, normally you should not need this constructor it's intended
   * for low-level usage.
   */
  ...
  public btGjkPairDetector(
    ...
    this(
        CollisionJNI.new_btGjkPairDetector__SWIG_0(
            btConvexShape.getCPtr(objectA),
            objectA,
            btConvexShape.getCPtr(objectB),
            objectB,
            btVoronoiSimplexSolver.getCPtr(simplexSolver),
            simplexSolver,
            btConvexPenetrationDepthSolver.getCPtr(penetrationDepthSolver),
  ...
  public btGjkPairDetector(
      ...
      btConvexPenetrationDepthSolver penetrationDepthSolver) {
    this(
        CollisionJNI.new_btGjkPairDetector__SWIG_1(
            btConvexShape.getCPtr(objectA),
            objectA,
            btConvexShape.getCPtr(objectB),
            objectB,
  ...
  public void getClosestPoints(
      ...
      boolean swapResults) {
    CollisionJNI.btGjkPairDetector_getClosestPoints__SWIG_0(
        swigCPtr,
        this,
  ...
  public void getClosestPoints(
      ...
      btDiscreteCollisionDetectorInterface.Result output,
      btIDebugDraw debugDraw) {
    CollisionJNI.btGjkPairDetector_getClosestPoints__SWIG_1(
        swigCPtr,
        this,
        btDiscreteCollisionDetectorInterface.ClosestPointInput.getCPtr(input),
        input,
  ...
  public void getClosestPointsNonVirtual(
      ...
      btDiscreteCollisionDetectorInterface.Result output,
      btIDebugDraw debugDraw) {
    CollisionJNI.btGjkPairDetector_getClosestPointsNonVirtual(
        swigCPtr,
        this,
        btDiscreteCollisionDetectorInterface.ClosestPointInput.getCPtr(input),
        input,
  ...
  public void setMinkowskiA(btConvexShape minkA) {
    CollisionJNI.btGjkPairDetector_setMinkowskiA(
        swigCPtr, this, btConvexShape.getCPtr(minkA), minkA);
  }

  public void setMinkowskiB(btConvexShape minkB) {
    CollisionJNI.btGjkPairDetector_setMinkowskiB(
        swigCPtr, this, btConvexShape.getCPtr(minkB), minkB);
  }
  ...
  public void setPenetrationDepthSolver(btConvexPenetrationDepthSolver penetrationDepthSolver) {
    CollisionJNI.btGjkPairDetector_setPenetrationDepthSolver(
        swigCPtr,
        this,
        btConvexPenetrationDepthSolver.getCPtr(penetrationDepthSolver),
        penetrationDepthSolver);
