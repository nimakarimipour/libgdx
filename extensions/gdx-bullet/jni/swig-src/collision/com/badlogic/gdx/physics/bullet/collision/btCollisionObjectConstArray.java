...
public class btCollisionObjectConstArray extends BulletBase {
  ...
  /**
   * Construct a new btCollisionObjectConstArray, normally you should not need this constructor it's
  ...
  public btCollisionObjectConstArray operatorAssignment(btCollisionObjectConstArray other) {
    return new btCollisionObjectConstArray(
        CollisionJNI.btCollisionObjectConstArray_operatorAssignment(
            swigCPtr, this, btCollisionObjectConstArray.getCPtr(other), other),
        false);
  }
  ...
  public btCollisionObjectConstArray(btCollisionObjectConstArray otherArray) {
    this(
        CollisionJNI.new_btCollisionObjectConstArray__SWIG_1(
            btCollisionObjectConstArray.getCPtr(otherArray), otherArray),
        true);
  }
  ...
  public btCollisionObject atConst(int n) {
    return btCollisionObject.getInstance(
        CollisionJNI.btCollisionObjectConstArray_atConst(swigCPtr, this, n), false);
  }

  public SWIGTYPE_p_p_btCollisionObject at(int n) {
    return new SWIGTYPE_p_p_btCollisionObject(
        CollisionJNI.btCollisionObjectConstArray_at(swigCPtr, this, n), false);
  }

  public btCollisionObject operatorSubscriptConst(int n) {
    return btCollisionObject.getInstance(
        CollisionJNI.btCollisionObjectConstArray_operatorSubscriptConst(swigCPtr, this, n), false);
  }

  public SWIGTYPE_p_p_btCollisionObject operatorSubscript(int n) {
    return new SWIGTYPE_p_p_btCollisionObject(
        CollisionJNI.btCollisionObjectConstArray_operatorSubscript(swigCPtr, this, n), false);
  }
  ...
  public void resize(int newsize, btCollisionObject fillData) {
    CollisionJNI.btCollisionObjectConstArray_resize__SWIG_0(
        swigCPtr, this, newsize, btCollisionObject.getCPtr(fillData), fillData);
  }
  ...
  public SWIGTYPE_p_p_btCollisionObject expandNonInitializing() {
    return new SWIGTYPE_p_p_btCollisionObject(
        CollisionJNI.btCollisionObjectConstArray_expandNonInitializing(swigCPtr, this), false);
  }

  public SWIGTYPE_p_p_btCollisionObject expand(btCollisionObject fillValue) {
    return new SWIGTYPE_p_p_btCollisionObject(
        CollisionJNI.btCollisionObjectConstArray_expand__SWIG_0(
            swigCPtr, this, btCollisionObject.getCPtr(fillValue), fillValue),
        false);
  }

  public SWIGTYPE_p_p_btCollisionObject expand() {
    return new SWIGTYPE_p_p_btCollisionObject(
        CollisionJNI.btCollisionObjectConstArray_expand__SWIG_1(swigCPtr, this), false);
  }

  public void push_back(btCollisionObject _Val) {
    CollisionJNI.btCollisionObjectConstArray_push_back(
        swigCPtr, this, btCollisionObject.getCPtr(_Val), _Val);
  }
  ...
  public static class less extends BulletBase {
    ...
    /**
     * Construct a new less, normally you should not need this constructor it's intended for
     * low-level usage.
     */
    ...
    public boolean operatorFunctionCall(btCollisionObject a, btCollisionObject b) {
      return CollisionJNI.btCollisionObjectConstArray_less_operatorFunctionCall(
          swigCPtr, this, btCollisionObject.getCPtr(a), a, btCollisionObject.getCPtr(b), b);
    }
  ...
  public int findBinarySearch(btCollisionObject key) {
    return CollisionJNI.btCollisionObjectConstArray_findBinarySearch(
        swigCPtr, this, btCollisionObject.getCPtr(key), key);
  }

  public int findLinearSearch(btCollisionObject key) {
    return CollisionJNI.btCollisionObjectConstArray_findLinearSearch(
        swigCPtr, this, btCollisionObject.getCPtr(key), key);
  }

  public int findLinearSearch2(btCollisionObject key) {
    return CollisionJNI.btCollisionObjectConstArray_findLinearSearch2(
        swigCPtr, this, btCollisionObject.getCPtr(key), key);
  }
  ...
  public void remove(btCollisionObject key) {
    CollisionJNI.btCollisionObjectConstArray_remove(
        swigCPtr, this, btCollisionObject.getCPtr(key), key);
  }

  public void initializeFromBuffer(long buffer, int size, int capacity) {
    CollisionJNI.btCollisionObjectConstArray_initializeFromBuffer(
        swigCPtr, this, buffer, size, capacity);
  }

  public void copyFromArray(btCollisionObjectConstArray otherArray) {
    CollisionJNI.btCollisionObjectConstArray_copyFromArray(
        swigCPtr, this, btCollisionObjectConstArray.getCPtr(otherArray), otherArray);
  }
}
