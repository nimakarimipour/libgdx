...
public class btAxisSweep3 extends btAxisSweep3InternalShort {
  ...
  /**
   * Construct a new btAxisSweep3, normally you should not need this constructor it's intended for
   * low-level usage.
   */
  ...
  public btAxisSweep3(
    ...
    this(
        CollisionJNI.new_btAxisSweep3__SWIG_0(
            worldAabbMin,
            worldAabbMax,
            maxHandles,
  ...
  public btAxisSweep3(
      ...
      btOverlappingPairCache pairCache) {
    this(
        CollisionJNI.new_btAxisSweep3__SWIG_1(
            worldAabbMin,
            worldAabbMax,
            maxHandles,
            btOverlappingPairCache.getCPtr(pairCache),
