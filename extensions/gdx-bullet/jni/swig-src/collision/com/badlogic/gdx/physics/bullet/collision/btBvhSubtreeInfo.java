...
public class btBvhSubtreeInfo extends BulletBase {
  ...
  /**
   * Construct a new btBvhSubtreeInfo, normally you should not need this constructor it's intended
   * for low-level usage.
   */
  ...
  public void setAabbFromQuantizeNode(btQuantizedBvhNode quantizedNode) {
    CollisionJNI.btBvhSubtreeInfo_setAabbFromQuantizeNode(
        swigCPtr, this, btQuantizedBvhNode.getCPtr(quantizedNode), quantizedNode);
  }
}
