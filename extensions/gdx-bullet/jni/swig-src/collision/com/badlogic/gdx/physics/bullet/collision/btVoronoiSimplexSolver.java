...
public class btVoronoiSimplexSolver extends BulletBase {
  ...
  /**
   * Construct a new btVoronoiSimplexSolver, normally you should not need this constructor it's
  ...
  public long operatorNewArray(long sizeInBytes) {
    return CollisionJNI.btVoronoiSimplexSolver_operatorNewArray__SWIG_0(
  ...
  public void setSimplexVectorW(btVector3 value) {
    CollisionJNI.btVoronoiSimplexSolver_simplexVectorW_set(
  ...
  public void setSimplexPointsP(btVector3 value) {
    CollisionJNI.btVoronoiSimplexSolver_simplexPointsP_set(
        swigCPtr, this, btVector3.getCPtr(value), value);
  }
  ...
  public void setSimplexPointsQ(btVector3 value) {
    CollisionJNI.btVoronoiSimplexSolver_simplexPointsQ_set(
        swigCPtr, this, btVector3.getCPtr(value), value);
  }
  ...
  public void setCachedP1(btVector3 value) {
    CollisionJNI.btVoronoiSimplexSolver_cachedP1_set(
        swigCPtr, this, btVector3.getCPtr(value), value);
  }
  ...
  public void setCachedP2(btVector3 value) {
    CollisionJNI.btVoronoiSimplexSolver_cachedP2_set(
        swigCPtr, this, btVector3.getCPtr(value), value);
  }
  ...
  public void setCachedV(btVector3 value) {
    CollisionJNI.btVoronoiSimplexSolver_cachedV_set(
        swigCPtr, this, btVector3.getCPtr(value), value);
  }
  ...
  public void setCachedBC(btSubSimplexClosestResult value) {
    CollisionJNI.btVoronoiSimplexSolver_cachedBC_set(
        swigCPtr, this, btSubSimplexClosestResult.getCPtr(value), value);
  }
  ...
  public void reduceVertices(btUsageBitfield usedVerts) {
    CollisionJNI.btVoronoiSimplexSolver_reduceVertices(
        swigCPtr, this, btUsageBitfield.getCPtr(usedVerts), usedVerts);
  }
  ...
  public boolean closestPtPointTetrahedron(
    ...
    return CollisionJNI.btVoronoiSimplexSolver_closestPtPointTetrahedron(
        swigCPtr, this, p, a, b, c, d, btSubSimplexClosestResult.getCPtr(finalResult), finalResult);
  }
  ...
  public boolean closestPtPointTriangle(
      Vector3 p, Vector3 a, Vector3 b, Vector3 c, btSubSimplexClosestResult result) {
    return CollisionJNI.btVoronoiSimplexSolver_closestPtPointTriangle(
        swigCPtr, this, p, a, b, c, btSubSimplexClosestResult.getCPtr(result), result);
  }
  ...
  public int getSimplex(btVector3 pBuf, btVector3 qBuf, btVector3 yBuf) {
    return CollisionJNI.btVoronoiSimplexSolver_getSimplex(
        swigCPtr,
        this,
        btVector3.getCPtr(pBuf),
        pBuf,
        btVector3.getCPtr(qBuf),
        qBuf,
        btVector3.getCPtr(yBuf),
        yBuf);
  }
