...
public class btPersistentManifold extends btTypedObject {
  ...
  /**
   * Construct a new btPersistentManifold, normally you should not need this constructor it's
  ...
  public btPersistentManifold(
    ...
    this(
        CollisionJNI.new_btPersistentManifold__SWIG_1(
            btCollisionObject.getCPtr(body0),
            body0,
            btCollisionObject.getCPtr(body1),
            body1,
            arg2,
  ...
  public btCollisionObject getBody0() {
    return btCollisionObject.getInstance(
        CollisionJNI.btPersistentManifold_getBody0(swigCPtr, this), false);
  }

  public btCollisionObject getBody1() {
    return btCollisionObject.getInstance(
        CollisionJNI.btPersistentManifold_getBody1(swigCPtr, this), false);
  }

  public void setBodies(btCollisionObject body0, btCollisionObject body1) {
    CollisionJNI.btPersistentManifold_setBodies(
        swigCPtr,
        this,
        btCollisionObject.getCPtr(body0),
        body0,
  ...
  public void clearUserCache(btManifoldPoint pt) {
    CollisionJNI.btPersistentManifold_clearUserCache(
        swigCPtr, this, btManifoldPoint.getCPtr(pt), pt);
  }
  ...
  public btManifoldPoint getContactPointConst(int index) {
    return new btManifoldPoint(
        CollisionJNI.btPersistentManifold_getContactPointConst(swigCPtr, this, index), false);
  }

  public btManifoldPoint getContactPoint(int index) {
    return new btManifoldPoint(
        CollisionJNI.btPersistentManifold_getContactPoint(swigCPtr, this, index), false);
  }
  ...
  public void setContactBreakingThreshold(float contactBreakingThreshold) {
    CollisionJNI.btPersistentManifold_setContactBreakingThreshold(
        swigCPtr, this, contactBreakingThreshold);
  }

  public void setContactProcessingThreshold(float contactProcessingThreshold) {
    CollisionJNI.btPersistentManifold_setContactProcessingThreshold(
        swigCPtr, this, contactProcessingThreshold);
  }

  public int getCacheEntry(btManifoldPoint newPoint) {
    return CollisionJNI.btPersistentManifold_getCacheEntry(
        swigCPtr, this, btManifoldPoint.getCPtr(newPoint), newPoint);
  }

  public int addManifoldPoint(btManifoldPoint newPoint, boolean isPredictive) {
    return CollisionJNI.btPersistentManifold_addManifoldPoint__SWIG_0(
        swigCPtr, this, btManifoldPoint.getCPtr(newPoint), newPoint, isPredictive);
  }

  public int addManifoldPoint(btManifoldPoint newPoint) {
    return CollisionJNI.btPersistentManifold_addManifoldPoint__SWIG_1(
        swigCPtr, this, btManifoldPoint.getCPtr(newPoint), newPoint);
  }
  ...
  public void replaceContactPoint(btManifoldPoint newPoint, int insertIndex) {
    CollisionJNI.btPersistentManifold_replaceContactPoint(
        swigCPtr, this, btManifoldPoint.getCPtr(newPoint), newPoint, insertIndex);
  }

  public boolean validContactDistance(btManifoldPoint pt) {
    return CollisionJNI.btPersistentManifold_validContactDistance(
        swigCPtr, this, btManifoldPoint.getCPtr(pt), pt);
  }
