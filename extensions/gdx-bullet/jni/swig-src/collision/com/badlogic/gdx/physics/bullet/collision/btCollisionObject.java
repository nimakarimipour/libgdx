...
public class btCollisionObject extends BulletBase implements com.badlogic.gdx.utils.Disposable {
  ...
  /**
   * Construct a new btCollisionObject, normally you should not need this constructor it's intended
   * for low-level usage.
   */
  ...
  public static final com.badlogic.gdx.utils.LongMap<btCollisionObject> instances =
      new com.badlogic.gdx.utils.LongMap<btCollisionObject>();
  ...
  /**
   * @return A user definable value set using {@link #setUserValue(int)}, intended to quickly
  ...
  /**
   * @return The filter (default to 0) that is used to match the flag of the other object for a
   *     contact callback to be triggered
   */
  ...
  public void setAnisotropicFriction(Vector3 anisotropicFriction, int frictionMode) {
    CollisionJNI.btCollisionObject_setAnisotropicFriction__SWIG_0(
        swigCPtr, this, anisotropicFriction, frictionMode);
  }

  public void setAnisotropicFriction(Vector3 anisotropicFriction) {
    CollisionJNI.btCollisionObject_setAnisotropicFriction__SWIG_1(
        swigCPtr, this, anisotropicFriction);
  }

  public boolean hasAnisotropicFriction(int frictionMode) {
    return CollisionJNI.btCollisionObject_hasAnisotropicFriction__SWIG_0(
        swigCPtr, this, frictionMode);
  }
  ...
  public void setContactProcessingThreshold(float contactProcessingThreshold) {
    CollisionJNI.btCollisionObject_setContactProcessingThreshold(
  ...
  private void internalSetCollisionShape(btCollisionShape collisionShape) {
    CollisionJNI.btCollisionObject_internalSetCollisionShape(
        swigCPtr, this, btCollisionShape.getCPtr(collisionShape), collisionShape);
  }
  ...
  public void setIgnoreCollisionCheck(btCollisionObject co, boolean ignoreCollisionCheck) {
    CollisionJNI.btCollisionObject_setIgnoreCollisionCheck(
        swigCPtr, this, btCollisionObject.getCPtr(co), co, ignoreCollisionCheck);
  }

  public boolean checkCollideWithOverride(btCollisionObject co) {
    return CollisionJNI.btCollisionObject_checkCollideWithOverride(
        swigCPtr, this, btCollisionObject.getCPtr(co), co);
  }
  ...
  public void setContactStiffnessAndDamping(float stiffness, float damping) {
    CollisionJNI.btCollisionObject_setContactStiffnessAndDamping(
        swigCPtr, this, stiffness, damping);
  }
  ...
  public btBroadphaseProxy getBroadphaseHandle() {
    return btBroadphaseProxy.internalTemp(
        CollisionJNI.btCollisionObject_getBroadphaseHandle__SWIG_0(swigCPtr, this), false);
  }

  public void setBroadphaseHandle(btBroadphaseProxy handle) {
    CollisionJNI.btCollisionObject_setBroadphaseHandle(
        swigCPtr, this, btBroadphaseProxy.getCPtr(handle), handle);
  }
  ...
  public boolean checkCollideWith(btCollisionObject co) {
    return CollisionJNI.btCollisionObject_checkCollideWith(
        swigCPtr, this, btCollisionObject.getCPtr(co), co);
  }
  ...
  public void serializeSingleObject(btSerializer serializer) {
    CollisionJNI.btCollisionObject_serializeSingleObject(
