...
public class btConvexHullShapeData extends BulletBase {
  ...
  /**
   * Construct a new btConvexHullShapeData, normally you should not need this constructor it's
  ...
  public void setConvexInternalShapeData(btConvexInternalShapeData value) {
    CollisionJNI.btConvexHullShapeData_convexInternalShapeData_set(
        swigCPtr, this, btConvexInternalShapeData.getCPtr(value), value);
  }
  ...
  public void setUnscaledPointsFloatPtr(btVector3FloatData value) {
    CollisionJNI.btConvexHullShapeData_unscaledPointsFloatPtr_set(
  ...
  public void setUnscaledPointsDoublePtr(btVector3DoubleData value) {
    CollisionJNI.btConvexHullShapeData_unscaledPointsDoublePtr_set(
