...
public class btConvexConcaveCollisionAlgorithm extends btActivatingCollisionAlgorithm {
  ...
  /**
   * Construct a new btConvexConcaveCollisionAlgorithm, normally you should not need this
  ...
  protected void reset(long cPtr, boolean cMemoryOwn) {
    ...
    super.reset(
        CollisionJNI.btConvexConcaveCollisionAlgorithm_SWIGUpcast(swigCPtr = cPtr), cMemoryOwn);
  }
  ...
  public long operatorNew(long sizeInBytes) {
    return CollisionJNI.btConvexConcaveCollisionAlgorithm_operatorNew__SWIG_0(
  ...
  public long operatorNew(long arg0, long ptr) {
    return CollisionJNI.btConvexConcaveCollisionAlgorithm_operatorNew__SWIG_1(
        swigCPtr, this, arg0, ptr);
  }

  public void operatorDelete(long arg0, long arg1) {
    CollisionJNI.btConvexConcaveCollisionAlgorithm_operatorDelete__SWIG_1(
        swigCPtr, this, arg0, arg1);
  }

  public long operatorNewArray(long sizeInBytes) {
    return CollisionJNI.btConvexConcaveCollisionAlgorithm_operatorNewArray__SWIG_0(
        swigCPtr, this, sizeInBytes);
  }
  ...
  public long operatorNewArray(long arg0, long ptr) {
    return CollisionJNI.btConvexConcaveCollisionAlgorithm_operatorNewArray__SWIG_1(
        swigCPtr, this, arg0, ptr);
  }

  public void operatorDeleteArray(long arg0, long arg1) {
    CollisionJNI.btConvexConcaveCollisionAlgorithm_operatorDeleteArray__SWIG_1(
        swigCPtr, this, arg0, arg1);
  }
  ...
  public btConvexConcaveCollisionAlgorithm(
      ...
      boolean isSwapped) {
    this(
        CollisionJNI.new_btConvexConcaveCollisionAlgorithm(
  ...
  public static class CreateFunc extends btCollisionAlgorithmCreateFunc {
    ...
    protected CreateFunc(final String className, long cPtr, boolean cMemoryOwn) {
      super(
          className,
          CollisionJNI.btConvexConcaveCollisionAlgorithm_CreateFunc_SWIGUpcast(cPtr),
          cMemoryOwn);
      swigCPtr = cPtr;
    }
    ...
    protected void reset(long cPtr, boolean cMemoryOwn) {
      if (!destroyed) destroy();
      super.reset(
          CollisionJNI.btConvexConcaveCollisionAlgorithm_CreateFunc_SWIGUpcast(swigCPtr = cPtr),
          cMemoryOwn);
    }
  ...
  public static class SwappedCreateFunc extends btCollisionAlgorithmCreateFunc {
    ...
    protected SwappedCreateFunc(final String className, long cPtr, boolean cMemoryOwn) {
      super(
          className,
          CollisionJNI.btConvexConcaveCollisionAlgorithm_SwappedCreateFunc_SWIGUpcast(cPtr),
          cMemoryOwn);
      swigCPtr = cPtr;
    }

    /**
     * Construct a new SwappedCreateFunc, normally you should not need this constructor it's
    ...
    protected void reset(long cPtr, boolean cMemoryOwn) {
      if (!destroyed) destroy();
      super.reset(
          CollisionJNI.btConvexConcaveCollisionAlgorithm_SwappedCreateFunc_SWIGUpcast(
              swigCPtr = cPtr),
          cMemoryOwn);
    }
