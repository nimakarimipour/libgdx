...
public class btSimulationIslandManager extends BulletBase {
  ...
  /**
   * Construct a new btSimulationIslandManager, normally you should not need this constructor it's
  ...
  public btUnionFind getUnionFind() {
    return new btUnionFind(
        CollisionJNI.btSimulationIslandManager_getUnionFind(swigCPtr, this), false);
  }

  public void updateActivationState(btCollisionWorld colWorld, btDispatcher dispatcher) {
    CollisionJNI.btSimulationIslandManager_updateActivationState(
        swigCPtr,
        this,
  ...
  public void storeIslandActivationState(btCollisionWorld world) {
    CollisionJNI.btSimulationIslandManager_storeIslandActivationState(
        swigCPtr, this, btCollisionWorld.getCPtr(world), world);
  }

  public void findUnions(btDispatcher dispatcher, btCollisionWorld colWorld) {
    CollisionJNI.btSimulationIslandManager_findUnions(
        swigCPtr,
        this,
        btDispatcher.getCPtr(dispatcher),
        dispatcher,
  ...
  public static class IslandCallback extends BulletBase {
    ...
    public void processIsland(
        ...
        int numManifolds,
        int islandId) {
      CollisionJNI.btSimulationIslandManager_IslandCallback_processIsland(
          swigCPtr,
          this,
  ...
  public void buildAndProcessIslands(
    ...
    CollisionJNI.btSimulationIslandManager_buildAndProcessIslands(
        swigCPtr,
        this,
        btDispatcher.getCPtr(dispatcher),
        dispatcher,
        ...
        collisionWorld,
        btSimulationIslandManager.IslandCallback.getCPtr(callback),
        callback);
  }

  public void buildIslands(btDispatcher dispatcher, btCollisionWorld colWorld) {
    CollisionJNI.btSimulationIslandManager_buildIslands(
        swigCPtr,
        this,
        btDispatcher.getCPtr(dispatcher),
        dispatcher,
