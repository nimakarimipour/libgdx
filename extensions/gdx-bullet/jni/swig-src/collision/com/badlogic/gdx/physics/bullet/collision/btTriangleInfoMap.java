...
public class btTriangleInfoMap extends btHashMapInternalShortBtHashIntBtTriangleInfo {
  ...
  /**
   * Construct a new btTriangleInfoMap, normally you should not need this constructor it's intended
   * for low-level usage.
   */
  ...
  public String serialize(long dataBuffer, btSerializer serializer) {
    return CollisionJNI.btTriangleInfoMap_serialize(
        swigCPtr, this, dataBuffer, btSerializer.getCPtr(serializer), serializer);
  }

  public void deSerialize(btTriangleInfoMapData data) {
    CollisionJNI.btTriangleInfoMap_deSerialize(
        swigCPtr, this, btTriangleInfoMapData.getCPtr(data), data);
  }
}
