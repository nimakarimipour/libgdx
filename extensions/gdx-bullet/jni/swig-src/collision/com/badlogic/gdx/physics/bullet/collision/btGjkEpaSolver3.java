...
public class btGjkEpaSolver3 extends BulletBase {
  ...
  /**
   * Construct a new btGjkEpaSolver3, normally you should not need this constructor it's intended
   * for low-level usage.
   */
  ...
  public static class sResults extends BulletBase {
    ...
    public void setWitnesses(btVector3 value) {
      CollisionJNI.btGjkEpaSolver3_sResults_witnesses_set(
    ...
    public void setNormal(btVector3 value) {
      CollisionJNI.btGjkEpaSolver3_sResults_normal_set(
          swigCPtr, this, btVector3.getCPtr(value), value);
    }
