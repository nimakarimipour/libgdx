...
public class btCompoundCollisionAlgorithm extends btActivatingCollisionAlgorithm {
  ...
  /**
   * Construct a new btCompoundCollisionAlgorithm, normally you should not need this constructor
  ...
  public btCompoundCollisionAlgorithm(
      ...
      boolean isSwapped) {
    this(
        CollisionJNI.new_btCompoundCollisionAlgorithm(
  ...
  public static class CreateFunc extends btCollisionAlgorithmCreateFunc {
    ...
    protected CreateFunc(final String className, long cPtr, boolean cMemoryOwn) {
      super(
          className,
          CollisionJNI.btCompoundCollisionAlgorithm_CreateFunc_SWIGUpcast(cPtr),
          cMemoryOwn);
      swigCPtr = cPtr;
    }
    ...
    protected void reset(long cPtr, boolean cMemoryOwn) {
      if (!destroyed) destroy();
      super.reset(
          CollisionJNI.btCompoundCollisionAlgorithm_CreateFunc_SWIGUpcast(swigCPtr = cPtr),
          cMemoryOwn);
    }
  ...
  public static class SwappedCreateFunc extends btCollisionAlgorithmCreateFunc {
    ...
    protected SwappedCreateFunc(final String className, long cPtr, boolean cMemoryOwn) {
      super(
          className,
          CollisionJNI.btCompoundCollisionAlgorithm_SwappedCreateFunc_SWIGUpcast(cPtr),
          cMemoryOwn);
      swigCPtr = cPtr;
    }
    ...
    protected void reset(long cPtr, boolean cMemoryOwn) {
      if (!destroyed) destroy();
      super.reset(
          CollisionJNI.btCompoundCollisionAlgorithm_SwappedCreateFunc_SWIGUpcast(swigCPtr = cPtr),
          cMemoryOwn);
    }
