...
public class btCompoundShapeChildData extends BulletBase {
  ...
  /**
   * Construct a new btCompoundShapeChildData, normally you should not need this constructor it's
  ...
  public void setTransform(btTransformFloatData value) {
    CollisionJNI.btCompoundShapeChildData_transform_set(
  ...
  public void setChildShape(btCollisionShapeData value) {
    CollisionJNI.btCompoundShapeChildData_childShape_set(
