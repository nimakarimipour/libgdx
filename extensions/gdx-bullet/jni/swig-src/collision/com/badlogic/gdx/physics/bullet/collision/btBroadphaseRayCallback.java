...
public class btBroadphaseRayCallback extends btBroadphaseAabbCallback {
  ...
  /**
   * Construct a new btBroadphaseRayCallback, normally you should not need this constructor it's
  ...
  public void setRayDirectionInverse(btVector3 value) {
    CollisionJNI.btBroadphaseRayCallback_rayDirectionInverse_set(
