...
public class btSphereBoxCollisionAlgorithm extends btActivatingCollisionAlgorithm {
  ...
  /**
   * Construct a new btSphereBoxCollisionAlgorithm, normally you should not need this constructor
  ...
  public btSphereBoxCollisionAlgorithm(
      ...
      boolean isSwapped) {
    this(
        CollisionJNI.new_btSphereBoxCollisionAlgorithm(
  ...
  public boolean getSphereDistance(
    ...
    return CollisionJNI.btSphereBoxCollisionAlgorithm_getSphereDistance(
        swigCPtr,
        this,
        btCollisionObjectWrapper.getCPtr(boxObjWrap),
        boxObjWrap,
        v3PointOnBox,
        normal,
        SWIGTYPE_p_float.getCPtr(penetrationDepth),
        v3SphereCenter,
        fRadius,
        maxContactDistance);
  }
  ...
  public float getSpherePenetration(
      Vector3 boxHalfExtent, Vector3 sphereRelPos, Vector3 closestPoint, Vector3 normal) {
    return CollisionJNI.btSphereBoxCollisionAlgorithm_getSpherePenetration(
        swigCPtr, this, boxHalfExtent, sphereRelPos, closestPoint, normal);
  }
  ...
  public static class CreateFunc extends btCollisionAlgorithmCreateFunc {
    ...
    protected CreateFunc(final String className, long cPtr, boolean cMemoryOwn) {
      super(
          className,
          CollisionJNI.btSphereBoxCollisionAlgorithm_CreateFunc_SWIGUpcast(cPtr),
          cMemoryOwn);
      swigCPtr = cPtr;
    }
    ...
    protected void reset(long cPtr, boolean cMemoryOwn) {
      if (!destroyed) destroy();
      super.reset(
          CollisionJNI.btSphereBoxCollisionAlgorithm_CreateFunc_SWIGUpcast(swigCPtr = cPtr),
          cMemoryOwn);
    }
