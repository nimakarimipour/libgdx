...
public class btConvexShape extends btCollisionShape {
  ...
  /**
   * Construct a new btConvexShape, normally you should not need this constructor it's intended for
   * low-level usage.
   */
  ...
  public Vector3 localGetSupportVertexWithoutMarginNonVirtual(Vector3 vec) {
    return CollisionJNI.btConvexShape_localGetSupportVertexWithoutMarginNonVirtual(
        swigCPtr, this, vec);
  }
  ...
  public void project(
      ...
      Vector3 witnesPtMin,
      Vector3 witnesPtMax) {
    CollisionJNI.btConvexShape_project(
        swigCPtr,
        this,
        trans,
        dir,
        SWIGTYPE_p_float.getCPtr(minProj),
        SWIGTYPE_p_float.getCPtr(maxProj),
        witnesPtMin,
        witnesPtMax);
  }
  ...
  public void batchedUnitVectorGetSupportingVertexWithoutMargin(
    ...
    CollisionJNI.btConvexShape_batchedUnitVectorGetSupportingVertexWithoutMargin(
        swigCPtr,
        this,
        btVector3.getCPtr(vectors),
        vectors,
        btVector3.getCPtr(supportVerticesOut),
        supportVerticesOut,
        numVectors);
  }
  ...
  public void getPreferredPenetrationDirection(int index, Vector3 penetrationVector) {
    CollisionJNI.btConvexShape_getPreferredPenetrationDirection(
        swigCPtr, this, index, penetrationVector);
  }
}
