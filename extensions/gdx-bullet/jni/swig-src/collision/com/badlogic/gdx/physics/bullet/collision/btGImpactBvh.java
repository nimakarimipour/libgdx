...
public class btGImpactBvh extends BulletBase {
  ...
  /**
   * Construct a new btGImpactBvh, normally you should not need this constructor it's intended for
   * low-level usage.
   */
  ...
  public btGImpactBvh(btPrimitiveManagerBase primitive_manager) {
    this(
        CollisionJNI.new_btGImpactBvh__SWIG_1(
  ...
  public void setPrimitiveManager(btPrimitiveManagerBase primitive_manager) {
    CollisionJNI.btGImpactBvh_setPrimitiveManager(
  ...
  public boolean boxQuery(btAABB box, SWIGTYPE_p_btAlignedObjectArrayT_int_t collided_results) {
    return CollisionJNI.btGImpactBvh_boxQuery(
        swigCPtr,
        this,
        btAABB.getCPtr(box),
        box,
  ...
  public boolean boxQueryTrans(
    ...
    return CollisionJNI.btGImpactBvh_boxQueryTrans(
        swigCPtr,
        this,
        btAABB.getCPtr(box),
        box,
  ...
  public boolean rayQuery(
    ...
    return CollisionJNI.btGImpactBvh_rayQuery(
        swigCPtr,
        this,
        ray_dir,
        ray_origin,
  ...
  public void getNodeTriangle(int nodeindex, btPrimitiveTriangle triangle) {
    CollisionJNI.btGImpactBvh_getNodeTriangle(
  ...
  public static void find_collision(
    ...
    CollisionJNI.btGImpactBvh_find_collision(
        btGImpactBvh.getCPtr(boxset1),
        boxset1,
        trans1,
        btGImpactBvh.getCPtr(boxset2),
        boxset2,
        trans2,
