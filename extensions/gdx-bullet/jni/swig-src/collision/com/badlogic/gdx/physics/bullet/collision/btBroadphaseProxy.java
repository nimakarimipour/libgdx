...
public class btBroadphaseProxy extends BulletBase {
  ...
  /**
   * Construct a new btBroadphaseProxy, normally you should not need this constructor it's intended
   * for low-level usage.
   */
  ...
  protected static final com.badlogic.gdx.utils.Pool<btBroadphaseProxy> pool =
      new com.badlogic.gdx.utils.Pool<btBroadphaseProxy>() {
        @Override
  ...
  public btBroadphaseProxy(
    ...
    this(
        CollisionJNI.new_btBroadphaseProxy__SWIG_1(
