...
public class btCollisionDispatcherMt extends btCollisionDispatcher {
  ...
  /**
   * Construct a new btCollisionDispatcherMt, normally you should not need this constructor it's
  ...
  public btCollisionDispatcherMt(btCollisionConfiguration config, int grainSize) {
    this(
        CollisionJNI.new_btCollisionDispatcherMt__SWIG_0(
            btCollisionConfiguration.getCPtr(config), config, grainSize),
        true);
  }

  public btCollisionDispatcherMt(btCollisionConfiguration config) {
    this(
        CollisionJNI.new_btCollisionDispatcherMt__SWIG_1(
            btCollisionConfiguration.getCPtr(config), config),
        true);
  }
}
