...
public class btCompoundShapeChild extends BulletBase {
  ...
  /**
   * Construct a new btCompoundShapeChild, normally you should not need this constructor it's
  ...
  public void setTransform(btTransform value) {
    CollisionJNI.btCompoundShapeChild_transform_set(
  ...
  public void setChildShape(btCollisionShape value) {
    CollisionJNI.btCompoundShapeChild_childShape_set(
  ...
  public btDbvtNode getNode() {
    return btDbvtNode.internalTemp(
        CollisionJNI.btCompoundShapeChild_node_get(swigCPtr, this), false);
  }
