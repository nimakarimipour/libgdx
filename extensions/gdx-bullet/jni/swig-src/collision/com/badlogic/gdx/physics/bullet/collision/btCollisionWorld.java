...
public class btCollisionWorld extends BulletBase {
  ...
  /**
   * Construct a new btCollisionWorld, normally you should not need this constructor it's intended
   * for low-level usage.
   */
  ...
  public btCollisionWorld(
    ...
    this(
        CollisionJNI.new_btCollisionWorld(
            btDispatcher.getCPtr(dispatcher),
            dispatcher,
            btBroadphaseInterface.getCPtr(broadphasePairCache),
            broadphasePairCache,
            btCollisionConfiguration.getCPtr(collisionConfiguration),
            collisionConfiguration),
        true);
  }

  public void setBroadphase(btBroadphaseInterface pairCache) {
    CollisionJNI.btCollisionWorld_setBroadphase(
  ...
  public void updateSingleAabb(btCollisionObject colObj) {
    CollisionJNI.btCollisionWorld_updateSingleAabb(
        swigCPtr, this, btCollisionObject.getCPtr(colObj), colObj);
  }
  ...
  public void setDebugDrawer(btIDebugDraw debugDrawer) {
    CollisionJNI.btCollisionWorld_setDebugDrawer(
        swigCPtr, this, btIDebugDraw.getCPtr(debugDrawer), debugDrawer);
  }
  ...
  public void debugDrawObject(Matrix4 worldTransform, btCollisionShape shape, Vector3 color) {
    CollisionJNI.btCollisionWorld_debugDrawObject(
        swigCPtr, this, worldTransform, btCollisionShape.getCPtr(shape), shape, color);
  }
  ...
  public void convexSweepTest(
    ...
    CollisionJNI.btCollisionWorld_convexSweepTest__SWIG_0(
        swigCPtr,
        this,
        btConvexShape.getCPtr(castShape),
        castShape,
        from,
        to,
        ConvexResultCallback.getCPtr(resultCallback),
        resultCallback,
        allowedCcdPenetration);
  }

  public void convexSweepTest(
      btConvexShape castShape, Matrix4 from, Matrix4 to, ConvexResultCallback resultCallback) {
    CollisionJNI.btCollisionWorld_convexSweepTest__SWIG_1(
        swigCPtr,
        this,
        btConvexShape.getCPtr(castShape),
        castShape,
  ...
  public void contactPairTest(
      btCollisionObject colObjA, btCollisionObject colObjB, ContactResultCallback resultCallback) {
    CollisionJNI.btCollisionWorld_contactPairTest(
        swigCPtr,
        this,
        btCollisionObject.getCPtr(colObjA),
        colObjA,
        btCollisionObject.getCPtr(colObjB),
        colObjB,
        ContactResultCallback.getCPtr(resultCallback),
        resultCallback);
  }
  ...
  public static void objectQuerySingle(
    ...
    CollisionJNI.btCollisionWorld_objectQuerySingle(
        btConvexShape.getCPtr(castShape),
        castShape,
        rayFromTrans,
        rayToTrans,
  ...
  public static void objectQuerySingleInternal(
      ...
      ConvexResultCallback resultCallback,
      float allowedPenetration) {
    CollisionJNI.btCollisionWorld_objectQuerySingleInternal(
        btConvexShape.getCPtr(castShape),
        castShape,
        convexFromTrans,
        convexToTrans,
  ...
  public void addCollisionObject(
    ...
    CollisionJNI.btCollisionWorld_addCollisionObject__SWIG_0(
        swigCPtr,
        this,
        btCollisionObject.getCPtr(collisionObject),
        collisionObject,
  ...
  public void addCollisionObject(btCollisionObject collisionObject) {
    CollisionJNI.btCollisionWorld_addCollisionObject__SWIG_2(
        swigCPtr, this, btCollisionObject.getCPtr(collisionObject), collisionObject);
  }

  public btCollisionObjectArray getCollisionObjectArray() {
    return new btCollisionObjectArray(
        CollisionJNI.btCollisionWorld_getCollisionObjectArray(swigCPtr, this), false);
  }

  public btCollisionObjectArray getCollisionObjectArrayConst() {
    return new btCollisionObjectArray(
        CollisionJNI.btCollisionWorld_getCollisionObjectArrayConst(swigCPtr, this), false);
  }

  public void removeCollisionObject(btCollisionObject collisionObject) {
    CollisionJNI.btCollisionWorld_removeCollisionObject(
        swigCPtr, this, btCollisionObject.getCPtr(collisionObject), collisionObject);
  }
  ...
  public btDispatcherInfo getDispatchInfo() {
    return new btDispatcherInfo(
        CollisionJNI.btCollisionWorld_getDispatchInfo(swigCPtr, this), false);
  }

  public btDispatcherInfo getDispatchInfoConst() {
    return new btDispatcherInfo(
        CollisionJNI.btCollisionWorld_getDispatchInfoConst(swigCPtr, this), false);
  }
  ...
  public void serialize(btSerializer serializer) {
    CollisionJNI.btCollisionWorld_serialize(
