...
public class btGimContactArray extends BulletBase {
  ...
  /**
   * Construct a new btGimContactArray, normally you should not need this constructor it's intended
   * for low-level usage.
   */
  ...
  public btGimContactArray operatorAssignment(btGimContactArray other) {
    return new btGimContactArray(
        CollisionJNI.btGimContactArray_operatorAssignment(
            swigCPtr, this, btGimContactArray.getCPtr(other), other),
        false);
  }
  ...
  public btGimContactArray(btGimContactArray otherArray) {
    this(
        CollisionJNI.new_btGimContactArray__SWIG_1(
            btGimContactArray.getCPtr(otherArray), otherArray),
        true);
  }
  ...
  public GIM_CONTACT operatorSubscriptConst(int n) {
    return new GIM_CONTACT(
        CollisionJNI.btGimContactArray_operatorSubscriptConst(swigCPtr, this, n), false);
  }

  public GIM_CONTACT operatorSubscript(int n) {
    return new GIM_CONTACT(
        CollisionJNI.btGimContactArray_operatorSubscript(swigCPtr, this, n), false);
  }
  ...
  public void resize(int newsize, GIM_CONTACT fillData) {
    CollisionJNI.btGimContactArray_resize__SWIG_0(
        swigCPtr, this, newsize, GIM_CONTACT.getCPtr(fillData), fillData);
  }
  ...
  public GIM_CONTACT expandNonInitializing() {
    return new GIM_CONTACT(
        CollisionJNI.btGimContactArray_expandNonInitializing(swigCPtr, this), false);
  }

  public GIM_CONTACT expand(GIM_CONTACT fillValue) {
    return new GIM_CONTACT(
        CollisionJNI.btGimContactArray_expand__SWIG_0(
            swigCPtr, this, GIM_CONTACT.getCPtr(fillValue), fillValue),
        false);
  }
  ...
  public void copyFromArray(btGimContactArray otherArray) {
    CollisionJNI.btGimContactArray_copyFromArray(
        swigCPtr, this, btGimContactArray.getCPtr(otherArray), otherArray);
  }
}
