...
public class btConvexCast extends BulletBase {
  ...
  /**
   * Construct a new btConvexCast, normally you should not need this constructor it's intended for
   * low-level usage.
   */
  ...
  public static class CastResult extends BulletBase {
    ...
    /**
     * Construct a new CastResult, normally you should not need this constructor it's intended for
     * low-level usage.
     */
    ...
    public void setHitTransformA(btTransform value) {
      CollisionJNI.btConvexCast_CastResult_hitTransformA_set(
    ...
    public void setHitTransformB(btTransform value) {
      CollisionJNI.btConvexCast_CastResult_hitTransformB_set(
          swigCPtr, this, btTransform.getCPtr(value), value);
    }
    ...
    public void setNormal(btVector3 value) {
      CollisionJNI.btConvexCast_CastResult_normal_set(
    ...
    public void setHitPoint(btVector3 value) {
      CollisionJNI.btConvexCast_CastResult_hitPoint_set(
          swigCPtr, this, btVector3.getCPtr(value), value);
    }
    ...
    public void setDebugDrawer(btIDebugDraw value) {
      CollisionJNI.btConvexCast_CastResult_debugDrawer_set(
          swigCPtr, this, btIDebugDraw.getCPtr(value), value);
    }
  ...
  public boolean calcTimeOfImpact(
      Matrix4 fromA, Matrix4 toA, Matrix4 fromB, Matrix4 toB, btConvexCast.CastResult result) {
    return CollisionJNI.btConvexCast_calcTimeOfImpact(
        swigCPtr, this, fromA, toA, fromB, toB, btConvexCast.CastResult.getCPtr(result), result);
  }
}
