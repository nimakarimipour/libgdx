...
public class btDbvt extends BulletBase {
  ...
  /**
   * Construct a new btDbvt, normally you should not need this constructor it's intended for
   * low-level usage.
   */
  ...
  public static class sStkNN extends BulletBase {
    ...
    /**
     * Construct a new sStkNN, normally you should not need this constructor it's intended for
     * low-level usage.
     */
    ...
    public sStkNN(btDbvtNode na, btDbvtNode nb) {
      this(
          CollisionJNI.new_btDbvt_sStkNN__SWIG_1(
              btDbvtNode.getCPtr(na), na, btDbvtNode.getCPtr(nb), nb),
          true);
    }
  }
  ...
  public static class sStkNP extends BulletBase {
    ...
    /**
     * Construct a new sStkNP, normally you should not need this constructor it's intended for
     * low-level usage.
     */
  ...
  public static class sStkNPS extends BulletBase {
    ...
    /**
     * Construct a new sStkNPS, normally you should not need this constructor it's intended for
     * low-level usage.
     */
  ...
  public static class sStkCLN extends BulletBase {
    ...
    /**
     * Construct a new sStkCLN, normally you should not need this constructor it's intended for
     * low-level usage.
     */
    ...
    public sStkCLN(btDbvtNode n, btDbvtNode p) {
      this(
          CollisionJNI.new_btDbvt_sStkCLN(btDbvtNode.getCPtr(n), n, btDbvtNode.getCPtr(p), p),
          true);
    }
  }
  ...
  public static class IWriter extends BulletBase {
    ...
    /**
     * Construct a new IWriter, normally you should not need this constructor it's intended for
     * low-level usage.
     */
    ...
    public void WriteNode(btDbvtNode arg0, int index, int parent, int child0, int child1) {
      CollisionJNI.btDbvt_IWriter_WriteNode(
          swigCPtr, this, btDbvtNode.getCPtr(arg0), arg0, index, parent, child0, child1);
    }

    public void WriteLeaf(btDbvtNode arg0, int index, int parent) {
      CollisionJNI.btDbvt_IWriter_WriteLeaf(
          swigCPtr, this, btDbvtNode.getCPtr(arg0), arg0, index, parent);
    }
  }
  ...
  public static class IClone extends BulletBase {
    ...
    /**
     * Construct a new IClone, normally you should not need this constructor it's intended for
     * low-level usage.
     */
  ...
  public void setStkStack(SWIGTYPE_p_btAlignedObjectArrayT_btDbvt__sStkNN_t value) {
    CollisionJNI.btDbvt_stkStack_set(
        swigCPtr, this, SWIGTYPE_p_btAlignedObjectArrayT_btDbvt__sStkNN_t.getCPtr(value));
  }
  ...
  public btDbvtNode insert(btDbvtAabbMm box, long data) {
    return btDbvtNode.internalTemp(
        CollisionJNI.btDbvt_insert(swigCPtr, this, btDbvtAabbMm.getCPtr(box), box, data), false);
  }
  ...
  public void update(btDbvtNode leaf, btDbvtAabbMm volume) {
    CollisionJNI.btDbvt_update__SWIG_2(
        swigCPtr, this, btDbvtNode.getCPtr(leaf), leaf, btDbvtAabbMm.getCPtr(volume), volume);
  }

  public boolean update(btDbvtNode leaf, btDbvtAabbMm volume, Vector3 velocity, float margin) {
    return CollisionJNI.btDbvt_update__SWIG_3(
        swigCPtr,
        this,
        btDbvtNode.getCPtr(leaf),
        leaf,
        btDbvtAabbMm.getCPtr(volume),
        volume,
        velocity,
        margin);
  }
  ...
  public boolean update(btDbvtNode leaf, btDbvtAabbMm volume, Vector3 velocity) {
    return CollisionJNI.btDbvt_update__SWIG_4(
        swigCPtr,
        this,
        btDbvtNode.getCPtr(leaf),
        leaf,
  ...
  public boolean update(btDbvtNode leaf, btDbvtAabbMm volume, float margin) {
    return CollisionJNI.btDbvt_update__SWIG_5(
        swigCPtr,
        this,
        btDbvtNode.getCPtr(leaf),
        leaf,
  ...
  public void clone(btDbvt dest, btDbvt.IClone iclone) {
    CollisionJNI.btDbvt_clone__SWIG_0(
        swigCPtr, this, btDbvt.getCPtr(dest), dest, btDbvt.IClone.getCPtr(iclone), iclone);
  }
  ...
  public static void extractLeaves(
      btDbvtNode node, SWIGTYPE_p_btAlignedObjectArrayT_btDbvtNode_const_p_t leaves) {
    CollisionJNI.btDbvt_extractLeaves(
  ...
  public static void enumLeaves(btDbvtNode root, ICollide policy) {
    CollisionJNI.btDbvt_enumLeaves(
        btDbvtNode.getCPtr(root), root, ICollide.getCPtr(policy), policy);
  }

  public void collideTT(btDbvtNode root0, btDbvtNode root1, ICollide policy) {
    CollisionJNI.btDbvt_collideTT(
        swigCPtr,
        this,
        btDbvtNode.getCPtr(root0),
        root0,
        btDbvtNode.getCPtr(root1),
        root1,
        ICollide.getCPtr(policy),
        policy);
  }

  public void collideTTpersistentStack(btDbvtNode root0, btDbvtNode root1, ICollide policy) {
    CollisionJNI.btDbvt_collideTTpersistentStack(
        swigCPtr,
        this,
        btDbvtNode.getCPtr(root0),
        root0,
  ...
  public void collideTV(btDbvtNode root, btDbvtAabbMm volume, ICollide policy) {
    CollisionJNI.btDbvt_collideTV(
        swigCPtr,
        this,
        btDbvtNode.getCPtr(root),
        root,
        btDbvtAabbMm.getCPtr(volume),
        volume,
        ICollide.getCPtr(policy),
  ...
  public void collideTVNoStackAlloc(
      btDbvtNode root,
      btDbvtAabbMm volume,
      SWIGTYPE_p_btAlignedObjectArrayT_btDbvtNode_const_p_t stack,
      ICollide policy) {
    CollisionJNI.btDbvt_collideTVNoStackAlloc(
        swigCPtr,
        this,
        btDbvtNode.getCPtr(root),
        root,
        btDbvtAabbMm.getCPtr(volume),
        volume,
        SWIGTYPE_p_btAlignedObjectArrayT_btDbvtNode_const_p_t.getCPtr(stack),
        ICollide.getCPtr(policy),
        policy);
  }

  public static void rayTest(btDbvtNode root, Vector3 rayFrom, Vector3 rayTo, ICollide policy) {
    CollisionJNI.btDbvt_rayTest(
        btDbvtNode.getCPtr(root), root, rayFrom, rayTo, ICollide.getCPtr(policy), policy);
  }
  ...
  public void rayTestInternal(
      ...
      SWIGTYPE_p_btAlignedObjectArrayT_btDbvtNode_const_p_t stack,
      ICollide policy) {
    CollisionJNI.btDbvt_rayTestInternal(
        swigCPtr,
        this,
        btDbvtNode.getCPtr(root),
        root,
  ...
  public static void collideKDOP(
      btDbvtNode root,
      btVector3 normals,
      java.nio.FloatBuffer offsets,
      int count,
      ICollide policy) {
    assert offsets.isDirect() : "Buffer must be allocated direct.";
    {
      CollisionJNI.btDbvt_collideKDOP__SWIG_0(
          btDbvtNode.getCPtr(root),
          root,
          btVector3.getCPtr(normals),
          normals,
          offsets,
          count,
          ICollide.getCPtr(policy),
  ...
  public static void collideOCL(
    ...
    assert offsets.isDirect() : "Buffer must be allocated direct.";
    {
      CollisionJNI.btDbvt_collideOCL__SWIG_0(
          btDbvtNode.getCPtr(root),
          root,
          btVector3.getCPtr(normals),
          normals,
  ...
  public static void collideOCL(
    ...
    assert offsets.isDirect() : "Buffer must be allocated direct.";
    {
      CollisionJNI.btDbvt_collideOCL__SWIG_1(
          btDbvtNode.getCPtr(root),
          root,
          btVector3.getCPtr(normals),
          normals,
  ...
  public static int allocate(
      SWIGTYPE_p_btAlignedObjectArrayT_int_t ifree,
      SWIGTYPE_p_btAlignedObjectArrayT_btDbvt__sStkNPS_t stock,
      btDbvt.sStkNPS value) {
    return CollisionJNI.btDbvt_allocate(
        SWIGTYPE_p_btAlignedObjectArrayT_int_t.getCPtr(ifree),
        SWIGTYPE_p_btAlignedObjectArrayT_btDbvt__sStkNPS_t.getCPtr(stock),
        btDbvt.sStkNPS.getCPtr(value),
        value);
  }
  ...
  public static void collideKDOP(
    ...
    assert offsets.isDirect() : "Buffer must be allocated direct.";
    {
      CollisionJNI.btDbvt_collideKDOP__SWIG_1(
          btDbvtNode.getCPtr(root),
          root,
          normals,
          offsets,
  ...
  public static void collideOCL(
    ...
    assert offsets.isDirect() : "Buffer must be allocated direct.";
    {
      CollisionJNI.btDbvt_collideOCL__SWIG_2(
          btDbvtNode.getCPtr(root),
          root,
          normals,
          offsets,
  ...
  public static void collideOCL(
    ...
    assert offsets.isDirect() : "Buffer must be allocated direct.";
    {
      CollisionJNI.btDbvt_collideOCL__SWIG_3(
          btDbvtNode.getCPtr(root),
          root,
          normals,
          offsets,
