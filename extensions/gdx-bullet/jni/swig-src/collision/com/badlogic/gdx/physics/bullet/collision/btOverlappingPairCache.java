...
public class btOverlappingPairCache extends btOverlappingPairCallback {
  ...
  /**
   * Construct a new btOverlappingPairCache, normally you should not need this constructor it's
  ...
  public btBroadphasePair getOverlappingPairArrayPtr() {
    return btBroadphasePair.internalTemp(
        CollisionJNI.btOverlappingPairCache_getOverlappingPairArrayPtr(swigCPtr, this), false);
  }

  public btBroadphasePair getOverlappingPairArrayPtrConst() {
    return btBroadphasePair.internalTemp(
        CollisionJNI.btOverlappingPairCache_getOverlappingPairArrayPtrConst(swigCPtr, this), false);
  }

  public btBroadphasePairArray getOverlappingPairArray() {
    return new btBroadphasePairArray(
        CollisionJNI.btOverlappingPairCache_getOverlappingPairArray(swigCPtr, this), false);
  }

  public void cleanOverlappingPair(btBroadphasePair pair, btDispatcher dispatcher) {
    CollisionJNI.btOverlappingPairCache_cleanOverlappingPair(
        swigCPtr, this, pair, btDispatcher.getCPtr(dispatcher), dispatcher);
  }
  ...
  public void setOverlapFilterCallback(btOverlapFilterCallback callback) {
    CollisionJNI.btOverlappingPairCache_setOverlapFilterCallback(
        swigCPtr, this, btOverlapFilterCallback.getCPtr(callback), callback);
  }
  ...
  public void setInternalGhostPairCallback(btOverlappingPairCallback ghostPairCallback) {
    CollisionJNI.btOverlappingPairCache_setInternalGhostPairCallback(
        swigCPtr, this, btOverlappingPairCallback.getCPtr(ghostPairCallback), ghostPairCallback);
  }

  public void sortOverlappingPairs(btDispatcher dispatcher) {
    CollisionJNI.btOverlappingPairCache_sortOverlappingPairs(
