...
public class btGImpactMeshShapePart extends btGImpactShapeInterface {
  ...
  /**
   * Construct a new btGImpactMeshShapePart, normally you should not need this constructor it's
  ...
  public static class TrimeshPrimitiveManager extends btPrimitiveManagerBase {
    ...
    protected TrimeshPrimitiveManager(final String className, long cPtr, boolean cMemoryOwn) {
      super(
          className,
          CollisionJNI.btGImpactMeshShapePart_TrimeshPrimitiveManager_SWIGUpcast(cPtr),
          cMemoryOwn);
      swigCPtr = cPtr;
    }

    /**
     * Construct a new TrimeshPrimitiveManager, normally you should not need this constructor it's
     * intended for low-level usage.
     */
    ...
    protected void reset(long cPtr, boolean cMemoryOwn) {
      if (!destroyed) destroy();
      super.reset(
          CollisionJNI.btGImpactMeshShapePart_TrimeshPrimitiveManager_SWIGUpcast(swigCPtr = cPtr),
          cMemoryOwn);
    }
    ...
    public void setMeshInterface(btStridingMeshInterface value) {
      CollisionJNI.btGImpactMeshShapePart_TrimeshPrimitiveManager_meshInterface_set(
          swigCPtr, this, btStridingMeshInterface.getCPtr(value), value);
    }

    public btStridingMeshInterface getMeshInterface() {
      long cPtr =
          CollisionJNI.btGImpactMeshShapePart_TrimeshPrimitiveManager_meshInterface_get(
              swigCPtr, this);
      return (cPtr == 0) ? null : new btStridingMeshInterface(cPtr, false);
    }

    public void setScale(btVector3 value) {
      CollisionJNI.btGImpactMeshShapePart_TrimeshPrimitiveManager_scale_set(
          swigCPtr, this, btVector3.getCPtr(value), value);
    }

    public btVector3 getScale() {
      long cPtr =
          CollisionJNI.btGImpactMeshShapePart_TrimeshPrimitiveManager_scale_get(swigCPtr, this);
    ...
    public void setLock_count(int value) {
      CollisionJNI.btGImpactMeshShapePart_TrimeshPrimitiveManager_lock_count_set(
          swigCPtr, this, value);
    }

    public int getLock_count() {
      return CollisionJNI.btGImpactMeshShapePart_TrimeshPrimitiveManager_lock_count_get(
          swigCPtr, this);
    }
    ...
    public void setVertexbase(java.nio.ByteBuffer value) {
      ...
      {
        CollisionJNI.btGImpactMeshShapePart_TrimeshPrimitiveManager_vertexbase_set(
            swigCPtr, this, value);
      }
    }

    public java.nio.ByteBuffer getVertexbase() {
      return CollisionJNI.btGImpactMeshShapePart_TrimeshPrimitiveManager_vertexbase_get(
          swigCPtr, this);
    }

    public void setNumverts(int value) {
      CollisionJNI.btGImpactMeshShapePart_TrimeshPrimitiveManager_numverts_set(
          swigCPtr, this, value);
    }

    public int getNumverts() {
      return CollisionJNI.btGImpactMeshShapePart_TrimeshPrimitiveManager_numverts_get(
          swigCPtr, this);
    }
    ...
    public void setIndexbase(java.nio.ByteBuffer value) {
      assert value.isDirect() : "Buffer must be allocated direct.";
      {
        CollisionJNI.btGImpactMeshShapePart_TrimeshPrimitiveManager_indexbase_set(
            swigCPtr, this, value);
      }
    }

    public java.nio.ByteBuffer getIndexbase() {
      return CollisionJNI.btGImpactMeshShapePart_TrimeshPrimitiveManager_indexbase_get(
          swigCPtr, this);
    }

    public void setIndexstride(int value) {
      CollisionJNI.btGImpactMeshShapePart_TrimeshPrimitiveManager_indexstride_set(
          swigCPtr, this, value);
    }

    public int getIndexstride() {
      return CollisionJNI.btGImpactMeshShapePart_TrimeshPrimitiveManager_indexstride_get(
          swigCPtr, this);
    }

    public void setNumfaces(int value) {
      CollisionJNI.btGImpactMeshShapePart_TrimeshPrimitiveManager_numfaces_set(
          swigCPtr, this, value);
    }

    public int getNumfaces() {
      return CollisionJNI.btGImpactMeshShapePart_TrimeshPrimitiveManager_numfaces_get(
          swigCPtr, this);
    }

    public void setIndicestype(int value) {
      CollisionJNI.btGImpactMeshShapePart_TrimeshPrimitiveManager_indicestype_set(
          swigCPtr, this, value);
    }

    public int getIndicestype() {
      return CollisionJNI.btGImpactMeshShapePart_TrimeshPrimitiveManager_indicestype_get(
          swigCPtr, this);
    }
    ...
    public TrimeshPrimitiveManager(btGImpactMeshShapePart.TrimeshPrimitiveManager manager) {
      this(
          CollisionJNI.new_btGImpactMeshShapePart_TrimeshPrimitiveManager__SWIG_1(
              btGImpactMeshShapePart.TrimeshPrimitiveManager.getCPtr(manager), manager),
          true);
    }
    ...
    public TrimeshPrimitiveManager(btStridingMeshInterface meshInterface, int part) {
      this(
          CollisionJNI.new_btGImpactMeshShapePart_TrimeshPrimitiveManager__SWIG_2(
              btStridingMeshInterface.getCPtr(meshInterface), meshInterface, part),
          true);
    }
    ...
    public int get_vertex_count() {
      return CollisionJNI.btGImpactMeshShapePart_TrimeshPrimitiveManager_get_vertex_count(
          swigCPtr, this);
    }

    public void get_indices(
        int face_index,
        SWIGTYPE_p_unsigned_int i0,
        SWIGTYPE_p_unsigned_int i1,
        SWIGTYPE_p_unsigned_int i2) {
      CollisionJNI.btGImpactMeshShapePart_TrimeshPrimitiveManager_get_indices(
          swigCPtr,
          this,
          face_index,
          SWIGTYPE_p_unsigned_int.getCPtr(i0),
          SWIGTYPE_p_unsigned_int.getCPtr(i1),
          SWIGTYPE_p_unsigned_int.getCPtr(i2));
    }

    public void get_vertex(long vertex_index, Vector3 vertex) {
      CollisionJNI.btGImpactMeshShapePart_TrimeshPrimitiveManager_get_vertex(
          swigCPtr, this, vertex_index, vertex);
    }

    public void get_bullet_triangle(int prim_index, btTriangleShapeEx triangle) {
      CollisionJNI.btGImpactMeshShapePart_TrimeshPrimitiveManager_get_bullet_triangle(
          swigCPtr, this, prim_index, btTriangleShapeEx.getCPtr(triangle), triangle);
    }
  }
  ...
  public btGImpactMeshShapePart(btStridingMeshInterface meshInterface, int part) {
    this(
        CollisionJNI.new_btGImpactMeshShapePart__SWIG_1(
            btStridingMeshInterface.getCPtr(meshInterface), meshInterface, part),
        true);
  }
