...
public class btAxisSweep3InternalInt extends btBroadphaseInterface {
  ...
  /**
   * Construct a new btAxisSweep3InternalInt, normally you should not need this constructor it's
  ...
  public long operatorNewArray(long sizeInBytes) {
    return CollisionJNI.btAxisSweep3InternalInt_operatorNewArray__SWIG_0(
  ...
  public static class Handle extends btBroadphaseProxy {
    ...
    protected void reset(long cPtr, boolean cMemoryOwn) {
      if (!destroyed) destroy();
      super.reset(
          CollisionJNI.btAxisSweep3InternalInt_Handle_SWIGUpcast(swigCPtr = cPtr), cMemoryOwn);
    }
    ...
    public long operatorNew(long sizeInBytes) {
      return CollisionJNI.btAxisSweep3InternalInt_Handle_operatorNew__SWIG_0(
          swigCPtr, this, sizeInBytes);
    }
    ...
    public long operatorNew(long arg0, long ptr) {
      return CollisionJNI.btAxisSweep3InternalInt_Handle_operatorNew__SWIG_1(
          swigCPtr, this, arg0, ptr);
    }

    public void operatorDelete(long arg0, long arg1) {
      CollisionJNI.btAxisSweep3InternalInt_Handle_operatorDelete__SWIG_1(
          swigCPtr, this, arg0, arg1);
    }

    public long operatorNewArray(long sizeInBytes) {
      return CollisionJNI.btAxisSweep3InternalInt_Handle_operatorNewArray__SWIG_0(
          swigCPtr, this, sizeInBytes);
    }
    ...
    public long operatorNewArray(long arg0, long ptr) {
      return CollisionJNI.btAxisSweep3InternalInt_Handle_operatorNewArray__SWIG_1(
          swigCPtr, this, arg0, ptr);
    }

    public void operatorDeleteArray(long arg0, long arg1) {
      CollisionJNI.btAxisSweep3InternalInt_Handle_operatorDeleteArray__SWIG_1(
          swigCPtr, this, arg0, arg1);
    }
    ...
    public void setDbvtProxy(btBroadphaseProxy value) {
      CollisionJNI.btAxisSweep3InternalInt_Handle_dbvtProxy_set(
    ...
    public btBroadphaseProxy getDbvtProxy() {
      return btBroadphaseProxy.internalTemp(
          CollisionJNI.btAxisSweep3InternalInt_Handle_dbvtProxy_get(swigCPtr, this), false);
    }
  ...
  public btAxisSweep3InternalInt(
    ...
    this(
        CollisionJNI.new_btAxisSweep3InternalInt__SWIG_0(
            worldAabbMin,
            worldAabbMax,
            handleMask,
            handleSentinel,
  ...
  public btAxisSweep3InternalInt(
      ...
      btOverlappingPairCache pairCache) {
    this(
        CollisionJNI.new_btAxisSweep3InternalInt__SWIG_1(
            worldAabbMin,
            worldAabbMax,
            handleMask,
            handleSentinel,
  ...
  public btAxisSweep3InternalInt(
      ...
      long maxHandles) {
    this(
        CollisionJNI.new_btAxisSweep3InternalInt__SWIG_2(
            worldAabbMin, worldAabbMax, handleMask, handleSentinel, maxHandles),
        true);
  }

  public btAxisSweep3InternalInt(
      Vector3 worldAabbMin, Vector3 worldAabbMax, long handleMask, long handleSentinel) {
    this(
        CollisionJNI.new_btAxisSweep3InternalInt__SWIG_3(
  ...
  public long addHandle(
    ...
    return CollisionJNI.btAxisSweep3InternalInt_addHandle(
        swigCPtr,
        this,
        aabbMin,
        aabbMax,
  ...
  public void removeHandle(long handle, btDispatcher dispatcher) {
    CollisionJNI.btAxisSweep3InternalInt_removeHandle(
  ...
  public void updateHandle(long handle, Vector3 aabbMin, Vector3 aabbMax, btDispatcher dispatcher) {
    CollisionJNI.btAxisSweep3InternalInt_updateHandle(
  ...
  public void rayTest(
      ...
      Vector3 aabbMin,
      Vector3 aabbMax) {
    CollisionJNI.btAxisSweep3InternalInt_rayTest__SWIG_0(
        swigCPtr,
        this,
        rayFrom,
        rayTo,
  ...
  public void rayTest(
    ...
    CollisionJNI.btAxisSweep3InternalInt_rayTest__SWIG_1(
        swigCPtr,
        this,
        rayFrom,
        rayTo,
  ...
  public void rayTest(Vector3 rayFrom, Vector3 rayTo, btBroadphaseRayCallback rayCallback) {
    CollisionJNI.btAxisSweep3InternalInt_rayTest__SWIG_2(
  ...
  public void unQuantize(btBroadphaseProxy proxy, Vector3 aabbMin, Vector3 aabbMax) {
    CollisionJNI.btAxisSweep3InternalInt_unQuantize(
  ...
  public boolean testAabbOverlap(btBroadphaseProxy proxy0, btBroadphaseProxy proxy1) {
    return CollisionJNI.btAxisSweep3InternalInt_testAabbOverlap(
        swigCPtr,
        this,
  ...
  public void setOverlappingPairUserCallback(btOverlappingPairCallback pairCallback) {
    CollisionJNI.btAxisSweep3InternalInt_setOverlappingPairUserCallback(
