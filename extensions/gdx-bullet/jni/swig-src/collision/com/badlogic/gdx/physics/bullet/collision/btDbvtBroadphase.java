...
public class btDbvtBroadphase extends btBroadphaseInterface {
  ...
  /**
   * Construct a new btDbvtBroadphase, normally you should not need this constructor it's intended
   * for low-level usage.
   */
  ...
  public void setStageRoots(SWIGTYPE_p_p_btDbvtProxy value) {
    CollisionJNI.btDbvtBroadphase_stageRoots_set(
        swigCPtr, this, SWIGTYPE_p_p_btDbvtProxy.getCPtr(value));
  }
  ...
  public void setPaircache(btOverlappingPairCache value) {
    CollisionJNI.btDbvtBroadphase_paircache_set(
        swigCPtr, this, btOverlappingPairCache.getCPtr(value), value);
  }
  ...
  public void setRayTestStacks(
      SWIGTYPE_p_btAlignedObjectArrayT_btAlignedObjectArrayT_btDbvtNode_const_p_t_t value) {
    CollisionJNI.btDbvtBroadphase_rayTestStacks_set(
        swigCPtr,
        this,
        SWIGTYPE_p_btAlignedObjectArrayT_btAlignedObjectArrayT_btDbvtNode_const_p_t_t.getCPtr(
            value));
  }

  public SWIGTYPE_p_btAlignedObjectArrayT_btAlignedObjectArrayT_btDbvtNode_const_p_t_t
      getRayTestStacks() {
    long cPtr = CollisionJNI.btDbvtBroadphase_rayTestStacks_get(swigCPtr, this);
    return (cPtr == 0)
        ? null
        : new SWIGTYPE_p_btAlignedObjectArrayT_btAlignedObjectArrayT_btDbvtNode_const_p_t_t(
            cPtr, false);
  }

  public btDbvtBroadphase(btOverlappingPairCache paircache) {
    this(
        CollisionJNI.new_btDbvtBroadphase__SWIG_0(
  ...
  public void collide(btDispatcher dispatcher) {
    CollisionJNI.btDbvtBroadphase_collide(
  ...
  public void rayTest(
      ...
      Vector3 aabbMin,
      Vector3 aabbMax) {
    CollisionJNI.btDbvtBroadphase_rayTest__SWIG_0(
        swigCPtr,
        this,
        rayFrom,
        rayTo,
  ...
  public void rayTest(
    ...
    CollisionJNI.btDbvtBroadphase_rayTest__SWIG_1(
        swigCPtr,
        this,
        rayFrom,
        rayTo,
  ...
  public void rayTest(Vector3 rayFrom, Vector3 rayTo, btBroadphaseRayCallback rayCallback) {
    CollisionJNI.btDbvtBroadphase_rayTest__SWIG_2(
  ...
  public void performDeferredRemoval(btDispatcher dispatcher) {
    CollisionJNI.btDbvtBroadphase_performDeferredRemoval(
        swigCPtr, this, btDispatcher.getCPtr(dispatcher), dispatcher);
  }
  ...
  public void setAabbForceUpdate(
      btBroadphaseProxy absproxy, Vector3 aabbMin, Vector3 aabbMax, btDispatcher arg3) {
    CollisionJNI.btDbvtBroadphase_setAabbForceUpdate(
        swigCPtr,
        this,
        btBroadphaseProxy.getCPtr(absproxy),
        absproxy,
        aabbMin,
        aabbMax,
        btDispatcher.getCPtr(arg3),
        arg3);
  }
