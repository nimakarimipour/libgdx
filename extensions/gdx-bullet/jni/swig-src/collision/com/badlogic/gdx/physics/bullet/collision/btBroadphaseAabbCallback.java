...
public class btBroadphaseAabbCallback extends BulletBase {
  ...
  /**
   * Construct a new btBroadphaseAabbCallback, normally you should not need this constructor it's
  ...
  public boolean process(btBroadphaseProxy proxy) {
    return CollisionJNI.btBroadphaseAabbCallback_process(
        swigCPtr, this, btBroadphaseProxy.getCPtr(proxy), proxy);
  }
