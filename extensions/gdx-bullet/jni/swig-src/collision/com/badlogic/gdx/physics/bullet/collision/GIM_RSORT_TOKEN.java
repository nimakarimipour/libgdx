...
public class GIM_RSORT_TOKEN extends BulletBase {
  ...
  /**
   * Construct a new GIM_RSORT_TOKEN, normally you should not need this constructor it's intended
   * for low-level usage.
   */
  ...
  public boolean operatorLessThan(GIM_RSORT_TOKEN other) {
    return CollisionJNI.GIM_RSORT_TOKEN_operatorLessThan(
        swigCPtr, this, GIM_RSORT_TOKEN.getCPtr(other), other);
  }

  public boolean operatorGreaterThan(GIM_RSORT_TOKEN other) {
    return CollisionJNI.GIM_RSORT_TOKEN_operatorGreaterThan(
        swigCPtr, this, GIM_RSORT_TOKEN.getCPtr(other), other);
  }
}
