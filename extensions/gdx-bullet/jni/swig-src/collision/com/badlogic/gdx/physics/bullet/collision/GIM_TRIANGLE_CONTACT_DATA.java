...
public class GIM_TRIANGLE_CONTACT_DATA extends BulletBase {
  ...
  /**
   * Construct a new GIM_TRIANGLE_CONTACT_DATA, normally you should not need this constructor it's
  ...
  public void setSeparating_normal(btVector4 value) {
    CollisionJNI.GIM_TRIANGLE_CONTACT_DATA_separating_normal_set(
        swigCPtr, this, btVector4.getCPtr(value), value);
  }
  ...
  public void setPoints(btVector3 value) {
    CollisionJNI.GIM_TRIANGLE_CONTACT_DATA_points_set(
  ...
  public void copy_from(GIM_TRIANGLE_CONTACT_DATA other) {
    CollisionJNI.GIM_TRIANGLE_CONTACT_DATA_copy_from(
        swigCPtr, this, GIM_TRIANGLE_CONTACT_DATA.getCPtr(other), other);
  }
  ...
  public GIM_TRIANGLE_CONTACT_DATA(GIM_TRIANGLE_CONTACT_DATA other) {
    this(
        CollisionJNI.new_GIM_TRIANGLE_CONTACT_DATA__SWIG_1(
            GIM_TRIANGLE_CONTACT_DATA.getCPtr(other), other),
        true);
  }

  public void merge_points(btVector4 plane, float margin, btVector3 points, long point_count) {
    CollisionJNI.GIM_TRIANGLE_CONTACT_DATA_merge_points(
        swigCPtr,
        this,
        btVector4.getCPtr(plane),
        plane,
        margin,
        btVector3.getCPtr(points),
        points,
        point_count);
  }
}
