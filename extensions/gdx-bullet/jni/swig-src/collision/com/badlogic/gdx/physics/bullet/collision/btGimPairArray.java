...
public class btGimPairArray extends BulletBase {
  ...
  /**
   * Construct a new btGimPairArray, normally you should not need this constructor it's intended for
   * low-level usage.
   */
  ...
  public btGimPairArray operatorAssignment(btGimPairArray other) {
    return new btGimPairArray(
        CollisionJNI.btGimPairArray_operatorAssignment(
            swigCPtr, this, btGimPairArray.getCPtr(other), other),
        false);
  }
  ...
  public btGimPairArray(btGimPairArray otherArray) {
    this(
        CollisionJNI.new_btGimPairArray__SWIG_1(btGimPairArray.getCPtr(otherArray), otherArray),
        true);
  }
  ...
  public GIM_PAIR operatorSubscriptConst(int n) {
    return new GIM_PAIR(
        CollisionJNI.btGimPairArray_operatorSubscriptConst(swigCPtr, this, n), false);
  }
  ...
  public void resize(int newsize, GIM_PAIR fillData) {
    CollisionJNI.btGimPairArray_resize__SWIG_0(
        swigCPtr, this, newsize, GIM_PAIR.getCPtr(fillData), fillData);
  }
  ...
  public GIM_PAIR expand(GIM_PAIR fillValue) {
    return new GIM_PAIR(
        CollisionJNI.btGimPairArray_expand__SWIG_0(
            swigCPtr, this, GIM_PAIR.getCPtr(fillValue), fillValue),
        false);
  }
  ...
  public void copyFromArray(btGimPairArray otherArray) {
    CollisionJNI.btGimPairArray_copyFromArray(
        swigCPtr, this, btGimPairArray.getCPtr(otherArray), otherArray);
  }
}
