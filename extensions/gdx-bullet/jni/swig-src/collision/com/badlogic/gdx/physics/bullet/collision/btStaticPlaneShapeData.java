...
public class btStaticPlaneShapeData extends BulletBase {
  ...
  /**
   * Construct a new btStaticPlaneShapeData, normally you should not need this constructor it's
  ...
  public void setCollisionShapeData(btCollisionShapeData value) {
    CollisionJNI.btStaticPlaneShapeData_collisionShapeData_set(
  ...
  public void setLocalScaling(btVector3FloatData value) {
    CollisionJNI.btStaticPlaneShapeData_localScaling_set(
  ...
  public void setPlaneNormal(btVector3FloatData value) {
    CollisionJNI.btStaticPlaneShapeData_planeNormal_set(
        swigCPtr, this, btVector3FloatData.getCPtr(value), value);
  }
