...
public class btSortedOverlappingPairCache extends btOverlappingPairCache {
  ...
  /**
   * Construct a new btSortedOverlappingPairCache, normally you should not need this constructor
  ...
  public boolean needsBroadphaseCollision(btBroadphaseProxy proxy0, btBroadphaseProxy proxy1) {
    return CollisionJNI.btSortedOverlappingPairCache_needsBroadphaseCollision(
        swigCPtr,
        this,
  ...
  public btBroadphasePairArray getOverlappingPairArrayConst() {
    return new btBroadphasePairArray(
        CollisionJNI.btSortedOverlappingPairCache_getOverlappingPairArrayConst(swigCPtr, this),
        false);
  }
