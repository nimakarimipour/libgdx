...
public class btConvexInternalShape extends btConvexShape {
  ...
  /**
   * Construct a new btConvexInternalShape, normally you should not need this constructor it's
  ...
  public void setSafeMargin(float minDimension, float defaultMarginMultiplier) {
    CollisionJNI.btConvexInternalShape_setSafeMargin__SWIG_0(
        swigCPtr, this, minDimension, defaultMarginMultiplier);
  }
  ...
  public void setSafeMargin(Vector3 halfExtents, float defaultMarginMultiplier) {
    CollisionJNI.btConvexInternalShape_setSafeMargin__SWIG_2(
        swigCPtr, this, halfExtents, defaultMarginMultiplier);
  }
