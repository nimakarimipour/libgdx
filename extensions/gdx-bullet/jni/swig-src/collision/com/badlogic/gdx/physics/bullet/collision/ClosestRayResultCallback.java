...
public class ClosestRayResultCallback extends RayResultCallback {
  ...
  /**
   * Construct a new ClosestRayResultCallback, normally you should not need this constructor it's
  ...
  public float addSingleResult(LocalRayResult rayResult, boolean normalInWorldSpace) {
    return (getClass() == ClosestRayResultCallback.class)
        ? CollisionJNI.ClosestRayResultCallback_addSingleResult(
            swigCPtr, this, LocalRayResult.getCPtr(rayResult), rayResult, normalInWorldSpace)
        : CollisionJNI.ClosestRayResultCallback_addSingleResultSwigExplicitClosestRayResultCallback(
            swigCPtr, this, LocalRayResult.getCPtr(rayResult), rayResult, normalInWorldSpace);
  }
