...
public class btHashedSimplePairCache extends BulletBase {
  ...
  /**
   * Construct a new btHashedSimplePairCache, normally you should not need this constructor it's
  ...
  public long removeOverlappingPair(int indexA, int indexB) {
    return CollisionJNI.btHashedSimplePairCache_removeOverlappingPair(
        swigCPtr, this, indexA, indexB);
  }

  public btSimplePair addOverlappingPair(int indexA, int indexB) {
    long cPtr =
        CollisionJNI.btHashedSimplePairCache_addOverlappingPair(swigCPtr, this, indexA, indexB);
  ...
  public btSimplePair getOverlappingPairArrayPtrConst() {
    long cPtr =
        CollisionJNI.btHashedSimplePairCache_getOverlappingPairArrayPtrConst(swigCPtr, this);
    return (cPtr == 0) ? null : new btSimplePair(cPtr, false);
  }
