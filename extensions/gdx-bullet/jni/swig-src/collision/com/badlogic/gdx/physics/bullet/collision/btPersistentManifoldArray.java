...
public class btPersistentManifoldArray extends BulletBase {
  ...
  /**
   * Construct a new btPersistentManifoldArray, normally you should not need this constructor it's
  ...
  public btPersistentManifoldArray operatorAssignment(btPersistentManifoldArray other) {
    return new btPersistentManifoldArray(
        CollisionJNI.btPersistentManifoldArray_operatorAssignment(
            swigCPtr, this, btPersistentManifoldArray.getCPtr(other), other),
        false);
  }
  ...
  public btPersistentManifoldArray(btPersistentManifoldArray otherArray) {
    this(
        CollisionJNI.new_btPersistentManifoldArray__SWIG_1(
            btPersistentManifoldArray.getCPtr(otherArray), otherArray),
        true);
  }
  ...
  public SWIGTYPE_p_p_btPersistentManifold at(int n) {
    return new SWIGTYPE_p_p_btPersistentManifold(
        CollisionJNI.btPersistentManifoldArray_at(swigCPtr, this, n), false);
  }
  ...
  public SWIGTYPE_p_p_btPersistentManifold operatorSubscript(int n) {
    return new SWIGTYPE_p_p_btPersistentManifold(
        CollisionJNI.btPersistentManifoldArray_operatorSubscript(swigCPtr, this, n), false);
  }
  ...
  public void resize(int newsize, btPersistentManifold fillData) {
    CollisionJNI.btPersistentManifoldArray_resize__SWIG_0(
        swigCPtr, this, newsize, btPersistentManifold.getCPtr(fillData), fillData);
  }
  ...
  public SWIGTYPE_p_p_btPersistentManifold expandNonInitializing() {
    return new SWIGTYPE_p_p_btPersistentManifold(
        CollisionJNI.btPersistentManifoldArray_expandNonInitializing(swigCPtr, this), false);
  }

  public SWIGTYPE_p_p_btPersistentManifold expand(btPersistentManifold fillValue) {
    return new SWIGTYPE_p_p_btPersistentManifold(
        CollisionJNI.btPersistentManifoldArray_expand__SWIG_0(
            swigCPtr, this, btPersistentManifold.getCPtr(fillValue), fillValue),
        false);
  }

  public SWIGTYPE_p_p_btPersistentManifold expand() {
    return new SWIGTYPE_p_p_btPersistentManifold(
        CollisionJNI.btPersistentManifoldArray_expand__SWIG_1(swigCPtr, this), false);
  }

  public void push_back(btPersistentManifold _Val) {
    CollisionJNI.btPersistentManifoldArray_push_back(
        swigCPtr, this, btPersistentManifold.getCPtr(_Val), _Val);
  }
  ...
  public static class less extends BulletBase {
    ...
    public boolean operatorFunctionCall(btPersistentManifold a, btPersistentManifold b) {
      return CollisionJNI.btPersistentManifoldArray_less_operatorFunctionCall(
          swigCPtr, this, btPersistentManifold.getCPtr(a), a, btPersistentManifold.getCPtr(b), b);
    }
  ...
  public int findBinarySearch(btPersistentManifold key) {
    return CollisionJNI.btPersistentManifoldArray_findBinarySearch(
        swigCPtr, this, btPersistentManifold.getCPtr(key), key);
  }

  public int findLinearSearch(btPersistentManifold key) {
    return CollisionJNI.btPersistentManifoldArray_findLinearSearch(
        swigCPtr, this, btPersistentManifold.getCPtr(key), key);
  }

  public int findLinearSearch2(btPersistentManifold key) {
    return CollisionJNI.btPersistentManifoldArray_findLinearSearch2(
        swigCPtr, this, btPersistentManifold.getCPtr(key), key);
  }
