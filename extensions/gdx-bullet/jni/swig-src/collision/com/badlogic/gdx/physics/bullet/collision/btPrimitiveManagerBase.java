...
public class btPrimitiveManagerBase extends BulletBase {
  ...
  /**
   * Construct a new btPrimitiveManagerBase, normally you should not need this constructor it's
  ...
  public void get_primitive_box(int prim_index, btAABB primbox) {
    CollisionJNI.btPrimitiveManagerBase_get_primitive_box(
        swigCPtr, this, prim_index, btAABB.getCPtr(primbox), primbox);
  }

  public void get_primitive_triangle(int prim_index, btPrimitiveTriangle triangle) {
    CollisionJNI.btPrimitiveManagerBase_get_primitive_triangle(
        swigCPtr, this, prim_index, btPrimitiveTriangle.getCPtr(triangle), triangle);
  }
}
