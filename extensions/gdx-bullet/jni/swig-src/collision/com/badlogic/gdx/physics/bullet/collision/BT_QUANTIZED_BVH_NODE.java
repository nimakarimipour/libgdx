...
public class BT_QUANTIZED_BVH_NODE extends BulletBase {
  ...
  /**
   * Construct a new BT_QUANTIZED_BVH_NODE, normally you should not need this constructor it's
  ...
  public boolean testQuantizedBoxOverlapp(
      java.nio.IntBuffer quantizedMin, java.nio.IntBuffer quantizedMax) {
    assert quantizedMin.isDirect() : "Buffer must be allocated direct.";
    assert quantizedMax.isDirect() : "Buffer must be allocated direct.";
    {
      return CollisionJNI.BT_QUANTIZED_BVH_NODE_testQuantizedBoxOverlapp(
