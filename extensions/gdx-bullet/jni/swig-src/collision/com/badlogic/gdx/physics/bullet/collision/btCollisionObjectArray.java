...
public class btCollisionObjectArray extends BulletBase {
  ...
  /**
   * Construct a new btCollisionObjectArray, normally you should not need this constructor it's
  ...
  public btCollisionObjectArray operatorAssignment(btCollisionObjectArray other) {
    return new btCollisionObjectArray(
        CollisionJNI.btCollisionObjectArray_operatorAssignment(
            swigCPtr, this, btCollisionObjectArray.getCPtr(other), other),
        false);
  }
  ...
  public btCollisionObjectArray(btCollisionObjectArray otherArray) {
    this(
        CollisionJNI.new_btCollisionObjectArray__SWIG_1(
            btCollisionObjectArray.getCPtr(otherArray), otherArray),
        true);
  }
  ...
  public btCollisionObject atConst(int n) {
    return btCollisionObject.getInstance(
        CollisionJNI.btCollisionObjectArray_atConst(swigCPtr, this, n), false);
  }

  public SWIGTYPE_p_p_btCollisionObject at(int n) {
    return new SWIGTYPE_p_p_btCollisionObject(
        CollisionJNI.btCollisionObjectArray_at(swigCPtr, this, n), false);
  }

  public btCollisionObject operatorSubscriptConst(int n) {
    return btCollisionObject.getInstance(
        CollisionJNI.btCollisionObjectArray_operatorSubscriptConst(swigCPtr, this, n), false);
  }

  public SWIGTYPE_p_p_btCollisionObject operatorSubscript(int n) {
    return new SWIGTYPE_p_p_btCollisionObject(
        CollisionJNI.btCollisionObjectArray_operatorSubscript(swigCPtr, this, n), false);
  }
  ...
  public void resize(int newsize, btCollisionObject fillData) {
    CollisionJNI.btCollisionObjectArray_resize__SWIG_0(
  ...
  public SWIGTYPE_p_p_btCollisionObject expandNonInitializing() {
    return new SWIGTYPE_p_p_btCollisionObject(
        CollisionJNI.btCollisionObjectArray_expandNonInitializing(swigCPtr, this), false);
  }

  public SWIGTYPE_p_p_btCollisionObject expand(btCollisionObject fillValue) {
    return new SWIGTYPE_p_p_btCollisionObject(
        CollisionJNI.btCollisionObjectArray_expand__SWIG_0(
  ...
  public SWIGTYPE_p_p_btCollisionObject expand() {
    return new SWIGTYPE_p_p_btCollisionObject(
        CollisionJNI.btCollisionObjectArray_expand__SWIG_1(swigCPtr, this), false);
  }

  public void push_back(btCollisionObject _Val) {
    CollisionJNI.btCollisionObjectArray_push_back(
  ...
  public static class less extends BulletBase {
    ...
    public boolean operatorFunctionCall(btCollisionObject a, btCollisionObject b) {
      return CollisionJNI.btCollisionObjectArray_less_operatorFunctionCall(
  ...
  public int findBinarySearch(btCollisionObject key) {
    return CollisionJNI.btCollisionObjectArray_findBinarySearch(
        swigCPtr, this, btCollisionObject.getCPtr(key), key);
  }

  public int findLinearSearch(btCollisionObject key) {
    return CollisionJNI.btCollisionObjectArray_findLinearSearch(
        swigCPtr, this, btCollisionObject.getCPtr(key), key);
  }

  public int findLinearSearch2(btCollisionObject key) {
    return CollisionJNI.btCollisionObjectArray_findLinearSearch2(
        swigCPtr, this, btCollisionObject.getCPtr(key), key);
  }
  ...
  public void initializeFromBuffer(long buffer, int size, int capacity) {
    CollisionJNI.btCollisionObjectArray_initializeFromBuffer(
        swigCPtr, this, buffer, size, capacity);
  }

  public void copyFromArray(btCollisionObjectArray otherArray) {
    CollisionJNI.btCollisionObjectArray_copyFromArray(
        swigCPtr, this, btCollisionObjectArray.getCPtr(otherArray), otherArray);
  }
}
