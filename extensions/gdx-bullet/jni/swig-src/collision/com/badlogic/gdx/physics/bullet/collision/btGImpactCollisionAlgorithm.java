...
public class btGImpactCollisionAlgorithm extends btActivatingCollisionAlgorithm {
  ...
  /**
   * Construct a new btGImpactCollisionAlgorithm, normally you should not need this constructor it's
  ...
  public btGImpactCollisionAlgorithm(
    ...
    this(
        CollisionJNI.new_btGImpactCollisionAlgorithm(
  ...
  public static class CreateFunc extends btCollisionAlgorithmCreateFunc {
    ...
    protected CreateFunc(final String className, long cPtr, boolean cMemoryOwn) {
      super(
          className,
          CollisionJNI.btGImpactCollisionAlgorithm_CreateFunc_SWIGUpcast(cPtr),
          cMemoryOwn);
      swigCPtr = cPtr;
    }
    ...
    protected void reset(long cPtr, boolean cMemoryOwn) {
      if (!destroyed) destroy();
      super.reset(
          CollisionJNI.btGImpactCollisionAlgorithm_CreateFunc_SWIGUpcast(swigCPtr = cPtr),
          cMemoryOwn);
    }
  ...
  public static void registerAlgorithm(btCollisionDispatcher dispatcher) {
    CollisionJNI.btGImpactCollisionAlgorithm_registerAlgorithm(
        btCollisionDispatcher.getCPtr(dispatcher), dispatcher);
  }

  public void gimpact_vs_gimpact(
      btCollisionObjectWrapper body0Wrap,
      btCollisionObjectWrapper body1Wrap,
      btGImpactShapeInterface shape0,
      btGImpactShapeInterface shape1) {
    CollisionJNI.btGImpactCollisionAlgorithm_gimpact_vs_gimpact(
        swigCPtr,
        this,
        btCollisionObjectWrapper.getCPtr(body0Wrap),
        body0Wrap,
        btCollisionObjectWrapper.getCPtr(body1Wrap),
        body1Wrap,
        btGImpactShapeInterface.getCPtr(shape0),
        shape0,
        btGImpactShapeInterface.getCPtr(shape1),
        shape1);
  }

  public void gimpact_vs_shape(
      btCollisionObjectWrapper body0Wrap,
      btCollisionObjectWrapper body1Wrap,
      btGImpactShapeInterface shape0,
      btCollisionShape shape1,
      boolean swapped) {
    CollisionJNI.btGImpactCollisionAlgorithm_gimpact_vs_shape(
        swigCPtr,
        this,
        btCollisionObjectWrapper.getCPtr(body0Wrap),
        body0Wrap,
        ...
        btGImpactShapeInterface.getCPtr(shape0),
        shape0,
        btCollisionShape.getCPtr(shape1),
        shape1,
        swapped);
  }

  public void gimpact_vs_compoundshape(
      btCollisionObjectWrapper body0Wrap,
      btCollisionObjectWrapper body1Wrap,
      btGImpactShapeInterface shape0,
      btCompoundShape shape1,
      boolean swapped) {
    CollisionJNI.btGImpactCollisionAlgorithm_gimpact_vs_compoundshape(
        swigCPtr,
        this,
        btCollisionObjectWrapper.getCPtr(body0Wrap),
        body0Wrap,
        ...
        btGImpactShapeInterface.getCPtr(shape0),
        shape0,
        btCompoundShape.getCPtr(shape1),
        shape1,
        swapped);
  }
  ...
  public void gimpact_vs_concave(
      ...
      boolean swapped) {
    CollisionJNI.btGImpactCollisionAlgorithm_gimpact_vs_concave(
        swigCPtr,
        this,
        btCollisionObjectWrapper.getCPtr(body0Wrap),
        body0Wrap,
