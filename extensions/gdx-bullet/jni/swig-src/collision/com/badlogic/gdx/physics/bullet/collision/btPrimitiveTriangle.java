...
public class btPrimitiveTriangle extends BulletBase {
  ...
  /**
   * Construct a new btPrimitiveTriangle, normally you should not need this constructor it's
  ...
  public boolean overlap_test_conservative(btPrimitiveTriangle other) {
    return CollisionJNI.btPrimitiveTriangle_overlap_test_conservative(
        swigCPtr, this, btPrimitiveTriangle.getCPtr(other), other);
  }

  public void get_edge_plane(int edge_index, btVector4 plane) {
    CollisionJNI.btPrimitiveTriangle_get_edge_plane(
        swigCPtr, this, edge_index, btVector4.getCPtr(plane), plane);
  }
  ...
  public int clip_triangle(btPrimitiveTriangle other, btVector3 clipped_points) {
    return CollisionJNI.btPrimitiveTriangle_clip_triangle(
        swigCPtr,
        this,
        btPrimitiveTriangle.getCPtr(other),
        other,
        btVector3.getCPtr(clipped_points),
        clipped_points);
  }

  public boolean find_triangle_collision_clip_method(
      btPrimitiveTriangle other, GIM_TRIANGLE_CONTACT contacts) {
    return CollisionJNI.btPrimitiveTriangle_find_triangle_collision_clip_method(
        swigCPtr,
        this,
        btPrimitiveTriangle.getCPtr(other),
        other,
        GIM_TRIANGLE_CONTACT.getCPtr(contacts),
        contacts);
  }
}
