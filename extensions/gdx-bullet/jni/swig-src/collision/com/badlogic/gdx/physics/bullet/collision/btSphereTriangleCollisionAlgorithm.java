...
public class btSphereTriangleCollisionAlgorithm extends btActivatingCollisionAlgorithm {
  ...
  /**
   * Construct a new btSphereTriangleCollisionAlgorithm, normally you should not need this
  ...
  protected void reset(long cPtr, boolean cMemoryOwn) {
    ...
    super.reset(
        CollisionJNI.btSphereTriangleCollisionAlgorithm_SWIGUpcast(swigCPtr = cPtr), cMemoryOwn);
  }
  ...
  public btSphereTriangleCollisionAlgorithm(
      ...
      boolean swapped) {
    this(
        CollisionJNI.new_btSphereTriangleCollisionAlgorithm__SWIG_0(
  ...
  public btSphereTriangleCollisionAlgorithm(btCollisionAlgorithmConstructionInfo ci) {
    this(
        CollisionJNI.new_btSphereTriangleCollisionAlgorithm__SWIG_1(
            btCollisionAlgorithmConstructionInfo.getCPtr(ci), ci),
        true);
  }
  ...
  public static class CreateFunc extends btCollisionAlgorithmCreateFunc {
    ...
    protected CreateFunc(final String className, long cPtr, boolean cMemoryOwn) {
      super(
          className,
          CollisionJNI.btSphereTriangleCollisionAlgorithm_CreateFunc_SWIGUpcast(cPtr),
          cMemoryOwn);
      swigCPtr = cPtr;
    }
    ...
    protected void reset(long cPtr, boolean cMemoryOwn) {
      if (!destroyed) destroy();
      super.reset(
          CollisionJNI.btSphereTriangleCollisionAlgorithm_CreateFunc_SWIGUpcast(swigCPtr = cPtr),
          cMemoryOwn);
    }
