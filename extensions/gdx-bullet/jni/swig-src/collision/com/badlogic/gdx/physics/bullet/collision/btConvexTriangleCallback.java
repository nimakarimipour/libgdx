...
public class btConvexTriangleCallback extends btTriangleCallback {
  ...
  /**
   * Construct a new btConvexTriangleCallback, normally you should not need this constructor it's
  ...
  public long operatorNewArray(long sizeInBytes) {
    return CollisionJNI.btConvexTriangleCallback_operatorNewArray__SWIG_0(
  ...
  public long operatorNewArray(long arg0, long ptr) {
    return CollisionJNI.btConvexTriangleCallback_operatorNewArray__SWIG_1(
  ...
  public void setManifoldPtr(btPersistentManifold value) {
    CollisionJNI.btConvexTriangleCallback_manifoldPtr_set(
        swigCPtr, this, btPersistentManifold.getCPtr(value), value);
  }
  ...
  public btConvexTriangleCallback(
      ...
      boolean isSwapped) {
    this(
        CollisionJNI.new_btConvexTriangleCallback(
  ...
  public void setTimeStepAndCounters(
    ...
    CollisionJNI.btConvexTriangleCallback_setTimeStepAndCounters(
        swigCPtr,
        this,
        collisionMarginTriangle,
        btDispatcherInfo.getCPtr(dispatchInfo),
        dispatchInfo,
        btCollisionObjectWrapper.getCPtr(convexBodyWrap),
        convexBodyWrap,
        btCollisionObjectWrapper.getCPtr(triBodyWrap),
        triBodyWrap,
        btManifoldResult.getCPtr(resultOut),
        resultOut);
  }
  ...
  public void processTriangle(btVector3 triangle, int partId, int triangleIndex) {
    if (getClass() == btConvexTriangleCallback.class)
      CollisionJNI.btConvexTriangleCallback_processTriangle(
          swigCPtr, this, btVector3.getCPtr(triangle), triangle, partId, triangleIndex);
    else
      CollisionJNI.btConvexTriangleCallback_processTriangleSwigExplicitbtConvexTriangleCallback(
          swigCPtr, this, btVector3.getCPtr(triangle), triangle, partId, triangleIndex);
  }
