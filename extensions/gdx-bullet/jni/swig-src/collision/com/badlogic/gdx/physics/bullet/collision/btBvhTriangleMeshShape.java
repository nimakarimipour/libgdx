...
public class btBvhTriangleMeshShape extends btTriangleMeshShape {
  ...
  /**
   * Construct a new btBvhTriangleMeshShape, normally you should not need this constructor it's
  ...
  protected static final Array<btBvhTriangleMeshShape> instances =
      new Array<btBvhTriangleMeshShape>();

  protected static <T extends MeshPart> btBvhTriangleMeshShape getInstance(
      final Array<T> meshParts) {
    for (final btBvhTriangleMeshShape instance : instances) {
      if (instance.meshInterface instanceof btTriangleIndexVertexArray
          && btTriangleIndexVertexArray.compare(
              (btTriangleIndexVertexArray) (instance.meshInterface), meshParts)) return instance;
    }
    return null;
  }

  /**
   * Obtain an instance of btBvhTriangleMeshShape, made up of the specified {@link MeshPart}
   * instances. Where possible previously obtained objects are reused. You must call {@link
   * #release()}, when you no longer need the shape.
   */
  ...
  public <T extends MeshPart> btBvhTriangleMeshShape(
      final Array<T> meshParts, boolean useQuantizedAabbCompression) {
    this(1, btTriangleIndexVertexArray.obtain(meshParts), useQuantizedAabbCompression);
  }

  public <T extends MeshPart> btBvhTriangleMeshShape(
      final Array<T> meshParts, boolean useQuantizedAabbCompression, boolean buildBvh) {
  ...
  public <T extends MeshPart> btBvhTriangleMeshShape(
    ...
    this(
        1,
        btTriangleIndexVertexArray.obtain(meshParts),
  ...
  private btBvhTriangleMeshShape(
      int obtained, btStridingMeshInterface meshInterface, boolean useQuantizedAabbCompression) {
  ...
  public long operatorNewArray(long sizeInBytes) {
    return CollisionJNI.btBvhTriangleMeshShape_operatorNewArray__SWIG_0(
  ...
  public void performRaycast(btTriangleCallback callback, Vector3 raySource, Vector3 rayTarget) {
    CollisionJNI.btBvhTriangleMeshShape_performRaycast(
        swigCPtr, this, btTriangleCallback.getCPtr(callback), callback, raySource, rayTarget);
  }
  ...
  public void performConvexcast(
      ...
      Vector3 boxMin,
      Vector3 boxMax) {
    CollisionJNI.btBvhTriangleMeshShape_performConvexcast(
        swigCPtr,
        this,
        btTriangleCallback.getCPtr(callback),
        callback,
        boxSource,
        boxTarget,
        boxMin,
  ...
  public void setOptimizedBvh(btOptimizedBvh bvh, Vector3 localScaling) {
    CollisionJNI.btBvhTriangleMeshShape_setOptimizedBvh__SWIG_0(
        swigCPtr, this, btOptimizedBvh.getCPtr(bvh), bvh, localScaling);
  }

  public void setOptimizedBvh(btOptimizedBvh bvh) {
    CollisionJNI.btBvhTriangleMeshShape_setOptimizedBvh__SWIG_1(
        swigCPtr, this, btOptimizedBvh.getCPtr(bvh), bvh);
  }
  ...
  public void setTriangleInfoMap(btTriangleInfoMap triangleInfoMap) {
    CollisionJNI.btBvhTriangleMeshShape_setTriangleInfoMap(
        swigCPtr, this, btTriangleInfoMap.getCPtr(triangleInfoMap), triangleInfoMap);
  }
  ...
  public void serializeSingleBvh(btSerializer serializer) {
    CollisionJNI.btBvhTriangleMeshShape_serializeSingleBvh(
        swigCPtr, this, btSerializer.getCPtr(serializer), serializer);
  }

  public void serializeSingleTriangleInfoMap(btSerializer serializer) {
    CollisionJNI.btBvhTriangleMeshShape_serializeSingleTriangleInfoMap(
        swigCPtr, this, btSerializer.getCPtr(serializer), serializer);
  }
  ...
  private btBvhTriangleMeshShape(
      ...
      boolean buildBvh) {
    this(
        CollisionJNI.new_btBvhTriangleMeshShape__SWIG_0(
            dummy,
  ...
  private btBvhTriangleMeshShape(
      boolean dummy, btStridingMeshInterface meshInterface, boolean useQuantizedAabbCompression) {
    this(
        CollisionJNI.new_btBvhTriangleMeshShape__SWIG_1(
            dummy,
            btStridingMeshInterface.getCPtr(meshInterface),
            meshInterface,
            useQuantizedAabbCompression),
  ...
  private btBvhTriangleMeshShape(
      ...
      boolean buildBvh) {
    this(
        CollisionJNI.new_btBvhTriangleMeshShape__SWIG_2(
            dummy,
            btStridingMeshInterface.getCPtr(meshInterface),
            meshInterface,
            useQuantizedAabbCompression,
  ...
  private btBvhTriangleMeshShape(
      ...
      Vector3 bvhAabbMax) {
    this(
        CollisionJNI.new_btBvhTriangleMeshShape__SWIG_3(
            dummy,
            btStridingMeshInterface.getCPtr(meshInterface),
            meshInterface,
            useQuantizedAabbCompression,
