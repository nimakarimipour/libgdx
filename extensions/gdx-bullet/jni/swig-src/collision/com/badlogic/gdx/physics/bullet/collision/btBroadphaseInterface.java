...
public class btBroadphaseInterface extends BulletBase {
  ...
  /**
   * Construct a new btBroadphaseInterface, normally you should not need this constructor it's
  ...
  public btBroadphaseProxy createProxy(
    ...
    return btBroadphaseProxy.internalTemp(
        CollisionJNI.btBroadphaseInterface_createProxy(
            swigCPtr,
            this,
            aabbMin,
            aabbMax,
  ...
  public void destroyProxy(btBroadphaseProxy proxy, btDispatcher dispatcher) {
    CollisionJNI.btBroadphaseInterface_destroyProxy(
        swigCPtr,
        this,
  ...
  public void setAabb(
      btBroadphaseProxy proxy, Vector3 aabbMin, Vector3 aabbMax, btDispatcher dispatcher) {
    CollisionJNI.btBroadphaseInterface_setAabb(
        swigCPtr,
        this,
        btBroadphaseProxy.getCPtr(proxy),
        proxy,
  ...
  public void getAabb(btBroadphaseProxy proxy, Vector3 aabbMin, Vector3 aabbMax) {
    CollisionJNI.btBroadphaseInterface_getAabb(
  ...
  public void rayTest(
      ...
      Vector3 aabbMin,
      Vector3 aabbMax) {
    CollisionJNI.btBroadphaseInterface_rayTest__SWIG_0(
        swigCPtr,
        this,
        rayFrom,
        rayTo,
  ...
  public void rayTest(
    ...
    CollisionJNI.btBroadphaseInterface_rayTest__SWIG_1(
        swigCPtr,
        this,
        rayFrom,
        rayTo,
  ...
  public void rayTest(Vector3 rayFrom, Vector3 rayTo, btBroadphaseRayCallback rayCallback) {
    CollisionJNI.btBroadphaseInterface_rayTest__SWIG_2(
  ...
  public void aabbTest(Vector3 aabbMin, Vector3 aabbMax, btBroadphaseAabbCallback callback) {
    CollisionJNI.btBroadphaseInterface_aabbTest(
        swigCPtr, this, aabbMin, aabbMax, btBroadphaseAabbCallback.getCPtr(callback), callback);
  }

  public void calculateOverlappingPairs(btDispatcher dispatcher) {
    CollisionJNI.btBroadphaseInterface_calculateOverlappingPairs(
  ...
  public void resetPool(btDispatcher dispatcher) {
    CollisionJNI.btBroadphaseInterface_resetPool(
        swigCPtr, this, btDispatcher.getCPtr(dispatcher), dispatcher);
  }
