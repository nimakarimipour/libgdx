...
public class btMultiSphereShapeData extends BulletBase {
  ...
  /**
   * Construct a new btMultiSphereShapeData, normally you should not need this constructor it's
  ...
  public void setConvexInternalShapeData(btConvexInternalShapeData value) {
    CollisionJNI.btMultiSphereShapeData_convexInternalShapeData_set(
  ...
  public void setLocalPositionArrayPtr(btPositionAndRadius value) {
    CollisionJNI.btMultiSphereShapeData_localPositionArrayPtr_set(
        swigCPtr, this, btPositionAndRadius.getCPtr(value), value);
  }
