...
public class btSoftSoftCollisionAlgorithm extends btCollisionAlgorithm {
  ...
  /**
   * Construct a new btSoftSoftCollisionAlgorithm, normally you should not need this constructor
  ...
  public btSoftSoftCollisionAlgorithm(btCollisionAlgorithmConstructionInfo ci) {
    this(
        SoftbodyJNI.new_btSoftSoftCollisionAlgorithm__SWIG_0(
            btCollisionAlgorithmConstructionInfo.getCPtr(ci), ci),
        true);
  }

  public btSoftSoftCollisionAlgorithm(
      btPersistentManifold mf,
      btCollisionAlgorithmConstructionInfo ci,
      btCollisionObjectWrapper body0Wrap,
      btCollisionObjectWrapper body1Wrap) {
    this(
        SoftbodyJNI.new_btSoftSoftCollisionAlgorithm__SWIG_1(
  ...
  public static class CreateFunc extends btCollisionAlgorithmCreateFunc {
    ...
    protected CreateFunc(final String className, long cPtr, boolean cMemoryOwn) {
      super(
          className,
          SoftbodyJNI.btSoftSoftCollisionAlgorithm_CreateFunc_SWIGUpcast(cPtr),
          cMemoryOwn);
      swigCPtr = cPtr;
    }
    ...
    protected void reset(long cPtr, boolean cMemoryOwn) {
      if (!destroyed) destroy();
      super.reset(
          SoftbodyJNI.btSoftSoftCollisionAlgorithm_CreateFunc_SWIGUpcast(swigCPtr = cPtr),
          cMemoryOwn);
    }
