...
public class SoftBodyPoseData extends BulletBase {
  ...
  /**
   * Construct a new SoftBodyPoseData, normally you should not need this constructor it's intended
   * for low-level usage.
   */
  ...
  public void setRot(btMatrix3x3FloatData value) {
    SoftbodyJNI.SoftBodyPoseData_rot_set(
  ...
  public void setScale(btMatrix3x3FloatData value) {
    SoftbodyJNI.SoftBodyPoseData_scale_set(
        swigCPtr, this, btMatrix3x3FloatData.getCPtr(value), value);
  }
  ...
  public void setAqq(btMatrix3x3FloatData value) {
    SoftbodyJNI.SoftBodyPoseData_aqq_set(
        swigCPtr, this, btMatrix3x3FloatData.getCPtr(value), value);
  }
  ...
  public void setPositions(btVector3FloatData value) {
    SoftbodyJNI.SoftBodyPoseData_positions_set(
