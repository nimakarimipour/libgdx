...
public class SoftRigidAnchorData extends BulletBase {
  ...
  /**
   * Construct a new SoftRigidAnchorData, normally you should not need this constructor it's
  ...
  public void setC0(btMatrix3x3FloatData value) {
    SoftbodyJNI.SoftRigidAnchorData_c0_set(
  ...
  public void setC1(btVector3FloatData value) {
    SoftbodyJNI.SoftRigidAnchorData_c1_set(
  ...
  public void setLocalFrame(btVector3FloatData value) {
    SoftbodyJNI.SoftRigidAnchorData_localFrame_set(
        swigCPtr, this, btVector3FloatData.getCPtr(value), value);
  }
  ...
  public void setRigidBody(btRigidBodyFloatData value) {
    SoftbodyJNI.SoftRigidAnchorData_rigidBody_set(
