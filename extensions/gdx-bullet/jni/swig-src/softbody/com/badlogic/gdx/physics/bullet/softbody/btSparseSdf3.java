...
public class btSparseSdf3 extends BulletBase {
  ...
  /**
   * Construct a new btSparseSdf3, normally you should not need this constructor it's intended for
   * low-level usage.
   */
  ...
  public static class IntFrac extends BulletBase {
    ...
    /**
     * Construct a new IntFrac, normally you should not need this constructor it's intended for
     * low-level usage.
     */
  ...
  public static class Cell extends BulletBase {
    ...
    /**
     * Construct a new Cell, normally you should not need this constructor it's intended for
     * low-level usage.
     */
    ...
    public void setD(SWIGTYPE_p_a_3_1__a_3_1__float value) {
      SoftbodyJNI.btSparseSdf3_Cell_d_set(
          swigCPtr, this, SWIGTYPE_p_a_3_1__a_3_1__float.getCPtr(value));
    }
    ...
    public void setPclient(btCollisionShape value) {
      SoftbodyJNI.btSparseSdf3_Cell_pclient_set(
    ...
    public void setNext(btSparseSdf3.Cell value) {
      SoftbodyJNI.btSparseSdf3_Cell_next_set(
          swigCPtr, this, btSparseSdf3.Cell.getCPtr(value), value);
    }
  ...
  public void setCells(SWIGTYPE_p_btAlignedObjectArrayT_btSparseSdfT_3_t__Cell_p_t value) {
    SoftbodyJNI.btSparseSdf3_cells_set(
        swigCPtr, this, SWIGTYPE_p_btAlignedObjectArrayT_btSparseSdfT_3_t__Cell_p_t.getCPtr(value));
  }
  ...
  public SWIGTYPE_p_btAlignedObjectArrayT_btSparseSdfT_3_t__Cell_p_t getCells() {
    ...
    return (cPtr == 0)
        ? null
        : new SWIGTYPE_p_btAlignedObjectArrayT_btSparseSdfT_3_t__Cell_p_t(cPtr, false);
  }
  ...
  public int RemoveReferences(btCollisionShape pcs) {
    return SoftbodyJNI.btSparseSdf3_RemoveReferences(
        swigCPtr, this, btCollisionShape.getCPtr(pcs), pcs);
  }

  public float Evaluate(Vector3 x, btCollisionShape shape, Vector3 normal, float margin) {
    return SoftbodyJNI.btSparseSdf3_Evaluate(
        swigCPtr, this, x, btCollisionShape.getCPtr(shape), shape, normal, margin);
  }
