...
public class SoftBodyFaceData extends BulletBase {
  ...
  /**
   * Construct a new SoftBodyFaceData, normally you should not need this constructor it's intended
   * for low-level usage.
   */
  ...
  public void setNormal(btVector3FloatData value) {
    SoftbodyJNI.SoftBodyFaceData_normal_set(
  ...
  public void setMaterial(SoftBodyMaterialData value) {
    SoftbodyJNI.SoftBodyFaceData_material_set(
