...
public class btSoftBodyConcaveCollisionAlgorithm extends btCollisionAlgorithm {
  ...
  /**
   * Construct a new btSoftBodyConcaveCollisionAlgorithm, normally you should not need this
  ...
  public btSoftBodyConcaveCollisionAlgorithm(
      ...
      boolean isSwapped) {
    this(
        SoftbodyJNI.new_btSoftBodyConcaveCollisionAlgorithm(
  ...
  public static class CreateFunc extends btCollisionAlgorithmCreateFunc {
    ...
    protected CreateFunc(final String className, long cPtr, boolean cMemoryOwn) {
      super(
          className,
          SoftbodyJNI.btSoftBodyConcaveCollisionAlgorithm_CreateFunc_SWIGUpcast(cPtr),
          cMemoryOwn);
      swigCPtr = cPtr;
    }
    ...
    protected void reset(long cPtr, boolean cMemoryOwn) {
      if (!destroyed) destroy();
      super.reset(
          SoftbodyJNI.btSoftBodyConcaveCollisionAlgorithm_CreateFunc_SWIGUpcast(swigCPtr = cPtr),
          cMemoryOwn);
    }
  ...
  public static class SwappedCreateFunc extends btCollisionAlgorithmCreateFunc {
    ...
    protected SwappedCreateFunc(final String className, long cPtr, boolean cMemoryOwn) {
      super(
          className,
          SoftbodyJNI.btSoftBodyConcaveCollisionAlgorithm_SwappedCreateFunc_SWIGUpcast(cPtr),
          cMemoryOwn);
      swigCPtr = cPtr;
    }
