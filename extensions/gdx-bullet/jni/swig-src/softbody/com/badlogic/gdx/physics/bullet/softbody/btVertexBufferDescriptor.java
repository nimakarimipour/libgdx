...
public class btVertexBufferDescriptor extends BulletBase {
  ...
  /**
   * Construct a new btVertexBufferDescriptor, normally you should not need this constructor it's
  ...
  public static final class BufferTypes {
    public static final int CPU_BUFFER = 0;
    public static final int DX11_BUFFER = CPU_BUFFER + 1;
    public static final int OPENGL_BUFFER = DX11_BUFFER + 1;
  }
}
