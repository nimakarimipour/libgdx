...
public class btSoftColliders extends BulletBase {
  ...
  /**
   * Construct a new btSoftColliders, normally you should not need this constructor it's intended
   * for low-level usage.
   */
  ...
  public static class ClusterBase extends ICollide {
    ...
    /**
     * Construct a new ClusterBase, normally you should not need this constructor it's intended for
     * low-level usage.
     */
    ...
    public boolean SolveContact(
        btGjkEpaSolver2.sResults res,
        btSoftBody.Body ba,
        btSoftBody.Body bb,
        btSoftBody.CJoint joint) {
      return SoftbodyJNI.btSoftColliders_ClusterBase_SolveContact(
          swigCPtr,
          this,
          btGjkEpaSolver2.sResults.getCPtr(res),
          res,
          btSoftBody.Body.getCPtr(ba),
          ba,
          btSoftBody.Body.getCPtr(bb),
          bb,
          btSoftBody.CJoint.getCPtr(joint),
          joint);
    }
  }

  public static class CollideCL_RS extends btSoftColliders.ClusterBase {
    private long swigCPtr;
    ...
    /**
     * Construct a new CollideCL_RS, normally you should not need this constructor it's intended for
     * low-level usage.
     */
    ...
    public void setPsb(btSoftBody value) {
      SoftbodyJNI.btSoftColliders_CollideCL_RS_psb_set(
          swigCPtr, this, btSoftBody.getCPtr(value), value);
    }
    ...
    public void setColObjWrap(btCollisionObjectWrapper value) {
      SoftbodyJNI.btSoftColliders_CollideCL_RS_colObjWrap_set(
          swigCPtr, this, btCollisionObjectWrapper.getCPtr(value), value);
    }

    public btCollisionObjectWrapper getColObjWrap() {
      return btCollisionObjectWrapper.internalTemp(
          SoftbodyJNI.btSoftColliders_CollideCL_RS_colObjWrap_get(swigCPtr, this), false);
    }

    public void ProcessColObj(btSoftBody ps, btCollisionObjectWrapper colObWrap) {
      SoftbodyJNI.btSoftColliders_CollideCL_RS_ProcessColObj(
          swigCPtr,
          this,
          btSoftBody.getCPtr(ps),
          ps,
          btCollisionObjectWrapper.getCPtr(colObWrap),
          colObWrap);
    }
  ...
  public static class CollideCL_SS extends btSoftColliders.ClusterBase {
    private long swigCPtr;
    ...
    /**
     * Construct a new CollideCL_SS, normally you should not need this constructor it's intended for
     * low-level usage.
     */
    ...
    public void setBodies(SWIGTYPE_p_p_btSoftBody value) {
      SoftbodyJNI.btSoftColliders_CollideCL_SS_bodies_set(
          swigCPtr, this, SWIGTYPE_p_p_btSoftBody.getCPtr(value));
    }
    ...
    public void ProcessSoftSoft(btSoftBody psa, btSoftBody psb) {
      SoftbodyJNI.btSoftColliders_CollideCL_SS_ProcessSoftSoft(
          swigCPtr, this, btSoftBody.getCPtr(psa), psa, btSoftBody.getCPtr(psb), psb);
    }
  ...
  public static class CollideSDF_RS extends ICollide {
    ...
    /**
     * Construct a new CollideSDF_RS, normally you should not need this constructor it's intended
     * for low-level usage.
     */
    ...
    protected void reset(long cPtr, boolean cMemoryOwn) {
      if (!destroyed) destroy();
      super.reset(
          SoftbodyJNI.btSoftColliders_CollideSDF_RS_SWIGUpcast(swigCPtr = cPtr), cMemoryOwn);
    }
    ...
    public void DoNode(btSoftBody.Node n) {
      SoftbodyJNI.btSoftColliders_CollideSDF_RS_DoNode(
          swigCPtr, this, btSoftBody.Node.getCPtr(n), n);
    }

    public void setPsb(btSoftBody value) {
      SoftbodyJNI.btSoftColliders_CollideSDF_RS_psb_set(
          swigCPtr, this, btSoftBody.getCPtr(value), value);
    }
    ...
    public void setColObj1Wrap(btCollisionObjectWrapper value) {
      SoftbodyJNI.btSoftColliders_CollideSDF_RS_colObj1Wrap_set(
          swigCPtr, this, btCollisionObjectWrapper.getCPtr(value), value);
    }

    public btCollisionObjectWrapper getColObj1Wrap() {
      return btCollisionObjectWrapper.internalTemp(
          SoftbodyJNI.btSoftColliders_CollideSDF_RS_colObj1Wrap_get(swigCPtr, this), false);
    }

    public void setRigidBody(btRigidBody value) {
      SoftbodyJNI.btSoftColliders_CollideSDF_RS_rigidBody_set(
          swigCPtr, this, btRigidBody.getCPtr(value), value);
    }

    public btRigidBody getRigidBody() {
      return btRigidBody.getInstance(
          SoftbodyJNI.btSoftColliders_CollideSDF_RS_rigidBody_get(swigCPtr, this), false);
    }
  ...
  public static class CollideVF_SS extends ICollide {
    ...
    /**
     * Construct a new CollideVF_SS, normally you should not need this constructor it's intended for
     * low-level usage.
     */
    ...
    public void setPsb(SWIGTYPE_p_p_btSoftBody value) {
      SoftbodyJNI.btSoftColliders_CollideVF_SS_psb_set(
          swigCPtr, this, SWIGTYPE_p_p_btSoftBody.getCPtr(value));
    }
