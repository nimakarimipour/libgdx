...
public class btTriIndex extends BulletBase {
  ...
  /**
   * Construct a new btTriIndex, normally you should not need this constructor it's intended for
   * low-level usage.
   */
  ...
  public btTriIndex(int partId, int triangleIndex, btCollisionShape shape) {
    this(
        SoftbodyJNI.new_btTriIndex(partId, triangleIndex, btCollisionShape.getCPtr(shape), shape),
        true);
  }
