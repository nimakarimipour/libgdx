...
public class btSoftMultiBodyDynamicsWorld extends btMultiBodyDynamicsWorld {
  ...
  /**
   * Construct a new btSoftMultiBodyDynamicsWorld, normally you should not need this constructor
  ...
  public btSoftMultiBodyDynamicsWorld(
    ...
    this(
        SoftbodyJNI.new_btSoftMultiBodyDynamicsWorld__SWIG_0(
            ...
            btSoftBodySolver.getCPtr(softBodySolver),
            softBodySolver),
        true);
  }
  ...
  public btSoftMultiBodyDynamicsWorld(
      ...
      btCollisionConfiguration collisionConfiguration) {
    this(
        SoftbodyJNI.new_btSoftMultiBodyDynamicsWorld__SWIG_1(
            btDispatcher.getCPtr(dispatcher),
            dispatcher,
            btBroadphaseInterface.getCPtr(pairCache),
            pairCache,
  ...
  public void addSoftBody(btSoftBody body, int collisionFilterGroup, int collisionFilterMask) {
    SoftbodyJNI.btSoftMultiBodyDynamicsWorld_addSoftBody__SWIG_0(
        swigCPtr, this, btSoftBody.getCPtr(body), body, collisionFilterGroup, collisionFilterMask);
  }

  public void addSoftBody(btSoftBody body, int collisionFilterGroup) {
    SoftbodyJNI.btSoftMultiBodyDynamicsWorld_addSoftBody__SWIG_1(
        swigCPtr, this, btSoftBody.getCPtr(body), body, collisionFilterGroup);
  }

  public void addSoftBody(btSoftBody body) {
    SoftbodyJNI.btSoftMultiBodyDynamicsWorld_addSoftBody__SWIG_2(
        swigCPtr, this, btSoftBody.getCPtr(body), body);
  }

  public void removeSoftBody(btSoftBody body) {
    SoftbodyJNI.btSoftMultiBodyDynamicsWorld_removeSoftBody(
        swigCPtr, this, btSoftBody.getCPtr(body), body);
  }
  ...
  public btSoftBodyWorldInfo getWorldInfo() {
    return new btSoftBodyWorldInfo(
        SoftbodyJNI.btSoftMultiBodyDynamicsWorld_getWorldInfo(swigCPtr, this), false);
  }

  public btSoftBodyWorldInfo getWorldInfoConst() {
    return new btSoftBodyWorldInfo(
        SoftbodyJNI.btSoftMultiBodyDynamicsWorld_getWorldInfoConst(swigCPtr, this), false);
  }
  ...
  public static void rayTestSingle(
    ...
    SoftbodyJNI.btSoftMultiBodyDynamicsWorld_rayTestSingle(
        rayFromTrans,
        rayToTrans,
