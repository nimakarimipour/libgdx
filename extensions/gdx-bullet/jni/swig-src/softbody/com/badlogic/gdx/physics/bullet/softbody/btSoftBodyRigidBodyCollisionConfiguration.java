...
public class btSoftBodyRigidBodyCollisionConfiguration extends btDefaultCollisionConfiguration {
  ...
  protected btSoftBodyRigidBodyCollisionConfiguration(
    ...
    super(
        className,
        SoftbodyJNI.btSoftBodyRigidBodyCollisionConfiguration_SWIGUpcast(cPtr),
        cMemoryOwn);
    swigCPtr = cPtr;
  }

  /**
   * Construct a new btSoftBodyRigidBodyCollisionConfiguration, normally you should not need this
  ...
  protected void reset(long cPtr, boolean cMemoryOwn) {
    ...
    super.reset(
        SoftbodyJNI.btSoftBodyRigidBodyCollisionConfiguration_SWIGUpcast(swigCPtr = cPtr),
        cMemoryOwn);
  }
  ...
  public btSoftBodyRigidBodyCollisionConfiguration(
    ...
    this(
        SoftbodyJNI.new_btSoftBodyRigidBodyCollisionConfiguration__SWIG_0(
