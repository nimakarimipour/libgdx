...
public class btSoftBodySolver extends BulletBase {
  ...
  /**
   * Construct a new btSoftBodySolver, normally you should not need this constructor it's intended
   * for low-level usage.
   */
  ...
  public void optimize(
    ...
    SoftbodyJNI.btSoftBodySolver_optimize__SWIG_0(
        swigCPtr,
        this,
  ...
  public void optimize(SWIGTYPE_p_btAlignedObjectArrayT_btSoftBody_p_t softBodies) {
    SoftbodyJNI.btSoftBodySolver_optimize__SWIG_1(
  ...
  public void processCollision(btSoftBody arg0, btCollisionObjectWrapper arg1) {
    SoftbodyJNI.btSoftBodySolver_processCollision__SWIG_0(
        swigCPtr,
        this,
  ...
  public void processCollision(btSoftBody arg0, btSoftBody arg1) {
    SoftbodyJNI.btSoftBodySolver_processCollision__SWIG_1(
  ...
  public static final class SolverTypes {
    ...
    public static final int CPU_SOLVER = DEFAULT_SOLVER + 1;
    public static final int CL_SOLVER = CPU_SOLVER + 1;
    public static final int CL_SIMD_SOLVER = CL_SOLVER + 1;
    public static final int DX_SOLVER = CL_SIMD_SOLVER + 1;
    public static final int DX_SIMD_SOLVER = DX_SOLVER + 1;
  }
}
