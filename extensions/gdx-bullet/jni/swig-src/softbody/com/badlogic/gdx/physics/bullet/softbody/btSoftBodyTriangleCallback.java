...
public class btSoftBodyTriangleCallback extends btTriangleCallback {
  ...
  /**
   * Construct a new btSoftBodyTriangleCallback, normally you should not need this constructor it's
  ...
  public btSoftBodyTriangleCallback(
      btDispatcher dispatcher,
      btCollisionObjectWrapper body0Wrap,
      btCollisionObjectWrapper body1Wrap,
      boolean isSwapped) {
    this(
        SoftbodyJNI.new_btSoftBodyTriangleCallback(
  ...
  public void setTimeStepAndCounters(
    ...
    SoftbodyJNI.btSoftBodyTriangleCallback_setTimeStepAndCounters(
        swigCPtr,
        this,
        collisionMarginTriangle,
        btCollisionObjectWrapper.getCPtr(triObjWrap),
        triObjWrap,
