...
public class btSoftBodyWorldInfo extends BulletBase {
  ...
  /**
   * Construct a new btSoftBodyWorldInfo, normally you should not need this constructor it's
  ...
  public void setWater_normal(btVector3 value) {
    SoftbodyJNI.btSoftBodyWorldInfo_water_normal_set(
  ...
  public void setBroadphase(btBroadphaseInterface value) {
    SoftbodyJNI.btSoftBodyWorldInfo_broadphase_set(
        swigCPtr, this, btBroadphaseInterface.getCPtr(value), value);
  }
  ...
  public void setDispatcher(btDispatcher value) {
    SoftbodyJNI.btSoftBodyWorldInfo_dispatcher_set(
  ...
  public void setSparsesdf(btSparseSdf3 value) {
    SoftbodyJNI.btSoftBodyWorldInfo_sparsesdf_set(
        swigCPtr, this, btSparseSdf3.getCPtr(value), value);
  }
