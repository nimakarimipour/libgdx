...
public class btSoftRigidDynamicsWorld extends btDiscreteDynamicsWorld {
  ...
  /**
   * Construct a new btSoftRigidDynamicsWorld, normally you should not need this constructor it's
  ...
  public btSoftRigidDynamicsWorld(
    ...
    this(
        SoftbodyJNI.new_btSoftRigidDynamicsWorld__SWIG_0(
  ...
  public btSoftRigidDynamicsWorld(
      ...
      btCollisionConfiguration collisionConfiguration) {
    this(
        SoftbodyJNI.new_btSoftRigidDynamicsWorld__SWIG_1(
            btDispatcher.getCPtr(dispatcher),
            dispatcher,
            btBroadphaseInterface.getCPtr(pairCache),
            pairCache,
  ...
  public void addSoftBody(btSoftBody body, int collisionFilterGroup, int collisionFilterMask) {
    SoftbodyJNI.btSoftRigidDynamicsWorld_addSoftBody__SWIG_0(
  ...
  public btSoftBodyWorldInfo getWorldInfo() {
    return new btSoftBodyWorldInfo(
        SoftbodyJNI.btSoftRigidDynamicsWorld_getWorldInfo(swigCPtr, this), false);
  }

  public btSoftBodyWorldInfo getWorldInfoConst() {
    return new btSoftBodyWorldInfo(
        SoftbodyJNI.btSoftRigidDynamicsWorld_getWorldInfoConst(swigCPtr, this), false);
  }
  ...
  public static void rayTestSingle(
    ...
    SoftbodyJNI.btSoftRigidDynamicsWorld_rayTestSingle(
        rayFromTrans,
        rayToTrans,
