...
public class btSoftBodyFloatData extends BulletBase {
  ...
  /**
   * Construct a new btSoftBodyFloatData, normally you should not need this constructor it's
  ...
  public void setCollisionObjectData(btCollisionObjectFloatData value) {
    SoftbodyJNI.btSoftBodyFloatData_collisionObjectData_set(
        swigCPtr, this, btCollisionObjectFloatData.getCPtr(value), value);
  }
  ...
  public void setPose(SoftBodyPoseData value) {
    SoftbodyJNI.btSoftBodyFloatData_pose_set(
        swigCPtr, this, SoftBodyPoseData.getCPtr(value), value);
  }
  ...
  public void setMaterials(SWIGTYPE_p_p_SoftBodyMaterialData value) {
    SoftbodyJNI.btSoftBodyFloatData_materials_set(
        swigCPtr, this, SWIGTYPE_p_p_SoftBodyMaterialData.getCPtr(value));
  }
  ...
  public void setNodes(SoftBodyNodeData value) {
    SoftbodyJNI.btSoftBodyFloatData_nodes_set(
        swigCPtr, this, SoftBodyNodeData.getCPtr(value), value);
  }
  ...
  public void setLinks(SoftBodyLinkData value) {
    SoftbodyJNI.btSoftBodyFloatData_links_set(
        swigCPtr, this, SoftBodyLinkData.getCPtr(value), value);
  }
  ...
  public void setFaces(SoftBodyFaceData value) {
    SoftbodyJNI.btSoftBodyFloatData_faces_set(
        swigCPtr, this, SoftBodyFaceData.getCPtr(value), value);
  }
  ...
  public void setTetrahedra(SoftBodyTetraData value) {
    SoftbodyJNI.btSoftBodyFloatData_tetrahedra_set(
        swigCPtr, this, SoftBodyTetraData.getCPtr(value), value);
  }
  ...
  public void setAnchors(SoftRigidAnchorData value) {
    SoftbodyJNI.btSoftBodyFloatData_anchors_set(
        swigCPtr, this, SoftRigidAnchorData.getCPtr(value), value);
  }
  ...
  public void setClusters(SoftBodyClusterData value) {
    SoftbodyJNI.btSoftBodyFloatData_clusters_set(
        swigCPtr, this, SoftBodyClusterData.getCPtr(value), value);
  }
  ...
  public void setJoints(btSoftBodyJointData value) {
    SoftbodyJNI.btSoftBodyFloatData_joints_set(
        swigCPtr, this, btSoftBodyJointData.getCPtr(value), value);
  }
  ...
  public void setConfig(SoftBodyConfigData value) {
    SoftbodyJNI.btSoftBodyFloatData_config_set(
        swigCPtr, this, SoftBodyConfigData.getCPtr(value), value);
  }
