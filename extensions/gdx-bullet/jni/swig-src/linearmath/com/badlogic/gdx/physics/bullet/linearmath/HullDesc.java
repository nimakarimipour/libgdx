...
public class HullDesc extends BulletBase {
  ...
  /**
   * Construct a new HullDesc, normally you should not need this constructor it's intended for
   * low-level usage.
   */
  ...
  public HullDesc(int flag, long vcount, btVector3 vertices, long stride) {
    this(
        LinearMathJNI.new_HullDesc__SWIG_1(
            flag, vcount, btVector3.getCPtr(vertices), vertices, stride),
        true);
  }

  public HullDesc(int flag, long vcount, btVector3 vertices) {
    this(
        LinearMathJNI.new_HullDesc__SWIG_2(flag, vcount, btVector3.getCPtr(vertices), vertices),
        true);
  }
