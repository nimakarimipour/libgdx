...
public class btSymmetricSpatialDyad extends BulletBase {
  ...
  /**
   * Construct a new btSymmetricSpatialDyad, normally you should not need this constructor it's
  ...
  public void setTopLeftMat(btMatrix3x3 value) {
    LinearMathJNI.btSymmetricSpatialDyad_topLeftMat_set(
  ...
  public void setTopRightMat(btMatrix3x3 value) {
    LinearMathJNI.btSymmetricSpatialDyad_topRightMat_set(
        swigCPtr, this, btMatrix3x3.getCPtr(value), value);
  }
  ...
  public void setBottomLeftMat(btMatrix3x3 value) {
    LinearMathJNI.btSymmetricSpatialDyad_bottomLeftMat_set(
        swigCPtr, this, btMatrix3x3.getCPtr(value), value);
  }
  ...
  public btSymmetricSpatialDyad(Matrix3 topLeftMat, Matrix3 topRightMat, Matrix3 bottomLeftMat) {
    this(
        LinearMathJNI.new_btSymmetricSpatialDyad__SWIG_1(topLeftMat, topRightMat, bottomLeftMat),
        true);
  }

  public void setMatrix(Matrix3 topLeftMat, Matrix3 topRightMat, Matrix3 bottomLeftMat) {
    LinearMathJNI.btSymmetricSpatialDyad_setMatrix(
        swigCPtr, this, topLeftMat, topRightMat, bottomLeftMat);
  }

  public void addMatrix(Matrix3 topLeftMat, Matrix3 topRightMat, Matrix3 bottomLeftMat) {
    LinearMathJNI.btSymmetricSpatialDyad_addMatrix(
        swigCPtr, this, topLeftMat, topRightMat, bottomLeftMat);
  }
  ...
  public btSymmetricSpatialDyad operatorSubtractionAssignment(btSymmetricSpatialDyad mat) {
    return new btSymmetricSpatialDyad(
        LinearMathJNI.btSymmetricSpatialDyad_operatorSubtractionAssignment(
            swigCPtr, this, btSymmetricSpatialDyad.getCPtr(mat), mat),
        false);
  }

  public btSpatialForceVector operatorMultiplication(btSpatialMotionVector vec) {
    return new btSpatialForceVector(
        LinearMathJNI.btSymmetricSpatialDyad_operatorMultiplication(
            swigCPtr, this, btSpatialMotionVector.getCPtr(vec), vec),
        true);
  }
}
