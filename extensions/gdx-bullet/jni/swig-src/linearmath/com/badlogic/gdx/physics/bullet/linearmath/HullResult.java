...
public class HullResult extends BulletBase {
  ...
  /**
   * Construct a new HullResult, normally you should not need this constructor it's intended for
   * low-level usage.
   */
  ...
  public void setOutputVertices(btVector3Array value) {
    LinearMathJNI.HullResult_OutputVertices_set(
  ...
  public void setIndices(SWIGTYPE_p_btAlignedObjectArrayT_unsigned_int_t value) {
    LinearMathJNI.HullResult_Indices_set(
        swigCPtr, this, SWIGTYPE_p_btAlignedObjectArrayT_unsigned_int_t.getCPtr(value));
  }
