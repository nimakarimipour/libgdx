...
public class btIDebugDraw extends BulletBase {
  ...
  /**
   * Construct a new btIDebugDraw, normally you should not need this constructor it's intended for
   * low-level usage.
   */
  ...
  public static class DefaultColors extends BulletBase {
    ...
    /**
     * Construct a new DefaultColors, normally you should not need this constructor it's intended
     * for low-level usage.
     */
    ...
    public void setActiveObject(btVector3 value) {
      LinearMathJNI.btIDebugDraw_DefaultColors_activeObject_set(
    ...
    public void setDeactivatedObject(btVector3 value) {
      LinearMathJNI.btIDebugDraw_DefaultColors_deactivatedObject_set(
          swigCPtr, this, btVector3.getCPtr(value), value);
    }
    ...
    public void setWantsDeactivationObject(btVector3 value) {
      LinearMathJNI.btIDebugDraw_DefaultColors_wantsDeactivationObject_set(
          swigCPtr, this, btVector3.getCPtr(value), value);
    }

    public btVector3 getWantsDeactivationObject() {
      long cPtr =
          LinearMathJNI.btIDebugDraw_DefaultColors_wantsDeactivationObject_get(swigCPtr, this);
      return (cPtr == 0) ? null : new btVector3(cPtr, false);
    }

    public void setDisabledDeactivationObject(btVector3 value) {
      LinearMathJNI.btIDebugDraw_DefaultColors_disabledDeactivationObject_set(
          swigCPtr, this, btVector3.getCPtr(value), value);
    }

    public btVector3 getDisabledDeactivationObject() {
      long cPtr =
          LinearMathJNI.btIDebugDraw_DefaultColors_disabledDeactivationObject_get(swigCPtr, this);
      return (cPtr == 0) ? null : new btVector3(cPtr, false);
    }

    public void setDisabledSimulationObject(btVector3 value) {
      LinearMathJNI.btIDebugDraw_DefaultColors_disabledSimulationObject_set(
          swigCPtr, this, btVector3.getCPtr(value), value);
    }

    public btVector3 getDisabledSimulationObject() {
      long cPtr =
          LinearMathJNI.btIDebugDraw_DefaultColors_disabledSimulationObject_get(swigCPtr, this);
      return (cPtr == 0) ? null : new btVector3(cPtr, false);
    }

    public void setAabb(btVector3 value) {
      LinearMathJNI.btIDebugDraw_DefaultColors_aabb_set(
          swigCPtr, this, btVector3.getCPtr(value), value);
    }
    ...
    public void setContactPoint(btVector3 value) {
      LinearMathJNI.btIDebugDraw_DefaultColors_contactPoint_set(
          swigCPtr, this, btVector3.getCPtr(value), value);
    }
  ...
  public btIDebugDraw.DefaultColors getDefaultColors() {
    return new btIDebugDraw.DefaultColors(
        (getClass() == btIDebugDraw.class)
            ? LinearMathJNI.btIDebugDraw_getDefaultColors(swigCPtr, this)
  ...
  public void setDefaultColors(btIDebugDraw.DefaultColors arg0) {
    if (getClass() == btIDebugDraw.class)
      LinearMathJNI.btIDebugDraw_setDefaultColors(
          swigCPtr, this, btIDebugDraw.DefaultColors.getCPtr(arg0), arg0);
    else
      LinearMathJNI.btIDebugDraw_setDefaultColorsSwigExplicitbtIDebugDraw(
          swigCPtr, this, btIDebugDraw.DefaultColors.getCPtr(arg0), arg0);
  }
  ...
  public void drawLine(Vector3 from, Vector3 to, Vector3 fromColor, Vector3 toColor) {
    if (getClass() == btIDebugDraw.class)
      ...
      LinearMathJNI.btIDebugDraw_drawLineSwigExplicitbtIDebugDraw__SWIG_1(
  ...
  public void drawSphere(float radius, Matrix4 transform, Vector3 color) {
    if (getClass() == btIDebugDraw.class)
      ...
      LinearMathJNI.btIDebugDraw_drawSphereSwigExplicitbtIDebugDraw__SWIG_0(
          swigCPtr, this, radius, transform, color);
  }
  ...
  public void drawSphere(Vector3 p, float radius, Vector3 color) {
    if (getClass() == btIDebugDraw.class)
      ...
      LinearMathJNI.btIDebugDraw_drawSphereSwigExplicitbtIDebugDraw__SWIG_1(
          swigCPtr, this, p, radius, color);
  }
  ...
  public void drawTriangle(
      ...
      float alpha) {
    if (getClass() == btIDebugDraw.class)
      LinearMathJNI.btIDebugDraw_drawTriangle__SWIG_0(
          swigCPtr, this, v0, v1, v2, arg3, arg4, arg5, color, alpha);
    else
      LinearMathJNI.btIDebugDraw_drawTriangleSwigExplicitbtIDebugDraw__SWIG_0(
          swigCPtr, this, v0, v1, v2, arg3, arg4, arg5, color, alpha);
  }
  ...
  public void drawTriangle(Vector3 v0, Vector3 v1, Vector3 v2, Vector3 color, float arg4) {
    if (getClass() == btIDebugDraw.class)
      ...
      LinearMathJNI.btIDebugDraw_drawTriangleSwigExplicitbtIDebugDraw__SWIG_1(
  ...
  public void drawContactPoint(
    ...
    LinearMathJNI.btIDebugDraw_drawContactPoint(
        swigCPtr, this, PointOnB, normalOnB, distance, lifeTime, color);
  }
  ...
  public void drawTransform(Matrix4 transform, float orthoLen) {
    if (getClass() == btIDebugDraw.class)
      ...
      LinearMathJNI.btIDebugDraw_drawTransformSwigExplicitbtIDebugDraw(
          swigCPtr, this, transform, orthoLen);
  }
  ...
  public void drawArc(
      ...
      float stepDegrees) {
    if (getClass() == btIDebugDraw.class)
      LinearMathJNI.btIDebugDraw_drawArc__SWIG_0(
          swigCPtr,
          this,
          center,
          normal,
      ...
      LinearMathJNI.btIDebugDraw_drawArcSwigExplicitbtIDebugDraw__SWIG_0(
          swigCPtr,
          this,
          center,
          normal,
  ...
  public void drawArc(
      ...
      boolean drawSect) {
    if (getClass() == btIDebugDraw.class)
      LinearMathJNI.btIDebugDraw_drawArc__SWIG_1(
          swigCPtr, this, center, normal, axis, radiusA, radiusB, minAngle, maxAngle, color,
          drawSect);
    else
      LinearMathJNI.btIDebugDraw_drawArcSwigExplicitbtIDebugDraw__SWIG_1(
          swigCPtr, this, center, normal, axis, radiusA, radiusB, minAngle, maxAngle, color,
          drawSect);
  }
  ...
  public void drawSpherePatch(
      ...
      boolean drawCenter) {
    if (getClass() == btIDebugDraw.class)
      LinearMathJNI.btIDebugDraw_drawSpherePatch__SWIG_0(
          swigCPtr,
          this,
          center,
          up,
      ...
      LinearMathJNI.btIDebugDraw_drawSpherePatchSwigExplicitbtIDebugDraw__SWIG_0(
          swigCPtr,
          this,
          center,
          up,
  ...
  public void drawSpherePatch(
      ...
      float stepDegrees) {
    if (getClass() == btIDebugDraw.class)
      LinearMathJNI.btIDebugDraw_drawSpherePatch__SWIG_1(
          swigCPtr, this, center, up, axis, radius, minTh, maxTh, minPs, maxPs, color, stepDegrees);
    else
      LinearMathJNI.btIDebugDraw_drawSpherePatchSwigExplicitbtIDebugDraw__SWIG_1(
          swigCPtr, this, center, up, axis, radius, minTh, maxTh, minPs, maxPs, color, stepDegrees);
  }
  ...
  public void drawSpherePatch(
      ...
      Vector3 color) {
    if (getClass() == btIDebugDraw.class)
      LinearMathJNI.btIDebugDraw_drawSpherePatch__SWIG_2(
          swigCPtr, this, center, up, axis, radius, minTh, maxTh, minPs, maxPs, color);
    else
      LinearMathJNI.btIDebugDraw_drawSpherePatchSwigExplicitbtIDebugDraw__SWIG_2(
          swigCPtr, this, center, up, axis, radius, minTh, maxTh, minPs, maxPs, color);
  }
  ...
  public void drawBox(Vector3 bbMin, Vector3 bbMax, Vector3 color) {
    if (getClass() == btIDebugDraw.class)
      ...
      LinearMathJNI.btIDebugDraw_drawBoxSwigExplicitbtIDebugDraw__SWIG_0(
          swigCPtr, this, bbMin, bbMax, color);
  }
  ...
  public void drawBox(Vector3 bbMin, Vector3 bbMax, Matrix4 trans, Vector3 color) {
    if (getClass() == btIDebugDraw.class)
      ...
      LinearMathJNI.btIDebugDraw_drawBoxSwigExplicitbtIDebugDraw__SWIG_1(
          swigCPtr, this, bbMin, bbMax, trans, color);
  }

  public void drawCapsule(
      float radius, float halfHeight, int upAxis, Matrix4 transform, Vector3 color) {
    if (getClass() == btIDebugDraw.class)
      LinearMathJNI.btIDebugDraw_drawCapsule(
          swigCPtr, this, radius, halfHeight, upAxis, transform, color);
    else
      LinearMathJNI.btIDebugDraw_drawCapsuleSwigExplicitbtIDebugDraw(
          swigCPtr, this, radius, halfHeight, upAxis, transform, color);
  }
  ...
  public void drawCylinder(
      float radius, float halfHeight, int upAxis, Matrix4 transform, Vector3 color) {
    if (getClass() == btIDebugDraw.class)
      LinearMathJNI.btIDebugDraw_drawCylinder(
          swigCPtr, this, radius, halfHeight, upAxis, transform, color);
    else
      LinearMathJNI.btIDebugDraw_drawCylinderSwigExplicitbtIDebugDraw(
          swigCPtr, this, radius, halfHeight, upAxis, transform, color);
  }
  ...
  public void drawCone(float radius, float height, int upAxis, Matrix4 transform, Vector3 color) {
    if (getClass() == btIDebugDraw.class)
      ...
      LinearMathJNI.btIDebugDraw_drawConeSwigExplicitbtIDebugDraw(
          swigCPtr, this, radius, height, upAxis, transform, color);
  }

  public void drawPlane(Vector3 planeNormal, float planeConst, Matrix4 transform, Vector3 color) {
    if (getClass() == btIDebugDraw.class)
      LinearMathJNI.btIDebugDraw_drawPlane(
          swigCPtr, this, planeNormal, planeConst, transform, color);
    else
      LinearMathJNI.btIDebugDraw_drawPlaneSwigExplicitbtIDebugDraw(
          swigCPtr, this, planeNormal, planeConst, transform, color);
  }
