...
public class btQuadWord extends BulletBase {
  ...
  /**
   * Construct a new btQuadWord, normally you should not need this constructor it's intended for
   * low-level usage.
   */
  ...
  public boolean operatorEqualTo(btQuadWord other) {
    return LinearMathJNI.btQuadWord_operatorEqualTo(
        swigCPtr, this, btQuadWord.getCPtr(other), other);
  }

  public boolean operatorNotEqualTo(btQuadWord other) {
    return LinearMathJNI.btQuadWord_operatorNotEqualTo(
        swigCPtr, this, btQuadWord.getCPtr(other), other);
  }
