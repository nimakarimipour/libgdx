...
public class btClock extends BulletBase {
  ...
  /**
   * Construct a new btClock, normally you should not need this constructor it's intended for
   * low-level usage.
   */
  ...
  public btClock operatorAssignment(btClock other) {
    return new btClock(
        LinearMathJNI.btClock_operatorAssignment(swigCPtr, this, btClock.getCPtr(other), other),
        false);
  }
