...
public class btVector3Array extends BulletBase {
  ...
  /**
   * Construct a new btVector3Array, normally you should not need this constructor it's intended for
   * low-level usage.
   */
  ...
  public btVector3Array operatorAssignment(btVector3Array other) {
    return new btVector3Array(
        LinearMathJNI.btVector3Array_operatorAssignment(
            swigCPtr, this, btVector3Array.getCPtr(other), other),
        false);
  }
  ...
  public btVector3Array(btVector3Array otherArray) {
    this(
        LinearMathJNI.new_btVector3Array__SWIG_1(btVector3Array.getCPtr(otherArray), otherArray),
        true);
  }
  ...
  public void copyFromArray(btVector3Array otherArray) {
    LinearMathJNI.btVector3Array_copyFromArray(
        swigCPtr, this, btVector3Array.getCPtr(otherArray), otherArray);
  }
}
