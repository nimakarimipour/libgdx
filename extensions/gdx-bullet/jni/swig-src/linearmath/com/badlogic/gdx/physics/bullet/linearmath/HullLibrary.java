...
public class HullLibrary extends BulletBase {
  ...
  /**
   * Construct a new HullLibrary, normally you should not need this constructor it's intended for
   * low-level usage.
   */
  ...
  public void setVertexIndexMapping(SWIGTYPE_p_btAlignedObjectArrayT_int_t value) {
    LinearMathJNI.HullLibrary_vertexIndexMapping_set(
  ...
  public int CreateConvexHull(HullDesc desc, HullResult result) {
    return LinearMathJNI.HullLibrary_CreateConvexHull(
        swigCPtr, this, HullDesc.getCPtr(desc), desc, HullResult.getCPtr(result), result);
  }

  public int ReleaseResult(HullResult result) {
    return LinearMathJNI.HullLibrary_ReleaseResult(
        swigCPtr, this, HullResult.getCPtr(result), result);
  }
