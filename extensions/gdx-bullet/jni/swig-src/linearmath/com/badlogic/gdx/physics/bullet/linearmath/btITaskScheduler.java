...
public class btITaskScheduler extends BulletBase {
  ...
  /**
   * Construct a new btITaskScheduler, normally you should not need this constructor it's intended
   * for low-level usage.
   */
  ...
  public void parallelFor(int iBegin, int iEnd, int grainSize, btIParallelForBody body) {
    LinearMathJNI.btITaskScheduler_parallelFor(
        swigCPtr, this, iBegin, iEnd, grainSize, btIParallelForBody.getCPtr(body), body);
  }
