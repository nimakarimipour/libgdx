...
public class btQuaternion extends btQuadWord {
  ...
  /**
   * Construct a new btQuaternion, normally you should not need this constructor it's intended for
   * low-level usage.
   */
  ...
  public void getEulerZYX(SWIGTYPE_p_float yawZ, SWIGTYPE_p_float pitchY, SWIGTYPE_p_float rollX) {
    LinearMathJNI.btQuaternion_getEulerZYX(
        swigCPtr,
        this,
        SWIGTYPE_p_float.getCPtr(yawZ),
        SWIGTYPE_p_float.getCPtr(pitchY),
  ...
  public void serialize(btQuaternionFloatData dataOut) {
    LinearMathJNI.btQuaternion_serialize(
        swigCPtr, this, btQuaternionFloatData.getCPtr(dataOut), dataOut);
  }

  public void deSerialize(btQuaternionFloatData dataIn) {
    LinearMathJNI.btQuaternion_deSerialize(
        swigCPtr, this, btQuaternionFloatData.getCPtr(dataIn), dataIn);
  }

  public void serializeFloat(btQuaternionFloatData dataOut) {
    LinearMathJNI.btQuaternion_serializeFloat(
        swigCPtr, this, btQuaternionFloatData.getCPtr(dataOut), dataOut);
  }

  public void deSerializeFloat(btQuaternionFloatData dataIn) {
    LinearMathJNI.btQuaternion_deSerializeFloat(
        swigCPtr, this, btQuaternionFloatData.getCPtr(dataIn), dataIn);
  }

  public void serializeDouble(btQuaternionDoubleData dataOut) {
    LinearMathJNI.btQuaternion_serializeDouble(
