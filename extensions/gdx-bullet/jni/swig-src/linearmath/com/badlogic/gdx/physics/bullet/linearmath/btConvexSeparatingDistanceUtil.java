...
public class btConvexSeparatingDistanceUtil extends BulletBase {
  ...
  /**
   * Construct a new btConvexSeparatingDistanceUtil, normally you should not need this constructor
  ...
  public float getConservativeSeparatingDistance() {
    return LinearMathJNI.btConvexSeparatingDistanceUtil_getConservativeSeparatingDistance(
        swigCPtr, this);
  }

  public void updateSeparatingDistance(Matrix4 transA, Matrix4 transB) {
    LinearMathJNI.btConvexSeparatingDistanceUtil_updateSeparatingDistance(
        swigCPtr, this, transA, transB);
  }

  public void initSeparatingDistance(
      Vector3 separatingVector, float separatingDistance, Matrix4 transA, Matrix4 transB) {
    LinearMathJNI.btConvexSeparatingDistanceUtil_initSeparatingDistance(
        swigCPtr, this, separatingVector, separatingDistance, transA, transB);
  }
}
