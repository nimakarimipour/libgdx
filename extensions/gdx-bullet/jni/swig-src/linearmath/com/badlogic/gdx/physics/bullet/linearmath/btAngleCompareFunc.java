...
public class btAngleCompareFunc extends BulletBase {
  ...
  /**
   * Construct a new btAngleCompareFunc, normally you should not need this constructor it's intended
   * for low-level usage.
   */
  ...
  public boolean operatorFunctionCall(GrahamVector3 a, GrahamVector3 b) {
    return LinearMathJNI.btAngleCompareFunc_operatorFunctionCall(
        swigCPtr, this, GrahamVector3.getCPtr(a), a, GrahamVector3.getCPtr(b), b);
  }
}
