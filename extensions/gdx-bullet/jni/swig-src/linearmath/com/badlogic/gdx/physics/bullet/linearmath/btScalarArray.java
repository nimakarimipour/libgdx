...
public class btScalarArray extends BulletBase {
  ...
  /**
   * Construct a new btScalarArray, normally you should not need this constructor it's intended for
   * low-level usage.
   */
  ...
  public btScalarArray operatorAssignment(btScalarArray other) {
    return new btScalarArray(
        LinearMathJNI.btScalarArray_operatorAssignment(
            swigCPtr, this, btScalarArray.getCPtr(other), other),
        false);
  }
  ...
  public btScalarArray(btScalarArray otherArray) {
    this(
        LinearMathJNI.new_btScalarArray__SWIG_1(btScalarArray.getCPtr(otherArray), otherArray),
        true);
  }
  ...
  public SWIGTYPE_p_float operatorSubscript(int n) {
    return new SWIGTYPE_p_float(
        LinearMathJNI.btScalarArray_operatorSubscript(swigCPtr, this, n), false);
  }
  ...
  public SWIGTYPE_p_float expandNonInitializing() {
    return new SWIGTYPE_p_float(
        LinearMathJNI.btScalarArray_expandNonInitializing(swigCPtr, this), false);
  }

  public SWIGTYPE_p_float expand(float fillValue) {
    return new SWIGTYPE_p_float(
        LinearMathJNI.btScalarArray_expand__SWIG_0(swigCPtr, this, fillValue), false);
  }
  ...
  public void copyFromArray(btScalarArray otherArray) {
    LinearMathJNI.btScalarArray_copyFromArray(
        swigCPtr, this, btScalarArray.getCPtr(otherArray), otherArray);
  }
}
