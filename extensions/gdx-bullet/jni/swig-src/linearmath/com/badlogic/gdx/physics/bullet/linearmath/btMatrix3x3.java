...
public class btMatrix3x3 extends BulletBase {
  ...
  /**
   * Construct a new btMatrix3x3, normally you should not need this constructor it's intended for
   * low-level usage.
   */
  ...
  public void getEulerYPR(SWIGTYPE_p_float yaw, SWIGTYPE_p_float pitch, SWIGTYPE_p_float roll) {
    LinearMathJNI.btMatrix3x3_getEulerYPR(
        swigCPtr,
        this,
        SWIGTYPE_p_float.getCPtr(yaw),
        SWIGTYPE_p_float.getCPtr(pitch),
        SWIGTYPE_p_float.getCPtr(roll));
  }

  public void getEulerZYX(
      SWIGTYPE_p_float yaw, SWIGTYPE_p_float pitch, SWIGTYPE_p_float roll, long solution_number) {
    LinearMathJNI.btMatrix3x3_getEulerZYX__SWIG_0(
        swigCPtr,
        this,
        SWIGTYPE_p_float.getCPtr(yaw),
        SWIGTYPE_p_float.getCPtr(pitch),
  ...
  public void getEulerZYX(SWIGTYPE_p_float yaw, SWIGTYPE_p_float pitch, SWIGTYPE_p_float roll) {
    LinearMathJNI.btMatrix3x3_getEulerZYX__SWIG_1(
        swigCPtr,
        this,
        SWIGTYPE_p_float.getCPtr(yaw),
        SWIGTYPE_p_float.getCPtr(pitch),
  ...
  public void serialize(btMatrix3x3FloatData dataOut) {
    LinearMathJNI.btMatrix3x3_serialize(
        swigCPtr, this, btMatrix3x3FloatData.getCPtr(dataOut), dataOut);
  }

  public void serializeFloat(btMatrix3x3FloatData dataOut) {
    LinearMathJNI.btMatrix3x3_serializeFloat(
        swigCPtr, this, btMatrix3x3FloatData.getCPtr(dataOut), dataOut);
  }

  public void deSerialize(btMatrix3x3FloatData dataIn) {
    LinearMathJNI.btMatrix3x3_deSerialize(
        swigCPtr, this, btMatrix3x3FloatData.getCPtr(dataIn), dataIn);
  }

  public void deSerializeFloat(btMatrix3x3FloatData dataIn) {
    LinearMathJNI.btMatrix3x3_deSerializeFloat(
        swigCPtr, this, btMatrix3x3FloatData.getCPtr(dataIn), dataIn);
  }

  public void deSerializeDouble(btMatrix3x3DoubleData dataIn) {
    LinearMathJNI.btMatrix3x3_deSerializeDouble(
        swigCPtr, this, btMatrix3x3DoubleData.getCPtr(dataIn), dataIn);
  }
}
