...
public class btSpatialMotionVector extends BulletBase {
  ...
  /**
   * Construct a new btSpatialMotionVector, normally you should not need this constructor it's
  ...
  public void setBottomVec(btVector3 value) {
    LinearMathJNI.btSpatialMotionVector_bottomVec_set(
  ...
  public float dot(btSpatialForceVector b) {
    return LinearMathJNI.btSpatialMotionVector_dot(
        swigCPtr, this, btSpatialForceVector.getCPtr(b), b);
  }

  public btSpatialMotionVector operatorAdditionAssignment(btSpatialMotionVector vec) {
    return new btSpatialMotionVector(
        LinearMathJNI.btSpatialMotionVector_operatorAdditionAssignment(
  ...
  public btSpatialMotionVector operatorSubtractionAssignment(btSpatialMotionVector vec) {
    return new btSpatialMotionVector(
        LinearMathJNI.btSpatialMotionVector_operatorSubtractionAssignment(
            swigCPtr, this, btSpatialMotionVector.getCPtr(vec), vec),
        false);
  }
  ...
  public btSpatialMotionVector operatorMultiplicationAssignment(float s) {
    return new btSpatialMotionVector(
        LinearMathJNI.btSpatialMotionVector_operatorMultiplicationAssignment(swigCPtr, this, s),
        false);
  }

  public btSpatialMotionVector operatorSubtraction(btSpatialMotionVector vec) {
    return new btSpatialMotionVector(
        LinearMathJNI.btSpatialMotionVector_operatorSubtraction__SWIG_0(
            swigCPtr, this, btSpatialMotionVector.getCPtr(vec), vec),
        true);
  }
  ...
  public btSpatialMotionVector operatorAddition(btSpatialMotionVector vec) {
    return new btSpatialMotionVector(
        LinearMathJNI.btSpatialMotionVector_operatorAddition(
            swigCPtr, this, btSpatialMotionVector.getCPtr(vec), vec),
        true);
  }
  ...
  public btSpatialMotionVector operatorSubtraction() {
    return new btSpatialMotionVector(
        LinearMathJNI.btSpatialMotionVector_operatorSubtraction__SWIG_1(swigCPtr, this), true);
  }

  public btSpatialMotionVector operatorMultiplication(float s) {
    return new btSpatialMotionVector(
        LinearMathJNI.btSpatialMotionVector_operatorMultiplication(swigCPtr, this, s), true);
  }
}
