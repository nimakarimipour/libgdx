...
public class btDefaultSerializer extends btSerializer {
  ...
  /**
   * Construct a new btDefaultSerializer, normally you should not need this constructor it's
  ...
  private static long SwigConstructbtDefaultSerializer(int totalSize, java.nio.ByteBuffer buffer) {
