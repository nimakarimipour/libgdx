...
public class btConvexHullComputer extends BulletBase {
  ...
  /**
   * Construct a new btConvexHullComputer, normally you should not need this constructor it's
  ...
  public void setVertices(btVector3Array value) {
    LinearMathJNI.btConvexHullComputer_vertices_set(
  ...
  public void setEdges(SWIGTYPE_p_btAlignedObjectArrayT_btConvexHullComputer__Edge_t value) {
    LinearMathJNI.btConvexHullComputer_edges_set(
        swigCPtr,
        this,
  ...
  public SWIGTYPE_p_btAlignedObjectArrayT_btConvexHullComputer__Edge_t getEdges() {
    ...
    return (cPtr == 0)
        ? null
        : new SWIGTYPE_p_btAlignedObjectArrayT_btConvexHullComputer__Edge_t(cPtr, false);
  }

  public void setFaces(SWIGTYPE_p_btAlignedObjectArrayT_int_t value) {
    LinearMathJNI.btConvexHullComputer_faces_set(
