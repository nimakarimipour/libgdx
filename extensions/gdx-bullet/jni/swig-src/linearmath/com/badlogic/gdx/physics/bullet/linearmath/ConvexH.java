...
public class ConvexH extends BulletBase {
  ...
  /**
   * Construct a new ConvexH, normally you should not need this constructor it's intended for
   * low-level usage.
   */
  ...
  public static class HalfEdge extends BulletBase {
    private long swigCPtr;
    ...
    /**
     * Construct a new HalfEdge, normally you should not need this constructor it's intended for
     * low-level usage.
     */
  ...
  public void setEdges(SWIGTYPE_p_btAlignedObjectArrayT_ConvexH__HalfEdge_t value) {
    LinearMathJNI.ConvexH_edges_set(
        swigCPtr, this, SWIGTYPE_p_btAlignedObjectArrayT_ConvexH__HalfEdge_t.getCPtr(value));
  }
  ...
  public SWIGTYPE_p_btAlignedObjectArrayT_ConvexH__HalfEdge_t getEdges() {
    ...
    return (cPtr == 0)
        ? null
        : new SWIGTYPE_p_btAlignedObjectArrayT_ConvexH__HalfEdge_t(cPtr, false);
  }

  public void setFacets(SWIGTYPE_p_btAlignedObjectArrayT_btPlane_t value) {
    LinearMathJNI.ConvexH_facets_set(
        swigCPtr, this, SWIGTYPE_p_btAlignedObjectArrayT_btPlane_t.getCPtr(value));
  }
