...
public class btGeometryUtil extends BulletBase {
  ...
  /**
   * Construct a new btGeometryUtil, normally you should not need this constructor it's intended for
   * low-level usage.
   */
  ...
  public static void getPlaneEquationsFromVertices(
      btVector3Array vertices, btVector3Array planeEquationsOut) {
    LinearMathJNI.btGeometryUtil_getPlaneEquationsFromVertices(
        btVector3Array.getCPtr(vertices),
        vertices,
        btVector3Array.getCPtr(planeEquationsOut),
        planeEquationsOut);
  }

  public static void getVerticesFromPlaneEquations(
      btVector3Array planeEquations, btVector3Array verticesOut) {
    LinearMathJNI.btGeometryUtil_getVerticesFromPlaneEquations(
        btVector3Array.getCPtr(planeEquations),
        planeEquations,
        btVector3Array.getCPtr(verticesOut),
        verticesOut);
  }
  ...
  public static boolean isInside(btVector3Array vertices, Vector3 planeNormal, float margin) {
    return LinearMathJNI.btGeometryUtil_isInside(
        btVector3Array.getCPtr(vertices), vertices, planeNormal, margin);
  }

  public static boolean isPointInsidePlanes(
      btVector3Array planeEquations, Vector3 point, float margin) {
    return LinearMathJNI.btGeometryUtil_isPointInsidePlanes(
        btVector3Array.getCPtr(planeEquations), planeEquations, point, margin);
  }

  public static boolean areVerticesBehindPlane(
      Vector3 planeNormal, btVector3Array vertices, float margin) {
    return LinearMathJNI.btGeometryUtil_areVerticesBehindPlane(
        planeNormal, btVector3Array.getCPtr(vertices), vertices, margin);
  }
