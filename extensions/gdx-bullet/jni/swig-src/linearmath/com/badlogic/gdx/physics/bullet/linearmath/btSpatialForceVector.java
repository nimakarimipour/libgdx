...
public class btSpatialForceVector extends BulletBase {
  ...
  /**
   * Construct a new btSpatialForceVector, normally you should not need this constructor it's
  ...
  public void setBottomVec(btVector3 value) {
    LinearMathJNI.btSpatialForceVector_bottomVec_set(
  ...
  public btSpatialForceVector operatorAdditionAssignment(btSpatialForceVector vec) {
    return new btSpatialForceVector(
        LinearMathJNI.btSpatialForceVector_operatorAdditionAssignment(
            swigCPtr, this, btSpatialForceVector.getCPtr(vec), vec),
        false);
  }

  public btSpatialForceVector operatorSubtractionAssignment(btSpatialForceVector vec) {
    return new btSpatialForceVector(
        LinearMathJNI.btSpatialForceVector_operatorSubtractionAssignment(
            swigCPtr, this, btSpatialForceVector.getCPtr(vec), vec),
        false);
  }
  ...
  public btSpatialForceVector operatorSubtraction(btSpatialForceVector vec) {
    return new btSpatialForceVector(
        LinearMathJNI.btSpatialForceVector_operatorSubtraction__SWIG_0(
            swigCPtr, this, btSpatialForceVector.getCPtr(vec), vec),
        true);
  }
  ...
  public btSpatialForceVector operatorAddition(btSpatialForceVector vec) {
    return new btSpatialForceVector(
        LinearMathJNI.btSpatialForceVector_operatorAddition(
            swigCPtr, this, btSpatialForceVector.getCPtr(vec), vec),
        true);
  }
  ...
  public btSpatialForceVector operatorSubtraction() {
    return new btSpatialForceVector(
        LinearMathJNI.btSpatialForceVector_operatorSubtraction__SWIG_1(swigCPtr, this), true);
  }

  public btSpatialForceVector operatorMultiplication(float s) {
    return new btSpatialForceVector(
        LinearMathJNI.btSpatialForceVector_operatorMultiplication(swigCPtr, this, s), true);
  }
}
