...
public class btSpatialTransformationMatrix extends BulletBase {
  ...
  /**
   * Construct a new btSpatialTransformationMatrix, normally you should not need this constructor
  ...
  public void setRotMat(btMatrix3x3 value) {
    LinearMathJNI.btSpatialTransformationMatrix_rotMat_set(
  ...
  public void setTrnVec(btVector3 value) {
    LinearMathJNI.btSpatialTransformationMatrix_trnVec_set(
  ...
  public void transformInverse(
      btSymmetricSpatialDyad inMat, btSymmetricSpatialDyad outMat, int outOp) {
    LinearMathJNI.btSpatialTransformationMatrix_transformInverse__SWIG_2(
        swigCPtr,
        this,
        btSymmetricSpatialDyad.getCPtr(inMat),
        inMat,
        btSymmetricSpatialDyad.getCPtr(outMat),
        outMat,
        outOp);
  }

  public void transformInverse(btSymmetricSpatialDyad inMat, btSymmetricSpatialDyad outMat) {
    LinearMathJNI.btSpatialTransformationMatrix_transformInverse__SWIG_3(
        swigCPtr,
        this,
        btSymmetricSpatialDyad.getCPtr(inMat),
        inMat,
