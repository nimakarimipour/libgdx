...
public class btGEN_Link extends BulletBase {
  ...
  /**
   * Construct a new btGEN_Link, normally you should not need this constructor it's intended for
   * low-level usage.
   */
  ...
  public btGEN_Link(btGEN_Link next, btGEN_Link prev) {
    this(
        LinearMathJNI.new_btGEN_Link__SWIG_1(
            btGEN_Link.getCPtr(next), next, btGEN_Link.getCPtr(prev), prev),
        true);
  }
