...
public class btPoint2PointConstraintFloatData extends BulletBase {
  ...
  protected btPoint2PointConstraintFloatData(
  ...
  /**
   * Construct a new btPoint2PointConstraintFloatData, normally you should not need this constructor
  ...
  public void setTypeConstraintData(btTypedConstraintData value) {
    DynamicsJNI.btPoint2PointConstraintFloatData_typeConstraintData_set(
  ...
  public void setPivotInA(btVector3FloatData value) {
    DynamicsJNI.btPoint2PointConstraintFloatData_pivotInA_set(
  ...
  public void setPivotInB(btVector3FloatData value) {
    DynamicsJNI.btPoint2PointConstraintFloatData_pivotInB_set(
        swigCPtr, this, btVector3FloatData.getCPtr(value), value);
  }
