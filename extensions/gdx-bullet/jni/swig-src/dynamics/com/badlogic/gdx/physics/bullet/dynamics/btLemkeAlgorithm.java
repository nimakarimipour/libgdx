...
public class btLemkeAlgorithm extends BulletBase {
  ...
  /**
   * Construct a new btLemkeAlgorithm, normally you should not need this constructor it's intended
   * for low-level usage.
   */
  ...
  public btLemkeAlgorithm(
      SWIGTYPE_p_btMatrixXT_float_t M_, SWIGTYPE_p_btVectorXT_float_t q_, int DEBUGLEVEL_) {
    this(
        DynamicsJNI.new_btLemkeAlgorithm__SWIG_0(
            SWIGTYPE_p_btMatrixXT_float_t.getCPtr(M_),
  ...
  public btLemkeAlgorithm(SWIGTYPE_p_btMatrixXT_float_t M_, SWIGTYPE_p_btVectorXT_float_t q_) {
    this(
        DynamicsJNI.new_btLemkeAlgorithm__SWIG_1(
            SWIGTYPE_p_btMatrixXT_float_t.getCPtr(M_), SWIGTYPE_p_btVectorXT_float_t.getCPtr(q_)),
        true);
  }
  ...
  public void setSystem(SWIGTYPE_p_btMatrixXT_float_t M_, SWIGTYPE_p_btVectorXT_float_t q_) {
    DynamicsJNI.btLemkeAlgorithm_setSystem(
        swigCPtr,
        this,
        SWIGTYPE_p_btMatrixXT_float_t.getCPtr(M_),
        SWIGTYPE_p_btVectorXT_float_t.getCPtr(q_));
  ...
  public SWIGTYPE_p_btVectorXT_float_t solve(long maxloops) {
    return new SWIGTYPE_p_btVectorXT_float_t(
        DynamicsJNI.btLemkeAlgorithm_solve__SWIG_0(swigCPtr, this, maxloops), true);
  }

  public SWIGTYPE_p_btVectorXT_float_t solve() {
    return new SWIGTYPE_p_btVectorXT_float_t(
        DynamicsJNI.btLemkeAlgorithm_solve__SWIG_1(swigCPtr, this), true);
  }
}
