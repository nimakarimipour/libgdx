...
public class btUniversalConstraint extends btGeneric6DofConstraint {
  ...
  /**
   * Construct a new btUniversalConstraint, normally you should not need this constructor it's
  ...
  public btUniversalConstraint(
      btRigidBody rbA, btRigidBody rbB, Vector3 anchor, Vector3 axis1, Vector3 axis2) {
    this(
        DynamicsJNI.new_btUniversalConstraint(
            btRigidBody.getCPtr(rbA), rbA, btRigidBody.getCPtr(rbB), rbB, anchor, axis1, axis2),
        true);
  }
