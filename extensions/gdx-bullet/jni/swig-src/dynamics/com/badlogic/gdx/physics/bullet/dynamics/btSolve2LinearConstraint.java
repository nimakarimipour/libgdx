...
public class btSolve2LinearConstraint extends BulletBase {
  ...
  /**
   * Construct a new btSolve2LinearConstraint, normally you should not need this constructor it's
  ...
  public void resolveUnilateralPairConstraint(
    ...
    DynamicsJNI.btSolve2LinearConstraint_resolveUnilateralPairConstraint(
        swigCPtr,
        this,
        ...
        depthB,
        normalB,
        SWIGTYPE_p_float.getCPtr(imp0),
        SWIGTYPE_p_float.getCPtr(imp1));
  }
  ...
  public void resolveBilateralPairConstraint(
      ...
      SWIGTYPE_p_float imp0,
      SWIGTYPE_p_float imp1) {
    DynamicsJNI.btSolve2LinearConstraint_resolveBilateralPairConstraint(
        swigCPtr,
        this,
        btRigidBody.getCPtr(body0),
        body0,
