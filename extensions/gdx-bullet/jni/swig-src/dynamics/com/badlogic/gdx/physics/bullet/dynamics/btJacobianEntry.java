...
public class btJacobianEntry extends BulletBase {
  ...
  /**
   * Construct a new btJacobianEntry, normally you should not need this constructor it's intended
   * for low-level usage.
   */
  ...
  public btJacobianEntry(
      ...
      float massInvB) {
    this(
        DynamicsJNI.new_btJacobianEntry__SWIG_1(
            world2A,
            world2B,
            rel_pos1,
            rel_pos2,
  ...
  public btJacobianEntry(
      ...
      Vector3 inertiaInvB) {
    this(
        DynamicsJNI.new_btJacobianEntry__SWIG_2(
            jointAxis, world2A, world2B, inertiaInvA, inertiaInvB),
        true);
  }

  public btJacobianEntry(
      Vector3 axisInA, Vector3 axisInB, Vector3 inertiaInvA, Vector3 inertiaInvB) {
  ...
  public btJacobianEntry(
      ...
      float massInvA) {
    this(
        DynamicsJNI.new_btJacobianEntry__SWIG_4(
            world2A, rel_pos1, rel_pos2, jointAxis, inertiaInvA, massInvA),
        true);
  }
  ...
  public float getNonDiagonal(btJacobianEntry jacB, float massInvA) {
    return DynamicsJNI.btJacobianEntry_getNonDiagonal__SWIG_0(
        swigCPtr, this, btJacobianEntry.getCPtr(jacB), jacB, massInvA);
  }

  public float getNonDiagonal(btJacobianEntry jacB, float massInvA, float massInvB) {
    return DynamicsJNI.btJacobianEntry_getNonDiagonal__SWIG_1(
        swigCPtr, this, btJacobianEntry.getCPtr(jacB), jacB, massInvA, massInvB);
  }

  public float getRelativeVelocity(
      Vector3 linvelA, Vector3 angvelA, Vector3 linvelB, Vector3 angvelB) {
    return DynamicsJNI.btJacobianEntry_getRelativeVelocity(
        swigCPtr, this, linvelA, angvelA, linvelB, angvelB);
  }

  public void setLinearJointAxis(btVector3 value) {
    DynamicsJNI.btJacobianEntry_linearJointAxis_set(
