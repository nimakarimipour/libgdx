...
public class btGearConstraintDoubleData extends BulletBase {
  ...
  /**
   * Construct a new btGearConstraintDoubleData, normally you should not need this constructor it's
  ...
  public void setTypeConstraintData(btTypedConstraintDoubleData value) {
    DynamicsJNI.btGearConstraintDoubleData_typeConstraintData_set(
  ...
  public void setAxisInA(btVector3DoubleData value) {
    DynamicsJNI.btGearConstraintDoubleData_axisInA_set(
  ...
  public void setAxisInB(btVector3DoubleData value) {
    DynamicsJNI.btGearConstraintDoubleData_axisInB_set(
        swigCPtr, this, btVector3DoubleData.getCPtr(value), value);
  }
