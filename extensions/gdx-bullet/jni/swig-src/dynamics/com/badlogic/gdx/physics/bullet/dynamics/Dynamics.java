...
public class Dynamics implements DynamicsConstants {
  ...
  public static float btAdjustAngleToLimits(
      float angleInRadians, float angleLowerLimitInRadians, float angleUpperLimitInRadians) {
    return DynamicsJNI.btAdjustAngleToLimits(
        angleInRadians, angleLowerLimitInRadians, angleUpperLimitInRadians);
  }
  ...
  public static float resolveSingleCollision(
      ...
      float distance) {
    return DynamicsJNI.resolveSingleCollision(
        btRigidBody.getCPtr(body1),
        body1,
        btCollisionObject.getCPtr(colObj2),
        colObj2,
        contactPositionWorld,
        contactNormalOnB,
        btContactSolverInfo.getCPtr(solverInfo),
        solverInfo,
        distance);
  }
  ...
  public static void resolveSingleBilateral(
      ...
      float timeStep) {
    DynamicsJNI.resolveSingleBilateral(
        btRigidBody.getCPtr(body1),
        body1,
        pos1,
        btRigidBody.getCPtr(body2),
        body2,
        pos2,
        distance,
        normal,
        SWIGTYPE_p_float.getCPtr(impulse),
        timeStep);
  }

  public static boolean btSolveDantzigLCP(
      int n,
      ...
      java.nio.FloatBuffer hi,
      java.nio.IntBuffer findex,
    ...
    {
      return DynamicsJNI.btSolveDantzigLCP(
          n, A, x, b, w, nub, lo, hi, findex, btDantzigScratchMemory.getCPtr(scratch), scratch);
    }
  }
}
