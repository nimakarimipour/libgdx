...
public class btDantzigScratchMemory extends BulletBase {
  ...
  /**
   * Construct a new btDantzigScratchMemory, normally you should not need this constructor it's
  ...
  public void setScratch(btScalarArray value) {
    DynamicsJNI.btDantzigScratchMemory_scratch_set(
  ...
  public void setDelta_w(btScalarArray value) {
    DynamicsJNI.btDantzigScratchMemory_delta_w_set(
        swigCPtr, this, btScalarArray.getCPtr(value), value);
  }
  ...
  public void setDelta_x(btScalarArray value) {
    DynamicsJNI.btDantzigScratchMemory_delta_x_set(
        swigCPtr, this, btScalarArray.getCPtr(value), value);
  }
  ...
  public void setDell(btScalarArray value) {
    DynamicsJNI.btDantzigScratchMemory_Dell_set(
        swigCPtr, this, btScalarArray.getCPtr(value), value);
  }
  ...
  public void setArows(SWIGTYPE_p_btAlignedObjectArrayT_float_p_t value) {
    DynamicsJNI.btDantzigScratchMemory_Arows_set(
        swigCPtr, this, SWIGTYPE_p_btAlignedObjectArrayT_float_p_t.getCPtr(value));
  }
  ...
  public void setP(SWIGTYPE_p_btAlignedObjectArrayT_int_t value) {
    DynamicsJNI.btDantzigScratchMemory_p_set(
  ...
  public void setC(SWIGTYPE_p_btAlignedObjectArrayT_int_t value) {
    DynamicsJNI.btDantzigScratchMemory_C_set(
        swigCPtr, this, SWIGTYPE_p_btAlignedObjectArrayT_int_t.getCPtr(value));
  }
  ...
  public void setState(SWIGTYPE_p_btAlignedObjectArrayT_bool_t value) {
    DynamicsJNI.btDantzigScratchMemory_state_set(
