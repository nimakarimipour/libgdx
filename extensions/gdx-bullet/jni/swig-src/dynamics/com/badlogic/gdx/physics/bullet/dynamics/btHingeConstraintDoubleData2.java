...
public class btHingeConstraintDoubleData2 extends BulletBase {
  ...
  /**
   * Construct a new btHingeConstraintDoubleData2, normally you should not need this constructor
  ...
  public void setTypeConstraintData(btTypedConstraintDoubleData value) {
    DynamicsJNI.btHingeConstraintDoubleData2_typeConstraintData_set(
  ...
  public void setRbAFrame(btTransformDoubleData value) {
    DynamicsJNI.btHingeConstraintDoubleData2_rbAFrame_set(
  ...
  public void setRbBFrame(btTransformDoubleData value) {
    DynamicsJNI.btHingeConstraintDoubleData2_rbBFrame_set(
        swigCPtr, this, btTransformDoubleData.getCPtr(value), value);
  }
