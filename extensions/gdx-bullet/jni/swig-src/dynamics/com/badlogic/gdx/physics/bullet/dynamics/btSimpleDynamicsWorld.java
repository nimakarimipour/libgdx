...
public class btSimpleDynamicsWorld extends btDynamicsWorld {
  ...
  /**
   * Construct a new btSimpleDynamicsWorld, normally you should not need this constructor it's
  ...
  public btSimpleDynamicsWorld(
    ...
    this(
        DynamicsJNI.new_btSimpleDynamicsWorld(
  ...
  public int stepSimulation(float timeStep, int maxSubSteps, float fixedTimeStep) {
    return DynamicsJNI.btSimpleDynamicsWorld_stepSimulation__SWIG_0(
        swigCPtr, this, timeStep, maxSubSteps, fixedTimeStep);
  }

  public int stepSimulation(float timeStep, int maxSubSteps) {
    return DynamicsJNI.btSimpleDynamicsWorld_stepSimulation__SWIG_1(
  ...
  public void addRigidBody(btRigidBody body) {
    DynamicsJNI.btSimpleDynamicsWorld_addRigidBody__SWIG_0(
        swigCPtr, this, btRigidBody.getCPtr(body), body);
  }

  public void addRigidBody(btRigidBody body, int group, int mask) {
    DynamicsJNI.btSimpleDynamicsWorld_addRigidBody__SWIG_1(
