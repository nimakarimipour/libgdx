...
public class btMultiBodyDoubleData extends BulletBase {
  ...
  /**
   * Construct a new btMultiBodyDoubleData, normally you should not need this constructor it's
  ...
  public void setBaseWorldTransform(btTransformDoubleData value) {
    DynamicsJNI.btMultiBodyDoubleData_baseWorldTransform_set(
  ...
  public void setBaseInertia(btVector3DoubleData value) {
    DynamicsJNI.btMultiBodyDoubleData_baseInertia_set(
  ...
  public void setLinks(btMultiBodyLinkDoubleData value) {
    DynamicsJNI.btMultiBodyDoubleData_links_set(
        swigCPtr, this, btMultiBodyLinkDoubleData.getCPtr(value), value);
  }
  ...
  public void setBaseCollider(btCollisionObjectDoubleData value) {
    DynamicsJNI.btMultiBodyDoubleData_baseCollider_set(
