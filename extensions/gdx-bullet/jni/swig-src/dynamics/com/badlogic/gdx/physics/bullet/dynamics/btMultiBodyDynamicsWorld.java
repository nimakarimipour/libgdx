...
public class btMultiBodyDynamicsWorld extends btDiscreteDynamicsWorld {
  ...
  /**
   * Construct a new btMultiBodyDynamicsWorld, normally you should not need this constructor it's
  ...
  public btMultiBodyDynamicsWorld(
    ...
    this(
        DynamicsJNI.new_btMultiBodyDynamicsWorld(
            btDispatcher.getCPtr(dispatcher),
            dispatcher,
            btBroadphaseInterface.getCPtr(pairCache),
            pairCache,
            btMultiBodyConstraintSolver.getCPtr(constraintSolver),
            constraintSolver,
  ...
  public void addMultiBody(btMultiBody body, int group, int mask) {
    DynamicsJNI.btMultiBodyDynamicsWorld_addMultiBody__SWIG_0(
        swigCPtr, this, btMultiBody.getCPtr(body), body, group, mask);
  }

  public void addMultiBody(btMultiBody body, int group) {
    DynamicsJNI.btMultiBodyDynamicsWorld_addMultiBody__SWIG_1(
        swigCPtr, this, btMultiBody.getCPtr(body), body, group);
  }

  public void addMultiBody(btMultiBody body) {
    DynamicsJNI.btMultiBodyDynamicsWorld_addMultiBody__SWIG_2(
        swigCPtr, this, btMultiBody.getCPtr(body), body);
  }

  public void removeMultiBody(btMultiBody body) {
    DynamicsJNI.btMultiBodyDynamicsWorld_removeMultiBody(
        swigCPtr, this, btMultiBody.getCPtr(body), body);
  }
  ...
  public void addMultiBodyConstraint(btMultiBodyConstraint constraint) {
    DynamicsJNI.btMultiBodyDynamicsWorld_addMultiBodyConstraint(
        swigCPtr, this, btMultiBodyConstraint.getCPtr(constraint), constraint);
  }
  ...
  public btMultiBodyConstraint getMultiBodyConstraint(int constraintIndex) {
    long cPtr =
        DynamicsJNI.btMultiBodyDynamicsWorld_getMultiBodyConstraint(
            swigCPtr, this, constraintIndex);
  ...
  public btMultiBodyConstraint getMultiBodyConstraintConst(int constraintIndex) {
    long cPtr =
        DynamicsJNI.btMultiBodyDynamicsWorld_getMultiBodyConstraintConst(
            swigCPtr, this, constraintIndex);
    return (cPtr == 0) ? null : new btMultiBodyConstraint(cPtr, false);
  }

  public void removeMultiBodyConstraint(btMultiBodyConstraint constraint) {
    DynamicsJNI.btMultiBodyDynamicsWorld_removeMultiBodyConstraint(
        swigCPtr, this, btMultiBodyConstraint.getCPtr(constraint), constraint);
  }
  ...
  public void debugDrawMultiBodyConstraint(btMultiBodyConstraint constraint) {
    DynamicsJNI.btMultiBodyDynamicsWorld_debugDrawMultiBodyConstraint(
        swigCPtr, this, btMultiBodyConstraint.getCPtr(constraint), constraint);
  }
