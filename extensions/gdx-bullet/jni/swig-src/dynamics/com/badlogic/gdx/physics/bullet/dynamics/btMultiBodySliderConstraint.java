...
public class btMultiBodySliderConstraint extends btMultiBodyConstraint {
  ...
  /**
   * Construct a new btMultiBodySliderConstraint, normally you should not need this constructor it's
  ...
  public btMultiBodySliderConstraint(
      ...
      Vector3 jointAxis) {
    this(
        DynamicsJNI.new_btMultiBodySliderConstraint__SWIG_0(
  ...
  public btMultiBodySliderConstraint(
      ...
      Vector3 jointAxis) {
    this(
        DynamicsJNI.new_btMultiBodySliderConstraint__SWIG_1(
