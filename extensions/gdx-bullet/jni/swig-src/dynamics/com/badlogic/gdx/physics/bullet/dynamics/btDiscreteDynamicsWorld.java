...
public class btDiscreteDynamicsWorld extends btDynamicsWorld {
  ...
  /**
   * Construct a new btDiscreteDynamicsWorld, normally you should not need this constructor it's
  ...
  public long operatorNewArray(long sizeInBytes) {
    return DynamicsJNI.btDiscreteDynamicsWorld_operatorNewArray__SWIG_0(
  ...
  public btDiscreteDynamicsWorld(
    ...
    this(
        DynamicsJNI.new_btDiscreteDynamicsWorld(
            btDispatcher.getCPtr(dispatcher),
            dispatcher,
            btBroadphaseInterface.getCPtr(pairCache),
            pairCache,
            btConstraintSolver.getCPtr(constraintSolver),
            constraintSolver,
  ...
  public int stepSimulation(float timeStep, int maxSubSteps, float fixedTimeStep) {
    return DynamicsJNI.btDiscreteDynamicsWorld_stepSimulation__SWIG_0(
        swigCPtr, this, timeStep, maxSubSteps, fixedTimeStep);
  }

  public int stepSimulation(float timeStep, int maxSubSteps) {
    return DynamicsJNI.btDiscreteDynamicsWorld_stepSimulation__SWIG_1(
  ...
  public void synchronizeSingleMotionState(btRigidBody body) {
    DynamicsJNI.btDiscreteDynamicsWorld_synchronizeSingleMotionState(
  ...
  public void addConstraint(
    ...
    DynamicsJNI.btDiscreteDynamicsWorld_addConstraint__SWIG_0(
        swigCPtr,
        this,
  ...
  public void addConstraint(btTypedConstraint constraint) {
    DynamicsJNI.btDiscreteDynamicsWorld_addConstraint__SWIG_1(
  ...
  public void addCollisionObject(
    ...
    DynamicsJNI.btDiscreteDynamicsWorld_addCollisionObject__SWIG_0(
        swigCPtr,
        this,
  ...
  public void addCollisionObject(btCollisionObject collisionObject, int collisionFilterGroup) {
    DynamicsJNI.btDiscreteDynamicsWorld_addCollisionObject__SWIG_1(
        swigCPtr,
        this,
        btCollisionObject.getCPtr(collisionObject),
        collisionObject,
  ...
  public void setSynchronizeAllMotionStates(boolean synchronizeAll) {
    DynamicsJNI.btDiscreteDynamicsWorld_setSynchronizeAllMotionStates(
        swigCPtr, this, synchronizeAll);
  }
  ...
  public void setApplySpeculativeContactRestitution(boolean enable) {
    DynamicsJNI.btDiscreteDynamicsWorld_setApplySpeculativeContactRestitution(
        swigCPtr, this, enable);
  }

  public boolean getApplySpeculativeContactRestitution() {
    return DynamicsJNI.btDiscreteDynamicsWorld_getApplySpeculativeContactRestitution(
        swigCPtr, this);
  }

  public void setLatencyMotionStateInterpolation(boolean latencyInterpolation) {
    DynamicsJNI.btDiscreteDynamicsWorld_setLatencyMotionStateInterpolation(
        swigCPtr, this, latencyInterpolation);
  }
