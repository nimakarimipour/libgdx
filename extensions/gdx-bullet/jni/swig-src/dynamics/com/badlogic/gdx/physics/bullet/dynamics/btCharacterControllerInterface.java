...
public class btCharacterControllerInterface extends btActionInterface {
  ...
  /**
   * Construct a new btCharacterControllerInterface, normally you should not need this constructor
  ...
  public void setVelocityForTimeInterval(Vector3 velocity, float timeInterval) {
    DynamicsJNI.btCharacterControllerInterface_setVelocityForTimeInterval(
        swigCPtr, this, velocity, timeInterval);
  }

  public void reset(btCollisionWorld collisionWorld) {
    DynamicsJNI.btCharacterControllerInterface_reset(
        swigCPtr, this, btCollisionWorld.getCPtr(collisionWorld), collisionWorld);
  }
  ...
  public void preStep(btCollisionWorld collisionWorld) {
    DynamicsJNI.btCharacterControllerInterface_preStep(
        swigCPtr, this, btCollisionWorld.getCPtr(collisionWorld), collisionWorld);
  }

  public void playerStep(btCollisionWorld collisionWorld, float dt) {
    DynamicsJNI.btCharacterControllerInterface_playerStep(
