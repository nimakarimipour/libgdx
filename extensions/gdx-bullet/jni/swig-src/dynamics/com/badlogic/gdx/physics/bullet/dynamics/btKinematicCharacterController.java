...
public class btKinematicCharacterController extends btCharacterControllerInterface {
  ...
  /**
   * Construct a new btKinematicCharacterController, normally you should not need this constructor
  ...
  public long operatorNew(long sizeInBytes) {
    return DynamicsJNI.btKinematicCharacterController_operatorNew__SWIG_0(
  ...
  public long operatorNew(long arg0, long ptr) {
    return DynamicsJNI.btKinematicCharacterController_operatorNew__SWIG_1(
  ...
  public long operatorNewArray(long sizeInBytes) {
    return DynamicsJNI.btKinematicCharacterController_operatorNewArray__SWIG_0(
        swigCPtr, this, sizeInBytes);
  }
  ...
  public long operatorNewArray(long arg0, long ptr) {
    return DynamicsJNI.btKinematicCharacterController_operatorNewArray__SWIG_1(
        swigCPtr, this, arg0, ptr);
  }

  public void operatorDeleteArray(long arg0, long arg1) {
    DynamicsJNI.btKinematicCharacterController_operatorDeleteArray__SWIG_1(
        swigCPtr, this, arg0, arg1);
  }

  public btKinematicCharacterController(
      btPairCachingGhostObject ghostObject,
      btConvexShape convexShape,
      float stepHeight,
      Vector3 up) {
    this(
        DynamicsJNI.new_btKinematicCharacterController__SWIG_0(
            btPairCachingGhostObject.getCPtr(ghostObject),
            ghostObject,
  ...
  public btKinematicCharacterController(
      btPairCachingGhostObject ghostObject, btConvexShape convexShape, float stepHeight) {
    this(
        DynamicsJNI.new_btKinematicCharacterController__SWIG_1(
            btPairCachingGhostObject.getCPtr(ghostObject),
            ghostObject,
            btConvexShape.getCPtr(convexShape),
            convexShape,
  ...
  public void setUseGhostSweepTest(boolean useGhostObjectSweepTest) {
    DynamicsJNI.btKinematicCharacterController_setUseGhostSweepTest(
        swigCPtr, this, useGhostObjectSweepTest);
  }
}
