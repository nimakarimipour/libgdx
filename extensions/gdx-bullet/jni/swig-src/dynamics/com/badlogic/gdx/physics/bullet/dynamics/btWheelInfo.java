...
public class btWheelInfo extends BulletBase {
  ...
  /**
   * Construct a new btWheelInfo, normally you should not need this constructor it's intended for
   * low-level usage.
   */
  ...
  public static class RaycastInfo extends BulletBase {
    ...
    /**
     * Construct a new RaycastInfo, normally you should not need this constructor it's intended for
     * low-level usage.
     */
    ...
    public void setContactNormalWS(btVector3 value) {
      DynamicsJNI.btWheelInfo_RaycastInfo_contactNormalWS_set(
    ...
    public void setContactPointWS(btVector3 value) {
      DynamicsJNI.btWheelInfo_RaycastInfo_contactPointWS_set(
          swigCPtr, this, btVector3.getCPtr(value), value);
    }
    ...
    public void setHardPointWS(btVector3 value) {
      DynamicsJNI.btWheelInfo_RaycastInfo_hardPointWS_set(
          swigCPtr, this, btVector3.getCPtr(value), value);
    }
    ...
    public void setWheelDirectionWS(btVector3 value) {
      DynamicsJNI.btWheelInfo_RaycastInfo_wheelDirectionWS_set(
          swigCPtr, this, btVector3.getCPtr(value), value);
    }
    ...
    public void setWheelAxleWS(btVector3 value) {
      DynamicsJNI.btWheelInfo_RaycastInfo_wheelAxleWS_set(
          swigCPtr, this, btVector3.getCPtr(value), value);
    }
  ...
  public void setRaycastInfo(btWheelInfo.RaycastInfo value) {
    DynamicsJNI.btWheelInfo_raycastInfo_set(
        swigCPtr, this, btWheelInfo.RaycastInfo.getCPtr(value), value);
  }
  ...
  public void setChassisConnectionPointCS(btVector3 value) {
    DynamicsJNI.btWheelInfo_chassisConnectionPointCS_set(
        swigCPtr, this, btVector3.getCPtr(value), value);
  }
  ...
  public void updateWheel(btRigidBody chassis, btWheelInfo.RaycastInfo raycastInfo) {
    DynamicsJNI.btWheelInfo_updateWheel(
        swigCPtr,
        this,
        btRigidBody.getCPtr(chassis),
        chassis,
        btWheelInfo.RaycastInfo.getCPtr(raycastInfo),
        raycastInfo);
  }
