...
public class btRotationalLimitMotor2 extends BulletBase {
  ...
  /**
   * Construct a new btRotationalLimitMotor2, normally you should not need this constructor it's
  ...
  public btRotationalLimitMotor2(btRotationalLimitMotor2 limot) {
    this(
        DynamicsJNI.new_btRotationalLimitMotor2__SWIG_1(
            btRotationalLimitMotor2.getCPtr(limot), limot),
        true);
  }
