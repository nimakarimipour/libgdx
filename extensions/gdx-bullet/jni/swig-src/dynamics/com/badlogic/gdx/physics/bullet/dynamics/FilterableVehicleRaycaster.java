...
public class FilterableVehicleRaycaster extends btDefaultVehicleRaycaster {
  ...
  /**
   * Construct a new FilterableVehicleRaycaster, normally you should not need this constructor it's
  ...
  public void setCollisionFilterMask(short collisionFilterMask) {
    DynamicsJNI.FilterableVehicleRaycaster_setCollisionFilterMask(
        swigCPtr, this, collisionFilterMask);
  }

  public void setCollisionFilterGroup(short collisionFilterGroup) {
    DynamicsJNI.FilterableVehicleRaycaster_setCollisionFilterGroup(
