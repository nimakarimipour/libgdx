...
public class btGeneric6DofSpring2Constraint extends btTypedConstraint {
  ...
  /**
   * Construct a new btGeneric6DofSpring2Constraint, normally you should not need this constructor
  ...
  public long operatorNew(long sizeInBytes) {
    return DynamicsJNI.btGeneric6DofSpring2Constraint_operatorNew__SWIG_0(
  ...
  public long operatorNew(long arg0, long ptr) {
    return DynamicsJNI.btGeneric6DofSpring2Constraint_operatorNew__SWIG_1(
  ...
  public long operatorNewArray(long sizeInBytes) {
    return DynamicsJNI.btGeneric6DofSpring2Constraint_operatorNewArray__SWIG_0(
        swigCPtr, this, sizeInBytes);
  }
  ...
  public long operatorNewArray(long arg0, long ptr) {
    return DynamicsJNI.btGeneric6DofSpring2Constraint_operatorNewArray__SWIG_1(
        swigCPtr, this, arg0, ptr);
  }

  public void operatorDeleteArray(long arg0, long arg1) {
    DynamicsJNI.btGeneric6DofSpring2Constraint_operatorDeleteArray__SWIG_1(
  ...
  public btGeneric6DofSpring2Constraint(
    ...
    this(
        DynamicsJNI.new_btGeneric6DofSpring2Constraint__SWIG_0(
  ...
  public btGeneric6DofSpring2Constraint(
      btRigidBody rbA, btRigidBody rbB, Matrix4 frameInA, Matrix4 frameInB) {
    this(
        DynamicsJNI.new_btGeneric6DofSpring2Constraint__SWIG_1(
            btRigidBody.getCPtr(rbA), rbA, btRigidBody.getCPtr(rbB), rbB, frameInA, frameInB),
        true);
  }

  public btGeneric6DofSpring2Constraint(btRigidBody rbB, Matrix4 frameInB, int rotOrder) {
    this(
        DynamicsJNI.new_btGeneric6DofSpring2Constraint__SWIG_2(
            btRigidBody.getCPtr(rbB), rbB, frameInB, rotOrder),
        true);
  }

  public btGeneric6DofSpring2Constraint(btRigidBody rbB, Matrix4 frameInB) {
    this(
        DynamicsJNI.new_btGeneric6DofSpring2Constraint__SWIG_3(
            btRigidBody.getCPtr(rbB), rbB, frameInB),
        true);
  }

  public btRotationalLimitMotor2 getRotationalLimitMotor(int index) {
    long cPtr =
        DynamicsJNI.btGeneric6DofSpring2Constraint_getRotationalLimitMotor(swigCPtr, this, index);
    return (cPtr == 0) ? null : new btRotationalLimitMotor2(cPtr, false);
  }

  public btTranslationalLimitMotor2 getTranslationalLimitMotor() {
    long cPtr =
        DynamicsJNI.btGeneric6DofSpring2Constraint_getTranslationalLimitMotor(swigCPtr, this);
  ...
  public void calculateTransforms(Matrix4 transA, Matrix4 transB) {
    DynamicsJNI.btGeneric6DofSpring2Constraint_calculateTransforms__SWIG_0(
        swigCPtr, this, transA, transB);
  }
  ...
  public float getRelativePivotPosition(int axis_index) {
    return DynamicsJNI.btGeneric6DofSpring2Constraint_getRelativePivotPosition(
        swigCPtr, this, axis_index);
  }
  ...
  public void setAngularLowerLimitReversed(Vector3 angularLower) {
    DynamicsJNI.btGeneric6DofSpring2Constraint_setAngularLowerLimitReversed(
        swigCPtr, this, angularLower);
  }
  ...
  public void getAngularLowerLimitReversed(Vector3 angularLower) {
    DynamicsJNI.btGeneric6DofSpring2Constraint_getAngularLowerLimitReversed(
        swigCPtr, this, angularLower);
  }
  ...
  public void setAngularUpperLimitReversed(Vector3 angularUpper) {
    DynamicsJNI.btGeneric6DofSpring2Constraint_setAngularUpperLimitReversed(
        swigCPtr, this, angularUpper);
  }
  ...
  public void getAngularUpperLimitReversed(Vector3 angularUpper) {
    DynamicsJNI.btGeneric6DofSpring2Constraint_getAngularUpperLimitReversed(
        swigCPtr, this, angularUpper);
  }
  ...
  public void setStiffness(int index, float stiffness, boolean limitIfNeeded) {
    DynamicsJNI.btGeneric6DofSpring2Constraint_setStiffness__SWIG_0(
        swigCPtr, this, index, stiffness, limitIfNeeded);
  }

  public void setStiffness(int index, float stiffness) {
    DynamicsJNI.btGeneric6DofSpring2Constraint_setStiffness__SWIG_1(
        swigCPtr, this, index, stiffness);
  }

  public void setDamping(int index, float damping, boolean limitIfNeeded) {
    DynamicsJNI.btGeneric6DofSpring2Constraint_setDamping__SWIG_0(
        swigCPtr, this, index, damping, limitIfNeeded);
  }
  ...
  public void setEquilibriumPoint(int index, float val) {
    DynamicsJNI.btGeneric6DofSpring2Constraint_setEquilibriumPoint__SWIG_2(
        swigCPtr, this, index, val);
  }
