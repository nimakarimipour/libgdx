...
public class btConstraintSolverPoolMt extends btConstraintSolver {
  ...
  /**
   * Construct a new btConstraintSolverPoolMt, normally you should not need this constructor it's
  ...
  public btConstraintSolverPoolMt(SWIGTYPE_p_p_btConstraintSolver solvers, int numSolvers) {
    this(
        DynamicsJNI.new_btConstraintSolverPoolMt__SWIG_1(
            SWIGTYPE_p_p_btConstraintSolver.getCPtr(solvers), numSolvers),
        true);
  }
}
