...
public class btTypedConstraintData extends BulletBase {
  ...
  /**
   * Construct a new btTypedConstraintData, normally you should not need this constructor it's
  ...
  public void setRbA(btRigidBodyFloatData value) {
    DynamicsJNI.btTypedConstraintData_rbA_set(
  ...
  public void setRbB(btRigidBodyFloatData value) {
    DynamicsJNI.btTypedConstraintData_rbB_set(
        swigCPtr, this, btRigidBodyFloatData.getCPtr(value), value);
  }
  ...
  public void setDisableCollisionsBetweenLinkedBodies(int value) {
    DynamicsJNI.btTypedConstraintData_disableCollisionsBetweenLinkedBodies_set(
        swigCPtr, this, value);
  }

  public int getDisableCollisionsBetweenLinkedBodies() {
    return DynamicsJNI.btTypedConstraintData_disableCollisionsBetweenLinkedBodies_get(
        swigCPtr, this);
  }
