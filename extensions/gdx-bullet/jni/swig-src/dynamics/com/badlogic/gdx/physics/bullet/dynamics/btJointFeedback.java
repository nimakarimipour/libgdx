...
public class btJointFeedback extends BulletBase {
  ...
  /**
   * Construct a new btJointFeedback, normally you should not need this constructor it's intended
   * for low-level usage.
   */
  ...
  public void setAppliedForceBodyA(btVector3 value) {
    DynamicsJNI.btJointFeedback_appliedForceBodyA_set(
  ...
  public void setAppliedTorqueBodyA(btVector3 value) {
    DynamicsJNI.btJointFeedback_appliedTorqueBodyA_set(
        swigCPtr, this, btVector3.getCPtr(value), value);
  }
  ...
  public void setAppliedForceBodyB(btVector3 value) {
    DynamicsJNI.btJointFeedback_appliedForceBodyB_set(
        swigCPtr, this, btVector3.getCPtr(value), value);
  }
  ...
  public void setAppliedTorqueBodyB(btVector3 value) {
    DynamicsJNI.btJointFeedback_appliedTorqueBodyB_set(
        swigCPtr, this, btVector3.getCPtr(value), value);
  }
