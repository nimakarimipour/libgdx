...
public class btMultibodyLink extends BulletBase {
  ...
  /**
   * Construct a new btMultibodyLink, normally you should not need this constructor it's intended
   * for low-level usage.
   */
  ...
  public void setZeroRotParentToThis(btQuaternion value) {
    DynamicsJNI.btMultibodyLink_zeroRotParentToThis_set(
        swigCPtr, this, btQuaternion.getCPtr(value), value);
  }
  ...
  public void setAbsFrameTotVelocity(btSpatialMotionVector value) {
    DynamicsJNI.btMultibodyLink_absFrameTotVelocity_set(
        swigCPtr, this, btSpatialMotionVector.getCPtr(value), value);
  }
  ...
  public void setAbsFrameLocVelocity(btSpatialMotionVector value) {
    DynamicsJNI.btMultibodyLink_absFrameLocVelocity_set(
        swigCPtr, this, btSpatialMotionVector.getCPtr(value), value);
  }
  ...
  public void setAxes(btSpatialMotionVector value) {
    DynamicsJNI.btMultibodyLink_axes_set(
        swigCPtr, this, btSpatialMotionVector.getCPtr(value), value);
  }
  ...
  public void setCachedRotParentToThis(btQuaternion value) {
    DynamicsJNI.btMultibodyLink_cachedRotParentToThis_set(
        swigCPtr, this, btQuaternion.getCPtr(value), value);
  }
  ...
  public void setAppliedConstraintForce(btVector3 value) {
    DynamicsJNI.btMultibodyLink_appliedConstraintForce_set(
  ...
  public void setAppliedConstraintTorque(btVector3 value) {
    DynamicsJNI.btMultibodyLink_appliedConstraintTorque_set(
        swigCPtr, this, btVector3.getCPtr(value), value);
  }
  ...
  public void setCollider(btMultiBodyLinkCollider value) {
    DynamicsJNI.btMultibodyLink_collider_set(
        swigCPtr, this, btMultiBodyLinkCollider.getCPtr(value), value);
  }
  ...
  public void setJointFeedback(btMultiBodyJointFeedback value) {
    DynamicsJNI.btMultibodyLink_jointFeedback_set(
        swigCPtr, this, btMultiBodyJointFeedback.getCPtr(value), value);
  }
  ...
  public void setCachedWorldTransform(btTransform value) {
    DynamicsJNI.btMultibodyLink_cachedWorldTransform_set(
  ...
  public static final class eFeatherstoneJointType {
    ...
    public static final int eInvalid = eFixed + 1;
  }
}
