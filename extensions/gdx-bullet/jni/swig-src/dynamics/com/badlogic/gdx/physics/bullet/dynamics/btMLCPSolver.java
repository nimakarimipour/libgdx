...
public class btMLCPSolver extends btSequentialImpulseConstraintSolver {
  ...
  /**
   * Construct a new btMLCPSolver, normally you should not need this constructor it's intended for
   * low-level usage.
   */
  ...
  public void setMLCPSolver(btMLCPSolverInterface solver) {
    DynamicsJNI.btMLCPSolver_setMLCPSolver(
        swigCPtr, this, btMLCPSolverInterface.getCPtr(solver), solver);
  }
