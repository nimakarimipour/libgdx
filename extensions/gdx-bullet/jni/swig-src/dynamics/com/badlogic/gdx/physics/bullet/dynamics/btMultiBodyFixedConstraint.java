...
public class btMultiBodyFixedConstraint extends btMultiBodyConstraint {
  ...
  /**
   * Construct a new btMultiBodyFixedConstraint, normally you should not need this constructor it's
  ...
  public btMultiBodyFixedConstraint(
      btMultiBody body,
      int link,
      btRigidBody bodyB,
      Vector3 pivotInA,
      ...
      Matrix3 frameInB) {
    this(
        DynamicsJNI.new_btMultiBodyFixedConstraint__SWIG_0(
  ...
  public btMultiBodyFixedConstraint(
      ...
      Matrix3 frameInB) {
    this(
        DynamicsJNI.new_btMultiBodyFixedConstraint__SWIG_1(
