...
public class btMultiBodyJacobianData extends BulletBase {
  ...
  /**
   * Construct a new btMultiBodyJacobianData, normally you should not need this constructor it's
  ...
  public void setJacobians(btScalarArray value) {
    DynamicsJNI.btMultiBodyJacobianData_jacobians_set(
  ...
  public void setDeltaVelocitiesUnitImpulse(btScalarArray value) {
    DynamicsJNI.btMultiBodyJacobianData_deltaVelocitiesUnitImpulse_set(
        swigCPtr, this, btScalarArray.getCPtr(value), value);
  }
  ...
  public void setDeltaVelocities(btScalarArray value) {
    DynamicsJNI.btMultiBodyJacobianData_deltaVelocities_set(
        swigCPtr, this, btScalarArray.getCPtr(value), value);
  }
  ...
  public void setScratch_r(btScalarArray value) {
    DynamicsJNI.btMultiBodyJacobianData_scratch_r_set(
        swigCPtr, this, btScalarArray.getCPtr(value), value);
  }
  ...
  public void setScratch_v(btVector3Array value) {
    DynamicsJNI.btMultiBodyJacobianData_scratch_v_set(
  ...
  public void setScratch_m(SWIGTYPE_p_btAlignedObjectArrayT_btMatrix3x3_t value) {
    DynamicsJNI.btMultiBodyJacobianData_scratch_m_set(
        swigCPtr, this, SWIGTYPE_p_btAlignedObjectArrayT_btMatrix3x3_t.getCPtr(value));
  }
  ...
  public void setSolverBodyPool(SWIGTYPE_p_btAlignedObjectArrayT_btSolverBody_t value) {
    DynamicsJNI.btMultiBodyJacobianData_solverBodyPool_set(
        swigCPtr, this, SWIGTYPE_p_btAlignedObjectArrayT_btSolverBody_t.getCPtr(value));
  }
