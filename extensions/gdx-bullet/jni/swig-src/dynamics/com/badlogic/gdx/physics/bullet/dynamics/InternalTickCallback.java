...
public class InternalTickCallback extends BulletBase {
  ...
  /**
   * Construct a new InternalTickCallback, normally you should not need this constructor it's
  ...
  public InternalTickCallback(btDynamicsWorld dynamicsWorld, boolean isPreTick) {
    this(
        DynamicsJNI.new_InternalTickCallback__SWIG_0(
            btDynamicsWorld.getCPtr(dynamicsWorld), dynamicsWorld, isPreTick),
        true);
  ...
  public InternalTickCallback(btDynamicsWorld dynamicsWorld) {
    this(
        DynamicsJNI.new_InternalTickCallback__SWIG_1(
            btDynamicsWorld.getCPtr(dynamicsWorld), dynamicsWorld),
        true);
    DynamicsJNI.InternalTickCallback_director_connect(this, swigCPtr, swigCMemOwn, true);
  }
  ...
  public void onInternalTick(btDynamicsWorld dynamicsWorld, float timeStep) {
    if (getClass() == InternalTickCallback.class)
      DynamicsJNI.InternalTickCallback_onInternalTick(
          swigCPtr, this, btDynamicsWorld.getCPtr(dynamicsWorld), dynamicsWorld, timeStep);
    else
      DynamicsJNI.InternalTickCallback_onInternalTickSwigExplicitInternalTickCallback(
          swigCPtr, this, btDynamicsWorld.getCPtr(dynamicsWorld), dynamicsWorld, timeStep);
  }
  ...
  public void attach(btDynamicsWorld dynamicsWorld, boolean isPreTick) {
    DynamicsJNI.InternalTickCallback_attach__SWIG_0(
        swigCPtr, this, btDynamicsWorld.getCPtr(dynamicsWorld), dynamicsWorld, isPreTick);
  }
  ...
  public static void detach(btDynamicsWorld dynamicsWorld, boolean isPreTick) {
    DynamicsJNI.InternalTickCallback_detach__SWIG_1(
        btDynamicsWorld.getCPtr(dynamicsWorld), dynamicsWorld, isPreTick);
  }
}
