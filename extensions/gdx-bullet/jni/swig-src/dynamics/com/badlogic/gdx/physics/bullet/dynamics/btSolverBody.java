...
public class btSolverBody extends BulletBase {
  ...
  /**
   * Construct a new btSolverBody, normally you should not need this constructor it's intended for
   * low-level usage.
   */
  ...
  public void setDeltaLinearVelocity(btVector3 value) {
    DynamicsJNI.btSolverBody_deltaLinearVelocity_set(
  ...
  public void setDeltaAngularVelocity(btVector3 value) {
    DynamicsJNI.btSolverBody_deltaAngularVelocity_set(
        swigCPtr, this, btVector3.getCPtr(value), value);
  }
  ...
  public void setExternalForceImpulse(btVector3 value) {
    DynamicsJNI.btSolverBody_externalForceImpulse_set(
        swigCPtr, this, btVector3.getCPtr(value), value);
  }
  ...
  public void setExternalTorqueImpulse(btVector3 value) {
    DynamicsJNI.btSolverBody_externalTorqueImpulse_set(
        swigCPtr, this, btVector3.getCPtr(value), value);
  }
  ...
  public btRigidBody getOriginalBody() {
    return btRigidBody.getInstance(
        DynamicsJNI.btSolverBody_originalBody_get(swigCPtr, this), false);
  }
  ...
  public void applyImpulse(
      Vector3 linearComponent, Vector3 angularComponent, float impulseMagnitude) {
    DynamicsJNI.btSolverBody_applyImpulse(
        swigCPtr, this, linearComponent, angularComponent, impulseMagnitude);
  }

  public void internalApplyPushImpulse(
      Vector3 linearComponent, Vector3 angularComponent, float impulseMagnitude) {
    DynamicsJNI.btSolverBody_internalApplyPushImpulse(
        swigCPtr, this, linearComponent, angularComponent, impulseMagnitude);
  }
  ...
  public void internalGetVelocityInLocalPointObsolete(Vector3 rel_pos, Vector3 velocity) {
    DynamicsJNI.btSolverBody_internalGetVelocityInLocalPointObsolete(
        swigCPtr, this, rel_pos, velocity);
  }
  ...
  public void internalApplyImpulse(
      Vector3 linearComponent, Vector3 angularComponent, float impulseMagnitude) {
    DynamicsJNI.btSolverBody_internalApplyImpulse(
        swigCPtr, this, linearComponent, angularComponent, impulseMagnitude);
  }
  ...
  public void writebackVelocityAndTransform(float timeStep, float splitImpulseTurnErp) {
    DynamicsJNI.btSolverBody_writebackVelocityAndTransform(
        swigCPtr, this, timeStep, splitImpulseTurnErp);
  }
