...
public class btGeneric6DofConstraintDoubleData2 extends BulletBase {
  ...
  protected btGeneric6DofConstraintDoubleData2(
  ...
  /**
   * Construct a new btGeneric6DofConstraintDoubleData2, normally you should not need this
  ...
  public void setRbBFrame(btTransformDoubleData value) {
    DynamicsJNI.btGeneric6DofConstraintDoubleData2_rbBFrame_set(
        swigCPtr, this, btTransformDoubleData.getCPtr(value), value);
  }
  ...
  public void setLinearUpperLimit(btVector3DoubleData value) {
    DynamicsJNI.btGeneric6DofConstraintDoubleData2_linearUpperLimit_set(
  ...
  public void setLinearLowerLimit(btVector3DoubleData value) {
    DynamicsJNI.btGeneric6DofConstraintDoubleData2_linearLowerLimit_set(
        swigCPtr, this, btVector3DoubleData.getCPtr(value), value);
  }
  ...
  public void setAngularUpperLimit(btVector3DoubleData value) {
    DynamicsJNI.btGeneric6DofConstraintDoubleData2_angularUpperLimit_set(
        swigCPtr, this, btVector3DoubleData.getCPtr(value), value);
  }

  public btVector3DoubleData getAngularUpperLimit() {
    long cPtr =
        DynamicsJNI.btGeneric6DofConstraintDoubleData2_angularUpperLimit_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btVector3DoubleData(cPtr, false);
  }

  public void setAngularLowerLimit(btVector3DoubleData value) {
    DynamicsJNI.btGeneric6DofConstraintDoubleData2_angularLowerLimit_set(
        swigCPtr, this, btVector3DoubleData.getCPtr(value), value);
  }

  public btVector3DoubleData getAngularLowerLimit() {
    long cPtr =
        DynamicsJNI.btGeneric6DofConstraintDoubleData2_angularLowerLimit_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btVector3DoubleData(cPtr, false);
  }

  public void setUseLinearReferenceFrameA(int value) {
    DynamicsJNI.btGeneric6DofConstraintDoubleData2_useLinearReferenceFrameA_set(
        swigCPtr, this, value);
  }

  public int getUseLinearReferenceFrameA() {
    return DynamicsJNI.btGeneric6DofConstraintDoubleData2_useLinearReferenceFrameA_get(
        swigCPtr, this);
  }

  public void setUseOffsetForConstraintFrame(int value) {
    DynamicsJNI.btGeneric6DofConstraintDoubleData2_useOffsetForConstraintFrame_set(
        swigCPtr, this, value);
  }

  public int getUseOffsetForConstraintFrame() {
    return DynamicsJNI.btGeneric6DofConstraintDoubleData2_useOffsetForConstraintFrame_get(
        swigCPtr, this);
  }
