...
public class btSolveProjectedGaussSeidel extends btMLCPSolverInterface {
  ...
  /**
   * Construct a new btSolveProjectedGaussSeidel, normally you should not need this constructor it's
  ...
  public void setLeastSquaresResidualThreshold(float value) {
    DynamicsJNI.btSolveProjectedGaussSeidel_leastSquaresResidualThreshold_set(
        swigCPtr, this, value);
  }

  public float getLeastSquaresResidualThreshold() {
    return DynamicsJNI.btSolveProjectedGaussSeidel_leastSquaresResidualThreshold_get(
        swigCPtr, this);
  }
  ...
  public boolean solveMLCP(
      SWIGTYPE_p_btMatrixXT_float_t A,
      ...
      int numIterations,
      boolean useSparsity) {
    return DynamicsJNI.btSolveProjectedGaussSeidel_solveMLCP__SWIG_0(
        swigCPtr,
        this,
        SWIGTYPE_p_btMatrixXT_float_t.getCPtr(A),
        SWIGTYPE_p_btVectorXT_float_t.getCPtr(b),
        SWIGTYPE_p_btVectorXT_float_t.getCPtr(x),
        SWIGTYPE_p_btVectorXT_float_t.getCPtr(lo),
        SWIGTYPE_p_btVectorXT_float_t.getCPtr(hi),
        SWIGTYPE_p_btAlignedObjectArrayT_int_t.getCPtr(limitDependency),
        numIterations,
        useSparsity);
  }
  ...
  public boolean solveMLCP(
      ...
      SWIGTYPE_p_btAlignedObjectArrayT_int_t limitDependency,
      int numIterations) {
    return DynamicsJNI.btSolveProjectedGaussSeidel_solveMLCP__SWIG_1(
        swigCPtr,
        this,
        SWIGTYPE_p_btMatrixXT_float_t.getCPtr(A),
        SWIGTYPE_p_btVectorXT_float_t.getCPtr(b),
