...
public class btMultiBodyGearConstraint extends btMultiBodyConstraint {
  ...
  /**
   * Construct a new btMultiBodyGearConstraint, normally you should not need this constructor it's
  ...
  public btMultiBodyGearConstraint(
      btMultiBody bodyA,
      int linkA,
      btMultiBody bodyB,
      int linkB,
      ...
      Matrix3 frameInB) {
    this(
        DynamicsJNI.new_btMultiBodyGearConstraint(
