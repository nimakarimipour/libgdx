...
public class btMultiBodyPoint2Point extends btMultiBodyConstraint {
  ...
  /**
   * Construct a new btMultiBodyPoint2Point, normally you should not need this constructor it's
  ...
  public btMultiBodyPoint2Point(
      btMultiBody body, int link, btRigidBody bodyB, Vector3 pivotInA, Vector3 pivotInB) {
    this(
        DynamicsJNI.new_btMultiBodyPoint2Point__SWIG_0(
            btMultiBody.getCPtr(body),
            body,
            link,
            btRigidBody.getCPtr(bodyB),
            bodyB,
            pivotInA,
            pivotInB),
        true);
  ...
  public btMultiBodyPoint2Point(
    ...
    this(
        DynamicsJNI.new_btMultiBodyPoint2Point__SWIG_1(
            btMultiBody.getCPtr(bodyA),
            bodyA,
            linkA,
            btMultiBody.getCPtr(bodyB),
            bodyB,
            linkB,
            pivotInA,
            pivotInB),
