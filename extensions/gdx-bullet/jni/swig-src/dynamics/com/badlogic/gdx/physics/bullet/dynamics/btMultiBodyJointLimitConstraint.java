...
public class btMultiBodyJointLimitConstraint extends btMultiBodyConstraint {
  ...
  /**
   * Construct a new btMultiBodyJointLimitConstraint, normally you should not need this constructor
  ...
  protected void reset(long cPtr, boolean cMemoryOwn) {
    ...
    super.reset(
        DynamicsJNI.btMultiBodyJointLimitConstraint_SWIGUpcast(swigCPtr = cPtr), cMemoryOwn);
  }
  ...
  public btMultiBodyJointLimitConstraint(btMultiBody body, int link, float lower, float upper) {
    this(
        DynamicsJNI.new_btMultiBodyJointLimitConstraint(
            btMultiBody.getCPtr(body), body, link, lower, upper),
        true);
  }
}
