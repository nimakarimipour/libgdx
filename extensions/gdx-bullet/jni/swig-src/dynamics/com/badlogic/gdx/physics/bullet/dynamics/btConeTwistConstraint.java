...
public class btConeTwistConstraint extends btTypedConstraint {
  ...
  /**
   * Construct a new btConeTwistConstraint, normally you should not need this constructor it's
  ...
  public btConeTwistConstraint(
    ...
    this(
        DynamicsJNI.new_btConeTwistConstraint__SWIG_0(
  ...
  public btConeTwistConstraint(btRigidBody rbA, Matrix4 rbAFrame) {
    this(
        DynamicsJNI.new_btConeTwistConstraint__SWIG_1(btRigidBody.getCPtr(rbA), rbA, rbAFrame),
        true);
  }

  public void getInfo1NonVirtual(btTypedConstraint.btConstraintInfo1 info) {
    DynamicsJNI.btConeTwistConstraint_getInfo1NonVirtual(
  ...
  public void getInfo2NonVirtual(
    ...
    DynamicsJNI.btConeTwistConstraint_getInfo2NonVirtual(
        swigCPtr,
        this,
  ...
  public btRigidBody getRigidBodyAConst() {
    return btRigidBody.getInstance(
        DynamicsJNI.btConeTwistConstraint_getRigidBodyAConst(swigCPtr, this), false);
  }

  public btRigidBody getRigidBodyBConst() {
    return btRigidBody.getInstance(
        DynamicsJNI.btConeTwistConstraint_getRigidBodyBConst(swigCPtr, this), false);
  }
  ...
  public void setLimit(
    ...
    DynamicsJNI.btConeTwistConstraint_setLimit__SWIG_1(
        swigCPtr,
        this,
        _swingSpan1,
        _swingSpan2,
  ...
  public void setLimit(
      float _swingSpan1, float _swingSpan2, float _twistSpan, float _softness, float _biasFactor) {
    DynamicsJNI.btConeTwistConstraint_setLimit__SWIG_2(
        swigCPtr, this, _swingSpan1, _swingSpan2, _twistSpan, _softness, _biasFactor);
  }

  public void setLimit(float _swingSpan1, float _swingSpan2, float _twistSpan, float _softness) {
    DynamicsJNI.btConeTwistConstraint_setLimit__SWIG_3(
        swigCPtr, this, _swingSpan1, _swingSpan2, _twistSpan, _softness);
  }

  public void setLimit(float _swingSpan1, float _swingSpan2, float _twistSpan) {
    DynamicsJNI.btConeTwistConstraint_setLimit__SWIG_4(
        swigCPtr, this, _swingSpan1, _swingSpan2, _twistSpan);
  }
  ...
  public void calcAngleInfo2(
      Matrix4 transA, Matrix4 transB, Matrix3 invInertiaWorldA, Matrix3 invInertiaWorldB) {
    DynamicsJNI.btConeTwistConstraint_calcAngleInfo2(
        swigCPtr, this, transA, transB, invInertiaWorldA, invInertiaWorldB);
  }
  ...
  public Vector3 GetPointForAngle(float fAngleInRadians, float fLength) {
    return DynamicsJNI.btConeTwistConstraint_GetPointForAngle(
        swigCPtr, this, fAngleInRadians, fLength);
  }
