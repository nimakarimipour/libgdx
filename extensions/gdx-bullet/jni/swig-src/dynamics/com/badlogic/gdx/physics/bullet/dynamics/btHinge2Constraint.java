...
public class btHinge2Constraint extends btGeneric6DofSpring2Constraint {
  ...
  /**
   * Construct a new btHinge2Constraint, normally you should not need this constructor it's intended
   * for low-level usage.
   */
