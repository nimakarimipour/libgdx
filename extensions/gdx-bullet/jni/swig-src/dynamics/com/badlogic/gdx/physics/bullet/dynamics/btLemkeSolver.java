...
public class btLemkeSolver extends btMLCPSolverInterface {
  ...
  /**
   * Construct a new btLemkeSolver, normally you should not need this constructor it's intended for
   * low-level usage.
   */
  ...
  public boolean solveMLCP(
      ...
      int numIterations,
      boolean useSparsity) {
    return DynamicsJNI.btLemkeSolver_solveMLCP__SWIG_0(
        swigCPtr,
        this,
  ...
  public boolean solveMLCP(
      ...
      SWIGTYPE_p_btAlignedObjectArrayT_int_t limitDependency,
      int numIterations) {
    return DynamicsJNI.btLemkeSolver_solveMLCP__SWIG_1(
        swigCPtr,
        this,
        SWIGTYPE_p_btMatrixXT_float_t.getCPtr(A),
        SWIGTYPE_p_btVectorXT_float_t.getCPtr(b),
