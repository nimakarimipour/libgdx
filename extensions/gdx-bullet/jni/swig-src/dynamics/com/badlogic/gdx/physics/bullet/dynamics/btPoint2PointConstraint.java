...
public class btPoint2PointConstraint extends btTypedConstraint {
  ...
  /**
   * Construct a new btPoint2PointConstraint, normally you should not need this constructor it's
  ...
  public long operatorNewArray(long sizeInBytes) {
    return DynamicsJNI.btPoint2PointConstraint_operatorNewArray__SWIG_0(
  ...
  public void setSetting(btConstraintSetting value) {
    DynamicsJNI.btPoint2PointConstraint_setting_set(
        swigCPtr, this, btConstraintSetting.getCPtr(value), value);
  }
  ...
  public btPoint2PointConstraint(
    ...
    this(
        DynamicsJNI.new_btPoint2PointConstraint__SWIG_0(
            btRigidBody.getCPtr(rbA), rbA, btRigidBody.getCPtr(rbB), rbB, pivotInA, pivotInB),
        true);
  }

  public btPoint2PointConstraint(btRigidBody rbA, Vector3 pivotInA) {
    this(
        DynamicsJNI.new_btPoint2PointConstraint__SWIG_1(btRigidBody.getCPtr(rbA), rbA, pivotInA),
        true);
  }

  public void getInfo1NonVirtual(btTypedConstraint.btConstraintInfo1 info) {
    DynamicsJNI.btPoint2PointConstraint_getInfo1NonVirtual(
        swigCPtr, this, btTypedConstraint.btConstraintInfo1.getCPtr(info), info);
  }

  public void getInfo2NonVirtual(
      btTypedConstraint.btConstraintInfo2 info, Matrix4 body0_trans, Matrix4 body1_trans) {
    DynamicsJNI.btPoint2PointConstraint_getInfo2NonVirtual(
        swigCPtr,
        this,
