...
public class btSimulationIslandManagerMt extends btSimulationIslandManager {
  ...
  /**
   * Construct a new btSimulationIslandManagerMt, normally you should not need this constructor it's
  ...
  public static class Island extends BulletBase {
    ...
    /**
     * Construct a new Island, normally you should not need this constructor it's intended for
     * low-level usage.
     */
    ...
    public void setBodyArray(btCollisionObjectArray value) {
      DynamicsJNI.btSimulationIslandManagerMt_Island_bodyArray_set(
          swigCPtr, this, btCollisionObjectArray.getCPtr(value), value);
    }
    ...
    public void setManifoldArray(btPersistentManifoldArray value) {
      DynamicsJNI.btSimulationIslandManagerMt_Island_manifoldArray_set(
          swigCPtr, this, btPersistentManifoldArray.getCPtr(value), value);
    }
    ...
    public void setConstraintArray(SWIGTYPE_p_btAlignedObjectArrayT_btTypedConstraint_p_t value) {
      DynamicsJNI.btSimulationIslandManagerMt_Island_constraintArray_set(
          swigCPtr, this, SWIGTYPE_p_btAlignedObjectArrayT_btTypedConstraint_p_t.getCPtr(value));
    }

    public SWIGTYPE_p_btAlignedObjectArrayT_btTypedConstraint_p_t getConstraintArray() {
      long cPtr =
          DynamicsJNI.btSimulationIslandManagerMt_Island_constraintArray_get(swigCPtr, this);
      return (cPtr == 0)
          ? null
          : new SWIGTYPE_p_btAlignedObjectArrayT_btTypedConstraint_p_t(cPtr, false);
    }
    ...
    public void append(btSimulationIslandManagerMt.Island other) {
      DynamicsJNI.btSimulationIslandManagerMt_Island_append(
          swigCPtr, this, btSimulationIslandManagerMt.Island.getCPtr(other), other);
    }
  ...
  public static class IslandCallback extends BulletBase {
    ...
    /**
     * Construct a new IslandCallback, normally you should not need this constructor it's intended
     * for low-level usage.
     */
    ...
    public void processIsland(
        SWIGTYPE_p_p_btCollisionObject bodies,
        int numBodies,
      ...
      DynamicsJNI.btSimulationIslandManagerMt_IslandCallback_processIsland(
          swigCPtr,
          this,
          SWIGTYPE_p_p_btCollisionObject.getCPtr(bodies),
          numBodies,
          SWIGTYPE_p_p_btPersistentManifold.getCPtr(manifolds),
          numManifolds,
          SWIGTYPE_p_p_btTypedConstraint.getCPtr(constraints),
          numConstraints,
          islandId);
    }
  }

  public static void serialIslandDispatch(
      SWIGTYPE_p_btAlignedObjectArrayT_btSimulationIslandManagerMt__Island_p_t islandsPtr,
      btSimulationIslandManagerMt.IslandCallback callback) {
    DynamicsJNI.btSimulationIslandManagerMt_serialIslandDispatch(
        SWIGTYPE_p_btAlignedObjectArrayT_btSimulationIslandManagerMt__Island_p_t.getCPtr(
            islandsPtr),
        btSimulationIslandManagerMt.IslandCallback.getCPtr(callback),
        callback);
  }

  public static void parallelIslandDispatch(
      SWIGTYPE_p_btAlignedObjectArrayT_btSimulationIslandManagerMt__Island_p_t islandsPtr,
      btSimulationIslandManagerMt.IslandCallback callback) {
  ...
  public void buildAndProcessIslands(
      ...
      btSimulationIslandManagerMt.IslandCallback callback) {
    DynamicsJNI.btSimulationIslandManagerMt_buildAndProcessIslands(
        swigCPtr,
        this,
        btDispatcher.getCPtr(dispatcher),
        dispatcher,
        btCollisionWorld.getCPtr(collisionWorld),
        collisionWorld,
  ...
  public void buildIslands(btDispatcher dispatcher, btCollisionWorld colWorld) {
    DynamicsJNI.btSimulationIslandManagerMt_buildIslands(
        swigCPtr,
        this,
        btDispatcher.getCPtr(dispatcher),
        dispatcher,
        btCollisionWorld.getCPtr(colWorld),
        colWorld);
  }
