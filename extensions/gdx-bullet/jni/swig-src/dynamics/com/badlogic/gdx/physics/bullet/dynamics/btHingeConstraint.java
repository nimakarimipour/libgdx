...
public class btHingeConstraint extends btTypedConstraint {
  ...
  /**
   * Construct a new btHingeConstraint, normally you should not need this constructor it's intended
   * for low-level usage.
   */
  ...
  public btHingeConstraint(
    ...
    this(
        DynamicsJNI.new_btHingeConstraint__SWIG_0(
  ...
  public btHingeConstraint(
      ...
      Vector3 axisInB) {
    this(
        DynamicsJNI.new_btHingeConstraint__SWIG_1(
            btRigidBody.getCPtr(rbA),
            rbA,
            btRigidBody.getCPtr(rbB),
            rbB,
  ...
  public btHingeConstraint(
    ...
    this(
        DynamicsJNI.new_btHingeConstraint__SWIG_2(
  ...
  public btHingeConstraint(btRigidBody rbA, Vector3 pivotInA, Vector3 axisInA) {
    this(
        DynamicsJNI.new_btHingeConstraint__SWIG_3(btRigidBody.getCPtr(rbA), rbA, pivotInA, axisInA),
        true);
  }
  ...
  public btHingeConstraint(
      ...
      boolean useReferenceFrameA) {
    this(
        DynamicsJNI.new_btHingeConstraint__SWIG_4(
            btRigidBody.getCPtr(rbA),
            rbA,
            btRigidBody.getCPtr(rbB),
            rbB,
  ...
  public btHingeConstraint(btRigidBody rbA, btRigidBody rbB, Matrix4 rbAFrame, Matrix4 rbBFrame) {
    this(
        DynamicsJNI.new_btHingeConstraint__SWIG_5(
  ...
  public btHingeConstraint(btRigidBody rbA, Matrix4 rbAFrame, boolean useReferenceFrameA) {
    this(
        DynamicsJNI.new_btHingeConstraint__SWIG_6(
  ...
  public void getInfo1NonVirtual(btTypedConstraint.btConstraintInfo1 info) {
    DynamicsJNI.btHingeConstraint_getInfo1NonVirtual(
  ...
  public void getInfo2NonVirtual(
      ...
      Vector3 angVelA,
      Vector3 angVelB) {
    DynamicsJNI.btHingeConstraint_getInfo2NonVirtual(
        swigCPtr,
        this,
        btTypedConstraint.btConstraintInfo2.getCPtr(info),
        info,
        transA,
        transB,
        angVelA,
  ...
  public void getInfo2Internal(
      ...
      Vector3 angVelA,
      Vector3 angVelB) {
    DynamicsJNI.btHingeConstraint_getInfo2Internal(
        swigCPtr,
        this,
        btTypedConstraint.btConstraintInfo2.getCPtr(info),
        info,
  ...
  public void getInfo2InternalUsingFrameOffset(
      ...
      Vector3 angVelA,
      Vector3 angVelB) {
    DynamicsJNI.btHingeConstraint_getInfo2InternalUsingFrameOffset(
        swigCPtr,
        this,
        btTypedConstraint.btConstraintInfo2.getCPtr(info),
        info,
  ...
  public btRigidBody getRigidBodyAConst() {
    return btRigidBody.getInstance(
        DynamicsJNI.btHingeConstraint_getRigidBodyAConst(swigCPtr, this), false);
  }

  public btRigidBody getRigidBodyBConst() {
    return btRigidBody.getInstance(
        DynamicsJNI.btHingeConstraint_getRigidBodyBConst(swigCPtr, this), false);
  }

  public btRigidBody getRigidBodyA() {
    return btRigidBody.getInstance(
        DynamicsJNI.btHingeConstraint_getRigidBodyA(swigCPtr, this), false);
  }

  public btRigidBody getRigidBodyB() {
    return btRigidBody.getInstance(
        DynamicsJNI.btHingeConstraint_getRigidBodyB(swigCPtr, this), false);
  }
  ...
  public void enableAngularMotor(boolean enableMotor, float targetVelocity, float maxMotorImpulse) {
    DynamicsJNI.btHingeConstraint_enableAngularMotor(
        swigCPtr, this, enableMotor, targetVelocity, maxMotorImpulse);
  }
  ...
  public void setLimit(
      float low, float high, float _softness, float _biasFactor, float _relaxationFactor) {
    DynamicsJNI.btHingeConstraint_setLimit__SWIG_0(
        swigCPtr, this, low, high, _softness, _biasFactor, _relaxationFactor);
  }

  public void setLimit(float low, float high, float _softness, float _biasFactor) {
    DynamicsJNI.btHingeConstraint_setLimit__SWIG_1(
        swigCPtr, this, low, high, _softness, _biasFactor);
  }
