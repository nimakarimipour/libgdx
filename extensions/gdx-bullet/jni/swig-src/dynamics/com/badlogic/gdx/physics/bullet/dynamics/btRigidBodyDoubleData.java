...
public class btRigidBodyDoubleData extends BulletBase {
  ...
  /**
   * Construct a new btRigidBodyDoubleData, normally you should not need this constructor it's
  ...
  public void setCollisionObjectData(btCollisionObjectDoubleData value) {
    DynamicsJNI.btRigidBodyDoubleData_collisionObjectData_set(
        swigCPtr, this, btCollisionObjectDoubleData.getCPtr(value), value);
  }
  ...
  public void setInvInertiaTensorWorld(btMatrix3x3DoubleData value) {
    DynamicsJNI.btRigidBodyDoubleData_invInertiaTensorWorld_set(
        swigCPtr, this, btMatrix3x3DoubleData.getCPtr(value), value);
  }
  ...
  public void setAngularVelocity(btVector3DoubleData value) {
    DynamicsJNI.btRigidBodyDoubleData_angularVelocity_set(
        swigCPtr, this, btVector3DoubleData.getCPtr(value), value);
  }
  ...
  public void setAngularFactor(btVector3DoubleData value) {
    DynamicsJNI.btRigidBodyDoubleData_angularFactor_set(
        swigCPtr, this, btVector3DoubleData.getCPtr(value), value);
  }
  ...
  public void setLinearFactor(btVector3DoubleData value) {
    DynamicsJNI.btRigidBodyDoubleData_linearFactor_set(
        swigCPtr, this, btVector3DoubleData.getCPtr(value), value);
  }
  ...
  public void setGravity(btVector3DoubleData value) {
    DynamicsJNI.btRigidBodyDoubleData_gravity_set(
        swigCPtr, this, btVector3DoubleData.getCPtr(value), value);
  }
  ...
  public void setGravity_acceleration(btVector3DoubleData value) {
    DynamicsJNI.btRigidBodyDoubleData_gravity_acceleration_set(
        swigCPtr, this, btVector3DoubleData.getCPtr(value), value);
  }
  ...
  public void setInvInertiaLocal(btVector3DoubleData value) {
    DynamicsJNI.btRigidBodyDoubleData_invInertiaLocal_set(
        swigCPtr, this, btVector3DoubleData.getCPtr(value), value);
  }
  ...
  public void setTotalForce(btVector3DoubleData value) {
    DynamicsJNI.btRigidBodyDoubleData_totalForce_set(
        swigCPtr, this, btVector3DoubleData.getCPtr(value), value);
  }
  ...
  public void setTotalTorque(btVector3DoubleData value) {
    DynamicsJNI.btRigidBodyDoubleData_totalTorque_set(
        swigCPtr, this, btVector3DoubleData.getCPtr(value), value);
  }
  ...
  public void setAdditionalLinearDampingThresholdSqr(double value) {
    DynamicsJNI.btRigidBodyDoubleData_additionalLinearDampingThresholdSqr_set(
        swigCPtr, this, value);
  }

  public double getAdditionalLinearDampingThresholdSqr() {
    return DynamicsJNI.btRigidBodyDoubleData_additionalLinearDampingThresholdSqr_get(
        swigCPtr, this);
  }

  public void setAdditionalAngularDampingThresholdSqr(double value) {
    DynamicsJNI.btRigidBodyDoubleData_additionalAngularDampingThresholdSqr_set(
        swigCPtr, this, value);
  }

  public double getAdditionalAngularDampingThresholdSqr() {
    return DynamicsJNI.btRigidBodyDoubleData_additionalAngularDampingThresholdSqr_get(
        swigCPtr, this);
  }
