...
public class btContactSolverInfoFloatData extends BulletBase {
  ...
  /**
   * Construct a new btContactSolverInfoFloatData, normally you should not need this constructor
  ...
  public void setSplitImpulsePenetrationThreshold(float value) {
    DynamicsJNI.btContactSolverInfoFloatData_splitImpulsePenetrationThreshold_set(
        swigCPtr, this, value);
  }

  public float getSplitImpulsePenetrationThreshold() {
    return DynamicsJNI.btContactSolverInfoFloatData_splitImpulsePenetrationThreshold_get(
        swigCPtr, this);
  }
  ...
  public void setSingleAxisRollingFrictionThreshold(float value) {
    DynamicsJNI.btContactSolverInfoFloatData_singleAxisRollingFrictionThreshold_set(
        swigCPtr, this, value);
  }

  public float getSingleAxisRollingFrictionThreshold() {
    return DynamicsJNI.btContactSolverInfoFloatData_singleAxisRollingFrictionThreshold_get(
        swigCPtr, this);
  }
  ...
  public void setRestingContactRestitutionThreshold(int value) {
    DynamicsJNI.btContactSolverInfoFloatData_restingContactRestitutionThreshold_set(
        swigCPtr, this, value);
  }

  public int getRestingContactRestitutionThreshold() {
    return DynamicsJNI.btContactSolverInfoFloatData_restingContactRestitutionThreshold_get(
        swigCPtr, this);
  }
