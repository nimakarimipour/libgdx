...
public class btMultiBodyJointMotor extends btMultiBodyConstraint {
  ...
  /**
   * Construct a new btMultiBodyJointMotor, normally you should not need this constructor it's
  ...
  public btMultiBodyJointMotor(
      btMultiBody body, int link, float desiredVelocity, float maxMotorImpulse) {
    this(
        DynamicsJNI.new_btMultiBodyJointMotor__SWIG_0(
            btMultiBody.getCPtr(body), body, link, desiredVelocity, maxMotorImpulse),
        true);
  }

  public btMultiBodyJointMotor(
      btMultiBody body, int link, int linkDoF, float desiredVelocity, float maxMotorImpulse) {
    this(
        DynamicsJNI.new_btMultiBodyJointMotor__SWIG_1(
            btMultiBody.getCPtr(body), body, link, linkDoF, desiredVelocity, maxMotorImpulse),
        true);
  }
