...
public class btGearConstraint extends btTypedConstraint {
  ...
  /**
   * Construct a new btGearConstraint, normally you should not need this constructor it's intended
   * for low-level usage.
   */
  ...
  public btGearConstraint(
      btRigidBody rbA, btRigidBody rbB, Vector3 axisInA, Vector3 axisInB, float ratio) {
    this(
        DynamicsJNI.new_btGearConstraint__SWIG_0(
            btRigidBody.getCPtr(rbA), rbA, btRigidBody.getCPtr(rbB), rbB, axisInA, axisInB, ratio),
        true);
  }

  public btGearConstraint(btRigidBody rbA, btRigidBody rbB, Vector3 axisInA, Vector3 axisInB) {
    this(
        DynamicsJNI.new_btGearConstraint__SWIG_1(
            btRigidBody.getCPtr(rbA), rbA, btRigidBody.getCPtr(rbB), rbB, axisInA, axisInB),
        true);
  }
