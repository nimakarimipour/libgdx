...
public class btMultiBodyConstraint extends BulletBase {
  ...
  /**
   * Construct a new btMultiBodyConstraint, normally you should not need this constructor it's
  ...
  public void createConstraintRows(
      SWIGTYPE_p_btAlignedObjectArrayT_btMultiBodySolverConstraint_t constraintRows,
    ...
    DynamicsJNI.btMultiBodyConstraint_createConstraintRows(
        ...
        btMultiBodyJacobianData.getCPtr(data),
        data,
  ...
  public void internalSetAppliedImpulse(int dof, float appliedImpulse) {
    DynamicsJNI.btMultiBodyConstraint_internalSetAppliedImpulse(
        swigCPtr, this, dof, appliedImpulse);
  }
  ...
  public void debugDraw(btIDebugDraw drawer) {
    DynamicsJNI.btMultiBodyConstraint_debugDraw(
        swigCPtr, this, btIDebugDraw.getCPtr(drawer), drawer);
  }
