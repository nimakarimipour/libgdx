...
public class btMultiBodyConstraintSolver extends btSequentialImpulseConstraintSolver {
  ...
  /**
   * Construct a new btMultiBodyConstraintSolver, normally you should not need this constructor it's
  ...
  public long operatorNewArray(long sizeInBytes) {
    return DynamicsJNI.btMultiBodyConstraintSolver_operatorNewArray__SWIG_0(
  ...
  public long operatorNewArray(long arg0, long ptr) {
    return DynamicsJNI.btMultiBodyConstraintSolver_operatorNewArray__SWIG_1(
  ...
  public float solveGroupCacheFriendlyFinish(
      SWIGTYPE_p_p_btCollisionObject bodies, int numBodies, btContactSolverInfo infoGlobal) {
    return DynamicsJNI.btMultiBodyConstraintSolver_solveGroupCacheFriendlyFinish(
        swigCPtr,
        this,
        SWIGTYPE_p_p_btCollisionObject.getCPtr(bodies),
        numBodies,
        btContactSolverInfo.getCPtr(infoGlobal),
        infoGlobal);
  }

  public void solveMultiBodyGroup(
    ...
    DynamicsJNI.btMultiBodyConstraintSolver_solveMultiBodyGroup(
        swigCPtr,
        this,
        SWIGTYPE_p_p_btCollisionObject.getCPtr(bodies),
        numBodies,
        SWIGTYPE_p_p_btPersistentManifold.getCPtr(manifold),
        numManifolds,
        SWIGTYPE_p_p_btTypedConstraint.getCPtr(constraints),
        numConstraints,
        SWIGTYPE_p_p_btMultiBodyConstraint.getCPtr(multiBodyConstraints),
        numMultiBodyConstraints,
        btContactSolverInfo.getCPtr(info),
        info,
        btIDebugDraw.getCPtr(debugDrawer),
        debugDrawer,
