...
public class btTranslationalLimitMotor extends BulletBase {
  ...
  /**
   * Construct a new btTranslationalLimitMotor, normally you should not need this constructor it's
  ...
  public void setLowerLimit(btVector3 value) {
    DynamicsJNI.btTranslationalLimitMotor_lowerLimit_set(
  ...
  public void setUpperLimit(btVector3 value) {
    DynamicsJNI.btTranslationalLimitMotor_upperLimit_set(
        swigCPtr, this, btVector3.getCPtr(value), value);
  }
  ...
  public void setAccumulatedImpulse(btVector3 value) {
    DynamicsJNI.btTranslationalLimitMotor_accumulatedImpulse_set(
        swigCPtr, this, btVector3.getCPtr(value), value);
  }
  ...
  public void setNormalCFM(btVector3 value) {
    DynamicsJNI.btTranslationalLimitMotor_normalCFM_set(
        swigCPtr, this, btVector3.getCPtr(value), value);
  }
  ...
  public void setStopERP(btVector3 value) {
    DynamicsJNI.btTranslationalLimitMotor_stopERP_set(
        swigCPtr, this, btVector3.getCPtr(value), value);
  }
  ...
  public void setStopCFM(btVector3 value) {
    DynamicsJNI.btTranslationalLimitMotor_stopCFM_set(
        swigCPtr, this, btVector3.getCPtr(value), value);
  }
  ...
  public void setTargetVelocity(btVector3 value) {
    DynamicsJNI.btTranslationalLimitMotor_targetVelocity_set(
        swigCPtr, this, btVector3.getCPtr(value), value);
  }
  ...
  public void setMaxMotorForce(btVector3 value) {
    DynamicsJNI.btTranslationalLimitMotor_maxMotorForce_set(
        swigCPtr, this, btVector3.getCPtr(value), value);
  }
  ...
  public void setCurrentLimitError(btVector3 value) {
    DynamicsJNI.btTranslationalLimitMotor_currentLimitError_set(
        swigCPtr, this, btVector3.getCPtr(value), value);
  }
  ...
  public void setCurrentLinearDiff(btVector3 value) {
    DynamicsJNI.btTranslationalLimitMotor_currentLinearDiff_set(
        swigCPtr, this, btVector3.getCPtr(value), value);
  }
  ...
  public btTranslationalLimitMotor(btTranslationalLimitMotor other) {
    this(
        DynamicsJNI.new_btTranslationalLimitMotor__SWIG_1(
            btTranslationalLimitMotor.getCPtr(other), other),
        true);
  }
  ...
  public int testLimitValue(int limitIndex, float test_value) {
    return DynamicsJNI.btTranslationalLimitMotor_testLimitValue(
        swigCPtr, this, limitIndex, test_value);
  }
  ...
  public float solveLinearAxis(
      ...
      Vector3 anchorPos) {
    return DynamicsJNI.btTranslationalLimitMotor_solveLinearAxis(
        swigCPtr,
        this,
        timeStep,
        jacDiagABInv,
