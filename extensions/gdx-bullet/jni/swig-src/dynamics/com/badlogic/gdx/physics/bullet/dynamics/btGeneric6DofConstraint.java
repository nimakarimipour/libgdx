...
public class btGeneric6DofConstraint extends btTypedConstraint {
  ...
  /**
   * Construct a new btGeneric6DofConstraint, normally you should not need this constructor it's
  ...
  public long operatorNewArray(long sizeInBytes) {
    return DynamicsJNI.btGeneric6DofConstraint_operatorNewArray__SWIG_0(
  ...
  public btGeneric6DofConstraint(
    ...
    this(
        DynamicsJNI.new_btGeneric6DofConstraint__SWIG_0(
  ...
  public btGeneric6DofConstraint(
    ...
    this(
        DynamicsJNI.new_btGeneric6DofConstraint__SWIG_1(
            btRigidBody.getCPtr(rbB), rbB, frameInB, useLinearReferenceFrameB),
        true);
  }
  ...
  public void getInfo1NonVirtual(btTypedConstraint.btConstraintInfo1 info) {
    DynamicsJNI.btGeneric6DofConstraint_getInfo1NonVirtual(
  ...
  public void getInfo2NonVirtual(
      ...
      Vector3 angVelA,
      Vector3 angVelB) {
    DynamicsJNI.btGeneric6DofConstraint_getInfo2NonVirtual(
        swigCPtr,
        this,
  ...
  public int get_limit_motor_info2(
      ...
      int rotational,
      int rotAllowed) {
    return DynamicsJNI.btGeneric6DofConstraint_get_limit_motor_info2__SWIG_0(
        swigCPtr,
        this,
        btRotationalLimitMotor.getCPtr(limot),
        limot,
        transA,
        transB,
        linVelA,
  ...
  public int get_limit_motor_info2(
      ...
      Vector3 ax1,
      int rotational) {
    return DynamicsJNI.btGeneric6DofConstraint_get_limit_motor_info2__SWIG_1(
        swigCPtr,
        this,
        btRotationalLimitMotor.getCPtr(limot),
        limot,
  ...
  public void setUseLinearReferenceFrameA(boolean linearReferenceFrameA) {
    DynamicsJNI.btGeneric6DofConstraint_setUseLinearReferenceFrameA(
        swigCPtr, this, linearReferenceFrameA);
  }
