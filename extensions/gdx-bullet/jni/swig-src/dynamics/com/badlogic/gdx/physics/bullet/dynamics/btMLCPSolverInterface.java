...
public class btMLCPSolverInterface extends BulletBase {
  ...
  /**
   * Construct a new btMLCPSolverInterface, normally you should not need this constructor it's
  ...
  public boolean solveMLCP(
      ...
      int numIterations,
      boolean useSparsity) {
    return DynamicsJNI.btMLCPSolverInterface_solveMLCP__SWIG_0(
        swigCPtr,
        this,
  ...
  public boolean solveMLCP(
      ...
      SWIGTYPE_p_btAlignedObjectArrayT_int_t limitDependency,
      int numIterations) {
    return DynamicsJNI.btMLCPSolverInterface_solveMLCP__SWIG_1(
        swigCPtr,
        this,
        SWIGTYPE_p_btMatrixXT_float_t.getCPtr(A),
        SWIGTYPE_p_btVectorXT_float_t.getCPtr(b),
