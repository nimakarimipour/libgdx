...
public class btRaycastVehicle extends btActionInterface {
  ...
  /**
   * Construct a new btRaycastVehicle, normally you should not need this constructor it's intended
   * for low-level usage.
   */
  ...
  public static class btVehicleTuning extends BulletBase {
    ...
    /**
     * Construct a new btVehicleTuning, normally you should not need this constructor it's intended
     * for low-level usage.
     */
  ...
  public btRaycastVehicle(
    ...
    this(
        DynamicsJNI.new_btRaycastVehicle(
            btRaycastVehicle.btVehicleTuning.getCPtr(tuning),
            tuning,
            btRigidBody.getCPtr(chassis),
            chassis,
            btVehicleRaycaster.getCPtr(raycaster),
            raycaster),
        true);
  }
  ...
  public void updateWheelTransform(int wheelIndex, boolean interpolatedTransform) {
    DynamicsJNI.btRaycastVehicle_updateWheelTransform__SWIG_0(
        swigCPtr, this, wheelIndex, interpolatedTransform);
  }
  ...
  public btWheelInfo addWheel(
    ...
    return new btWheelInfo(
        DynamicsJNI.btRaycastVehicle_addWheel(
            swigCPtr,
            this,
            connectionPointCS0,
            wheelDirectionCS0,
  ...
  public void setWheelInfo(SWIGTYPE_p_btAlignedObjectArrayT_btWheelInfo_t value) {
    DynamicsJNI.btRaycastVehicle_wheelInfo_set(
        swigCPtr, this, SWIGTYPE_p_btAlignedObjectArrayT_btWheelInfo_t.getCPtr(value));
  }
  ...
  public btWheelInfo getWheelInfoConst(int index) {
    return new btWheelInfo(
        DynamicsJNI.btRaycastVehicle_getWheelInfoConst(swigCPtr, this, index), false);
  }

  public void updateWheelTransformsWS(btWheelInfo wheel, boolean interpolatedTransform) {
    DynamicsJNI.btRaycastVehicle_updateWheelTransformsWS__SWIG_0(
        swigCPtr, this, btWheelInfo.getCPtr(wheel), wheel, interpolatedTransform);
  }

  public void updateWheelTransformsWS(btWheelInfo wheel) {
    DynamicsJNI.btRaycastVehicle_updateWheelTransformsWS__SWIG_1(
        swigCPtr, this, btWheelInfo.getCPtr(wheel), wheel);
  }
  ...
  public btRigidBody getRigidBody() {
    return btRigidBody.getInstance(
        DynamicsJNI.btRaycastVehicle_getRigidBody(swigCPtr, this), false);
  }

  public btRigidBody getRigidBodyConst() {
    return btRigidBody.getInstance(
        DynamicsJNI.btRaycastVehicle_getRigidBodyConst(swigCPtr, this), false);
  }
  ...
  public void setCoordinateSystem(int rightIndex, int upIndex, int forwardIndex) {
    DynamicsJNI.btRaycastVehicle_setCoordinateSystem(
        swigCPtr, this, rightIndex, upIndex, forwardIndex);
  }
