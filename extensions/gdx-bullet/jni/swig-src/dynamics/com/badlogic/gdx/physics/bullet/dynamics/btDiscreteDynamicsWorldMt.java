...
public class btDiscreteDynamicsWorldMt extends btDiscreteDynamicsWorld {
  ...
  /**
   * Construct a new btDiscreteDynamicsWorldMt, normally you should not need this constructor it's
  ...
  public long operatorNewArray(long sizeInBytes) {
    return DynamicsJNI.btDiscreteDynamicsWorldMt_operatorNewArray__SWIG_0(
  ...
  public long operatorNewArray(long arg0, long ptr) {
    return DynamicsJNI.btDiscreteDynamicsWorldMt_operatorNewArray__SWIG_1(
  ...
  public btDiscreteDynamicsWorldMt(
    ...
    this(
        DynamicsJNI.new_btDiscreteDynamicsWorldMt(
            btDispatcher.getCPtr(dispatcher),
            dispatcher,
            btBroadphaseInterface.getCPtr(pairCache),
            pairCache,
            btConstraintSolverPoolMt.getCPtr(constraintSolver),
            constraintSolver,
