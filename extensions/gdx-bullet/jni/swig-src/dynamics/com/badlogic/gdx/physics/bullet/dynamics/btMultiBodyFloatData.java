...
public class btMultiBodyFloatData extends BulletBase {
  ...
  /**
   * Construct a new btMultiBodyFloatData, normally you should not need this constructor it's
  ...
  public void setLinks(btMultiBodyLinkFloatData value) {
    DynamicsJNI.btMultiBodyFloatData_links_set(
        swigCPtr, this, btMultiBodyLinkFloatData.getCPtr(value), value);
  }
  ...
  public void setBaseCollider(btCollisionObjectFloatData value) {
    DynamicsJNI.btMultiBodyFloatData_baseCollider_set(
  ...
  public void setBaseWorldTransform(btTransformFloatData value) {
    DynamicsJNI.btMultiBodyFloatData_baseWorldTransform_set(
  ...
  public void setBaseInertia(btVector3FloatData value) {
    DynamicsJNI.btMultiBodyFloatData_baseInertia_set(
