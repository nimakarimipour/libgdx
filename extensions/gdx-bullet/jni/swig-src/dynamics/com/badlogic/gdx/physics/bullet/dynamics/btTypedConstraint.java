...
public class btTypedConstraint extends btTypedObject {
  ...
  /**
   * Construct a new btTypedConstraint, normally you should not need this constructor it's intended
   * for low-level usage.
   */
  ...
  public static class btConstraintInfo1 extends BulletBase {
    ...
    /**
     * Construct a new btConstraintInfo1, normally you should not need this constructor it's
  ...
  public static class btConstraintInfo2 extends BulletBase {
    ...
    /**
     * Construct a new btConstraintInfo2, normally you should not need this constructor it's
     * intended for low-level usage.
     */
    ...
    public void setJ1linearAxis(SWIGTYPE_p_float value) {
      DynamicsJNI.btTypedConstraint_btConstraintInfo2_J1linearAxis_set(
          swigCPtr, this, SWIGTYPE_p_float.getCPtr(value));
    }
    ...
    public void setJ1angularAxis(SWIGTYPE_p_float value) {
      DynamicsJNI.btTypedConstraint_btConstraintInfo2_J1angularAxis_set(
          swigCPtr, this, SWIGTYPE_p_float.getCPtr(value));
    }
    ...
    public void setJ2linearAxis(SWIGTYPE_p_float value) {
      DynamicsJNI.btTypedConstraint_btConstraintInfo2_J2linearAxis_set(
          swigCPtr, this, SWIGTYPE_p_float.getCPtr(value));
    }
    ...
    public void setJ2angularAxis(SWIGTYPE_p_float value) {
      DynamicsJNI.btTypedConstraint_btConstraintInfo2_J2angularAxis_set(
          swigCPtr, this, SWIGTYPE_p_float.getCPtr(value));
    }
    ...
    public void setConstraintError(SWIGTYPE_p_float value) {
      DynamicsJNI.btTypedConstraint_btConstraintInfo2_constraintError_set(
          swigCPtr, this, SWIGTYPE_p_float.getCPtr(value));
    }

    public SWIGTYPE_p_float getConstraintError() {
      long cPtr =
          DynamicsJNI.btTypedConstraint_btConstraintInfo2_constraintError_get(swigCPtr, this);
      return (cPtr == 0) ? null : new SWIGTYPE_p_float(cPtr, false);
    }

    public void setCfm(SWIGTYPE_p_float value) {
      DynamicsJNI.btTypedConstraint_btConstraintInfo2_cfm_set(
          swigCPtr, this, SWIGTYPE_p_float.getCPtr(value));
    }
    ...
    public void setLowerLimit(SWIGTYPE_p_float value) {
      DynamicsJNI.btTypedConstraint_btConstraintInfo2_lowerLimit_set(
          swigCPtr, this, SWIGTYPE_p_float.getCPtr(value));
    }
    ...
    public void setUpperLimit(SWIGTYPE_p_float value) {
      DynamicsJNI.btTypedConstraint_btConstraintInfo2_upperLimit_set(
          swigCPtr, this, SWIGTYPE_p_float.getCPtr(value));
    }
  ...
  public void setOverrideNumSolverIterations(int overideNumIterations) {
    DynamicsJNI.btTypedConstraint_setOverrideNumSolverIterations(
        swigCPtr, this, overideNumIterations);
  }
  ...
  public void setupSolverConstraint(
      SWIGTYPE_p_btAlignedObjectArrayT_btSolverConstraint_t ca,
      int solverBodyA,
      int solverBodyB,
      float timeStep) {
    DynamicsJNI.btTypedConstraint_setupSolverConstraint(
        swigCPtr,
        this,
        SWIGTYPE_p_btAlignedObjectArrayT_btSolverConstraint_t.getCPtr(ca),
        solverBodyA,
        solverBodyB,
        timeStep);
  }
  ...
  public void getInfo1(btTypedConstraint.btConstraintInfo1 info) {
    DynamicsJNI.btTypedConstraint_getInfo1(
        swigCPtr, this, btTypedConstraint.btConstraintInfo1.getCPtr(info), info);
  }

  public void getInfo2(btTypedConstraint.btConstraintInfo2 info) {
    DynamicsJNI.btTypedConstraint_getInfo2(
        swigCPtr, this, btTypedConstraint.btConstraintInfo2.getCPtr(info), info);
  }
  ...
  public void solveConstraintObsolete(btSolverBody arg0, btSolverBody arg1, float arg2) {
    DynamicsJNI.btTypedConstraint_solveConstraintObsolete(
        swigCPtr, this, btSolverBody.getCPtr(arg0), arg0, btSolverBody.getCPtr(arg1), arg1, arg2);
  }

  public btRigidBody getRigidBodyAConst() {
    return btRigidBody.getInstance(
        DynamicsJNI.btTypedConstraint_getRigidBodyAConst(swigCPtr, this), false);
  }

  public btRigidBody getRigidBodyBConst() {
    return btRigidBody.getInstance(
        DynamicsJNI.btTypedConstraint_getRigidBodyBConst(swigCPtr, this), false);
  }

  public btRigidBody getRigidBodyA() {
    return btRigidBody.getInstance(
        DynamicsJNI.btTypedConstraint_getRigidBodyA(swigCPtr, this), false);
  }

  public btRigidBody getRigidBodyB() {
    return btRigidBody.getInstance(
        DynamicsJNI.btTypedConstraint_getRigidBodyB(swigCPtr, this), false);
  }
  ...
  public void setJointFeedback(btJointFeedback jointFeedback) {
    DynamicsJNI.btTypedConstraint_setJointFeedback(
        swigCPtr, this, btJointFeedback.getCPtr(jointFeedback), jointFeedback);
  }
  ...
  public String serialize(long dataBuffer, btSerializer serializer) {
    return DynamicsJNI.btTypedConstraint_serialize(
