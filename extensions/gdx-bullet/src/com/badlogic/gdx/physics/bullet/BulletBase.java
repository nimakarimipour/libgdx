...
public class BulletBase implements Disposable {
  ...
  /**
   * Release a previously obtained reference, causing the object to be disposed when this was the
   * last reference.
   */
  public void release() {
  ...
  /**
   * Take ownership of the native instance, causing the native object to be deleted when this object
   * gets out of scope.
   */
  ...
  /**
   * Release ownership of the native instance, causing the native object NOT to be deleted when this
  ...
  /**
   * Deletes the bullet object this class encapsulates. Do not call directly, instead use the {@link
   * #dispose()} method.
   */
  ...
  public void dispose() {
    if (refCount > 0 && Bullet.useRefCounting && Bullet.enableLogging)
      Gdx.app.error(
          "Bullet", "Disposing " + toString() + " while it still has " + refCount + " references.");
    disposed = true;
    delete();
  }
