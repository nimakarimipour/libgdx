...
/**
 * Creates {@link BitmapFont} instances from FreeType font files. Requires a {@link
 * FreeTypeFontLoaderParameter} to be passed to {@link AssetManager#load(String, Class,
 * AssetLoaderParameters)} which specifies the name of the TTF file as well the parameters used to
 * generate the BitmapFont (size, characters, etc.)
 */
public class FreetypeFontLoader
  ...
  public BitmapFont loadSync(
    ...
    FreeTypeFontGenerator generator =
        manager.get(parameter.fontFileName + ".gen", FreeTypeFontGenerator.class);
  ...
  public Array<AssetDescriptor> getDependencies(
      String fileName, FileHandle file, FreeTypeFontLoaderParameter parameter) {
    Array<AssetDescriptor> deps = new Array<AssetDescriptor>();
    deps.add(
        new AssetDescriptor<FreeTypeFontGenerator>(
            parameter.fontFileName + ".gen", FreeTypeFontGenerator.class));
    return deps;
  }
}
