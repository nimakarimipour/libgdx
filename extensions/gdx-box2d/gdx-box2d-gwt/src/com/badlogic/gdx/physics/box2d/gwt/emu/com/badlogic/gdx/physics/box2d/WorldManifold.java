...
public class WorldManifold {
  ...
  /**
   * Returns the contact points of this manifold. Use getNumberOfContactPoints to determine how many
   * contact points there are (0,1 or 2)
   */
  ...
  /**
   * Returns the separations of this manifold, a negative value indicates overlap, in meters. Use
   * getNumberOfContactPoints to determine how many separations there are (0,1 or 2)
   */
