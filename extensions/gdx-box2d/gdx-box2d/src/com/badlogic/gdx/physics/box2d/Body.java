...
public class Body {
  ...
  private native long jniCreateFixture(
      long addr,
      long shapeAddr,
      float friction,
      float restitution,
   ...
   * b2FixtureDef if you need to set parameters like friction, restitution, user data, or filtering.
  ...
  /**
   * Get the world body origin position. Note that the same Vector2 instance is returned each time
  ...
  /**
   * Get the world position of the center of mass. Note that the same Vector2 instance is returned
  ...
  /**
   * Get the local position of the center of mass. Note that the same Vector2 instance is returned
   * each time this method is called.
   */
  ...
  /**
   * Get the linear velocity of the center of mass. Note that the same Vector2 instance is returned
   * each time this method is called.
   */
  ...
  private native void jniApplyForce(
      long addr, float forceX, float forceY, float pointX, float pointY, boolean wake); /*
		b2Body* body = (b2Body*)addr;
  ...
  private native void jniApplyForceToCenter(
      long addr, float forceX, float forceY, boolean wake); /*
		b2Body* body = (b2Body*)addr;
  ...
  public void applyLinearImpulse(
      float impulseX, float impulseY, float pointX, float pointY, boolean wake) {
    jniApplyLinearImpulse(addr, impulseX, impulseY, pointX, pointY, wake);
  }

  private native void jniApplyLinearImpulse(
      long addr, float impulseX, float impulseY, float pointX, float pointY, boolean wake); /*
		b2Body* body = (b2Body*)addr;
  ...
  private native void jniSetMassData(
      long addr, float mass, float centerX, float centerY, float I); /*
		b2Body* body = (b2Body*)addr;
		b2MassData m;
		m.mass = mass;
		m.center.x = centerX;
  ...
  /**
   * Get the world coordinates of a point given the local coordinates. Note that the same Vector2
   * instance is returned each time this method is called.
   *
  ...
  private native void jniGetWorldPoint(
      long addr, float localPointX, float localPointY, float[] worldPoint); /*
		b2Body* body = (b2Body*)addr;
  ...
  /**
   * Get the world coordinates of a vector given the local coordinates. Note that the same Vector2
   * instance is returned each time this method is called.
   *
  ...
  private native void jniGetWorldVector(
      long addr, float localVectorX, float localVectorY, float[] worldVector); /*
		b2Body* body = (b2Body*)addr;
  ...
  /**
   * Gets a local point relative to the body's origin given a world point. Note that the same
   * Vector2 instance is returned each time this method is called.
   *
  ...
  private native void jniGetLocalPoint(
      long addr, float worldPointX, float worldPointY, float[] localPoint); /*
		b2Body* body = (b2Body*)addr;
  ...
  /**
   * Gets a local vector given a world vector. Note that the same Vector2 instance is returned each
  ...
  private native void jniGetLocalVector(
      long addr, float worldVectorX, float worldVectorY, float[] worldVector); /*
		b2Body* body = (b2Body*)addr;
  ...
  /**
   * Get the world linear velocity of a world point attached to this body. Note that the same
   * Vector2 instance is returned each time this method is called.
   *
   * @param worldPoint a point in world coordinates.
  ...
  private native void jniGetLinearVelocityFromWorldPoint(
      long addr, float worldPointX, float worldPointY, float[] linVelWorld); /*
		b2Body* body = (b2Body*)addr;
  ...
  /**
   * Get the world velocity of a local point. Note that the same Vector2 instance is returned each
   * time this method is called.
   *
  ...
  private native void jniGetLinearVelocityFromLocalPoint(
      long addr, float localPointX, float localPointY, float[] linVelLoc); /*
		b2Body* body = (b2Body*)addr;
  ...
  */
   ...
   * body are implicitly inactive. An inactive body is still owned by a b2World object and remains
   * in the body list.
   */
   ...
   *     use b2ContactListener. Do not modify the returned list!
   */
