...
public class Fixture {
  ...
  /**
   * Set the contact filtering data. This will not update contacts until the next time step when
   * either parent body is active and awake. This automatically calls Refilter.
   */
  ...
  private native void jniSetFilterData(
      long addr, short categoryBits, short maskBits, short groupIndex); /*
		b2Fixture* fixture = (b2Fixture*)addr;
		b2Filter filter;
  ...
  /**
   * Get the contact filtering data. Modifying the returned {@code Filter} without calling {@link
   * #setFilterData} can result in unpredictable behaviour.
   */
  ...
  /**
   * Set the density of this fixture. This will _not_ automatically adjust the mass of the body. You
   * must call b2Body::ResetMassData to update the body's mass.
   */
