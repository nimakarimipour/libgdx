 ...
 * shader to draw bitmap fonts that remain crisp even under high magnification.
 *
 * <p>An example of the use of such a font is included in the libgdx test suite under the name
...
public class DistanceFieldEffect implements ConfigurableEffect {
  ...
  public void draw(BufferedImage image, Graphics2D g, UnicodeFont unicodeFont, Glyph glyph) {
    BufferedImage input =
        new BufferedImage(
            scale * glyph.getWidth(), scale * glyph.getHeight(), BufferedImage.TYPE_BYTE_BINARY);
