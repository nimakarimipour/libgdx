...
/** @author Inferno */
public class TemplatePickerPanel<T> extends EditorPanel<Array<T>>
  ...
  protected void initializeComponents(Class<T> type, LoaderButton<T> loaderButton) {
            ...
            0));
    {
      ...
      templatesTableModel =
          new DefaultTableModel(new String[0][0], new String[] {"Template", "Selected"});
      templatesTable.setModel(templatesTableModel);
      reloadTemplates();

      templatesTableModel.addTableModelListener(
