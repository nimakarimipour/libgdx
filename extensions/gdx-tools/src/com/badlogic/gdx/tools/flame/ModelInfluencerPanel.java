...
public class ModelInfluencerPanel extends InfluencerPanel<ModelInfluencer>
  ...
  public ModelInfluencerPanel(
      FlameMain editor, ModelInfluencer influencer, boolean single, String name, String desc) {
  ...
  protected void initializeComponents() {
    ...
    pickerPanel =
        new TemplatePickerPanel<Model>(
            editor, null, this, Model.class, new LoaderButton.ModelLoaderButton(editor));
