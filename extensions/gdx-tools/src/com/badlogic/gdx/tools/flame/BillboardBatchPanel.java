...
public class BillboardBatchPanel extends EditorPanel<BillboardParticleBatch> {
  ...
  private void initializeComponents(BillboardParticleBatch renderer) {
    ...
    srcBlendFunction.setSelectedItem(
        BlendFunction.find(renderer.getBlendingAttribute().sourceFunction));
    srcBlendFunction.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent event) {
    ...
    destBlendFunction.setSelectedItem(
        BlendFunction.find(renderer.getBlendingAttribute().destFunction));
    destBlendFunction.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent event) {
    ...
    contentPanel.add(
        ...
        new GridBagConstraints(
            0, i, 1, 1, 0, 0, GridBagConstraints.WEST, GridBagConstraints.NONE, insets, 0, 0));
    contentPanel.add(
        alignCombo,
        new GridBagConstraints(
            1, i++, 1, 1, 1, 0, GridBagConstraints.WEST, GridBagConstraints.NONE, insets, 0, 0));
    contentPanel.add(
        new JLabel("Use GPU"),
        new GridBagConstraints(
            0, i, 1, 1, 0, 0, GridBagConstraints.WEST, GridBagConstraints.NONE, insets, 0, 0));
    ...
    contentPanel.add(
        sortCombo,
        new GridBagConstraints(
            1, i++, 1, 1, 0, 0, GridBagConstraints.WEST, GridBagConstraints.NONE, insets, 0, 0));
    contentPanel.add(
        new JLabel("Blending Src"),
        new GridBagConstraints(
            0, i, 1, 1, 0, 0, GridBagConstraints.WEST, GridBagConstraints.NONE, insets, 0, 0));
    contentPanel.add(
        srcBlendFunction,
