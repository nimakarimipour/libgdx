...
public abstract class EditorPanel<T> extends JPanel {
  ...
  protected void addContent(int row, int column, JComponent component, boolean addBorder) {
    addContent(
        row, column, component, addBorder, GridBagConstraints.CENTER, GridBagConstraints.BOTH);
  }
  ...
  protected void addContent(
      int row, int column, JComponent component, boolean addBorders, int anchor, int fill) {
  ...
  public static void addContent(
    ...
    panel.add(
        component,
        new GridBagConstraints(
            column, row, 1, 1, wx, wy, anchor, fill, new Insets(0, 0, 0, 0), 0, 0));
  }
