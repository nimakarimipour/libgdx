...
public class TextureLoaderPanel extends EditorPanel {
  ...
  protected void initializeComponents() {
        ...
        new ActionListener() {
          public void actionPerformed(ActionEvent event) {
            editor
                .getTexture()
                .setFilter(
                    (TextureFilter) minFilterBox.getSelectedItem(),
    ...
    atlasButton.addActionListener(
        new ActionListener() {
          ...
          public void actionPerformed(ActionEvent e) {
            ...
            if (file != null) {
              TextureAtlas atlas =
                  editor.load(file.getAbsolutePath(), TextureAtlas.class, null, null);
              if (atlas != null) {
    ...
    defaultTextureButton.addActionListener(
        new ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            editor.setTexture(
                editor.assetManager.get(FlameMain.DEFAULT_BILLBOARD_PARTICLE, Texture.class));
          }
        });

    contentPanel.add(
        new JLabel("Min. Filter"),
