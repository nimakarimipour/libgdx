...
public class RegionPickerPanel extends JPanel {
  ...
  private void initializeComponents() {
    ...
    pickPanel.add(
        selectAllButton = new JButton("Pick All"),
        new GridBagConstraints(
            0,
            0,
            1,
    ...
    pickPanel.add(
        ...
        new GridBagConstraints(
            ...
            0));
    pickPanel.add(
        reverseButton = new JButton("Reverse Selection"),
        new GridBagConstraints(
            0,
            1,
            1,
    ...
    generationPanel.add(
        ...
        new GridBagConstraints(
            ...
            0));
    generationPanel.add(
        rowSlider = new Slider(1, 1, 9999, 1),
        new GridBagConstraints(
            1,
            0,
            1,
    ...
    generationPanel.add(
        ...
        new GridBagConstraints(
            ...
            0));
    generationPanel.add(
        columnSlider = new Slider(1, 1, 9999, 1),
        new GridBagConstraints(
            1,
            1,
            1,
            ...
            0));
    generationPanel.add(
        generateBox = new JComboBox(new DefaultComboBoxModel(GenerationMode.values())),
        new GridBagConstraints(
            0,
            2,
            1,
    ...
    selectButton.addActionListener(
        new ActionListener() {
          ...
          public void actionPerformed(ActionEvent arg0) {
            ...
            TexturePanel currentTexturePanel =
                panel == atlasPanel ? atlasPanel.getCurrentRegionPanel() : texturePanel;
    ...
    if (mode == GenerationMode.ByRows) {
      for (int j = 0; j < rows; ++j) {
        ...
        for (int i = 0; i < columns; ++i) {
          texturePanel.unselectedRegions.add(
              new TextureRegion(texture, i * xOffset, rowOffset, xOffset, yOffset));
        }
      }
      ...
      for (int i = 0; i < columns; ++i) {
        ...
        for (int j = 0; j < rows; ++j) {
          texturePanel.unselectedRegions.add(
              new TextureRegion(texture, columnOffset, j * yOffset, xOffset, yOffset));
        }
      }
    }
  }
