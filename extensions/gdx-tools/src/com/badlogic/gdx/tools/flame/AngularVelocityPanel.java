...
public class AngularVelocityPanel extends EditorPanel<DynamicsModifier.Angular> {
  ...
  public AngularVelocityPanel(
      FlameMain editor,
      DynamicsModifier.Angular aValue,
      String charTitle,
      String name,
      String description) {
  ...
  private void initializeComponents(DynamicsModifier.Angular aValue, String charTitle) {
    JPanel contentPanel = getContentPanel();
    {
      ...
      panel.add(
          ...
          new GridBagConstraints(
              ...
              0));
      panel.add(
          isGlobalCheckBox = new JCheckBox(),
          new GridBagConstraints(
              1,
              0,
              1,
      ...
      contentPanel.add(
          magnitudePanel =
              new ScaledNumericPanel(
                  editor,
                  aValue == null ? null : aValue.strengthValue,
                  charTitle,
                  "Strength",
    ...
    }
    {
      contentPanel.add(
          phiPanel =
              new ScaledNumericPanel(
                  editor,
                  aValue == null ? null : aValue.phiValue,
                  charTitle,
                  "Azimuth",
                  "Rotation starting on Y",
                  true),
          new GridBagConstraints(
              0,
              4,
    ...
    }
    {
      contentPanel.add(
          thetaPanel =
              new ScaledNumericPanel(
                  editor,
                  aValue == null ? null : aValue.thetaValue,
                  charTitle,
                  "Polar angle",
                  "around Y axis on XZ plane",
                  true),
          new GridBagConstraints(
              0,
              3,
    ...
    isGlobalCheckBox.addActionListener(
        new ActionListener() {
          @Override
