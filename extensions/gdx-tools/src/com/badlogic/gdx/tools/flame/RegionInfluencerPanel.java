...
/** @author Inferno */
public class RegionInfluencerPanel extends InfluencerPanel<RegionInfluencer>
    implements RegionPickerPanel.Listener {
  JDialog regionSelectDialog;
  RegionPickerPanel regionPickerPanel;

  public RegionInfluencerPanel(
      FlameMain editor, String name, String desc, RegionInfluencer influencer) {
  ...
  protected void initializeComponents() {
    ...
    addContent(
        0,
        0,
        pickButton = new JButton("Pick Regions"),
        false,
