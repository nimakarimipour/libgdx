...
class EffectPanel extends JPanel {
  ...
  public <T extends ParticleController> T createDefaultEmitter(
      ControllerType type, boolean select, boolean add) {
  ...
  private ParticleController createDefaultModelInstanceController() {
    ...
    // Directional
    DynamicsModifier.CentripetalAcceleration velocityValue =
        new DynamicsModifier.CentripetalAcceleration();
    ...
    return new ParticleController(
        ...
        new ModelInfluencer.Single(
            (Model) editor.assetManager.get(FlameMain.DEFAULT_MODEL_PARTICLE)),
        spawnSource,
        colorInfluencer,
        velocityInfluencer);
  }
  ...
  private ParticleController createDefaultBillboardController() {
    ...
    return new ParticleController(
        ...
        emitter,
        new BillboardRenderer(editor.getBillboardBatch()),
  ...
  private ParticleController createDefaultPointController() {
    ...
    return new ParticleController(
        ...
        emitter,
        new PointSpriteRenderer(editor.getPointSpriteBatch()),
        new RegionInfluencer.Single(
            (Texture) editor.assetManager.get(FlameMain.DEFAULT_BILLBOARD_PARTICLE)),
        spawnSource,
        scaleInfluencer,
        colorInfluencer,
        velocityInfluencer);
  ...
  private ParticleController createDefaultParticleController() {
    ...
    return new ParticleController(
        ...
        new ParticleControllerInfluencer.Single(
            editor
                .assetManager
                .get(FlameMain.DEFAULT_TEMPLATE_PFX, ParticleEffect.class)
                .getControllers()
                .get(0)),
        spawnSource,
        scaleInfluencer,
