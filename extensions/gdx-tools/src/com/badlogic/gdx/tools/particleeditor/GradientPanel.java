...
class GradientPanel extends EditorPanel {
  ...
  public GradientPanel(
      GradientColorValue value, String name, String description, boolean hideGradientEditor) {
  ...
  private void initializeComponents() {
      ...
      hueSlider =
          new ColorSlider(
            ...
            protected void colorPicked() {
              saturationSlider.setColors(
                  new Color[] {new Color(Color.HSBtoRGB(getPercentage(), 1, 1)), Color.white});
              updateColor();
            }
          };
      contentPanel.add(
    ...
    {
      saturationSlider =
          new ColorSlider(new Color[] {Color.red, Color.white}) {
            protected void colorPicked() {
              updateColor();
            }
          };
    ...
    colorPanel.addMouseListener(
        new MouseAdapter() {
          public void mouseClicked(MouseEvent e) {
            Color color =
                JColorChooser.showDialog(colorPanel, "Set Color", colorPanel.getBackground());
  ...
  void updateColor() {
    Color color =
        new Color(
            Color.HSBtoRGB(hueSlider.getPercentage(), 1 - saturationSlider.getPercentage(), 1));
    lightnessSlider.setColors(new Color[] {color, Color.black});
    color =
        new Color(
            Color.HSBtoRGB(
                hueSlider.getPercentage(),
