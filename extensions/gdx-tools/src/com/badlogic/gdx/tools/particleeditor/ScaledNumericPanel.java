...
class ScaledNumericPanel extends EditorPanel {
  ...
  public ScaledNumericPanel(
      final ScaledNumericValue value, String chartTitle, String name, String description) {
    ...
    if (hasIndependent)
      independentCheckbox.setSelected(
          ((ParticleEmitter.IndependentScaledNumericValue) value).isIndependent());
    lowMinSlider.addChangeListener(
        new ChangeListener() {
    ...
    lowMaxSlider.addChangeListener(
        new ChangeListener() {
          public void stateChanged(ChangeEvent event) {
            value.setLowMax((Float) lowMaxSlider.getValue());
          }
        });
    highMinSlider.addChangeListener(
        new ChangeListener() {
          public void stateChanged(ChangeEvent event) {
    ...
    highMaxSlider.addChangeListener(
        new ChangeListener() {
          public void stateChanged(ChangeEvent event) {
    ...
    relativeCheckBox.addActionListener(
        new ActionListener() {
    ...
    if (hasIndependent) {
      independentCheckbox.addActionListener(
          new ActionListener() {
            public void actionPerformed(ActionEvent event) {
              ((ParticleEmitter.IndependentScaledNumericValue) value)
                  .setIndependent(independentCheckbox.isSelected());
            }
          });
    }

    lowRangeButton.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent event) {
    ...
    highRangeButton.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent event) {
