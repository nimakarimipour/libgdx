...
public class TiledMapPackerTestRender extends ApplicationAdapter {
  ...
  // --WARNING!--
  // Please do not edit the MAP_PATH. This deletes the folder recursively and could be very
  // dangerous. The default location is:
  // MAP_PATH = "../../tests/gdx-tests-android/assets/data/maps/tiled-atlas-processed/deleteMe/";

  private final boolean DELETE_DELETEME_FOLDER_ON_EXIT =
      false; // read warning before setting to true
  private static final String MAP_PATH =
      "../../tests/gdx-tests-android/assets/data/maps/tiled-atlas-processed/deleteMe/";
