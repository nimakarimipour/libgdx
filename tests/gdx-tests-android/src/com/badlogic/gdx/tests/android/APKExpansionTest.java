...
public class APKExpansionTest extends GdxTest {
  ...
  /**
   * The OBB zip assets are taken from the android tests assets directory Extension prefix is
   * prepended to each asset and zipped up into a obb. Extension prefix is required so we can be
   * certain the assets are coming from the obb, while keeping the structure of the assets file tree
   * for easier testing
   */
