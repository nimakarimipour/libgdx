...
public class GwtTestWrapper extends AbstractTestWrapper {
	...
	protected AbstractTestWrapper.Instancer[] getTestList () {
		Instancer[] tests = {new GwtInstancer() {
			...
			// new GwtInstancer() {public GdxTest instance(){return new FlickScrollPaneTest();}}, // FIXME
			// this messes up stuff, why?
			new GwtInstancer() {
				public GdxTest instance () {
			...
			new GwtInstancer() {
				...
				// }, new GwtInstancer() { public GdxTest instance () { return new
				// NoncontinuousRenderingTest(); } // FIXME doesn't compile due to
				// the use of Thread
			}, new GwtInstancer() {
				public GdxTest instance () {
			...
			// new GwtInstancer() {public GdxTest instance(){return new PixmapBlendingTest();}}, // FIXME
			// no idea why this doesn't
			// work
			new GwtInstancer() {
				public GdxTest instance () {
				...
				// new GwtInstancer() {public GdxTest instance(){return new RunnablePostTest();}}, // Goes
				// into infinite loop
				// new GwtInstancer() {public GdxTest instance(){return new ScrollPaneTest();}}, // FIXME
				// this messes up stuff, why?
				// new GwtInstancer() {public GdxTest instance(){return new ShaderMultitextureTest();}}, //
				// FIXME fucks up stuff
			}, new GwtInstancer() {
				public GdxTest instance () {
			...
			// new GwtInstancer() {public GdxTest instance(){return new StagePerformanceTest();}}, //
			// FIXME borks out
			new GwtInstancer() {
				public GdxTest instance () {
