...
public class Lwjgl3TestStarter {
   ...
   * Runs libgdx tests.
   *
   * <p>some options can be passed, see {@link CommandLineOptions}
   *
        ...
        testButton.addListener(
            new ChangeListener() {
              ...
              public void changed(ChangeEvent event, Actor actor) {
                ...
                ((Lwjgl3Application) Gdx.app)
                    .newWindow(new GdxTestWrapper(test, options.logGLErrors), winConfig);
