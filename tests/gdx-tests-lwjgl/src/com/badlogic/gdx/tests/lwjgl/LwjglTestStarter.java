...
public class LwjglTestStarter extends JFrame {
   ...
   * Runs a libGDX test.
   *
   * <p>If no arguments are provided on the command line, shows a list of tests to choose from. If
   * an argument is present, the test with that name will immediately be run. Additional options can
   * be passed, see {@link CommandLineOptions}
   *
