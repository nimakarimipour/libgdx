...
public class Benchmark3DTest extends BaseG3dHudTest {
  ...
  protected Vector3 randomPosition() {
    return new Vector3(
        MathUtils.random(-10f, 10f), MathUtils.random(-10f, 10f), MathUtils.random(-10f, 10f));
  }
  ...
  protected void getStatus(final StringBuilder stringBuilder) {
    ...
    DirectionalLightsAttribute dirLights =
        (DirectionalLightsAttribute) environment.get(DirectionalLightsAttribute.Type);
    PointLightsAttribute pointLights =
        (PointLightsAttribute) environment.get(PointLightsAttribute.Type);

    stringBuilder.setLength(0);
    stringBuilder.append("Lights: ");

    stringBuilder.append(
        (dirLights == null ? 0 : dirLights.lights.size)
            + (pointLights == null ? 0 : pointLights.lights.size));
  ...
  protected void onLoaded() {
    ...
    instance.transform.setToTranslation(
        MathUtils.random(-10, 10), MathUtils.random(-10, 10), MathUtils.random(-10, 10));
