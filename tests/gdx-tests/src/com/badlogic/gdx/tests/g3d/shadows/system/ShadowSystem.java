 ...
 * </pre>
 *
 * <p>Current environnment should be alway be synchonized with shadow system lights. It means that
 * if you add or remove light from environment, you should do it in shadow system too. <br>
 * If you have two different environments, when you switch, you should add and remove all lights in
 * shadow system.
 *
 * @author realitix
 */
