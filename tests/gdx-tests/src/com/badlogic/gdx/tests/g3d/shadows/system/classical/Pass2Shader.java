...
public class Pass2Shader extends DefaultShader {
	...
	public static class Inputs extends DefaultShader.Inputs {
		public static final Uniform shadowMapProjViewTrans = new Uniform("u_shadowMapProjViewTrans");
		public static final Uniform shadowTexture = new Uniform("u_shadowTexture");
		public static final Uniform uvTransform = new Uniform("u_uvTransform");
		public static final Uniform lightColor = new Uniform("u_lightColor");
		public static final Uniform lightDirection = new Uniform("u_lightDirection");
		public static final Uniform lightIntensity = new Uniform("u_lightIntensity");
		public static final Uniform lightPosition = new Uniform("u_lightPosition");
		public static final Uniform lightCutoffAngle = new Uniform("u_lightCutoffAngle");
		public static final Uniform lightExponent = new Uniform("u_lightExponent");
	}

	public static class Setters extends DefaultShader.Setters {
		public static final Setter shadowMapProjViewTrans = new GlobalSetter() {
			@Override
			public void set (BaseShader shader, int inputID, Renderable renderable, Attributes combinedAttributes) {
				shader.set(inputID, shadowSystem.getCurrentLightProperties().camera.combined);
			}
		};
		public static final Setter shadowTexture = new GlobalSetter() {
			@Override
			public void set (BaseShader shader, int inputID, Renderable renderable, Attributes combinedAttributes) {
				shader.set(inputID, shadowSystem.getTexture(0));
			}
		};
		public static final Setter uvTransform = new GlobalSetter() {
			@Override
			public void set (BaseShader shader, int inputID, Renderable renderable, Attributes combinedAttributes) {
		...
		public static final Setter lightColor = new GlobalSetter() {
			@Override
			public void set (BaseShader shader, int inputID, Renderable renderable, Attributes combinedAttributes) {
		...
		public static final Setter lightDirection = new GlobalSetter() {
			@Override
			public void set (BaseShader shader, int inputID, Renderable renderable, Attributes combinedAttributes) {
				BaseLight l = shadowSystem.getCurrentLight();
		...
		public static final Setter lightIntensity = new GlobalSetter() {
			@Override
			public void set (BaseShader shader, int inputID, Renderable renderable, Attributes combinedAttributes) {
				BaseLight l = shadowSystem.getCurrentLight();
				if (l instanceof PointLight) {
		...
		public static final Setter lightPosition = new GlobalSetter() {
			@Override
			public void set (BaseShader shader, int inputID, Renderable renderable, Attributes combinedAttributes) {
				BaseLight l = shadowSystem.getCurrentLight();
				if (l instanceof PointLight) {
		...
		public static final Setter lightCutoffAngle = new GlobalSetter() {
			@Override
			public void set (BaseShader shader, int inputID, Renderable renderable, Attributes combinedAttributes) {
		...
		public static final Setter lightExponent = new GlobalSetter() {
			@Override
			public void set (BaseShader shader, int inputID, Renderable renderable, Attributes combinedAttributes) {
				BaseLight l = shadowSystem.getCurrentLight();
				if (l instanceof SpotLight) {
