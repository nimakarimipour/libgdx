...
public class Pass2Shader extends DefaultShader {
  ...
  public static class Setters extends DefaultShader.Setters {
    public static final Setter shadowMapProjViewTrans =
        new GlobalSetter() {
          @Override
          public void set(
              BaseShader shader,
    ...
    public static final Setter uvTransform =
        new GlobalSetter() {
          @Override
          public void set(
              BaseShader shader,
            ...
            shader.set(
                inputID, tr.getU(), tr.getV(), tr.getU2() - tr.getU(), tr.getV2() - tr.getV());
          }
        };
    public static final Setter lightColor =
        new GlobalSetter() {
          @Override
          public void set(
              BaseShader shader,
            ...
            shader.set(
                inputID, l.color.r * intensity, l.color.g * intensity, l.color.b * intensity);
          }
        };
    public static final Setter lightDirection =
        new GlobalSetter() {
          @Override
          public void set(
              BaseShader shader,
    ...
    public static final Setter lightIntensity =
        new GlobalSetter() {
          @Override
          public void set(
              BaseShader shader,
    ...
    public static final Setter lightPosition =
        new GlobalSetter() {
          @Override
          public void set(
              BaseShader shader,
    ...
    public static final Setter lightCutoffAngle =
        new GlobalSetter() {
          @Override
          public void set(
              BaseShader shader,
            ...
            if (!(shadowSystem.getCurrentLight() instanceof DirectionalLight)) {
              shader.set(
                  inputID,
                  ((PerspectiveCamera) shadowSystem.getCurrentLightProperties().camera)
                      .fieldOfView);
            }
          }
        };
    public static final Setter lightExponent =
        new GlobalSetter() {
          @Override
          public void set(
              BaseShader shader,
