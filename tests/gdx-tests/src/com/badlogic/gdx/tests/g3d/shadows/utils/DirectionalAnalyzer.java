...
/**
 * Directional Analyzer computes the camera's properties needed by directional light. Implementation
 * should use main camera frustum and scene objects to encompass all casting shadow objects.
 *
 * @author realitix
 */
public interface DirectionalAnalyzer {
  /**
   * Compute the camera dimension based on directional light. Camera should be an orthographic
   * camera.
   *
