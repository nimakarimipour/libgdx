...
public class MeshBuilderTest extends BaseG3dHudTest {
  ...
  public void create() {
    ...
    mpb.setUVRange(1f, 1f, 0f, 0f);
    mpb.sphere(
        new Matrix4().translate(5, 0, 10).rotate(Vector3.Z, 45).scale(1, 2, 1), 1f, 1f, 1f, 12, 16);
    ...
    instances.add(
        new ModelInstance(model, new Matrix4().trn(0f, 0f, 10f), "capsuleNoTexture", true));
    instances.add(
        new ModelInstance(model, new Matrix4().trn(0f, 0f, 0f), "transformedSphere", true));
  }
