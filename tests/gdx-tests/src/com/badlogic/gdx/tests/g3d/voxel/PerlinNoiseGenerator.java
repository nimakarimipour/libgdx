...
/**
 * Adapted from <a
 * href="http://devmag.org.za/2009/04/25/perlin-noise/">http://devmag.org.za/2009/04/25/perlin-noise/</a>
 *
 * @author badlogic
 */
public class PerlinNoiseGenerator {
  ...
  public static float[][] generateSmoothNoise(float[][] baseNoise, int octave) {
    ...
    for (int i = 0; i < width; i++) {
      ...
      for (int j = 0; j < height; j++) {
        ...
        float top =
            interpolate(
                baseNoise[sample_i0][sample_j0], baseNoise[sample_i1][sample_j0], horizontal_blend);
        float bottom =
            interpolate(
                baseNoise[sample_i0][sample_j1], baseNoise[sample_i1][sample_j1], horizontal_blend);
  ...
  public static void generateVoxels(VoxelWorld voxelWorld, int min, int max, int octaveCount) {
    byte[] heightMap =
        PerlinNoiseGenerator.generateHeightMap(
            voxelWorld.voxelsX, voxelWorld.voxelsZ, min, max, octaveCount);
    int idx = 0;
