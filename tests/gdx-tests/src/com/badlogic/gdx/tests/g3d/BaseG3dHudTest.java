...
public abstract class BaseG3dHudTest extends BaseG3dTest {
  ...
  public static final float rotationSpeed = 0.02f * 360f; // degrees per second
  public static final float moveSpeed = 0.25f; // cycles per second
  ...
  protected String models[] =
      new String[] {
        ...
        "g3d/monkey.g3db",
        "g3d/ship.obj",
        "g3d/shapes/cube_1.0x1.0.g3dj",
        "g3d/shapes/cube_1.5x1.5.g3dj",
        "g3d/shapes/sphere.g3dj",
        "g3d/shapes/teapot.g3dj",
  ...
  public void render() {
    ...
    if (rotateCheckBox.isChecked())
      transform.rotate(
          Vector3.Y, rotation = (rotation + rotationSpeed * Gdx.graphics.getDeltaTime()) % 360);
    ...
    public CollapsableWindow(String title, Skin skin) {
      ...
      addListener(
          new ClickListener() {
            ...
            public void clicked(InputEvent event, float x, float y) {
              if (getTapCount() == 2
                  && getHeight() - y <= getPadTop()
                  && y < getHeight()
                  && x > 0
                  && x < getWidth()) toggleCollapsed();
            }
          });
    }
