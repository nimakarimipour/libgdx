...
/**
 * Draws a triangle and a trapezoid. The trapezoid is intersection between two triangles, one
 * stencil and the triangle shown on left.
 */
public class FrameBufferTest extends GdxTest {
  ...
  public void render() {
    ...
    spriteBatch.draw(
        stencilFrameBuffer.getColorBufferTexture(),
        256,
        256,
        256,
        256,
