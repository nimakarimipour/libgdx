...
public class CollisionPlaygroundTest extends GdxTest implements ApplicationListener {
  ...
  private ModelInstance createFrustum(PerspectiveCamera camera) {
    ...
    MeshPartBuilder meshPartBuilder =
        mb.part("frustum", PRIMITIVE_TYPE, VertexAttributes.Usage.Position, material);
  ...
  class AABB extends Shape {
    ...
    AABB() {
      ...
      mb.begin();
      MeshPartBuilder meshPartBuilder =
          mb.part("aabb", PRIMITIVE_TYPE, VertexAttributes.Usage.Position, material);
  ...
  class Sphere extends Shape {
    ...
    Sphere() {
      ...
      mb.begin();
      MeshPartBuilder meshPartBuilder =
          mb.part("sphere", PRIMITIVE_TYPE, VertexAttributes.Usage.Position, material);
      meshPartBuilder.setVertexTransform(transform);
