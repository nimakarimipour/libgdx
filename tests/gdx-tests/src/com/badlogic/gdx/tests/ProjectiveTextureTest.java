...
public class ProjectiveTextureTest extends GdxTest {
  ...
  public void setupScene() {
    ...
    plane.setVertices(
        new float[] {
          -10, -1, 10, 0, 1, 0, 10, -1, 10, 0, 1, 0, 10, -1, -10, 0, 1, 0, -10, -1, -10, 0, 1, 0
        });
    ...
    reload.addListener(
        new ClickListener() {
          public void clicked(InputEvent event, float x, float y) {
            ShaderProgram prog =
                new ShaderProgram(
                    Gdx.files.internal("data/shaders/projtex-vert.glsl").readString(),
  ...
  public void render() {
    ...
    if (camera.getSelectedIndex() == 0) {
      ...
      renderMesh(
          projTexShader, projector.combined, projector.combined, planeTrans, plane, Color.WHITE);
      /*
  ...
  private void renderMesh(
      ShaderProgram shader, Matrix4 cam, Matrix4 projector, Matrix4 model, Mesh mesh, Color color) {
