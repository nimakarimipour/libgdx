...
public class FullscreenTest extends GdxTest {
  ...
  public void render() {
    ...
    batch.begin();
    batch.setColor(
        Gdx.input.getX() < Gdx.graphics.getSafeInsetLeft()
                || Gdx.input.getX() + tex.getWidth()
                    > Gdx.graphics.getWidth() - Gdx.graphics.getSafeInsetRight()
            ? Color.RED
            : Color.WHITE);
  ...
  public void resize(int width, int height) {
    ...
    Gdx.app.log(
        "FullscreenTest",
        "safe insets: " + Gdx.graphics.getSafeInsetLeft() + "/" + Gdx.graphics.getSafeInsetRight());
