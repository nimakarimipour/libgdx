...
public class AnnotationTest extends GdxTest {
  ...
  /**
   * Sample annotation. It is required to annotate annotations themselves with {@link
   * RetentionPolicy}.RUNTIME to become available to the {@link ClassReflection} package.
   */
  ...
  public static class AnnotatedClass {
    ...
    @TestAnnotation(
        name = "MyAnnotatedField",
        values = {4, 5})
    public int annotatedValue;

    @TestAnnotation(
        name = "MyAnnotatedMethod",
        values = {6, 7})
  ...
  public void create() {
    ...
    try {
      Annotation annotation =
          ClassReflection.getDeclaredAnnotation(AnnotatedClass.class, TestAnnotation.class);
      if (annotation != null) {
        ...
        println(
            "Class annotation:\n name="
                ...
                + ",\n enum="
                + annotationInstance.someEnum().toString());
      } else {
