...
/**
 * Super Mario Brothers-like very basic platformer, using a tile map built using <a
 * href="http://www.mapeditor.org/">Tiled</a> and a tileset and sprites by <a
 * href="http://www.vickiwenderlich.com/">Vicky Wenderlich</a> Shows simple platformer collision
 * detection as well as on-the-fly map modifications through destructible blocks!
 *
 * @author mzechner
 */
public class SuperKoalio extends GdxTest {
  ...
  private void renderKoala(float deltaTime) {
    ...
    if (koala.facesRight) {
      ...
      batch.draw(
          frame, koala.position.x + Koala.WIDTH, koala.position.y, -Koala.WIDTH, Koala.HEIGHT);
    }
    batch.end();
  }
