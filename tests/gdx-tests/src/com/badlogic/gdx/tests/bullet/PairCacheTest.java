...
public class PairCacheTest extends BaseBulletTest {
  ...
  public void create() {
    ...
    // The ghost object does not need to be shaped as a camera frustum, it can have any collision
    // shape.
  ...
  public void render() {
    ...
    // Find all overlapping pairs which contain the ghost object and draw lines between the
    // collision points.
    ...
    for (int i = 0; i < numPairs; ++i) {
      ...
      for (int j = 0; j < manifoldArray.size(); j++) {
        ...
        int otherObjectIndex =
            isFirstBody ? manifold.getBody1().getUserValue() : manifold.getBody0().getUserValue();
