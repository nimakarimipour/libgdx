...
public class BaseWorld<T extends BaseEntity> implements Disposable {
  public abstract static class Constructor<T extends BaseEntity> implements Disposable {
  ...
  private final ObjectMap<String, Constructor<T>> constructors =
      new ObjectMap<String, Constructor<T>>();
