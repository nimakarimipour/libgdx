...
public class SoftMeshTest extends BaseBulletTest {
  ...
  public BulletWorld createWorld() {
    ...
    btAxisSweep3 broadphase =
        new btAxisSweep3(tmpV1.set(-1000, -1000, -1000), tmpV2.set(1000, 1000, 1000), 1024);
  ...
  public void create() {
    ...
    // Note: not every model is suitable for a one on one translation with a soft body, a better
    // model might be added later.
    ...
    softBody =
        new btSoftBody(
            ...
            indexMap,
            0);
    // Set mass of the first vertex to zero so its unmovable, comment out this line to make it a
    // fully dynamic body.
