...
/**
 * @author xoppa Holds the information necessary to create a bullet btRigidBody. This class should
 *     outlive the btRigidBody (entity) itself.
 */
public class BulletConstructor extends BaseWorld.Constructor<BulletEntity> {
  ...
  /**
   * Specify null for the shape to use only the renderable part of this entity and not the physics
   * part.
   */
  ...
  public BulletConstructor(
      final Model model, final float width, final float height, final float depth) {
