...
public class VehicleFilterTest extends VehicleTest {
  ...
  protected btVehicleRaycaster getRaycaster() {
    FilterableVehicleRaycaster raycaster =
        new FilterableVehicleRaycaster((btDynamicsWorld) world.collisionWorld);
        ...
        if (entity.body != null) {
          if (entity.body instanceof btRigidBody)
            ((btDiscreteDynamicsWorld) collisionWorld)
                .addRigidBody((btRigidBody) entity.body, FILTER_GROUP, FILTER_MASK);
