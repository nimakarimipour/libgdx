...
public class CollisionWorldTest extends BaseBulletTest {
  ...
  @Override
  public void render() {
    movingBox.transform.val[Matrix4.M03] =
        movingBox.transform.val[Matrix4.M13] = movingBox.transform.val[Matrix4.M23] = 0f;
