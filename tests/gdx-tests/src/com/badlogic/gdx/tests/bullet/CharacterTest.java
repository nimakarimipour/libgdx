...
public class CharacterTest extends BaseBulletTest {
  ...
  public BulletWorld createWorld() {
    ...
    btAxisSweep3 sweep =
        new btAxisSweep3(new Vector3(-1000, -1000, -1000), new Vector3(1000, 1000, 1000));
  ...
  public void create() {
    ...
    // Create a visual representation of the character (note that we don't use the physics part of
    // BulletEntity, we'll do that
    // manually)
    ...
    characterController =
        new btKinematicCharacterController(ghostObject, ghostShape, .35f, Vector3.Y);
  ...
  @Override
  public void update() {
    // If the left or right key is pressed, rotate the character and update its physics update
    // accordingly.
    ...
    super.update();
    // And fetch the new transformation of the character (this will make the model be rendered
    // correctly)
