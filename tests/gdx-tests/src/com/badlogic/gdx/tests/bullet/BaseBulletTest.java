...
public class BaseBulletTest extends BulletTest {
  ...
  private static final String customDesktopLib =
  ...
  protected static final Vector3 tmpV1 = new Vector3(), tmpV2 = new Vector3();
  ...
  public void create() {
    ...
    light =
        shadows
            ? new DirectionalShadowLight(1024, 1024, 20f, 20f, 1f, 300f)
  ...
  public void toggleDebugMode() {
    if (world.getDebugMode() == DebugDrawModes.DBG_NoDebug)
      setDebugMode(
          DebugDrawModes.DBG_DrawWireframe
