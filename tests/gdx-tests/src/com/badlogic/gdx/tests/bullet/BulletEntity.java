...
public class BulletEntity extends BaseEntity {
  ...
  public BulletEntity(
      final Model model, final btRigidBodyConstructionInfo bodyInfo, final Matrix4 transform) {
    this(model, bodyInfo == null ? null : new btRigidBody(bodyInfo), transform);
  }

  public BulletEntity(
      final Model model,
      final btCollisionObject body,
      final float x,
      final float y,
      final float z) {
  ...
  static class MotionState extends btMotionState {
    ...
    /**
     * For dynamic and static bodies this method is called by bullet once to get the initial state
     * of the body. For kinematic bodies this method is called on every update, unless the body is
     * deactivated.
     */
    @Override
    ...
    /**
     * For dynamic bodies this method is called by bullet every update to inform about the new
