...
public class KinematicTest extends BaseBulletTest {
  ...
  Vector3 position;
  static final Vector3 position1 = new Vector3(5f, 0.5f, 0f);
  static final Vector3 position2 = new Vector3(8f, 0.5f, 0f);
  static final Vector3 position3 = new Vector3(10f, 0.5f, 0f);
  float angle;
  ...
  public void create() {
    ...
    kinematicBox1.body.setCollisionFlags(
        kinematicBox1.body.getCollisionFlags()
            | btCollisionObject.CollisionFlags.CF_KINEMATIC_OBJECT);
    kinematicBox2 = world.add("staticbox", position2.x, position2.y, position2.z);
    kinematicBox2.setColor(Color.RED);
    kinematicBox2.body.setCollisionFlags(
        kinematicBox2.body.getCollisionFlags()
            | btCollisionObject.CollisionFlags.CF_KINEMATIC_OBJECT);
    ;
    kinematicBox3 = world.add("staticbox", position3.x, position3.y, position3.z);
    kinematicBox3.setColor(Color.RED);
    kinematicBox3.body.setCollisionFlags(
        kinematicBox3.body.getCollisionFlags()
            | btCollisionObject.CollisionFlags.CF_KINEMATIC_OBJECT);
    ;
