...
/**
 * Touch the screen to cycle over 9 test case : (2 triangles, first triangle, second triangle) x
 * (short buffer/short, byte buffer/short, byte buffer/byte).
 */
...
public class VertexArrayTest extends GdxTest {
  ...
  Mesh mesh;
  int[][] testCases = {
    {0, 0, 6}, {0, 0, 3}, {0, 3, 3}, {1, 0, 6}, {1, 0, 3}, {1, 3, 3}, {2, 0, 6}, {2, 0, 3},
    {2, 3, 3}
  };
  int testCase = 0;
