...
public class ReflectionCorrectnessTest extends GdxTest {
  ...
  public void testCustomInterfaceArrayClass() {
    ...
    Class componentClazz =
        com.badlogic.gdx.tests.ReflectionCorrectnessTest.AbstractInterfaceStatic.class;
    Expectation e = new Expectation().mArray().mCompType(componentClazz);
    doTest(clazz, e);
  }
  ...
  public void testCustomAnnotationArrayClass() {
    Class clazz = com.badlogic.gdx.tests.ReflectionCorrectnessTest.AbstractAnnotationStatic[].class;
    Class componentClazz =
        com.badlogic.gdx.tests.ReflectionCorrectnessTest.AbstractAnnotationStatic.class;
    Expectation e = new Expectation().mArray().mCompType(componentClazz);
    doTest(clazz, e);
  }
  ...
  public void expectResult(boolean expected, boolean actual, String message) {
    if (expected != actual) {
      throw new AssertionError(
          "Expected that " + message + " is " + expected + " but is " + actual);
    }
  }
  ...
  public abstract static interface AbstractInterfaceStatic {}

  public abstract static @interface AbstractAnnotationStatic {}
