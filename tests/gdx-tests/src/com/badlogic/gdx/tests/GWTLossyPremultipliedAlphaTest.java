...
public class GWTLossyPremultipliedAlphaTest extends GdxTest {
  ...
  public void create() {
    ...
    FileTextureData data =
        new FileTextureData(
            Gdx.files.internal("data/premultiplied_alpha_test.png"), null, null, false);
    goodTexture = new Texture(data);

    // Load the texture again. But this time, force the GWT implementation of Pixmap to move to a
    // Canvas representation of the
    // image
