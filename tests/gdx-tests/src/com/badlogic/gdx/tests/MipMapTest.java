...
public class MipMapTest extends GdxTest {
  ...
  public void create() {
    ...
    shader =
        new ShaderProgram(
            Gdx.files.internal("data/shaders/flattex-vert.glsl").readString(),
  ...
  public void render() {
    ...
    currTexture.bind();
    currTexture.setFilter(
        TextureFilter.valueOf(minFilter.getSelected()),
        TextureFilter.valueOf(magFilter.getSelected()));
