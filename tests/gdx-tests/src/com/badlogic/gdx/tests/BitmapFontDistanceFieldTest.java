...
public class BitmapFontDistanceFieldTest extends GdxTest {
  ...
  public void create() {
    ...
    regularFont =
        new BitmapFont(
            Gdx.files.internal("data/verdana39.fnt"), new TextureRegion(regularTexture), true);
    regularFont.setColor(COLOR);

    distanceFieldTexture = new Texture(Gdx.files.internal("data/verdana39distancefield.png"), true);
    distanceFieldFont =
        new BitmapFont(
            Gdx.files.internal("data/verdana39distancefield.fnt"),
            new TextureRegion(distanceFieldTexture),
            true);
  ...
  private int drawFont(
    ...
    TextureFilter minFilter =
        linearFiltering ? TextureFilter.MipMapLinearNearest : TextureFilter.Nearest;
