...
public class Scene2dTest extends GdxTest {
  ...
  public void create() {
    ...
    // actor.addAction(parallel(moveTo(250, 250, 2, elasticOut), color(RED, 6), delay(0.5f),
    // rotateTo(180, 5, swing)));
    ...
    ImageTextButtonStyle style =
        new ImageTextButtonStyle(skin.get("default", TextButtonStyle.class));
    style.imageUp = skin.getDrawable("default-round");
    ImageTextButton buttonLeft = new ImageTextButton("HI IM LEFT", style);
    ImageTextButton buttonRight =
        new ImageTextButton("HI IM RIGHT", style) {
          {
            clearChildren();
            add(getLabel());
            add(getImage());
    ...
    CheckBox checkBoxRight =
        new CheckBox("HI IM RIGHT", skin, "default") {
          {
            clearChildren();
            add(getLabel());
            add(getImage());
