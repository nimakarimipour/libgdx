...
public class VibratorTest extends GdxTest {
  ...
  public void create() {
    ...
    buttonVibrateAmplitude.addListener(
        new ChangeListener() {
          @Override
          public void changed(ChangeEvent event, Actor actor) {
            ...
            Gdx.app.log(
                "VibratorTest", "Length: " + randomLength + "ms, Amplitude: " + randomAmplitude);
          }
        });
    final Button buttonVibrateType = getButton("Vibrate \n Type \n Random");
    buttonVibrateType.addListener(
        new ChangeListener() {
          @Override
          public void changed(ChangeEvent event, Actor actor) {
            Input.VibrationType vibrationType =
                Input.VibrationType.values()[
                    MathUtils.random(0, Input.VibrationType.values().length - 1)];
