...
public class ClipboardTest extends GdxTest {
  ...
  public void create() {
    ...
    buttonHasContents =
        new TextButton("Has Contents: " + Gdx.app.getClipboard().hasContents(), skin);

    textArea.setSize(Gdx.graphics.getWidth() / 3f, Gdx.graphics.getHeight() / 3f);

    textArea.setPosition(
        Gdx.graphics.getWidth() / 2f - textArea.getWidth() / 2f,
        Gdx.graphics.getHeight() / 2f - textArea.getHeight() / 2f);
    buttonCopy.setPosition(
        Gdx.graphics.getWidth() / 4f - buttonCopy.getWidth() / 2f,
        Gdx.graphics.getHeight() / 4f - buttonCopy.getHeight() / 2f);
    buttonPaste.setPosition(
        3 * Gdx.graphics.getWidth() / 4f - buttonPaste.getWidth() / 2f,
        Gdx.graphics.getHeight() / 4f - buttonPaste.getHeight() / 2f);
    buttonHasContents.setPosition(
        Gdx.graphics.getWidth() / 2f - buttonHasContents.getWidth() / 2f,
