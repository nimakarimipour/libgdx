...
public class BufferUtilsTest extends GdxTest {
  ...
  public void create() {
    ...
    if (Gdx.app.getType()
        != ApplicationType.WebGL) { // gwt throws: NYI: Numbers.doubleToRawLongBits
  ...
  private void benchByte() {
    ...
    Gdx.app.log(
        "BufferUtilsTest",
        "ByteBuffer relative put: " + (TimeUtils.nanoTime() - start) / 1000000000.0f);
    ...
    Gdx.app.log(
        "BufferUtilsTest",
        "ByteBuffer absolute put: " + (TimeUtils.nanoTime() - start) / 1000000000.0f);
    ...
    Gdx.app.log(
        "BufferUtilsTest",
        "ByteBuffer bulk put: " + (TimeUtils.nanoTime() - start) / 1000000000.0f);
    ...
    Gdx.app.log(
        "BufferUtilsTest",
        "ByteBuffer native bulk put: " + (TimeUtils.nanoTime() - start) / 1000000000.0f);
  }
  ...
  private void benchShort() {
    ...
    Gdx.app.log(
        "BufferUtilsTest",
        "ShortBuffer relative put: " + (TimeUtils.nanoTime() - start) / 1000000000.0f);
    ...
    Gdx.app.log(
        "BufferUtilsTest",
        "ShortBuffer absolute put: " + (TimeUtils.nanoTime() - start) / 1000000000.0f);
    ...
    Gdx.app.log(
        "BufferUtilsTest",
        "ShortBuffer bulk put: " + (TimeUtils.nanoTime() - start) / 1000000000.0f);
    ...
    Gdx.app.log(
        "BufferUtilsTest",
        "ShortBuffer native bulk put: " + (TimeUtils.nanoTime() - start) / 1000000000.0f);
  }
  ...
  private void benchInt() {
    ...
    Gdx.app.log(
        "BufferUtilsTest",
        "IntBuffer relative put: " + (TimeUtils.nanoTime() - start) / 1000000000.0f);
    ...
    Gdx.app.log(
        "BufferUtilsTest",
        "IntBuffer absolute put: " + (TimeUtils.nanoTime() - start) / 1000000000.0f);
    ...
    Gdx.app.log(
        "BufferUtilsTest", "IntBuffer bulk put: " + (TimeUtils.nanoTime() - start) / 1000000000.0f);
    ...
    Gdx.app.log(
        "BufferUtilsTest",
        "IntBuffer native bulk put: " + (TimeUtils.nanoTime() - start) / 1000000000.0f);
  }
  ...
  private void benchLong() {
    ...
    Gdx.app.log(
        "BufferUtilsTest",
        "LongBuffer relative put: " + (TimeUtils.nanoTime() - start) / 1000000000.0f);
    ...
    Gdx.app.log(
        "BufferUtilsTest",
        "LongBuffer absolute put: " + (TimeUtils.nanoTime() - start) / 1000000000.0f);
    ...
    Gdx.app.log(
        "BufferUtilsTest",
        "LongBuffer bulk put: " + (TimeUtils.nanoTime() - start) / 1000000000.0f);
    ...
    Gdx.app.log(
        "BufferUtilsTest",
        "LongBuffer native bulk put: " + (TimeUtils.nanoTime() - start) / 1000000000.0f);
  }
  ...
  private void benchFloat() {
    ...
    Gdx.app.log(
        "BufferUtilsTest",
        "FloatBuffer relative put: " + (TimeUtils.nanoTime() - start) / 1000000000.0f);
    ...
    Gdx.app.log(
        "BufferUtilsTest",
        "FloatBuffer absolute put: " + (TimeUtils.nanoTime() - start) / 1000000000.0f);
    ...
    Gdx.app.log(
        "BufferUtilsTest",
        "FloatBuffer bulk put: " + (TimeUtils.nanoTime() - start) / 1000000000.0f);
    ...
    Gdx.app.log(
        "BufferUtilsTest",
        "FloatBuffer native bulk put: " + (TimeUtils.nanoTime() - start) / 1000000000.0f);
  }
  ...
  private void benchDouble() {
    ...
    Gdx.app.log(
        "BufferUtilsTest",
        "DoubleBuffer relative put: " + (TimeUtils.nanoTime() - start) / 1000000000.0f);
    ...
    Gdx.app.log(
        "BufferUtilsTest",
        "DoubleBuffer absolute put: " + (TimeUtils.nanoTime() - start) / 1000000000.0f);
    ...
    Gdx.app.log(
        "BufferUtilsTest",
        "DoubleBuffer bulk put: " + (TimeUtils.nanoTime() - start) / 1000000000.0f);
