...
public class UBJsonTest extends GdxTest {
  ...
  static {
    ...
    for (int i = 0; i < 300; i++) sb.append((char) ((i % 26) + 'a'));
  ...
  public void create() {
    try {
      ...
      uw.set(
          "xfloats",
          new float[] {Float.MIN_VALUE, Float.MAX_VALUE, Float.NaN, Float.NEGATIVE_INFINITY});
  ...
  private void performanceTest() throws Exception {
    ...
    Gdx.app.log(
        "UBJsonTest", "Writing the test file took " + (System.currentTimeMillis() - start) + "ms");
    ...
    Gdx.app.log(
        "UBJsonTest", "Parsing the test file took " + (System.currentTimeMillis() - start) + "ms");
  }
}
