...
/**
 * Demonstrates how to use non-continuous (aka dirty-only) rendering. The application will clear the
 * screen with a random color every frame it renders. Rendering requests are issued automatically if
