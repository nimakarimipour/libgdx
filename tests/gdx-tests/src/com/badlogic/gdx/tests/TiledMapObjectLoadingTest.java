...
public class TiledMapObjectLoadingTest extends GdxTest {
  ...
  public void create() {
    ...
    // Test get objects by type (adding circle manually because it doesn't exists in Tiledmap
    // editor)
    ...
    loadingStatus +=
        "- CircleMapObject : " + mapObjects.getByType(CircleMapObject.class).size + "\n";
    loadingStatus +=
        "- EllipseMapObject : " + mapObjects.getByType(EllipseMapObject.class).size + "\n";
    loadingStatus +=
        "- PolygonMapObject : " + mapObjects.getByType(PolygonMapObject.class).size + "\n";
    loadingStatus +=
        "- PolylineMapObject : " + mapObjects.getByType(PolylineMapObject.class).size + "\n";
    loadingStatus +=
        "- RectangleMapObject : " + mapObjects.getByType(RectangleMapObject.class).size + "\n";
    loadingStatus +=
        "- TextureMapObject : " + mapObjects.getByType(TextureMapObject.class).size + "\n";
    loadingStatus +=
        "- TiledMapTileMapObject : "
            + mapObjects.getByType(TiledMapTileMapObject.class).size
            + "\n";
  }
    ...
    for (MapObject mapObject : layer.getObjects()) {
      ...
      if (mapObject instanceof TiledMapTileMapObject) {
        ...
        batch.draw(
            ...
            xPos,
            yPos,
            tmtObject.getOriginX() * scaleX,
            tmtObject.getOriginY() * scaleY,
