...
public class TiledMapLayerOffsetTest extends GdxTest {
	private static final String MAP_ORTHO = "data/maps/tiled-offsets/ortho.tmx";
	private static final String MAP_ISO = "data/maps/tiled-offsets/iso.tmx";
	private static final String MAP_ISO_STAG = "data/maps/tiled-offsets/iso_stag.tmx";
	private static final String MAP_HEX_X = "data/maps/tiled-offsets/hex_x.tmx";
	private static final String MAP_HEX_Y = "data/maps/tiled-offsets/hex_y.tmx";
	...
	public void render () {
		...
		// add margin to view bounds so it is easy to see any issues with clipping, calculated same way
		// as
