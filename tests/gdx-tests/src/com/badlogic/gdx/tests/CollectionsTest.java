...
public class CollectionsTest extends GdxTest {
  ...
  private Object[] values = {
    "just", "some", "random", "values", true, false, 50, "nope", "yeah", 53
  };
  private Object[] valuesWithNulls = {
    "just", "some", null, "values", true, false, 50, "nope", "yeah", 53
  };
  ...
  // It is extremely easy to generate String keys that have colliding hashCode()s, so we check to
  // make
  ...
  private String[] problemValues =
      ("21oo 0oq1 0opP 0ooo 0pPo 21pP 21q1 1Poo 1Pq1 1PpP 0q31 0pR1 0q2P 0q1o 232P 231o 2331 0pQP 22QP"
              ...
              + " 22up 1S92 1S8Q 23WQ 23Vp 22w2 1QvQ 1Qw2 1RVp 1RWQ 1RX2 0qX2")
          .split(" ");
  ...
  private void assertEquals(Object a, Object b) {
    if (!a.equals(b))
      throw new GdxRuntimeException(
          a.getClass().getSimpleName() + " equals() failed:\n" + a + "\n!=\n" + b);
    if (!b.equals(a))
      throw new GdxRuntimeException(
          a.getClass().getSimpleName() + " equals() failed (not symmetric):\n" + b + "\n!=\n" + a);
    if (a.hashCode() != b.hashCode())
      throw new GdxRuntimeException(
          a.getClass().getSimpleName() + " hashCode() failed:\n" + a + "\n!=\n" + b);
  }
  ...
  public void testBinaryHeap() {
    ...
    // at this point in a debugger, you can tell that 610.04565 is in position 1, while 700.856 is
    // in position 0.
