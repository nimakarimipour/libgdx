...
public class CollisionFiltering extends Box2DTest {
  ...
  private static final short k_defaultCategory = 0x0001;
  private static final short k_triangleCategory = 0x0002;
  private static final short k_boxCategory = 0x0004;
  private static final short k_circleCategory = 0x0008;

  private static final short k_triangleMask = -1;
  private static final short k_boxMask = -1 ^ k_triangleCategory;
