...
public class NinePatchTest extends GdxTest {
  ...
  // Make a new 'pixmapSize' square texture region with 'patchSize' patches in it. Each patch is a
  // different color.
  ...
  static NinePatch newMidlessPatch() {
    ...
    return new NinePatch(
        new TextureRegion(new Texture(testPatch), fullPatchWidth, fullPatchHeight),
        patchSize,
        patchSize,
        patchSize,
        patchSize);
