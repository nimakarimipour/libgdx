...
public class Lwjgl3Window implements Disposable {
  ...
  private final GLFWWindowIconifyCallback iconifyCallback =
  ...
  private final GLFWWindowCloseCallback closeCallback =
  ...
  private final GLFWWindowRefreshCallback refreshCallback =
  ...
  /**
   * Post a {@link Runnable} to this window's event queue. Use this if you access statics like
   * {@link Gdx#graphics} in your runnable instead of {@link Application#postRunnable(Runnable)}.
   */
  ...
  /**
   * Sets the position of the window in logical coordinates. All monitors span a virtual surface
  ...
  /**
   * @return the window position in logical coordinates. All monitors span a virtual surface
   *     together. The coordinates are relative to the first monitor in the virtual surface. *
   */
  ...
  /**
   * Sets the visibility of the window. Invisible windows will still call their {@link
   * ApplicationListener}
   */
  ...
  /**
   * Minimizes (iconifies) the window. Iconified windows do not call their {@link
   * ApplicationListener} until the window is restored.
   */
  ...
  /**
   * Brings the window to front and sets input focus. The window should already be visible and not
   * iconified.
   */
   ...
   *
   * @param image One or more images. The one closest to the system's desired size will be scaled.
   *     Good sizes include 16x16, 32x32 and 48x48. Pixmap format {@link
   *     com.badlogic.gdx.graphics.Pixmap.Format#RGBA8888 RGBA8888} is preferred so the images will
   *     not have to be copied and converted. The chosen image is copied, and the provided Pixmaps
   *     are not disposed.
   */
   ...
   * resizable, these limits are ignored. Use -1 to indicate an unrestricted dimension.
   */
  public void setSizeLimits(int minWidth, int minHeight, int maxWidth, int maxHeight) {
    setSizeLimits(windowHandle, minWidth, minHeight, maxWidth, maxHeight);
  }

  static void setSizeLimits(
      long windowHandle, int minWidth, int minHeight, int maxWidth, int maxHeight) {
