 ...
 *
 * <p>Taken from the WebGL Draft Spec as of Aug 30, 2010:
 * https://cvs.khronos.org/svn/repos/registry/trunk/public/webgl/doc/spec/WebGL-spec.html TODO:
 * Update this to the Feb 11 version.
 */
public class WebGLRenderingContext extends JavaScriptObject {
   ...
   * available.
   */
  public static native WebGLRenderingContext getContext(
  ...
  public final native void blendFuncSeparate(
  ...
  public final native void copyTexImage2D(
      int target,
      int level,
      int internalformat,
      int x,
  ...
  public final native void copyTexSubImage2D(
  ...
  public final native void framebufferRenderbuffer(
  ...
  public final native void framebufferTexture2D(
  ...
  public final native void readPixels(
  ...
  public final native void renderbufferStorage(
  ...
  public final native void texImage2D(
      int target,
      int level,
      int internalformat,
      int width,
  ...
  public final native void texImage2D(
      int target, int level, int internalformat, int format, int type, ImageData pixels) /*-{
		this.texImage2D(target, level, internalformat, format, type, pixels);
	}-*/;

  public final native void texImage2D(
      int target, int level, int internalformat, int format, int type, ImageElement image) /*-{
		this.texImage2D(target, level, internalformat, format, type, image);
	}-*/;

  public final native void texImage2D(
      int target, int level, int internalformat, int format, int type, CanvasElement canvas) /*-{
		this.texImage2D(target, level, internalformat, format, type, canvas);
	}-*/;

  public final native void texImage2D(
      int target, int level, int internalformat, int format, int type, VideoElement video) /*-{
  ...
  public final native void texSubImage2D(
      int target,
      int level,
      int xoffset,
      int yoffset,
  ...
  public final native void uniform3f(
      WebGLUniformLocation location, float x, float y, float z) /*-{
  ...
  public final native void uniform4f(
      WebGLUniformLocation location, float x, float y, float z, float w) /*-{
  ...
  public final native void uniform4i(
  ...
  public final void uniformMatrix2fv(
      WebGLUniformLocation location, boolean transpose, Float32Array value) {
    this.uniformMatrix2fv(location, transpose, (JavaScriptObject) value);
  }

  public final void uniformMatrix2fv(
      WebGLUniformLocation location, boolean transpose, float[] value) {
    this.uniformMatrix2fv(location, transpose, toJsArray(value));
  }

  private final native void uniformMatrix2fv(
      WebGLUniformLocation location, boolean transpose, JavaScriptObject value) /*-{
		this.uniformMatrix2fv(location, transpose, value);
	}-*/;

  public final void uniformMatrix3fv(
      WebGLUniformLocation location, boolean transpose, Float32Array value) {
  ...
  private final native void uniformMatrix3fv(
      WebGLUniformLocation location, boolean transpose, JavaScriptObject value) /*-{
		this.uniformMatrix3fv(location, transpose, value);
	}-*/;

  public final void uniformMatrix4fv(
      WebGLUniformLocation location, boolean transpose, Float32Array value) {
  ...
  private final native void uniformMatrix4fv(
      WebGLUniformLocation location, boolean transpose, JavaScriptObject value) /*-{
  ...
  public final native void vertexAttribPointer(
   ...
   * Return the value for the passed pname.
   *
   * @param pname one of ACTIVE_TEXTURE, ALPHA_BITS, BLEND_DST_ALPHA, BLEND_DST_RGB,
   *     BLEND_EQUATION_ALPHA, BLEND_EQUATION_RGB, BLEND_SRC_ALPHA, BLEND_SRC_RGB, BLUE_BITS,
   *     CULL_FACE_MODE, DEPTH_BITS, DEPTH_FUNC, FRONT_FACE, GENERATE_MIPMAP_HINT, GREEN_BITS,
   ...
   *     NUM_COMPRESSED_TEXTURE_FORMATS, PACK_ALIGNMENT, RED_BITS, SAMPLE_BUFFERS, SAMPLES,
   *     STENCIL_BACK_FAIL, STENCIL_BACK_FUNC, STENCIL_BACK_PASS_DEPTH_FAIL,
   *     STENCIL_BACK_PASS_DEPTH_PASS, STENCIL_BACK_REF, STENCIL_BACK_VALUE_MASK,
   *     STENCIL_BACK_WRITEMASK, STENCIL_BITS, STENCIL_CLEAR_VALUE, STENCIL_FAIL, STENCIL_FUNC,
   *     STENCIL_PASS_DEPTH_FAIL, STENCIL_PASS_DEPTH_PASS, STENCIL_REF, STENCIL_VALUE_MASK,
   ...
   *     SAMPLE_COVERAGE_INVERT, SCISSOR_TEST, STENCIL_TEST, UNPACK_FLIP_Y_WEBGL,
   ...
   * Return the value for the passed pname.
   *
   * @param pname one of DEPTH_CLEAR_VALUE, LINE_WIDTH, POLYGON_OFFSET_FACTOR, POLYGON_OFFSET_UNITS,
   ...
   * Return the value for the passed pname.
   *
   * @param pname one of ARRAY_BUFFER_BINDING, COMPRESSED_TEXTURE_FORMATS, CURRENT_PROGRAM,
   *     ELEMENT_ARRAY_BUFFER_BINDING, FRAMEBUFFER_BINDING, RENDERBUFFER_BINDING,
   ...
   * Return the value for the passed pname.
   *
   * @param pname one of ALIASED_LINE_WIDTH_RANGE, ALIASED_POINT_SIZE_RANGE, BLEND_COLOR,
   *     COLOR_CLEAR_VALUE, COLOR_WRITEMASK, DEPTH_RANGE, MAX_VIEWPORT_DIMS, SCISSOR_BOX, VIEWPORT
   */
  ...
  public final native boolean getUniformb(
   ...
   * type for the requested pname, as given in the following table: If an attempt is made to call
   * this function with no WebGLTexture bound (see above), an INVALID_OPERATION error is generated.
   *
   ...
   *
   * @param pname one of RENDERBUFFER_WIDTH, RENDERBUFFER_HEIGHT, RENDERBUFFER_INTERNAL_FORMAT,
   *     RENDERBUFFER_RED_SIZE, RENDERBUFFER_GREEN_SIZE, RENDERBUFFER_BLUE_SIZE,
   *     RENDERBUFFER_ALPHA_SIZE, RENDERBUFFER_DEPTH_SIZE, RENDERBUFFER_STENCIL_SIZE
   */
   ...
   */
  public final native int getFramebufferAttachmentParameteri(
