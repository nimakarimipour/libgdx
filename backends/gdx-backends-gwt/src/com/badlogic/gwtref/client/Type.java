...
/**
 * Describes a type (equivalent to {@link Class}), providing methods to retrieve fields,
 * constructors, methods and super interfaces of the type. Only types that are visible (public) can
 * be described by this class.
 *
 * @author mzechner
 */
public class Type {
  ...
  private static final Set<Class> EMPTY_ASSIGNABLES =
      Collections.unmodifiableSet(new HashSet<Class>());
  private static final Set<Class> EMPTY_INTERFACES =
      Collections.unmodifiableSet(new HashSet<Class>());
  ...
  /**
   * @return an array containing all the fields of this class, including private and protected
   *     fields. See {@link Class#getDeclaredFields()}.
   */
  ...
  /**
   * @return an array containing all methods of this class, including abstract, private and
   *     protected methods. See {@link Class#getDeclaredMethods()}.
   */
