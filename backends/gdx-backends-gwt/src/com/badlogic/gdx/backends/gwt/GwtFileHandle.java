...
public class GwtFileHandle extends FileHandle {
  ...
  /**
   * @return The full url to an asset, e.g.
   *     http://localhost:8080/assets/data/shotgun-e5f56587d6f025bff049632853ae4ff9.ogg
   */
  ...
  public FileHandle child(String name) {
    return new GwtFileHandle(
        preloader,
        (file.isEmpty() ? "" : (file + (file.endsWith("/") ? "" : "/"))) + name,
        FileType.Internal);
  }
