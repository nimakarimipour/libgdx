...
public class Timer {
  ...
  /**
   * Timer instance for general application wide usage. Static methods on {@link Timer} make
   * convenient use of this instance.
   */
  ...
  /**
   * Manages the single timer thread. Stops thread on libGDX application pause and dispose, starts
   * thread on resume.
   *
   * @author Nathan Sweet
   */
  static class TimerThread extends com.google.gwt.user.client.Timer
