...
public final class BufferUtils {
  ...
  public static void copy(Buffer src, Buffer dst, int numElements) {
    ...
    else if ((srcIsByte || src instanceof DoubleBuffer)
        && (dstIsByte || dst instanceof DoubleBuffer))
  ...
  private static final FloatBuffer asFloatBuffer(final Buffer data) {
  ...
  private static final float[] asFloatArray(final FloatBuffer buffer) {
  ...
  public static long findFloats(
    ...
    return findFloats(
        asFloatArray(asFloatBuffer(vertex)),
        strideInBytes,
        asFloatArray(asFloatBuffer(vertices)),
        numVertices);
  }
  ...
  public static long findFloats(
    ...
    return findFloats(
        vertex, strideInBytes, asFloatArray(asFloatBuffer(vertices)), numVertices, epsilon);
  }

  public static long findFloats(
      Buffer vertex, int strideInBytes, float[] vertices, int numVertices, float epsilon) {
    return findFloats(
        asFloatArray(asFloatBuffer(vertex)), strideInBytes, vertices, numVertices, epsilon);
  }
