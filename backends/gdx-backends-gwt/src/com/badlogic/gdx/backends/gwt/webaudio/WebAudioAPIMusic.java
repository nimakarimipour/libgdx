...
public class WebAudioAPIMusic implements Music {
  ...
  public WebAudioAPIMusic(
      JavaScriptObject audioContext, Audio audio, AudioControlGraphPool audioControlGraphPool) {
    this.audio = audio;
    this.audioControlGraphPool = audioControlGraphPool;

    // Create AudioSourceNode from Audio element
    JavaScriptObject audioSourceNode =
        createMediaElementAudioSourceNode(audioContext, audio.getAudioElement());
  ...
  public native JavaScriptObject createMediaElementAudioSourceNode(
      JavaScriptObject audioContext, JavaScriptObject audioElement) /*-{
  ...
  public void setVolume(float volume) {
    // Volume can be controlled on the Audio element, or as part of the audio graph. We do it as
    // part of the graph to ensure we
    // use as much common
