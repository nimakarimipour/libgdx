...
public final class ClassReflection {
  ...
  public static Constructor[] getConstructors(Class c) {
    com.badlogic.gwtref.client.Constructor[] constructors =
        ReflectionCache.getType(c).getConstructors();
  ...
  /**
   * Returns an {@link Annotation} object reflecting the annotation provided, or null of this class
   * doesn't have, or doesn't inherit, such an annotation. This is a convenience function if the
   * caller knows already which annotation type he's looking for.
   */
  ...
  public static Annotation[] getDeclaredAnnotations(Class c) {
    java.lang.annotation.Annotation[] annotations =
        ReflectionCache.getType(c).getDeclaredAnnotations();
    Annotation[] result = new Annotation[annotations.length];
    for (int i = 0; i < annotations.length; i++) {
      result[i] = new Annotation(annotations[i]);
    }
  ...
  public static Annotation getDeclaredAnnotation(
    ...
    java.lang.annotation.Annotation annotation =
        ReflectionCache.getType(c).getDeclaredAnnotation(annotationType);
