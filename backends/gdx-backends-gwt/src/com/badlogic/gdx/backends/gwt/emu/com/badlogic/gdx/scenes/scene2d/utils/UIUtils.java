...
public class UIUtils {
  ...
  public static boolean isLinux =
      Navigator.getPlatform().contains("Linux") || Navigator.getPlatform().contains("FreeBSD");
  public static boolean isIos =
      Navigator.getPlatform().contains("iPhone")
  ...
  public static boolean ctrl(int keycode) {
    if (isMac) return keycode == Keys.SYM;
    else return keycode == Keys.CONTROL_LEFT || keycode == Keys.CONTROL_RIGHT;
  }
