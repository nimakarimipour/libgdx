...
/**
 * Interface used by the PreloaderBundleGenerator to decide whether an asset found in the
 * gdx.assetpath should be included in the war/ folder or not. Also used to determine the type of an
 * asset. Default implementation can be found in DefaultAssetFilter, and is used if user doesn't
 * specify a custom filter in the module gwt.xml file.
 *
 * @author mzechner
 */
