 ...
 *
 * <ul class='css'>
 *   <li>.gwt-ProgressBar-shell { primary style }
 *   <li>.gwt-ProgressBar-shell .gwt-ProgressBar-bar { the actual progress bar }
 *   <li>.gwt-ProgressBar-shell .gwt-ProgressBar-text { text on the bar }
 *   <li>.gwt-ProgressBar-shell .gwt-ProgressBar-text-firstHalf { applied to text when progress is
 *       less than 50 percent }
 *   <li>.gwt-ProgressBar-shell .gwt-ProgressBar-text-secondHalf { applied to text when progress is
...
public class ProgressBar extends Widget implements ResizableWidget {
  ...
  public abstract static class TextFormatter {
     ...
     *
     * <p>Override this method to change the text displayed within the ProgressBar.
     *
   ...
   */
  public ProgressBar(
      double minProgress, double maxProgress, double curProgress, TextFormatter textFormatter) {
  ...
  /**
   * Get the current percent complete, relative to the minimum and maximum values. The percent will
   * always be between 0.0 - 1.0.
   *
  ...
  /**
   * This method is called when the dimensions of the parent element change. Subclasses should
   * override this method as needed.
   *
   * <p>Move the text to the center of the progress bar.
   *
  ...
  /**
   * Set the maximum progress. If the minimum progress is more than the current progress, the
   * current progress is adjusted to be within the new range.
   *
   * @param maxProgress the maximum progress
   */
  ...
  /**
   * Set the minimum progress. If the minimum progress is more than the current progress, the
   * current progress is adjusted to be within the new range.
   *
   * @param minProgress the minimum progress
   */
  ...
  /**
   * Generate the text to display within the progress bar. Override this function to change the
   * default progress percent to a more informative message, such as the number of kilobytes
   * downloaded.
   *
   * @param curProgress the current progress
   * @return the text to display in the progress bar
