...
public class AssetDownloader {
  ...
  public void loadImage(
      final String url, final String mimeType, final AssetLoaderListener<ImageElement> listener) {
  ...
  private static native void setOnProgress(
      XMLHttpRequest req, AssetLoaderListener<?> listener) /*-{
