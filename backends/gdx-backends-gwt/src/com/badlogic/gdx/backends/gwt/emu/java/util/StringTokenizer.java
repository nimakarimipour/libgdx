...
public class StringTokenizer implements Enumeration<Object> {
  ...
  /**
   * Constructs a new {@code StringTokenizer} for the parameter string using whitespace as the
   * delimiter. The {@code returnDelimiters} flag is set to {@code false}.
   *
  ...
  /**
   * Constructs a new {@code StringTokenizer} for the parameter string using the specified
   * delimiters, returning the delimiters as tokens if the parameter {@code returnDelimiters} is
   * {@code true}. If {@code delimiters} is null this constructor doesn't throw an {@code
   * Exception}, but later calls to some methods might throw a {@code NullPointerException}.
   *
   * @param string the string to be tokenized.
   * @param delimiters the delimiters to use.
  ...
  /**
   * Returns {@code true} if unprocessed tokens remain. This method is implemented in order to
   * satisfy the {@code Enumeration} interface.
   *
  ...
  /**
   * Returns the next token in the string as a {@code String}. The delimiters used are changed to
