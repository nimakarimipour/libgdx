 ...
 * generated and whether the TextureData is able to manage the pixel data if the OpenGL ES context is lost. In case the
 * TextureData implementation has the type {@link TextureDataType#Custom}, the implementation has to generate the mipmaps itself
 * if necessary. See {@link MipMapGenerator}. Before a call to either {@link #consumePixmap()} or {@link #consumeCustomData(int)},
 * Texture will bind the OpenGL ES texture. Look at {@link FileTextureData} for example implementations of this interface.
 *
 * @author mzechner */
