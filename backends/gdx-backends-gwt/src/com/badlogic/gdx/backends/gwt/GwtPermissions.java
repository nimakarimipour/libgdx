...
public class GwtPermissions {
  /**
   * Returns the user permission status for a given API via the <a
   * href="https://w3c.github.io/permissions/">Permissions API</a>
   *
   * @param permission the permission, see <a
   *     href="https://w3c.github.io/permissions/#permission-registry">w3c</a> for all permissions
   * @param result handler of permission result
   */
  public static native void queryPermission(String permission, GwtPermissionResult result) /*-{
  ...
  /**
   * See <a
   * href="https://w3c.github.io/permissions/#status-of-a-permission">status-of-a-permission</a> for
   * more information
   */
