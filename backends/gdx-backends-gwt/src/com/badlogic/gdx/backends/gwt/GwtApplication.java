...
/**
 * Implementation of an {@link Application} based on GWT. Clients have to override {@link
 * #getConfig()} and {@link #createApplicationListener()}. Clients can override the default loading
 * screen via {@link #getPreloaderCallback()} and implement any loading screen drawing via GWT
 * widgets.
 *
 * @author mzechner
 */
public abstract class GwtApplication implements EntryPoint, Application {
  ...
  public String getPreloaderBaseURL() {
    ...
    // The assets directory is stored alongside the module, find the base path without the module
    // name
  ...
  /**
   * Override this method to return a custom widget informing the that their browser lacks support
   * of WebGL.
   *
   ...
   * colors to your needs by overriding {@link #adjustMeterPanel(Panel, Style)}. <br>
  ...
  /**
   * called by {@link #createPreloaderPanel(String)} for overriding purpose. override this method to
   * adjust the styles of the loading progress bar. Example for changing the bars padding and color:
   *
   * <pre>
   ...
   * behavioral differences. Kindly borrowed from PlayN
   */
  ...
  /**
   * LoadingListener interface main purpose is to do some things before or after {@link
   * GwtApplication#setupLoop()}
   */
