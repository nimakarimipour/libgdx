...
public class LwjglApplication implements LwjglApplicationBase {
  ...
  public LwjglApplication(
      ApplicationListener listener, LwjglApplicationConfiguration config, Canvas canvas) {
    this(listener, config, new LwjglGraphics(canvas, config));
  }

  public LwjglApplication(
      ApplicationListener listener, LwjglApplicationConfiguration config, LwjglGraphics graphics) {
  ...
  protected void mainLoop() {
    ...
    while (running) {
      ...
      if (isMinimized) shouldRender = false;
