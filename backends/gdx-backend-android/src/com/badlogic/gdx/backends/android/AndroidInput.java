...
public interface AndroidInput
    extends Input, OnTouchListener, OnKeyListener, OnGenericMotionListener {
  ...
  /**
   * Process all events (touch, key) that have been registered by the listeners so that event
