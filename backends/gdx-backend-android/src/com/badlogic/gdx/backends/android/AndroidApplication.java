 ...
 * that derives from this class. In the {@link Activity#onCreate(Bundle)} method call the {@link
...
public class AndroidApplication extends Activity implements AndroidApplicationBase {
   ...
   * the things necessary to get input, render via OpenGL and so on. Uses a default {@link
