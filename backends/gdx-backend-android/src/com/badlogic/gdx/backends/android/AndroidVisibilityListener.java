...
/**
 * Allows immersive mode support while maintaining compatibility with Android versions before API
 * Level 19 (4.4)
 *
 * @author Unkn0wn0ne
 */
public class AndroidVisibilityListener {
  ...
  public void createListener(final AndroidApplicationBase application) {
    try {
      ...
      application.log(
          "AndroidApplication",
          "Can't create OnSystemUiVisibilityChangeListener, unable to use immersive mode.",
          t);
    }
  }
}
