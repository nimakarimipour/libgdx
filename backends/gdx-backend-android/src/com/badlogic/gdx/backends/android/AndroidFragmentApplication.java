...
/**
 * Implementation of the {@link AndroidApplicationBase} that is based on the {@link Fragment} class.
 * This class is similar in use to the {@link AndroidApplication} class, which is based on an {@link
 * Activity}.
 *
...
public class AndroidFragmentApplication extends Fragment implements AndroidApplicationBase {
  ...
  /**
   * Callbacks interface for letting the fragment interact with the Activitiy, parent fragment or
   * target fragment.
   *
   * @author Bartol Karuza (me@bartolkaruza.com)
   */
  ...
  private final Array<AndroidEventListener> androidEventListeners =
      new Array<AndroidEventListener>();
  ...
  /**
   * This method has to be called in the {@link Fragment#onCreateView(android.view.LayoutInflater,
   * android.view.ViewGroup, android.os.Bundle)} method. It sets up all the things necessary to get
   * input, render via OpenGL and so on. Uses a default {@link AndroidApplicationConfiguration}.
   *
   * <p>Note: you have to return the returned view from the {@link
   ...
   * This method has to be called in the {@link Fragment#onCreateView(android.view.LayoutInflater,
   * android.view.ViewGroup, android.os.Bundle)} method. It sets up all the things necessary to get
   * input, render via OpenGL and so on. You can configure other aspects of the application with the
   * rest of the fields in the {@link AndroidApplicationConfiguration} instance.
   *
   * <p>Note: you have to return the returned view from {@link
   * Fragment#onCreateView(android.view.LayoutInflater, android.view.ViewGroup, android.os.Bundle)}
   *
   * @param listener the {@link ApplicationListener} implementing the program logic
  ...
  public View initializeForView(
      ApplicationListener listener, AndroidApplicationConfiguration config) {
  ...
  public void onPause() {
    ...
    // This fragment (or one of the parent) is currently being removed from its activity or the
    // activity is in the process of
    // finishing
  ...
  /**
   * Iterates over nested fragments hierarchy and returns true if one of the fragment is in the
   * removal process
   *
