 ...
 * that derives from this class. In the Activity#onCreate(Bundle) method call the {@link
 * #initialize(ApplicationListener)} method specifying the configuration for the {@link
 * GLSurfaceView}.
 *
 * @author mzechner
 */
...
public class AndroidDaydream extends DreamService implements AndroidApplicationBase {
  ...
  /**
   * This method has to be called in the Activity#onCreate(Bundle) method. It sets up all the things
   * necessary to get input, render via OpenGL and so on. Uses a default {@link
  ...
  /**
   * This method has to be called in the Activity#onCreate(Bundle) method. It sets up all the things
   * necessary to get input, render via OpenGL and so on. You can configure other aspects of the
   * application with the rest of the fields in the {@link AndroidApplicationConfiguration}
   * instance.
   *
   * @param listener the {@link ApplicationListener} implementing the program logic
   ...
   * AndroidApplicationConfiguration}.
   *
   * <p>Note: you have to add the returned view to your layout!
   *
   * @param listener the {@link ApplicationListener} implementing the program logic
