...
public final class AndroidGraphicsLiveWallpaper extends AndroidGraphics {
  ...
  public AndroidGraphicsLiveWallpaper(
      AndroidLiveWallpaper lwp,
  ...
  protected GLSurfaceView20 createGLSurfaceView(
    ...
    GLSurfaceView20 view =
        new GLSurfaceView20(application.getContext(), resolutionStrategy) {
          @Override
  ...
  public void onDrawFrame(javax.microedition.khronos.opengles.GL10 gl) {
    ...
    // error in renderer
    // jw: this hack is not working always, renderer ends with error for some devices - because of
