...
public class AndroidGL30 extends AndroidGL20 implements GL30 {
  ...
  public void glTexImage3D(
    ...
    if (pixels == null)
      GLES30.glTexImage3D(
          target, level, internalformat, width, height, depth, border, format, type, 0);
    else
      GLES30.glTexImage3D(
  ...
  public void glTexImage3D(
      ...
      int offset) {
    GLES30.glTexImage3D(
        target, level, internalformat, width, height, depth, border, format, type, offset);
  }
  ...
  public void glTexSubImage3D(
      ...
      int offset) {
    GLES30.glTexSubImage3D(
        target, level, xoffset, yoffset, zoffset, width, height, depth, format, type, offset);
  }
  ...
  //
  // @Override
  // public void glCompressedTexImage3D(int target, int level, int internalformat, int width, int
  // height, int depth, int border, int
  // imageSize, java.nio.Buffer data) {
  // GLES30.glCompressedTexImage3D(target, level, internalformat, width, height, depth, border,
  // imageSize, data);
  // }
  //
  // @Override
  ...
  //
  // @Override
  // public void glCompressedTexSubImage3D(int target, int level, int xoffset, int yoffset, int
  // zoffset, int width, int height, int
  // depth, int format, int imageSize, java.nio.Buffer data) {
  // GLES30.glCompressedTexSubImage3D(target, level, xoffset, yoffset, zoffset, width, height,
  ...
  // @Override
  // public void glUniformMatrix2x3fv(int location, int count, boolean transpose, float[] value, int
  // offset) {
  ...
  // @Override
  // public void glUniformMatrix3x2fv(int location, int count, boolean transpose, float[] value, int
  // offset) {
  ...
  // @Override
  // public void glUniformMatrix2x4fv(int location, int count, boolean transpose, float[] value, int
  // offset) {
  ...
  // @Override
  // public void glUniformMatrix4x2fv(int location, int count, boolean transpose, float[] value, int
  // offset) {
  ...
  // @Override
  // public void glUniformMatrix3x4fv(int location, int count, boolean transpose, float[] value, int
  // offset) {
  ...
  // @Override
  // public void glUniformMatrix4x3fv(int location, int count, boolean transpose, float[] value, int
  // offset) {
  ...
  // int lengthOffset, int[] size, int
  // sizeOffset, int[] type, int typeOffset, byte[] name, int nameOffset) {
  // GLES30.glGetTransformFeedbackVarying(program, index, bufsize, length, lengthOffset, size,
  // sizeOffset, type, typeOffset, name,
  // nameOffset);
  // }

  // @Override
  // public void glGetTransformFeedbackVarying(int program, int index, int bufsize,
  // java.nio.IntBuffer length, java.nio.IntBuffer
  // size, java.nio.IntBuffer type, byte name) {
  // GLES30.glGetTransformFeedbackVarying(program, index, bufsize, length, size, type, name);
  // }
  //
  // @Override
  // public String glGetTransformFeedbackVarying(int program, int index, int[] size, int sizeOffset,
  // int[] type, int typeOffset) {
  // return GLES30.glGetTransformFeedbackVarying(program, index, size, sizeOffset, type,
  // typeOffset);
  // }
  //
  // @Override
  ...
  //
  // @Override
  // public void glGetUniformIndices(int program, String[] uniformNames, int[] uniformIndices, int
  ...
  // @Override
  // public void glGetActiveUniformsiv(int program, int uniformCount, int[] uniformIndices, int
  // uniformIndicesOffset, int pname,
  // int[] params, int paramsOffset) {
  // GLES30.glGetActiveUniformsiv(program, uniformCount, uniformIndices, uniformIndicesOffset,
  // pname, params, paramsOffset);
  // }
  ...
  //
  // @Override
  // public void glGetActiveUniformBlockiv(int program, int uniformBlockIndex, int pname, int[]
  // params, int offset) {
  ...
  //
  // @Override
  // public void glGetActiveUniformBlockName(int program, int uniformBlockIndex, int bufSize, int[]
  // length, int lengthOffset, byte[]
  // uniformBlockName, int uniformBlockNameOffset) {
  // GLES30.glGetActiveUniformBlockName(program, uniformBlockIndex, bufSize, length, lengthOffset,
  // uniformBlockName,
  ...
  // @Override
  // public void glDrawElementsInstanced(int mode, int count, int type, java.nio.Buffer indices, int
  // instanceCount) {
  ...
  // @Override
  // public void glGetSynciv(long sync, int pname, int bufSize, int[] length, int lengthOffset,
  // int[] values, int valuesOffset) {
  // GLES30.glGetSynciv(sync, pname, bufSize, length, lengthOffset, values, valuesOffset);
  // }
  //
  // @Override
  // public void glGetSynciv(long sync, int pname, int bufSize, java.nio.IntBuffer length,
  ...
  // @Override
  // public void glGetProgramBinary(int program, int bufSize, int[] length, int lengthOffset, int[]
  // binaryFormat, int
  // binaryFormatOffset, java.nio.Buffer binary) {
  // GLES30.glGetProgramBinary(program, bufSize, length, lengthOffset, binaryFormat,
  // binaryFormatOffset, binary);
  // }
  //
  // @Override
  // public void glGetProgramBinary(int program, int bufSize, java.nio.IntBuffer length,
  ...
  // @Override
  // public void glInvalidateFramebuffer(int target, int numAttachments, int[] attachments, int
  // offset) {
  ...
  //
  // @Override
  // public void glInvalidateSubFramebuffer(int target, int numAttachments, int[] attachments, int
  // offset, int x, int y, int width,
  // int height) {
  // GLES30.glInvalidateSubFramebuffer(target, numAttachments, attachments, offset, x, y, width,
  // height);
  // }
  ...
  //
  // @Override
  // public void glGetInternalformativ(int target, int internalformat, int pname, int bufSize, int[]
  // params, int offset) {
