...
/**
 * Interface that abstracts the Android application class usages, so that libGDX can be used with a
 * fragment (or with any other client code)
 *
...
public interface AndroidApplicationBase extends Application {
  ...
  /**
   * Method signifies an intent to start an activity, may be the default method of the {@link
   * Activity} class
   *
