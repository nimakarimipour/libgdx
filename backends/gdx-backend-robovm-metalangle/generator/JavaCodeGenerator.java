...
public class JavaCodeGenerator {
  /**
   * This would allow us to keep exact formatting, but it's broken for FieldDeclarations for some
   * reason. Potential related to https://github.com/javaparser/javaparser/issues/1601
   */
  ...
  static {
    ...
    IMPORT_REPLACEMENTS.put(
        "org.robovm.apple.glkit.GLKViewControllerDelegate",
        "com.badlogic.gdx.backends.iosrobovm.bindings.metalangle.MGLKViewControllerDelegate");
    IMPORT_REPLACEMENTS.put(
        "org.robovm.apple.glkit.GLKViewDelegate",
  ...
  private static void parse(File f) throws Exception {
    ...
    ModifierVisitor<Object> visitor =
        new ModifierVisitor() {
          @Override
          ...
          public Visitable visit(ClassOrInterfaceType n, final Object arg) {
            ...
            if (CLASS_REPLACEMENTS.containsKey(n.asString())) {
              n =
                  javaParser
                      .parseClassOrInterfaceType(CLASS_REPLACEMENTS.get(n.asString()))
                      .getResult()
                      .get();
            }
            return n;
          ...
          public Visitable visit(ClassOrInterfaceDeclaration n, Object arg) {
            ...
            String base =
                n.getJavadocComment().isPresent() ? n.getJavadocComment().get().getContent() : "";
    ...
    File out =
        new File(
            "src", f.getCanonicalPath().substring(BASE_PROJECT_SRC.getCanonicalPath().length()));
