...
public class IOSApplicationConfiguration {
   ...
   * OpenGL ES 2.0. When GL ES 3 is enabled, {@link com.badlogic.gdx.Gdx#gl30} can be used to access
   * it's functionality.
   *
  ...
  /**
   * whether the home indicator should auto-hide or not. Be careful that if enabled, leaving the app
   * only takes one swipe gesture instead of two and the indicator is never semitransparent. *
   */
  ...
  /**
   * Edges where app gestures must be fired over system gestures. Prior to iOS 11, UIRectEdge.All
   * was default behaviour if status bar hidden, see https://github.com/libgdx/libgdx/issues/5110 *
   */
  ...
  /**
   * This setting allows you to specify whether you want to work in logical or raw pixel units. See
   * {@link HdpiMode} for more information. Note that some OpenGL functions like {@link
